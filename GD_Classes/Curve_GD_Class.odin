...
Curve_Init_ :: proc (Curve_methods: ^Curve_MethodBind_List, loc := #caller_location) {
  ...
  Curve_methods.get_point_count.m_call = cast(type_of(Curve_methods.get_point_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Curve_methods.set_point_count.m_call = cast(type_of(Curve_methods.set_point_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Curve_methods.add_point._add_point = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Curve, "add_point", 434072736, loc))
  Curve_methods.add_point.m_call = cast(type_of(Curve_methods.add_point.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Curve_methods.remove_point._remove_point = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Curve, "remove_point", 1286410249, loc))
  Curve_methods.remove_point.m_call = cast(type_of(Curve_methods.remove_point.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Curve_methods.clear_points._clear_points = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Curve, "clear_points", 3218959716, loc))
  Curve_methods.clear_points.m_call = cast(type_of(Curve_methods.clear_points.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Curve_methods.get_point_position.m_call = cast(type_of(Curve_methods.get_point_position.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Curve_methods.set_point_value.m_call = cast(type_of(Curve_methods.set_point_value.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Curve_methods.set_point_offset.m_call = cast(type_of(Curve_methods.set_point_offset.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Curve_methods.sample._sample = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Curve, "sample", 3919130443, loc))
  Curve_methods.sample.m_call = cast(type_of(Curve_methods.sample.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Curve_methods.sample_baked._sample_baked = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Curve, "sample_baked", 3919130443, loc))
  Curve_methods.sample_baked.m_call = cast(type_of(Curve_methods.sample_baked.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Curve_methods.get_point_left_tangent.m_call = cast(type_of(Curve_methods.get_point_left_tangent.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Curve_methods.get_point_right_tangent.m_call = cast(type_of(Curve_methods.get_point_right_tangent.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Curve_methods.get_point_left_mode.m_call = cast(type_of(Curve_methods.get_point_left_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Curve_methods.get_point_right_mode.m_call = cast(type_of(Curve_methods.get_point_right_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Curve_methods.set_point_left_tangent.m_call = cast(type_of(Curve_methods.set_point_left_tangent.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Curve_methods.set_point_right_tangent.m_call = cast(type_of(Curve_methods.set_point_right_tangent.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Curve_methods.set_point_left_mode.m_call = cast(type_of(Curve_methods.set_point_left_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Curve_methods.set_point_right_mode.m_call = cast(type_of(Curve_methods.set_point_right_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Curve_methods.get_min_value.m_call = cast(type_of(Curve_methods.get_min_value.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Curve_methods.set_min_value.m_call = cast(type_of(Curve_methods.set_min_value.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Curve_methods.get_max_value.m_call = cast(type_of(Curve_methods.get_max_value.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Curve_methods.set_max_value.m_call = cast(type_of(Curve_methods.set_max_value.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Curve_methods.get_value_range.m_call = cast(type_of(Curve_methods.get_value_range.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Curve_methods.get_min_domain.m_call = cast(type_of(Curve_methods.get_min_domain.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Curve_methods.set_min_domain.m_call = cast(type_of(Curve_methods.set_min_domain.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Curve_methods.get_max_domain.m_call = cast(type_of(Curve_methods.get_max_domain.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Curve_methods.set_max_domain.m_call = cast(type_of(Curve_methods.set_max_domain.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Curve_methods.get_domain_range.m_call = cast(type_of(Curve_methods.get_domain_range.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Curve_methods.clean_dupes._clean_dupes = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Curve, "clean_dupes", 3218959716, loc))
  Curve_methods.clean_dupes.m_call = cast(type_of(Curve_methods.clean_dupes.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Curve_methods.bake._bake = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Curve, "bake", 3218959716, loc))
  Curve_methods.bake.m_call = cast(type_of(Curve_methods.bake.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Curve_methods.get_bake_resolution.m_call = cast(type_of(Curve_methods.get_bake_resolution.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Curve_methods.set_bake_resolution.m_call = cast(type_of(Curve_methods.set_bake_resolution.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
