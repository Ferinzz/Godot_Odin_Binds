...
VisualShaderNodeVectorFunc_MethodBind_List :: struct {
  set_function: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: VisualShaderNodeVectorFunc, #by_ptr args: struct{func: ^VisualShaderNodeVectorFunc_Function, }, r_ret: rawptr = nil)
  },
    get_function: struct{
    using _get_function: ^GDW.MethodBind,
    m_call: proc "c" (_:^GDW.MethodBind, obj: VisualShaderNodeVectorFunc, args: rawptr = nil, r_ret: ^VisualShaderNodeVectorFunc_Function)
  },
};
VisualShaderNodeVectorFunc_Init_ :: proc (VisualShaderNodeVectorFunc_methods: ^VisualShaderNodeVectorFunc_MethodBind_List, loc := #caller_location) {
  ...
  VisualShaderNodeVectorFunc_methods.set_function._set_function = (cast(^GDW.MethodBind)classDBGetMethodBind3(.VisualShaderNodeVectorFunc, "set_function", 629964457, loc))
  ...
  VisualShaderNodeVectorFunc_methods.get_function._get_function = (cast(^GDW.MethodBind)classDBGetMethodBind3(.VisualShaderNodeVectorFunc, "get_function", 4047776843, loc))
