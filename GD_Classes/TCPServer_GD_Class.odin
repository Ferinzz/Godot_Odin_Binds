...
TCPServer_Init_ :: proc (TCPServer_methods: ^TCPServer_MethodBind_List, loc := #caller_location) {
  ...
  TCPServer_methods.listen.m_call = cast(type_of(TCPServer_methods.listen.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TCPServer_methods.get_local_port.m_call = cast(type_of(TCPServer_methods.get_local_port.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TCPServer_methods.take_connection.m_call = cast(type_of(TCPServer_methods.take_connection.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
