...
StaticBody2D_Init_ :: proc (StaticBody2D_methods: ^StaticBody2D_MethodBind_List, loc := #caller_location) {
  ...
  StaticBody2D_methods.set_constant_linear_velocity.m_call = cast(type_of(StaticBody2D_methods.set_constant_linear_velocity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  StaticBody2D_methods.set_constant_angular_velocity.m_call = cast(type_of(StaticBody2D_methods.set_constant_angular_velocity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  StaticBody2D_methods.get_constant_linear_velocity.m_call = cast(type_of(StaticBody2D_methods.get_constant_linear_velocity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  StaticBody2D_methods.get_constant_angular_velocity.m_call = cast(type_of(StaticBody2D_methods.get_constant_angular_velocity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  StaticBody2D_methods.set_physics_material_override.m_call = cast(type_of(StaticBody2D_methods.set_physics_material_override.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  StaticBody2D_methods.get_physics_material_override.m_call = cast(type_of(StaticBody2D_methods.get_physics_material_override.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
