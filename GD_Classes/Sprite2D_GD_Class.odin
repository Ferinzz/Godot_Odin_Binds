...
Sprite2D_Init_ :: proc (Sprite2D_methods: ^Sprite2D_MethodBind_List, loc := #caller_location) {
  ...
  Sprite2D_methods.set_texture.m_call = cast(type_of(Sprite2D_methods.set_texture.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Sprite2D_methods.get_texture.m_call = cast(type_of(Sprite2D_methods.get_texture.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Sprite2D_methods.set_centered.m_call = cast(type_of(Sprite2D_methods.set_centered.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Sprite2D_methods.is_centered.m_call = cast(type_of(Sprite2D_methods.is_centered.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Sprite2D_methods.set_offset._set_offset = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Sprite2D, "set_offset", 743155724, loc))
  Sprite2D_methods.set_offset.m_call = cast(type_of(Sprite2D_methods.set_offset.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Sprite2D_methods.get_offset._get_offset = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Sprite2D, "get_offset", 3341600327, loc))
  Sprite2D_methods.get_offset.m_call = cast(type_of(Sprite2D_methods.get_offset.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Sprite2D_methods.set_flip_h._set_flip_h = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Sprite2D, "set_flip_h", 2586408642, loc))
  Sprite2D_methods.set_flip_h.m_call = cast(type_of(Sprite2D_methods.set_flip_h.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Sprite2D_methods.is_flipped_h.m_call = cast(type_of(Sprite2D_methods.is_flipped_h.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Sprite2D_methods.set_flip_v._set_flip_v = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Sprite2D, "set_flip_v", 2586408642, loc))
  Sprite2D_methods.set_flip_v.m_call = cast(type_of(Sprite2D_methods.set_flip_v.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Sprite2D_methods.is_flipped_v.m_call = cast(type_of(Sprite2D_methods.is_flipped_v.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Sprite2D_methods.set_region_enabled.m_call = cast(type_of(Sprite2D_methods.set_region_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Sprite2D_methods.is_region_enabled.m_call = cast(type_of(Sprite2D_methods.is_region_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Sprite2D_methods.is_pixel_opaque.m_call = cast(type_of(Sprite2D_methods.is_pixel_opaque.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Sprite2D_methods.set_region_rect.m_call = cast(type_of(Sprite2D_methods.set_region_rect.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Sprite2D_methods.get_region_rect.m_call = cast(type_of(Sprite2D_methods.get_region_rect.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Sprite2D_methods.set_region_filter_clip_enabled.m_call = cast(type_of(Sprite2D_methods.set_region_filter_clip_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Sprite2D_methods.is_region_filter_clip_enabled.m_call = cast(type_of(Sprite2D_methods.is_region_filter_clip_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Sprite2D_methods.set_frame._set_frame = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Sprite2D, "set_frame", 1286410249, loc))
  Sprite2D_methods.set_frame.m_call = cast(type_of(Sprite2D_methods.set_frame.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Sprite2D_methods.get_frame._get_frame = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Sprite2D, "get_frame", 3905245786, loc))
  Sprite2D_methods.get_frame.m_call = cast(type_of(Sprite2D_methods.get_frame.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Sprite2D_methods.set_frame_coords.m_call = cast(type_of(Sprite2D_methods.set_frame_coords.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Sprite2D_methods.get_frame_coords.m_call = cast(type_of(Sprite2D_methods.get_frame_coords.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Sprite2D_methods.set_vframes.m_call = cast(type_of(Sprite2D_methods.set_vframes.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Sprite2D_methods.get_vframes.m_call = cast(type_of(Sprite2D_methods.get_vframes.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Sprite2D_methods.set_hframes.m_call = cast(type_of(Sprite2D_methods.set_hframes.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Sprite2D_methods.get_hframes.m_call = cast(type_of(Sprite2D_methods.get_hframes.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Sprite2D_methods.get_rect._get_rect = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Sprite2D, "get_rect", 1639390495, loc))
  Sprite2D_methods.get_rect.m_call = cast(type_of(Sprite2D_methods.get_rect.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
