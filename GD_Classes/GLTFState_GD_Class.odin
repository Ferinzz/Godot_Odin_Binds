...
GLTFState_Init_ :: proc (GLTFState_methods: ^GLTFState_MethodBind_List, loc := #caller_location) {
  ...
  GLTFState_methods.add_used_extension.m_call = cast(type_of(GLTFState_methods.add_used_extension.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.append_data_to_buffers.m_call = cast(type_of(GLTFState_methods.append_data_to_buffers.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.append_gltf_node.m_call = cast(type_of(GLTFState_methods.append_gltf_node.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  GLTFState_methods.get_json._get_json = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GLTFState, "get_json", 3102165223, loc))
  GLTFState_methods.get_json.m_call = cast(type_of(GLTFState_methods.get_json.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  GLTFState_methods.set_json._set_json = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GLTFState, "set_json", 4155329257, loc))
  GLTFState_methods.set_json.m_call = cast(type_of(GLTFState_methods.set_json.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.get_major_version.m_call = cast(type_of(GLTFState_methods.get_major_version.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.set_major_version.m_call = cast(type_of(GLTFState_methods.set_major_version.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.get_minor_version.m_call = cast(type_of(GLTFState_methods.get_minor_version.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.set_minor_version.m_call = cast(type_of(GLTFState_methods.set_minor_version.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.get_copyright.m_call = cast(type_of(GLTFState_methods.get_copyright.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.set_copyright.m_call = cast(type_of(GLTFState_methods.set_copyright.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.get_glb_data.m_call = cast(type_of(GLTFState_methods.get_glb_data.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.set_glb_data.m_call = cast(type_of(GLTFState_methods.set_glb_data.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.get_use_named_skin_binds.m_call = cast(type_of(GLTFState_methods.get_use_named_skin_binds.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.set_use_named_skin_binds.m_call = cast(type_of(GLTFState_methods.set_use_named_skin_binds.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  GLTFState_methods.get_nodes._get_nodes = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GLTFState, "get_nodes", 3995934104, loc))
  GLTFState_methods.get_nodes.m_call = cast(type_of(GLTFState_methods.get_nodes.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  GLTFState_methods.set_nodes._set_nodes = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GLTFState, "set_nodes", 381264803, loc))
  GLTFState_methods.set_nodes.m_call = cast(type_of(GLTFState_methods.set_nodes.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.get_buffers.m_call = cast(type_of(GLTFState_methods.get_buffers.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.set_buffers.m_call = cast(type_of(GLTFState_methods.set_buffers.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.get_buffer_views.m_call = cast(type_of(GLTFState_methods.get_buffer_views.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.set_buffer_views.m_call = cast(type_of(GLTFState_methods.set_buffer_views.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.get_accessors.m_call = cast(type_of(GLTFState_methods.get_accessors.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.set_accessors.m_call = cast(type_of(GLTFState_methods.set_accessors.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.get_meshes.m_call = cast(type_of(GLTFState_methods.get_meshes.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.set_meshes.m_call = cast(type_of(GLTFState_methods.set_meshes.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.get_animation_players_count.m_call = cast(type_of(GLTFState_methods.get_animation_players_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.get_animation_player.m_call = cast(type_of(GLTFState_methods.get_animation_player.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.get_materials.m_call = cast(type_of(GLTFState_methods.get_materials.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.set_materials.m_call = cast(type_of(GLTFState_methods.set_materials.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.get_scene_name.m_call = cast(type_of(GLTFState_methods.get_scene_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.set_scene_name.m_call = cast(type_of(GLTFState_methods.set_scene_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.get_base_path.m_call = cast(type_of(GLTFState_methods.get_base_path.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.set_base_path.m_call = cast(type_of(GLTFState_methods.set_base_path.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.get_filename.m_call = cast(type_of(GLTFState_methods.get_filename.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.set_filename.m_call = cast(type_of(GLTFState_methods.set_filename.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.get_root_nodes.m_call = cast(type_of(GLTFState_methods.get_root_nodes.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.set_root_nodes.m_call = cast(type_of(GLTFState_methods.set_root_nodes.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.get_textures.m_call = cast(type_of(GLTFState_methods.get_textures.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.set_textures.m_call = cast(type_of(GLTFState_methods.set_textures.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.get_texture_samplers.m_call = cast(type_of(GLTFState_methods.get_texture_samplers.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.set_texture_samplers.m_call = cast(type_of(GLTFState_methods.set_texture_samplers.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.get_images.m_call = cast(type_of(GLTFState_methods.get_images.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.set_images.m_call = cast(type_of(GLTFState_methods.set_images.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  GLTFState_methods.get_skins._get_skins = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GLTFState, "get_skins", 3995934104, loc))
  GLTFState_methods.get_skins.m_call = cast(type_of(GLTFState_methods.get_skins.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  GLTFState_methods.set_skins._set_skins = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GLTFState, "set_skins", 381264803, loc))
  GLTFState_methods.set_skins.m_call = cast(type_of(GLTFState_methods.set_skins.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.get_cameras.m_call = cast(type_of(GLTFState_methods.get_cameras.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.set_cameras.m_call = cast(type_of(GLTFState_methods.set_cameras.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.get_lights.m_call = cast(type_of(GLTFState_methods.get_lights.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.set_lights.m_call = cast(type_of(GLTFState_methods.set_lights.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.get_unique_names.m_call = cast(type_of(GLTFState_methods.get_unique_names.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.set_unique_names.m_call = cast(type_of(GLTFState_methods.set_unique_names.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.get_unique_animation_names.m_call = cast(type_of(GLTFState_methods.get_unique_animation_names.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.set_unique_animation_names.m_call = cast(type_of(GLTFState_methods.set_unique_animation_names.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.get_skeletons.m_call = cast(type_of(GLTFState_methods.get_skeletons.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.set_skeletons.m_call = cast(type_of(GLTFState_methods.set_skeletons.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.get_create_animations.m_call = cast(type_of(GLTFState_methods.get_create_animations.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.set_create_animations.m_call = cast(type_of(GLTFState_methods.set_create_animations.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.get_import_as_skeleton_bones.m_call = cast(type_of(GLTFState_methods.get_import_as_skeleton_bones.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.set_import_as_skeleton_bones.m_call = cast(type_of(GLTFState_methods.set_import_as_skeleton_bones.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.get_animations.m_call = cast(type_of(GLTFState_methods.get_animations.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.set_animations.m_call = cast(type_of(GLTFState_methods.set_animations.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.get_scene_node.m_call = cast(type_of(GLTFState_methods.get_scene_node.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.get_node_index.m_call = cast(type_of(GLTFState_methods.get_node_index.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.get_additional_data.m_call = cast(type_of(GLTFState_methods.get_additional_data.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.set_additional_data.m_call = cast(type_of(GLTFState_methods.set_additional_data.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.get_handle_binary_image_mode.m_call = cast(type_of(GLTFState_methods.get_handle_binary_image_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.set_handle_binary_image_mode.m_call = cast(type_of(GLTFState_methods.set_handle_binary_image_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.set_bake_fps.m_call = cast(type_of(GLTFState_methods.set_bake_fps.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.get_bake_fps.m_call = cast(type_of(GLTFState_methods.get_bake_fps.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.get_handle_binary_image.m_call = cast(type_of(GLTFState_methods.get_handle_binary_image.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFState_methods.set_handle_binary_image.m_call = cast(type_of(GLTFState_methods.set_handle_binary_image.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
