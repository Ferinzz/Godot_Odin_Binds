...
ZIPReader_Init_ :: proc (ZIPReader_methods: ^ZIPReader_MethodBind_List, loc := #caller_location) {
  ...
  ZIPReader_methods.open.m_call = cast(type_of(ZIPReader_methods.open.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ZIPReader_methods.close._close = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.ZIPReader, "close", 166280745, loc))
  ZIPReader_methods.close.m_call = cast(type_of(ZIPReader_methods.close.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ZIPReader_methods.get_files._get_files = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.ZIPReader, "get_files", 2981934095, loc))
  ZIPReader_methods.get_files.m_call = cast(type_of(ZIPReader_methods.get_files.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ZIPReader_methods.read_file._read_file = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.ZIPReader, "read_file", 740857591, loc))
  ZIPReader_methods.read_file.m_call = cast(type_of(ZIPReader_methods.read_file.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ZIPReader_methods.file_exists.m_call = cast(type_of(ZIPReader_methods.file_exists.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ZIPReader_methods.get_compression_level.m_call = cast(type_of(ZIPReader_methods.get_compression_level.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
