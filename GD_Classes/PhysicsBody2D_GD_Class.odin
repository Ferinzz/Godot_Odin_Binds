...
PhysicsBody2D_Init_ :: proc (PhysicsBody2D_methods: ^PhysicsBody2D_MethodBind_List, loc := #caller_location) {
  ...
  PhysicsBody2D_methods.move_and_collide.m_call = cast(type_of(PhysicsBody2D_methods.move_and_collide.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsBody2D_methods.test_move.m_call = cast(type_of(PhysicsBody2D_methods.test_move.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsBody2D_methods.get_gravity.m_call = cast(type_of(PhysicsBody2D_methods.get_gravity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsBody2D_methods.get_collision_exceptions.m_call = cast(type_of(PhysicsBody2D_methods.get_collision_exceptions.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsBody2D_methods.add_collision_exception_with.m_call = cast(type_of(PhysicsBody2D_methods.add_collision_exception_with.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsBody2D_methods.remove_collision_exception_with.m_call = cast(type_of(PhysicsBody2D_methods.remove_collision_exception_with.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
