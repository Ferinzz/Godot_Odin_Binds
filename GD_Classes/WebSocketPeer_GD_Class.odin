...
WebSocketPeer_Init_ :: proc (WebSocketPeer_methods: ^WebSocketPeer_MethodBind_List, loc := #caller_location) {
  ...
  WebSocketPeer_methods.connect_to_url.m_call = cast(type_of(WebSocketPeer_methods.connect_to_url.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  WebSocketPeer_methods.accept_stream.m_call = cast(type_of(WebSocketPeer_methods.accept_stream.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  WebSocketPeer_methods.send._send = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.WebSocketPeer, "send", 2780360567, loc))
  WebSocketPeer_methods.send.m_call = cast(type_of(WebSocketPeer_methods.send.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  WebSocketPeer_methods.send_text.m_call = cast(type_of(WebSocketPeer_methods.send_text.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  WebSocketPeer_methods.was_string_packet.m_call = cast(type_of(WebSocketPeer_methods.was_string_packet.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  WebSocketPeer_methods.poll._poll = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.WebSocketPeer, "poll", 3218959716, loc))
  WebSocketPeer_methods.poll.m_call = cast(type_of(WebSocketPeer_methods.poll.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  WebSocketPeer_methods.close._close = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.WebSocketPeer, "close", 1047156615, loc))
  WebSocketPeer_methods.close.m_call = cast(type_of(WebSocketPeer_methods.close.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  WebSocketPeer_methods.get_connected_host.m_call = cast(type_of(WebSocketPeer_methods.get_connected_host.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  WebSocketPeer_methods.get_connected_port.m_call = cast(type_of(WebSocketPeer_methods.get_connected_port.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  WebSocketPeer_methods.get_selected_protocol.m_call = cast(type_of(WebSocketPeer_methods.get_selected_protocol.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  WebSocketPeer_methods.get_requested_url.m_call = cast(type_of(WebSocketPeer_methods.get_requested_url.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  WebSocketPeer_methods.set_no_delay.m_call = cast(type_of(WebSocketPeer_methods.set_no_delay.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  WebSocketPeer_methods.get_current_outbound_buffered_amount.m_call = cast(type_of(WebSocketPeer_methods.get_current_outbound_buffered_amount.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  WebSocketPeer_methods.get_ready_state.m_call = cast(type_of(WebSocketPeer_methods.get_ready_state.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  WebSocketPeer_methods.get_close_code.m_call = cast(type_of(WebSocketPeer_methods.get_close_code.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  WebSocketPeer_methods.get_close_reason.m_call = cast(type_of(WebSocketPeer_methods.get_close_reason.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  WebSocketPeer_methods.get_supported_protocols.m_call = cast(type_of(WebSocketPeer_methods.get_supported_protocols.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  WebSocketPeer_methods.set_supported_protocols.m_call = cast(type_of(WebSocketPeer_methods.set_supported_protocols.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  WebSocketPeer_methods.get_handshake_headers.m_call = cast(type_of(WebSocketPeer_methods.get_handshake_headers.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  WebSocketPeer_methods.set_handshake_headers.m_call = cast(type_of(WebSocketPeer_methods.set_handshake_headers.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  WebSocketPeer_methods.get_inbound_buffer_size.m_call = cast(type_of(WebSocketPeer_methods.get_inbound_buffer_size.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  WebSocketPeer_methods.set_inbound_buffer_size.m_call = cast(type_of(WebSocketPeer_methods.set_inbound_buffer_size.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  WebSocketPeer_methods.get_outbound_buffer_size.m_call = cast(type_of(WebSocketPeer_methods.get_outbound_buffer_size.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  WebSocketPeer_methods.set_outbound_buffer_size.m_call = cast(type_of(WebSocketPeer_methods.set_outbound_buffer_size.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  WebSocketPeer_methods.set_max_queued_packets.m_call = cast(type_of(WebSocketPeer_methods.set_max_queued_packets.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  WebSocketPeer_methods.get_max_queued_packets.m_call = cast(type_of(WebSocketPeer_methods.get_max_queued_packets.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  WebSocketPeer_methods.set_heartbeat_interval.m_call = cast(type_of(WebSocketPeer_methods.set_heartbeat_interval.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  WebSocketPeer_methods.get_heartbeat_interval.m_call = cast(type_of(WebSocketPeer_methods.get_heartbeat_interval.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
