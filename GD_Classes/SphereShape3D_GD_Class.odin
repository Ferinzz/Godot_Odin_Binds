...
SphereShape3D_Init_ :: proc (SphereShape3D_methods: ^SphereShape3D_MethodBind_List, loc := #caller_location) {
  SphereShape3D_methods.set_radius = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.SphereShape3D, "set_radius", 373806689, loc))
  SphereShape3D_methods.get_radius = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.SphereShape3D, "get_radius", 1740695150, loc))
};
