...
PhysicsTestMotionResult2D_MethodBind_List :: struct {
  get_travel: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: PhysicsTestMotionResult2D, #by_ptr args: i64 = 0, r_ret: ^GDW.Vector2)
  },
  ...
  get_collider_id: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: PhysicsTestMotionResult2D, #by_ptr args: i64 = 0, r_ret: ^GDW.Int)
  },
  get_collider_rid: struct{
    using _get_collider_rid: ^GDW.MethodBind,
    m_call: proc(_:^GDW.MethodBind, obj: PhysicsTestMotionResult2D, #by_ptr args: i64 = 0, r_ret: ^GDW.RID)
  },
  get_collider: struct{
    using _get_collider: ^GDW.MethodBind,
    m_call: proc(_:^GDW.MethodBind, obj: PhysicsTestMotionResult2D, #by_ptr args: i64 = 0, r_ret: ^GDW.Object)
  },
  ...
  get_collision_depth: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: PhysicsTestMotionResult2D, #by_ptr args: i64 = 0, r_ret: ^GDW.float)
  },
...
PhysicsTestMotionResult2D_Init_ :: proc (PhysicsTestMotionResult2D_methods: ^PhysicsTestMotionResult2D_MethodBind_List, loc := #caller_location) {
  ...
  PhysicsTestMotionResult2D_methods.get_travel.m_call = cast(type_of(PhysicsTestMotionResult2D_methods.get_travel.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsTestMotionResult2D_methods.get_remainder.m_call = cast(type_of(PhysicsTestMotionResult2D_methods.get_remainder.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsTestMotionResult2D_methods.get_collision_point.m_call = cast(type_of(PhysicsTestMotionResult2D_methods.get_collision_point.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsTestMotionResult2D_methods.get_collision_normal.m_call = cast(type_of(PhysicsTestMotionResult2D_methods.get_collision_normal.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsTestMotionResult2D_methods.get_collider_velocity.m_call = cast(type_of(PhysicsTestMotionResult2D_methods.get_collider_velocity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsTestMotionResult2D_methods.get_collider_id.m_call = cast(type_of(PhysicsTestMotionResult2D_methods.get_collider_id.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsTestMotionResult2D_methods.get_collider_rid.m_call = cast(type_of(PhysicsTestMotionResult2D_methods.get_collider_rid.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsTestMotionResult2D_methods.get_collider.m_call = cast(type_of(PhysicsTestMotionResult2D_methods.get_collider.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsTestMotionResult2D_methods.get_collider_shape.m_call = cast(type_of(PhysicsTestMotionResult2D_methods.get_collider_shape.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsTestMotionResult2D_methods.get_collision_local_shape.m_call = cast(type_of(PhysicsTestMotionResult2D_methods.get_collision_local_shape.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsTestMotionResult2D_methods.get_collision_depth.m_call = cast(type_of(PhysicsTestMotionResult2D_methods.get_collision_depth.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsTestMotionResult2D_methods.get_collision_safe_fraction.m_call = cast(type_of(PhysicsTestMotionResult2D_methods.get_collision_safe_fraction.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsTestMotionResult2D_methods.get_collision_unsafe_fraction.m_call = cast(type_of(PhysicsTestMotionResult2D_methods.get_collision_unsafe_fraction.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
