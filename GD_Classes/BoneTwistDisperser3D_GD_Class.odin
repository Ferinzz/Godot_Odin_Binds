...
BoneTwistDisperser3D_MethodBind_List :: struct {
  set_setting_count: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: BoneTwistDisperser3D, #by_ptr args: i64 = 0, r_ret: ^GDW.Int)
  },
  clear_settings: struct{
    using _clear_settings: ^GDW.MethodBind,
    m_call: proc(_:^GDW.MethodBind, obj: BoneTwistDisperser3D, #by_ptr args: i64 = 0, r_ret: rawptr = nil)
  },
    ...
    m_call: proc(_:^GDW.MethodBind, obj: BoneTwistDisperser3D, #by_ptr args: i64 = 0, r_ret: ^GDW.Bool)
  },
...
BoneTwistDisperser3D_Init_ :: proc (BoneTwistDisperser3D_methods: ^BoneTwistDisperser3D_MethodBind_List, loc := #caller_location) {
  ...
  BoneTwistDisperser3D_methods.set_setting_count.m_call = cast(type_of(BoneTwistDisperser3D_methods.set_setting_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BoneTwistDisperser3D_methods.get_setting_count.m_call = cast(type_of(BoneTwistDisperser3D_methods.get_setting_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BoneTwistDisperser3D_methods.clear_settings.m_call = cast(type_of(BoneTwistDisperser3D_methods.clear_settings.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BoneTwistDisperser3D_methods.set_mutable_bone_axes.m_call = cast(type_of(BoneTwistDisperser3D_methods.set_mutable_bone_axes.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BoneTwistDisperser3D_methods.are_bone_axes_mutable.m_call = cast(type_of(BoneTwistDisperser3D_methods.are_bone_axes_mutable.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BoneTwistDisperser3D_methods.set_root_bone_name.m_call = cast(type_of(BoneTwistDisperser3D_methods.set_root_bone_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BoneTwistDisperser3D_methods.get_root_bone_name.m_call = cast(type_of(BoneTwistDisperser3D_methods.get_root_bone_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BoneTwistDisperser3D_methods.set_root_bone.m_call = cast(type_of(BoneTwistDisperser3D_methods.set_root_bone.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BoneTwistDisperser3D_methods.get_root_bone.m_call = cast(type_of(BoneTwistDisperser3D_methods.get_root_bone.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BoneTwistDisperser3D_methods.set_end_bone_name.m_call = cast(type_of(BoneTwistDisperser3D_methods.set_end_bone_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BoneTwistDisperser3D_methods.get_end_bone_name.m_call = cast(type_of(BoneTwistDisperser3D_methods.get_end_bone_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BoneTwistDisperser3D_methods.set_end_bone.m_call = cast(type_of(BoneTwistDisperser3D_methods.set_end_bone.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BoneTwistDisperser3D_methods.get_end_bone.m_call = cast(type_of(BoneTwistDisperser3D_methods.get_end_bone.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BoneTwistDisperser3D_methods.get_reference_bone_name.m_call = cast(type_of(BoneTwistDisperser3D_methods.get_reference_bone_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BoneTwistDisperser3D_methods.get_reference_bone.m_call = cast(type_of(BoneTwistDisperser3D_methods.get_reference_bone.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BoneTwistDisperser3D_methods.set_extend_end_bone.m_call = cast(type_of(BoneTwistDisperser3D_methods.set_extend_end_bone.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BoneTwistDisperser3D_methods.is_end_bone_extended.m_call = cast(type_of(BoneTwistDisperser3D_methods.is_end_bone_extended.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BoneTwistDisperser3D_methods.set_end_bone_direction.m_call = cast(type_of(BoneTwistDisperser3D_methods.set_end_bone_direction.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BoneTwistDisperser3D_methods.get_end_bone_direction.m_call = cast(type_of(BoneTwistDisperser3D_methods.get_end_bone_direction.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BoneTwistDisperser3D_methods.set_twist_from_rest.m_call = cast(type_of(BoneTwistDisperser3D_methods.set_twist_from_rest.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BoneTwistDisperser3D_methods.is_twist_from_rest.m_call = cast(type_of(BoneTwistDisperser3D_methods.is_twist_from_rest.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BoneTwistDisperser3D_methods.set_twist_from.m_call = cast(type_of(BoneTwistDisperser3D_methods.set_twist_from.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BoneTwistDisperser3D_methods.get_twist_from.m_call = cast(type_of(BoneTwistDisperser3D_methods.get_twist_from.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BoneTwistDisperser3D_methods.set_disperse_mode.m_call = cast(type_of(BoneTwistDisperser3D_methods.set_disperse_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BoneTwistDisperser3D_methods.get_disperse_mode.m_call = cast(type_of(BoneTwistDisperser3D_methods.get_disperse_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BoneTwistDisperser3D_methods.set_weight_position.m_call = cast(type_of(BoneTwistDisperser3D_methods.set_weight_position.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BoneTwistDisperser3D_methods.get_weight_position.m_call = cast(type_of(BoneTwistDisperser3D_methods.get_weight_position.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BoneTwistDisperser3D_methods.set_damping_curve.m_call = cast(type_of(BoneTwistDisperser3D_methods.set_damping_curve.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BoneTwistDisperser3D_methods.get_damping_curve.m_call = cast(type_of(BoneTwistDisperser3D_methods.get_damping_curve.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BoneTwistDisperser3D_methods.get_joint_bone_name.m_call = cast(type_of(BoneTwistDisperser3D_methods.get_joint_bone_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BoneTwistDisperser3D_methods.get_joint_bone.m_call = cast(type_of(BoneTwistDisperser3D_methods.get_joint_bone.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BoneTwistDisperser3D_methods.get_joint_twist_amount.m_call = cast(type_of(BoneTwistDisperser3D_methods.get_joint_twist_amount.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BoneTwistDisperser3D_methods.set_joint_twist_amount.m_call = cast(type_of(BoneTwistDisperser3D_methods.set_joint_twist_amount.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BoneTwistDisperser3D_methods.get_joint_count.m_call = cast(type_of(BoneTwistDisperser3D_methods.get_joint_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
