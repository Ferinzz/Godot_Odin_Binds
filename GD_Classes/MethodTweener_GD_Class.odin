...
MethodTweener_Init_ :: proc (MethodTweener_methods: ^MethodTweener_MethodBind_List, loc := #caller_location) {
  ...
  MethodTweener_methods.set_delay.m_call = cast(type_of(MethodTweener_methods.set_delay.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MethodTweener_methods.set_trans.m_call = cast(type_of(MethodTweener_methods.set_trans.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MethodTweener_methods.set_ease.m_call = cast(type_of(MethodTweener_methods.set_ease.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
