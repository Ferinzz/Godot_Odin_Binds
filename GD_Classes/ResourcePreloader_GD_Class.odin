...
ResourcePreloader_Init_ :: proc (ResourcePreloader_methods: ^ResourcePreloader_MethodBind_List, loc := #caller_location) {
  ...
  ResourcePreloader_methods.add_resource.m_call = cast(type_of(ResourcePreloader_methods.add_resource.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ResourcePreloader_methods.remove_resource.m_call = cast(type_of(ResourcePreloader_methods.remove_resource.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ResourcePreloader_methods.rename_resource.m_call = cast(type_of(ResourcePreloader_methods.rename_resource.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ResourcePreloader_methods.has_resource.m_call = cast(type_of(ResourcePreloader_methods.has_resource.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ResourcePreloader_methods.get_resource.m_call = cast(type_of(ResourcePreloader_methods.get_resource.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ResourcePreloader_methods.get_resource_list.m_call = cast(type_of(ResourcePreloader_methods.get_resource_list.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
