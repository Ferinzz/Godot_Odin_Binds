...
OpenXRSpatialCapabilityConfigurationPlaneTracking_MethodBind_List :: struct {
  supports_mesh_2d: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: OpenXRSpatialCapabilityConfigurationPlaneTracking, args: rawptr = nil, r_ret: ^GDW.Bool)
  },
  ...
  get_enabled_components: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: OpenXRSpatialCapabilityConfigurationPlaneTracking, args: rawptr = nil, r_ret: ^GDW.PackedInt64Array)
  },
};
OpenXRSpatialCapabilityConfigurationPlaneTracking_Init_ :: proc (OpenXRSpatialCapabilityConfigurationPlaneTracking_methods: ^OpenXRSpatialCapabilityConfigurationPlaneTracking_MethodBind_List, loc := #caller_location) {
  ...
  OpenXRSpatialCapabilityConfigurationPlaneTracking_methods.supports_mesh_2d._supports_mesh_2d = (cast(^GDW.MethodBind)classDBGetMethodBind3(.OpenXRSpatialCapabilityConfigurationPlaneTracking, "supports_mesh_2d", 2240911060, loc))
  ...
  OpenXRSpatialCapabilityConfigurationPlaneTracking_methods.supports_polygons._supports_polygons = (cast(^GDW.MethodBind)classDBGetMethodBind3(.OpenXRSpatialCapabilityConfigurationPlaneTracking, "supports_polygons", 2240911060, loc))
  ...
  OpenXRSpatialCapabilityConfigurationPlaneTracking_methods.supports_labels._supports_labels = (cast(^GDW.MethodBind)classDBGetMethodBind3(.OpenXRSpatialCapabilityConfigurationPlaneTracking, "supports_labels", 2240911060, loc))
  ...
  OpenXRSpatialCapabilityConfigurationPlaneTracking_methods.get_enabled_components._get_enabled_components = (cast(^GDW.MethodBind)classDBGetMethodBind3(.OpenXRSpatialCapabilityConfigurationPlaneTracking, "get_enabled_components", 235988956, loc))
