...
OpenXRSpatialCapabilityConfigurationPlaneTracking_Init_ :: proc (OpenXRSpatialCapabilityConfigurationPlaneTracking_methods: ^OpenXRSpatialCapabilityConfigurationPlaneTracking_MethodBind_List, loc := #caller_location) {
  ...
  OpenXRSpatialCapabilityConfigurationPlaneTracking_methods.supports_mesh_2d.m_call = cast(type_of(OpenXRSpatialCapabilityConfigurationPlaneTracking_methods.supports_mesh_2d.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRSpatialCapabilityConfigurationPlaneTracking_methods.supports_polygons.m_call = cast(type_of(OpenXRSpatialCapabilityConfigurationPlaneTracking_methods.supports_polygons.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRSpatialCapabilityConfigurationPlaneTracking_methods.supports_labels.m_call = cast(type_of(OpenXRSpatialCapabilityConfigurationPlaneTracking_methods.supports_labels.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRSpatialCapabilityConfigurationPlaneTracking_methods.get_enabled_components.m_call = cast(type_of(OpenXRSpatialCapabilityConfigurationPlaneTracking_methods.get_enabled_components.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
