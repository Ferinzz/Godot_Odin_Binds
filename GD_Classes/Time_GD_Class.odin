...
Time_Init_ :: proc (Time_methods: ^Time_MethodBind_List, loc := #caller_location) {
  ...
  Time_methods.get_datetime_dict_from_unix_time.m_call = cast(type_of(Time_methods.get_datetime_dict_from_unix_time.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Time_methods.get_date_dict_from_unix_time.m_call = cast(type_of(Time_methods.get_date_dict_from_unix_time.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Time_methods.get_time_dict_from_unix_time.m_call = cast(type_of(Time_methods.get_time_dict_from_unix_time.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Time_methods.get_datetime_string_from_unix_time.m_call = cast(type_of(Time_methods.get_datetime_string_from_unix_time.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Time_methods.get_date_string_from_unix_time.m_call = cast(type_of(Time_methods.get_date_string_from_unix_time.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Time_methods.get_time_string_from_unix_time.m_call = cast(type_of(Time_methods.get_time_string_from_unix_time.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Time_methods.get_datetime_dict_from_datetime_string.m_call = cast(type_of(Time_methods.get_datetime_dict_from_datetime_string.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Time_methods.get_datetime_string_from_datetime_dict.m_call = cast(type_of(Time_methods.get_datetime_string_from_datetime_dict.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Time_methods.get_unix_time_from_datetime_dict.m_call = cast(type_of(Time_methods.get_unix_time_from_datetime_dict.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Time_methods.get_unix_time_from_datetime_string.m_call = cast(type_of(Time_methods.get_unix_time_from_datetime_string.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Time_methods.get_offset_string_from_offset_minutes.m_call = cast(type_of(Time_methods.get_offset_string_from_offset_minutes.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Time_methods.get_datetime_dict_from_system.m_call = cast(type_of(Time_methods.get_datetime_dict_from_system.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Time_methods.get_date_dict_from_system.m_call = cast(type_of(Time_methods.get_date_dict_from_system.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Time_methods.get_time_dict_from_system.m_call = cast(type_of(Time_methods.get_time_dict_from_system.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Time_methods.get_datetime_string_from_system.m_call = cast(type_of(Time_methods.get_datetime_string_from_system.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Time_methods.get_date_string_from_system.m_call = cast(type_of(Time_methods.get_date_string_from_system.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Time_methods.get_time_string_from_system.m_call = cast(type_of(Time_methods.get_time_string_from_system.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Time_methods.get_time_zone_from_system.m_call = cast(type_of(Time_methods.get_time_zone_from_system.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Time_methods.get_unix_time_from_system.m_call = cast(type_of(Time_methods.get_unix_time_from_system.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Time_methods.get_ticks_msec.m_call = cast(type_of(Time_methods.get_ticks_msec.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Time_methods.get_ticks_usec.m_call = cast(type_of(Time_methods.get_ticks_usec.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
