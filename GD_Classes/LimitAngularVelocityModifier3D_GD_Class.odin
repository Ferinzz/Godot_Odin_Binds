...
LimitAngularVelocityModifier3D_Init_ :: proc (LimitAngularVelocityModifier3D_methods: ^LimitAngularVelocityModifier3D_MethodBind_List, loc := #caller_location) {
  ...
  LimitAngularVelocityModifier3D_methods.set_root_bone_name.m_call = cast(type_of(LimitAngularVelocityModifier3D_methods.set_root_bone_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  LimitAngularVelocityModifier3D_methods.get_root_bone_name.m_call = cast(type_of(LimitAngularVelocityModifier3D_methods.get_root_bone_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  LimitAngularVelocityModifier3D_methods.set_root_bone.m_call = cast(type_of(LimitAngularVelocityModifier3D_methods.set_root_bone.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  LimitAngularVelocityModifier3D_methods.get_root_bone.m_call = cast(type_of(LimitAngularVelocityModifier3D_methods.get_root_bone.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  LimitAngularVelocityModifier3D_methods.set_end_bone_name.m_call = cast(type_of(LimitAngularVelocityModifier3D_methods.set_end_bone_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  LimitAngularVelocityModifier3D_methods.get_end_bone_name.m_call = cast(type_of(LimitAngularVelocityModifier3D_methods.get_end_bone_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  LimitAngularVelocityModifier3D_methods.set_end_bone.m_call = cast(type_of(LimitAngularVelocityModifier3D_methods.set_end_bone.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  LimitAngularVelocityModifier3D_methods.get_end_bone.m_call = cast(type_of(LimitAngularVelocityModifier3D_methods.get_end_bone.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  LimitAngularVelocityModifier3D_methods.set_chain_count.m_call = cast(type_of(LimitAngularVelocityModifier3D_methods.set_chain_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  LimitAngularVelocityModifier3D_methods.get_chain_count.m_call = cast(type_of(LimitAngularVelocityModifier3D_methods.get_chain_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  LimitAngularVelocityModifier3D_methods.clear_chains.m_call = cast(type_of(LimitAngularVelocityModifier3D_methods.clear_chains.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  LimitAngularVelocityModifier3D_methods.set_max_angular_velocity.m_call = cast(type_of(LimitAngularVelocityModifier3D_methods.set_max_angular_velocity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  LimitAngularVelocityModifier3D_methods.get_max_angular_velocity.m_call = cast(type_of(LimitAngularVelocityModifier3D_methods.get_max_angular_velocity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  LimitAngularVelocityModifier3D_methods.set_exclude.m_call = cast(type_of(LimitAngularVelocityModifier3D_methods.set_exclude.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  LimitAngularVelocityModifier3D_methods.is_exclude.m_call = cast(type_of(LimitAngularVelocityModifier3D_methods.is_exclude.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  LimitAngularVelocityModifier3D_methods.reset.m_call = cast(type_of(LimitAngularVelocityModifier3D_methods.reset.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
