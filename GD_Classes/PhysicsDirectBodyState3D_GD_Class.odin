...
PhysicsDirectBodyState3D_Init_ :: proc (PhysicsDirectBodyState3D_methods: ^PhysicsDirectBodyState3D_MethodBind_List, loc := #caller_location) {
  ...
  PhysicsDirectBodyState3D_methods.get_total_gravity.m_call = cast(type_of(PhysicsDirectBodyState3D_methods.get_total_gravity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsDirectBodyState3D_methods.get_total_linear_damp.m_call = cast(type_of(PhysicsDirectBodyState3D_methods.get_total_linear_damp.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsDirectBodyState3D_methods.get_total_angular_damp.m_call = cast(type_of(PhysicsDirectBodyState3D_methods.get_total_angular_damp.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsDirectBodyState3D_methods.get_center_of_mass.m_call = cast(type_of(PhysicsDirectBodyState3D_methods.get_center_of_mass.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsDirectBodyState3D_methods.get_center_of_mass_local.m_call = cast(type_of(PhysicsDirectBodyState3D_methods.get_center_of_mass_local.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsDirectBodyState3D_methods.get_principal_inertia_axes.m_call = cast(type_of(PhysicsDirectBodyState3D_methods.get_principal_inertia_axes.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsDirectBodyState3D_methods.get_inverse_mass.m_call = cast(type_of(PhysicsDirectBodyState3D_methods.get_inverse_mass.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsDirectBodyState3D_methods.get_inverse_inertia.m_call = cast(type_of(PhysicsDirectBodyState3D_methods.get_inverse_inertia.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsDirectBodyState3D_methods.get_inverse_inertia_tensor.m_call = cast(type_of(PhysicsDirectBodyState3D_methods.get_inverse_inertia_tensor.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsDirectBodyState3D_methods.set_linear_velocity.m_call = cast(type_of(PhysicsDirectBodyState3D_methods.set_linear_velocity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsDirectBodyState3D_methods.get_linear_velocity.m_call = cast(type_of(PhysicsDirectBodyState3D_methods.get_linear_velocity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsDirectBodyState3D_methods.set_angular_velocity.m_call = cast(type_of(PhysicsDirectBodyState3D_methods.set_angular_velocity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsDirectBodyState3D_methods.get_angular_velocity.m_call = cast(type_of(PhysicsDirectBodyState3D_methods.get_angular_velocity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsDirectBodyState3D_methods.set_transform.m_call = cast(type_of(PhysicsDirectBodyState3D_methods.set_transform.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsDirectBodyState3D_methods.get_transform.m_call = cast(type_of(PhysicsDirectBodyState3D_methods.get_transform.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsDirectBodyState3D_methods.get_velocity_at_local_position.m_call = cast(type_of(PhysicsDirectBodyState3D_methods.get_velocity_at_local_position.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsDirectBodyState3D_methods.apply_central_impulse.m_call = cast(type_of(PhysicsDirectBodyState3D_methods.apply_central_impulse.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsDirectBodyState3D_methods.apply_impulse.m_call = cast(type_of(PhysicsDirectBodyState3D_methods.apply_impulse.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsDirectBodyState3D_methods.apply_torque_impulse.m_call = cast(type_of(PhysicsDirectBodyState3D_methods.apply_torque_impulse.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsDirectBodyState3D_methods.apply_central_force.m_call = cast(type_of(PhysicsDirectBodyState3D_methods.apply_central_force.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsDirectBodyState3D_methods.apply_force.m_call = cast(type_of(PhysicsDirectBodyState3D_methods.apply_force.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsDirectBodyState3D_methods.apply_torque.m_call = cast(type_of(PhysicsDirectBodyState3D_methods.apply_torque.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsDirectBodyState3D_methods.add_constant_central_force.m_call = cast(type_of(PhysicsDirectBodyState3D_methods.add_constant_central_force.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsDirectBodyState3D_methods.add_constant_force.m_call = cast(type_of(PhysicsDirectBodyState3D_methods.add_constant_force.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsDirectBodyState3D_methods.add_constant_torque.m_call = cast(type_of(PhysicsDirectBodyState3D_methods.add_constant_torque.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsDirectBodyState3D_methods.set_constant_force.m_call = cast(type_of(PhysicsDirectBodyState3D_methods.set_constant_force.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsDirectBodyState3D_methods.get_constant_force.m_call = cast(type_of(PhysicsDirectBodyState3D_methods.get_constant_force.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsDirectBodyState3D_methods.set_constant_torque.m_call = cast(type_of(PhysicsDirectBodyState3D_methods.set_constant_torque.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsDirectBodyState3D_methods.get_constant_torque.m_call = cast(type_of(PhysicsDirectBodyState3D_methods.get_constant_torque.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsDirectBodyState3D_methods.set_sleep_state.m_call = cast(type_of(PhysicsDirectBodyState3D_methods.set_sleep_state.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsDirectBodyState3D_methods.is_sleeping.m_call = cast(type_of(PhysicsDirectBodyState3D_methods.is_sleeping.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsDirectBodyState3D_methods.set_collision_layer.m_call = cast(type_of(PhysicsDirectBodyState3D_methods.set_collision_layer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsDirectBodyState3D_methods.get_collision_layer.m_call = cast(type_of(PhysicsDirectBodyState3D_methods.get_collision_layer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsDirectBodyState3D_methods.set_collision_mask.m_call = cast(type_of(PhysicsDirectBodyState3D_methods.set_collision_mask.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsDirectBodyState3D_methods.get_collision_mask.m_call = cast(type_of(PhysicsDirectBodyState3D_methods.get_collision_mask.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsDirectBodyState3D_methods.get_contact_count.m_call = cast(type_of(PhysicsDirectBodyState3D_methods.get_contact_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsDirectBodyState3D_methods.get_contact_local_position.m_call = cast(type_of(PhysicsDirectBodyState3D_methods.get_contact_local_position.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsDirectBodyState3D_methods.get_contact_local_normal.m_call = cast(type_of(PhysicsDirectBodyState3D_methods.get_contact_local_normal.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsDirectBodyState3D_methods.get_contact_impulse.m_call = cast(type_of(PhysicsDirectBodyState3D_methods.get_contact_impulse.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsDirectBodyState3D_methods.get_contact_local_shape.m_call = cast(type_of(PhysicsDirectBodyState3D_methods.get_contact_local_shape.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsDirectBodyState3D_methods.get_contact_local_velocity_at_position.m_call = cast(type_of(PhysicsDirectBodyState3D_methods.get_contact_local_velocity_at_position.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsDirectBodyState3D_methods.get_contact_collider.m_call = cast(type_of(PhysicsDirectBodyState3D_methods.get_contact_collider.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsDirectBodyState3D_methods.get_contact_collider_position.m_call = cast(type_of(PhysicsDirectBodyState3D_methods.get_contact_collider_position.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsDirectBodyState3D_methods.get_contact_collider_id.m_call = cast(type_of(PhysicsDirectBodyState3D_methods.get_contact_collider_id.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsDirectBodyState3D_methods.get_contact_collider_object.m_call = cast(type_of(PhysicsDirectBodyState3D_methods.get_contact_collider_object.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsDirectBodyState3D_methods.get_contact_collider_shape.m_call = cast(type_of(PhysicsDirectBodyState3D_methods.get_contact_collider_shape.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsDirectBodyState3D_methods.get_contact_collider_velocity_at_position.m_call = cast(type_of(PhysicsDirectBodyState3D_methods.get_contact_collider_velocity_at_position.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsDirectBodyState3D_methods.get_step.m_call = cast(type_of(PhysicsDirectBodyState3D_methods.get_step.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsDirectBodyState3D_methods.integrate_forces.m_call = cast(type_of(PhysicsDirectBodyState3D_methods.integrate_forces.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsDirectBodyState3D_methods.get_space_state.m_call = cast(type_of(PhysicsDirectBodyState3D_methods.get_space_state.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
