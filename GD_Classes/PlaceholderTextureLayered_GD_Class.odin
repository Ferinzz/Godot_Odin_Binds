...
PlaceholderTextureLayered_Init_ :: proc (PlaceholderTextureLayered_methods: ^PlaceholderTextureLayered_MethodBind_List, loc := #caller_location) {
  ...
  PlaceholderTextureLayered_methods.set_size.m_call = cast(type_of(PlaceholderTextureLayered_methods.set_size.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PlaceholderTextureLayered_methods.get_size.m_call = cast(type_of(PlaceholderTextureLayered_methods.get_size.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PlaceholderTextureLayered_methods.set_layers.m_call = cast(type_of(PlaceholderTextureLayered_methods.set_layers.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
