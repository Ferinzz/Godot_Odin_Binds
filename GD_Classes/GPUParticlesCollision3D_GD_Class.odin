...
GPUParticlesCollision3D_Init_ :: proc (GPUParticlesCollision3D_methods: ^GPUParticlesCollision3D_MethodBind_List, loc := #caller_location) {
  ...
  GPUParticlesCollision3D_methods.set_cull_mask.m_call = cast(type_of(GPUParticlesCollision3D_methods.set_cull_mask.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GPUParticlesCollision3D_methods.get_cull_mask.m_call = cast(type_of(GPUParticlesCollision3D_methods.get_cull_mask.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
