...
GPUParticlesCollision3D_MethodBind_List :: struct {
  set_cull_mask: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: GPUParticlesCollision3D, #by_ptr args: struct{mask: ^GDW.Int, }, r_ret: rawptr = nil)
  },
    get_cull_mask: struct{
    using _get_cull_mask: ^GDW.MethodBind,
    m_call: proc "c" (_:^GDW.MethodBind, obj: GPUParticlesCollision3D, args: rawptr = nil, r_ret: ^GDW.Int)
  },
};
GPUParticlesCollision3D_Init_ :: proc (GPUParticlesCollision3D_methods: ^GPUParticlesCollision3D_MethodBind_List, loc := #caller_location) {
  ...
  GPUParticlesCollision3D_methods.set_cull_mask._set_cull_mask = (cast(^GDW.MethodBind)classDBGetMethodBind3(.GPUParticlesCollision3D, "set_cull_mask", 1286410249, loc))
  ...
  GPUParticlesCollision3D_methods.get_cull_mask._get_cull_mask = (cast(^GDW.MethodBind)classDBGetMethodBind3(.GPUParticlesCollision3D, "get_cull_mask", 3905245786, loc))
