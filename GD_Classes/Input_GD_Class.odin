...
Input_Init_ :: proc (Input_methods: ^Input_MethodBind_List, loc := #caller_location) {
  ...
  Input_methods.is_anything_pressed.m_call = cast(type_of(Input_methods.is_anything_pressed.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Input_methods.is_key_pressed.m_call = cast(type_of(Input_methods.is_key_pressed.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Input_methods.is_physical_key_pressed.m_call = cast(type_of(Input_methods.is_physical_key_pressed.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Input_methods.is_key_label_pressed.m_call = cast(type_of(Input_methods.is_key_label_pressed.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Input_methods.is_mouse_button_pressed.m_call = cast(type_of(Input_methods.is_mouse_button_pressed.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Input_methods.is_joy_button_pressed.m_call = cast(type_of(Input_methods.is_joy_button_pressed.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Input_methods.is_action_pressed.m_call = cast(type_of(Input_methods.is_action_pressed.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Input_methods.is_action_just_pressed.m_call = cast(type_of(Input_methods.is_action_just_pressed.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Input_methods.is_action_just_released.m_call = cast(type_of(Input_methods.is_action_just_released.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Input_methods.is_action_just_pressed_by_event.m_call = cast(type_of(Input_methods.is_action_just_pressed_by_event.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Input_methods.is_action_just_released_by_event.m_call = cast(type_of(Input_methods.is_action_just_released_by_event.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Input_methods.get_action_strength.m_call = cast(type_of(Input_methods.get_action_strength.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Input_methods.get_action_raw_strength.m_call = cast(type_of(Input_methods.get_action_raw_strength.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Input_methods.get_axis._get_axis = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Input, "get_axis", 1958752504, loc))
  Input_methods.get_axis.m_call = cast(type_of(Input_methods.get_axis.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Input_methods.get_vector._get_vector = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Input, "get_vector", 2479607902, loc))
  Input_methods.get_vector.m_call = cast(type_of(Input_methods.get_vector.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Input_methods.add_joy_mapping.m_call = cast(type_of(Input_methods.add_joy_mapping.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Input_methods.remove_joy_mapping.m_call = cast(type_of(Input_methods.remove_joy_mapping.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Input_methods.is_joy_known._is_joy_known = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Input, "is_joy_known", 3067735520, loc))
  Input_methods.is_joy_known.m_call = cast(type_of(Input_methods.is_joy_known.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Input_methods.get_joy_axis._get_joy_axis = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Input, "get_joy_axis", 4063175957, loc))
  Input_methods.get_joy_axis.m_call = cast(type_of(Input_methods.get_joy_axis.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Input_methods.get_joy_name._get_joy_name = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Input, "get_joy_name", 990163283, loc))
  Input_methods.get_joy_name.m_call = cast(type_of(Input_methods.get_joy_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Input_methods.get_joy_guid._get_joy_guid = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Input, "get_joy_guid", 844755477, loc))
  Input_methods.get_joy_guid.m_call = cast(type_of(Input_methods.get_joy_guid.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Input_methods.get_joy_info._get_joy_info = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Input, "get_joy_info", 3485342025, loc))
  Input_methods.get_joy_info.m_call = cast(type_of(Input_methods.get_joy_info.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Input_methods.should_ignore_device.m_call = cast(type_of(Input_methods.should_ignore_device.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Input_methods.get_connected_joypads.m_call = cast(type_of(Input_methods.get_connected_joypads.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Input_methods.get_joy_vibration_strength.m_call = cast(type_of(Input_methods.get_joy_vibration_strength.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Input_methods.get_joy_vibration_duration.m_call = cast(type_of(Input_methods.get_joy_vibration_duration.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Input_methods.start_joy_vibration.m_call = cast(type_of(Input_methods.start_joy_vibration.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Input_methods.stop_joy_vibration.m_call = cast(type_of(Input_methods.stop_joy_vibration.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Input_methods.vibrate_handheld.m_call = cast(type_of(Input_methods.vibrate_handheld.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Input_methods.get_gravity._get_gravity = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Input, "get_gravity", 3360562783, loc))
  Input_methods.get_gravity.m_call = cast(type_of(Input_methods.get_gravity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Input_methods.get_accelerometer.m_call = cast(type_of(Input_methods.get_accelerometer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Input_methods.get_magnetometer.m_call = cast(type_of(Input_methods.get_magnetometer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Input_methods.get_gyroscope.m_call = cast(type_of(Input_methods.get_gyroscope.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Input_methods.set_gravity._set_gravity = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Input, "set_gravity", 3460891852, loc))
  Input_methods.set_gravity.m_call = cast(type_of(Input_methods.set_gravity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Input_methods.set_accelerometer.m_call = cast(type_of(Input_methods.set_accelerometer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Input_methods.set_magnetometer.m_call = cast(type_of(Input_methods.set_magnetometer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Input_methods.set_gyroscope.m_call = cast(type_of(Input_methods.set_gyroscope.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Input_methods.set_joy_light.m_call = cast(type_of(Input_methods.set_joy_light.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Input_methods.has_joy_light.m_call = cast(type_of(Input_methods.has_joy_light.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Input_methods.get_last_mouse_velocity.m_call = cast(type_of(Input_methods.get_last_mouse_velocity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Input_methods.get_last_mouse_screen_velocity.m_call = cast(type_of(Input_methods.get_last_mouse_screen_velocity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Input_methods.get_mouse_button_mask.m_call = cast(type_of(Input_methods.get_mouse_button_mask.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Input_methods.set_mouse_mode.m_call = cast(type_of(Input_methods.set_mouse_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Input_methods.get_mouse_mode.m_call = cast(type_of(Input_methods.get_mouse_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Input_methods.warp_mouse._warp_mouse = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Input, "warp_mouse", 743155724, loc))
  Input_methods.warp_mouse.m_call = cast(type_of(Input_methods.warp_mouse.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Input_methods.action_press._action_press = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Input, "action_press", 1713091165, loc))
  Input_methods.action_press.m_call = cast(type_of(Input_methods.action_press.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Input_methods.action_release.m_call = cast(type_of(Input_methods.action_release.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Input_methods.set_default_cursor_shape.m_call = cast(type_of(Input_methods.set_default_cursor_shape.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Input_methods.get_current_cursor_shape.m_call = cast(type_of(Input_methods.get_current_cursor_shape.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Input_methods.set_custom_mouse_cursor.m_call = cast(type_of(Input_methods.set_custom_mouse_cursor.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Input_methods.parse_input_event.m_call = cast(type_of(Input_methods.parse_input_event.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Input_methods.set_use_accumulated_input.m_call = cast(type_of(Input_methods.set_use_accumulated_input.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Input_methods.is_using_accumulated_input.m_call = cast(type_of(Input_methods.is_using_accumulated_input.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Input_methods.flush_buffered_events.m_call = cast(type_of(Input_methods.flush_buffered_events.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Input_methods.set_emulate_mouse_from_touch.m_call = cast(type_of(Input_methods.set_emulate_mouse_from_touch.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Input_methods.is_emulating_mouse_from_touch.m_call = cast(type_of(Input_methods.is_emulating_mouse_from_touch.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Input_methods.set_emulate_touch_from_mouse.m_call = cast(type_of(Input_methods.set_emulate_touch_from_mouse.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Input_methods.is_emulating_touch_from_mouse.m_call = cast(type_of(Input_methods.is_emulating_touch_from_mouse.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
