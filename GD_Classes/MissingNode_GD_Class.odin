...
MissingNode_MethodBind_List :: struct {
  set_original_class: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: MissingNode, #by_ptr args: struct{name: ^GDW.gdstring, }, r_ret: rawptr = nil)
  },
    get_original_class: struct{
    using _get_original_class: ^GDW.MethodBind,
    m_call: proc "c" (_:^GDW.MethodBind, obj: MissingNode, args: rawptr = nil, r_ret: ^GDW.gdstring)
  },
  ...
  set_recording_properties: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: MissingNode, #by_ptr args: struct{enable: ^GDW.Bool, }, r_ret: rawptr = nil)
  },
    is_recording_properties: struct{
    using _is_recording_properties: ^GDW.MethodBind,
    m_call: proc "c" (_:^GDW.MethodBind, obj: MissingNode, args: rawptr = nil, r_ret: ^GDW.Bool)
  },
...
MissingNode_Init_ :: proc (MissingNode_methods: ^MissingNode_MethodBind_List, loc := #caller_location) {
  ...
  MissingNode_methods.set_original_class._set_original_class = (cast(^GDW.MethodBind)classDBGetMethodBind3(.MissingNode, "set_original_class", 83702148, loc))
  MissingNode_methods.set_original_class.m_call = cast(type_of(MissingNode_methods.set_original_class.m_call))MB_ptr_call
  MissingNode_methods.get_original_class._get_original_class = (cast(^GDW.MethodBind)classDBGetMethodBind3(.MissingNode, "get_original_class", 201670096, loc))
  MissingNode_methods.get_original_class.m_call = cast(type_of(MissingNode_methods.get_original_class.m_call))MB_ptr_call
  MissingNode_methods.set_original_scene._set_original_scene = (cast(^GDW.MethodBind)classDBGetMethodBind3(.MissingNode, "set_original_scene", 83702148, loc))
  MissingNode_methods.set_original_scene.m_call = cast(type_of(MissingNode_methods.set_original_scene.m_call))MB_ptr_call
  MissingNode_methods.get_original_scene._get_original_scene = (cast(^GDW.MethodBind)classDBGetMethodBind3(.MissingNode, "get_original_scene", 201670096, loc))
  MissingNode_methods.get_original_scene.m_call = cast(type_of(MissingNode_methods.get_original_scene.m_call))MB_ptr_call
  MissingNode_methods.set_recording_properties._set_recording_properties = (cast(^GDW.MethodBind)classDBGetMethodBind3(.MissingNode, "set_recording_properties", 2586408642, loc))
  ...
  MissingNode_methods.is_recording_properties._is_recording_properties = (cast(^GDW.MethodBind)classDBGetMethodBind3(.MissingNode, "is_recording_properties", 36873697, loc))
  ...
  MissingNode_methods.set_recording_signals._set_recording_signals = (cast(^GDW.MethodBind)classDBGetMethodBind3(.MissingNode, "set_recording_signals", 2586408642, loc))
  ...
  MissingNode_methods.is_recording_signals._is_recording_signals = (cast(^GDW.MethodBind)classDBGetMethodBind3(.MissingNode, "is_recording_signals", 36873697, loc))
