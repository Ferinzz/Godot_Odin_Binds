...
EncodedObjectAsID_Init_ :: proc (EncodedObjectAsID_methods: ^EncodedObjectAsID_MethodBind_List, loc := #caller_location) {
  ...
  EncodedObjectAsID_methods.set_object_id.m_call = cast(type_of(EncodedObjectAsID_methods.set_object_id.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EncodedObjectAsID_methods.get_object_id.m_call = cast(type_of(EncodedObjectAsID_methods.get_object_id.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
