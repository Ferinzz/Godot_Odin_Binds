...
EncodedObjectAsID_MethodBind_List :: struct {
  set_object_id: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: EncodedObjectAsID, #by_ptr args: struct{id: ^GDW.Int, }, r_ret: rawptr = nil)
  },
    get_object_id: struct{
    using _get_object_id: ^GDW.MethodBind,
    m_call: proc "c" (_:^GDW.MethodBind, obj: EncodedObjectAsID, args: rawptr = nil, r_ret: ^GDW.Int)
  },
};
EncodedObjectAsID_Init_ :: proc (EncodedObjectAsID_methods: ^EncodedObjectAsID_MethodBind_List, loc := #caller_location) {
  ...
  EncodedObjectAsID_methods.set_object_id._set_object_id = (cast(^GDW.MethodBind)classDBGetMethodBind3(.EncodedObjectAsID, "set_object_id", 1286410249, loc))
  EncodedObjectAsID_methods.set_object_id.m_call = cast(type_of(EncodedObjectAsID_methods.set_object_id.m_call))MB_ptr_call
  EncodedObjectAsID_methods.get_object_id._get_object_id = (cast(^GDW.MethodBind)classDBGetMethodBind3(.EncodedObjectAsID, "get_object_id", 3905245786, loc))
