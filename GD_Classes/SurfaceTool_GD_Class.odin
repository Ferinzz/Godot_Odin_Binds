...
SurfaceTool_Init_ :: proc (SurfaceTool_methods: ^SurfaceTool_MethodBind_List, loc := #caller_location) {
  ...
  SurfaceTool_methods.set_skin_weight_count.m_call = cast(type_of(SurfaceTool_methods.set_skin_weight_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SurfaceTool_methods.get_skin_weight_count.m_call = cast(type_of(SurfaceTool_methods.get_skin_weight_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SurfaceTool_methods.set_custom_format.m_call = cast(type_of(SurfaceTool_methods.set_custom_format.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SurfaceTool_methods.get_custom_format.m_call = cast(type_of(SurfaceTool_methods.get_custom_format.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  SurfaceTool_methods.begin._begin = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.SurfaceTool, "begin", 2230304113, loc))
  SurfaceTool_methods.begin.m_call = cast(type_of(SurfaceTool_methods.begin.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SurfaceTool_methods.add_vertex.m_call = cast(type_of(SurfaceTool_methods.add_vertex.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SurfaceTool_methods.set_color.m_call = cast(type_of(SurfaceTool_methods.set_color.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SurfaceTool_methods.set_normal.m_call = cast(type_of(SurfaceTool_methods.set_normal.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SurfaceTool_methods.set_tangent.m_call = cast(type_of(SurfaceTool_methods.set_tangent.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  SurfaceTool_methods.set_uv._set_uv = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.SurfaceTool, "set_uv", 743155724, loc))
  SurfaceTool_methods.set_uv.m_call = cast(type_of(SurfaceTool_methods.set_uv.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  SurfaceTool_methods.set_uv2._set_uv2 = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.SurfaceTool, "set_uv2", 743155724, loc))
  SurfaceTool_methods.set_uv2.m_call = cast(type_of(SurfaceTool_methods.set_uv2.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SurfaceTool_methods.set_bones.m_call = cast(type_of(SurfaceTool_methods.set_bones.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SurfaceTool_methods.set_weights.m_call = cast(type_of(SurfaceTool_methods.set_weights.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SurfaceTool_methods.set_custom.m_call = cast(type_of(SurfaceTool_methods.set_custom.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SurfaceTool_methods.set_smooth_group.m_call = cast(type_of(SurfaceTool_methods.set_smooth_group.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SurfaceTool_methods.add_triangle_fan.m_call = cast(type_of(SurfaceTool_methods.add_triangle_fan.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SurfaceTool_methods.add_index.m_call = cast(type_of(SurfaceTool_methods.add_index.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  SurfaceTool_methods.index._index = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.SurfaceTool, "index", 3218959716, loc))
  SurfaceTool_methods.index.m_call = cast(type_of(SurfaceTool_methods.index.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  SurfaceTool_methods.deindex._deindex = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.SurfaceTool, "deindex", 3218959716, loc))
  SurfaceTool_methods.deindex.m_call = cast(type_of(SurfaceTool_methods.deindex.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SurfaceTool_methods.generate_normals.m_call = cast(type_of(SurfaceTool_methods.generate_normals.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SurfaceTool_methods.generate_tangents.m_call = cast(type_of(SurfaceTool_methods.generate_tangents.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SurfaceTool_methods.optimize_indices_for_cache.m_call = cast(type_of(SurfaceTool_methods.optimize_indices_for_cache.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  SurfaceTool_methods.get_aabb._get_aabb = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.SurfaceTool, "get_aabb", 1068685055, loc))
  SurfaceTool_methods.get_aabb.m_call = cast(type_of(SurfaceTool_methods.get_aabb.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SurfaceTool_methods.generate_lod.m_call = cast(type_of(SurfaceTool_methods.generate_lod.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SurfaceTool_methods.set_material.m_call = cast(type_of(SurfaceTool_methods.set_material.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SurfaceTool_methods.get_primitive_type.m_call = cast(type_of(SurfaceTool_methods.get_primitive_type.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  SurfaceTool_methods.clear._clear = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.SurfaceTool, "clear", 3218959716, loc))
  SurfaceTool_methods.clear.m_call = cast(type_of(SurfaceTool_methods.clear.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SurfaceTool_methods.create_from.m_call = cast(type_of(SurfaceTool_methods.create_from.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SurfaceTool_methods.create_from_arrays.m_call = cast(type_of(SurfaceTool_methods.create_from_arrays.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SurfaceTool_methods.create_from_blend_shape.m_call = cast(type_of(SurfaceTool_methods.create_from_blend_shape.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SurfaceTool_methods.append_from.m_call = cast(type_of(SurfaceTool_methods.append_from.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  SurfaceTool_methods.commit._commit = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.SurfaceTool, "commit", 4107864055, loc))
  SurfaceTool_methods.commit.m_call = cast(type_of(SurfaceTool_methods.commit.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SurfaceTool_methods.commit_to_arrays.m_call = cast(type_of(SurfaceTool_methods.commit_to_arrays.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
