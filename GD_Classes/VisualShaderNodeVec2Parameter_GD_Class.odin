...
VisualShaderNodeVec2Parameter_Init_ :: proc (VisualShaderNodeVec2Parameter_methods: ^VisualShaderNodeVec2Parameter_MethodBind_List, loc := #caller_location) {
  VisualShaderNodeVec2Parameter_methods.set_default_value_enabled = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.VisualShaderNodeVec2Parameter, "set_default_value_enabled", 2586408642, loc))
  VisualShaderNodeVec2Parameter_methods.is_default_value_enabled = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.VisualShaderNodeVec2Parameter, "is_default_value_enabled", 36873697, loc))
  VisualShaderNodeVec2Parameter_methods.set_default_value = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.VisualShaderNodeVec2Parameter, "set_default_value", 743155724, loc))
  VisualShaderNodeVec2Parameter_methods.get_default_value = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.VisualShaderNodeVec2Parameter, "get_default_value", 3341600327, loc))
};
