...
ENetPacketPeer_Init_ :: proc (ENetPacketPeer_methods: ^ENetPacketPeer_MethodBind_List, loc := #caller_location) {
  ...
  ENetPacketPeer_methods.peer_disconnect.m_call = cast(type_of(ENetPacketPeer_methods.peer_disconnect.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ENetPacketPeer_methods.peer_disconnect_later.m_call = cast(type_of(ENetPacketPeer_methods.peer_disconnect_later.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ENetPacketPeer_methods.peer_disconnect_now.m_call = cast(type_of(ENetPacketPeer_methods.peer_disconnect_now.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ENetPacketPeer_methods.ping._ping = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.ENetPacketPeer, "ping", 3218959716, loc))
  ENetPacketPeer_methods.ping.m_call = cast(type_of(ENetPacketPeer_methods.ping.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ENetPacketPeer_methods.ping_interval.m_call = cast(type_of(ENetPacketPeer_methods.ping_interval.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ENetPacketPeer_methods.reset._reset = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.ENetPacketPeer, "reset", 3218959716, loc))
  ENetPacketPeer_methods.reset.m_call = cast(type_of(ENetPacketPeer_methods.reset.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ENetPacketPeer_methods.send._send = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.ENetPacketPeer, "send", 120522849, loc))
  ENetPacketPeer_methods.send.m_call = cast(type_of(ENetPacketPeer_methods.send.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ENetPacketPeer_methods.throttle_configure.m_call = cast(type_of(ENetPacketPeer_methods.throttle_configure.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ENetPacketPeer_methods.set_timeout.m_call = cast(type_of(ENetPacketPeer_methods.set_timeout.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ENetPacketPeer_methods.get_packet_flags.m_call = cast(type_of(ENetPacketPeer_methods.get_packet_flags.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ENetPacketPeer_methods.get_remote_address.m_call = cast(type_of(ENetPacketPeer_methods.get_remote_address.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ENetPacketPeer_methods.get_remote_port.m_call = cast(type_of(ENetPacketPeer_methods.get_remote_port.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ENetPacketPeer_methods.get_statistic.m_call = cast(type_of(ENetPacketPeer_methods.get_statistic.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ENetPacketPeer_methods.get_state.m_call = cast(type_of(ENetPacketPeer_methods.get_state.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ENetPacketPeer_methods.get_channels.m_call = cast(type_of(ENetPacketPeer_methods.get_channels.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ENetPacketPeer_methods.is_active.m_call = cast(type_of(ENetPacketPeer_methods.is_active.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
