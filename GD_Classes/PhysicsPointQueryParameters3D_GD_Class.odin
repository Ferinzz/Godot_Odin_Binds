...
PhysicsPointQueryParameters3D_MethodBind_List :: struct {
  set_position: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: PhysicsPointQueryParameters3D, #by_ptr args: i64 = 0, r_ret: ^GDW.Vector3)
  },
  set_collision_mask: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: PhysicsPointQueryParameters3D, #by_ptr args: i64 = 0, r_ret: ^GDW.Int)
  },
  set_exclude: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: PhysicsPointQueryParameters3D, #by_ptr args: i64 = 0, r_ret: ^GDW.Array)
  },
  set_collide_with_bodies: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: PhysicsPointQueryParameters3D, #by_ptr args: i64 = 0, r_ret: ^GDW.Bool)
  },
...
PhysicsPointQueryParameters3D_Init_ :: proc (PhysicsPointQueryParameters3D_methods: ^PhysicsPointQueryParameters3D_MethodBind_List, loc := #caller_location) {
  ...
  PhysicsPointQueryParameters3D_methods.set_position.m_call = cast(type_of(PhysicsPointQueryParameters3D_methods.set_position.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsPointQueryParameters3D_methods.get_position.m_call = cast(type_of(PhysicsPointQueryParameters3D_methods.get_position.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsPointQueryParameters3D_methods.set_collision_mask.m_call = cast(type_of(PhysicsPointQueryParameters3D_methods.set_collision_mask.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsPointQueryParameters3D_methods.get_collision_mask.m_call = cast(type_of(PhysicsPointQueryParameters3D_methods.get_collision_mask.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsPointQueryParameters3D_methods.set_exclude.m_call = cast(type_of(PhysicsPointQueryParameters3D_methods.set_exclude.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsPointQueryParameters3D_methods.get_exclude.m_call = cast(type_of(PhysicsPointQueryParameters3D_methods.get_exclude.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsPointQueryParameters3D_methods.set_collide_with_bodies.m_call = cast(type_of(PhysicsPointQueryParameters3D_methods.set_collide_with_bodies.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsPointQueryParameters3D_methods.is_collide_with_bodies_enabled.m_call = cast(type_of(PhysicsPointQueryParameters3D_methods.is_collide_with_bodies_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsPointQueryParameters3D_methods.set_collide_with_areas.m_call = cast(type_of(PhysicsPointQueryParameters3D_methods.set_collide_with_areas.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsPointQueryParameters3D_methods.is_collide_with_areas_enabled.m_call = cast(type_of(PhysicsPointQueryParameters3D_methods.is_collide_with_areas_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
