...
OpenXRSpatialContextPersistenceConfig_MethodBind_List :: struct {
  add_persistence_context: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: OpenXRSpatialContextPersistenceConfig, #by_ptr args: struct{persistence_context: ^GDW.RID, }, r_ret: rawptr = nil)
  },
...
OpenXRSpatialContextPersistenceConfig_Init_ :: proc (OpenXRSpatialContextPersistenceConfig_methods: ^OpenXRSpatialContextPersistenceConfig_MethodBind_List, loc := #caller_location) {
  ...
  OpenXRSpatialContextPersistenceConfig_methods.add_persistence_context._add_persistence_context = (cast(^GDW.MethodBind)classDBGetMethodBind3(.OpenXRSpatialContextPersistenceConfig, "add_persistence_context", 2722037293, loc))
  ...
  OpenXRSpatialContextPersistenceConfig_methods.remove_persistence_context._remove_persistence_context = (cast(^GDW.MethodBind)classDBGetMethodBind3(.OpenXRSpatialContextPersistenceConfig, "remove_persistence_context", 2722037293, loc))
