...
AStar2D_MethodBind_List :: struct {
  get_available_point_id: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: AStar2D, #by_ptr args: i64 = 0, r_ret: ^GDW.Int)
  },
  add_point: struct{
  ...
  get_point_ids: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: AStar2D, #by_ptr args: i64 = 0, r_ret: ^GDW.PackedInt64Array)
  },
  set_neighbor_filter_enabled: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: AStar2D, #by_ptr args: i64 = 0, r_ret: ^GDW.Bool)
  },
  ...
  reserve_space: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: AStar2D, #by_ptr args: i64 = 0, r_ret: rawptr = nil)
  },
...
AStar2D_Init_ :: proc (AStar2D_methods: ^AStar2D_MethodBind_List, loc := #caller_location) {
  ...
  AStar2D_methods.get_available_point_id.m_call = cast(type_of(AStar2D_methods.get_available_point_id.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  AStar2D_methods.add_point._add_point = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AStar2D, "add_point", 4074201818, loc))
  AStar2D_methods.add_point.m_call = cast(type_of(AStar2D_methods.add_point.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AStar2D_methods.get_point_position.m_call = cast(type_of(AStar2D_methods.get_point_position.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AStar2D_methods.set_point_position.m_call = cast(type_of(AStar2D_methods.set_point_position.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AStar2D_methods.get_point_weight_scale.m_call = cast(type_of(AStar2D_methods.get_point_weight_scale.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AStar2D_methods.set_point_weight_scale.m_call = cast(type_of(AStar2D_methods.set_point_weight_scale.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AStar2D_methods.remove_point.m_call = cast(type_of(AStar2D_methods.remove_point.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  AStar2D_methods.has_point._has_point = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AStar2D, "has_point", 1116898809, loc))
  AStar2D_methods.has_point.m_call = cast(type_of(AStar2D_methods.has_point.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AStar2D_methods.get_point_connections.m_call = cast(type_of(AStar2D_methods.get_point_connections.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AStar2D_methods.get_point_ids.m_call = cast(type_of(AStar2D_methods.get_point_ids.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AStar2D_methods.set_neighbor_filter_enabled.m_call = cast(type_of(AStar2D_methods.set_neighbor_filter_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AStar2D_methods.is_neighbor_filter_enabled.m_call = cast(type_of(AStar2D_methods.is_neighbor_filter_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AStar2D_methods.set_point_disabled.m_call = cast(type_of(AStar2D_methods.set_point_disabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AStar2D_methods.is_point_disabled.m_call = cast(type_of(AStar2D_methods.is_point_disabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AStar2D_methods.connect_points.m_call = cast(type_of(AStar2D_methods.connect_points.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AStar2D_methods.disconnect_points.m_call = cast(type_of(AStar2D_methods.disconnect_points.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AStar2D_methods.are_points_connected.m_call = cast(type_of(AStar2D_methods.are_points_connected.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AStar2D_methods.get_point_count.m_call = cast(type_of(AStar2D_methods.get_point_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AStar2D_methods.get_point_capacity.m_call = cast(type_of(AStar2D_methods.get_point_capacity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AStar2D_methods.reserve_space.m_call = cast(type_of(AStar2D_methods.reserve_space.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  AStar2D_methods.clear._clear = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AStar2D, "clear", 3218959716, loc))
  AStar2D_methods.clear.m_call = cast(type_of(AStar2D_methods.clear.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AStar2D_methods.get_closest_point.m_call = cast(type_of(AStar2D_methods.get_closest_point.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AStar2D_methods.get_closest_position_in_segment.m_call = cast(type_of(AStar2D_methods.get_closest_position_in_segment.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AStar2D_methods.get_point_path.m_call = cast(type_of(AStar2D_methods.get_point_path.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AStar2D_methods.get_id_path.m_call = cast(type_of(AStar2D_methods.get_id_path.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
