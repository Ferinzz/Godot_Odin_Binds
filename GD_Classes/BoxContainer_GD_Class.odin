...
AlignmentMode_BoxContainer :: enum i64 {
  ALIGNMENT_BEGIN = 0,
  ALIGNMENT_CENTER = 1,
  ALIGNMENT_END = 2,
};
BoxContainer_MethodBind_List :: struct {
  add_spacer: ^GDW.MethodBind,
...
BoxContainer_Init_ :: proc (BoxContainer_methods: ^BoxContainer_MethodBind_List, loc := #caller_location) {
  BoxContainer_methods.add_spacer = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BoxContainer, "add_spacer", 1326660695, loc))
  BoxContainer_methods.set_alignment = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BoxContainer, "set_alignment", 2456745134, loc))
  BoxContainer_methods.get_alignment = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BoxContainer, "get_alignment", 1915476527, loc))
  BoxContainer_methods.set_vertical = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BoxContainer, "set_vertical", 2586408642, loc))
  BoxContainer_methods.is_vertical = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BoxContainer, "is_vertical", 36873697, loc))
};
