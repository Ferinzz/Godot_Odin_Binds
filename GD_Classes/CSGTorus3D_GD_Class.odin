...
CSGTorus3D_MethodBind_List :: struct {
  ...
  set_ring_sides: ^GDW.MethodBind,
  get_ring_sides: ^GDW.MethodBind,
...
CSGTorus3D_Init_ :: proc (CSGTorus3D_methods: ^CSGTorus3D_MethodBind_List, loc := #caller_location) {
  CSGTorus3D_methods.set_inner_radius = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.CSGTorus3D, "set_inner_radius", 373806689, loc))
  CSGTorus3D_methods.get_inner_radius = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.CSGTorus3D, "get_inner_radius", 1740695150, loc))
  CSGTorus3D_methods.set_outer_radius = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.CSGTorus3D, "set_outer_radius", 373806689, loc))
  CSGTorus3D_methods.get_outer_radius = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.CSGTorus3D, "get_outer_radius", 1740695150, loc))
  CSGTorus3D_methods.set_sides = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.CSGTorus3D, "set_sides", 1286410249, loc))
  CSGTorus3D_methods.get_sides = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.CSGTorus3D, "get_sides", 3905245786, loc))
  CSGTorus3D_methods.set_ring_sides = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.CSGTorus3D, "set_ring_sides", 1286410249, loc))
  CSGTorus3D_methods.get_ring_sides = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.CSGTorus3D, "get_ring_sides", 3905245786, loc))
  CSGTorus3D_methods.set_material = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.CSGTorus3D, "set_material", 2757459619, loc))
  CSGTorus3D_methods.get_material = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.CSGTorus3D, "get_material", 5934680, loc))
  CSGTorus3D_methods.set_smooth_faces = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.CSGTorus3D, "set_smooth_faces", 2586408642, loc))
  CSGTorus3D_methods.get_smooth_faces = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.CSGTorus3D, "get_smooth_faces", 36873697, loc))
};
