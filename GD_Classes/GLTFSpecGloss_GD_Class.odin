...
GLTFSpecGloss_Init_ :: proc (GLTFSpecGloss_methods: ^GLTFSpecGloss_MethodBind_List, loc := #caller_location) {
  ...
  GLTFSpecGloss_methods.get_diffuse_img.m_call = cast(type_of(GLTFSpecGloss_methods.get_diffuse_img.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFSpecGloss_methods.set_diffuse_img.m_call = cast(type_of(GLTFSpecGloss_methods.set_diffuse_img.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFSpecGloss_methods.get_diffuse_factor.m_call = cast(type_of(GLTFSpecGloss_methods.get_diffuse_factor.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFSpecGloss_methods.set_diffuse_factor.m_call = cast(type_of(GLTFSpecGloss_methods.set_diffuse_factor.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFSpecGloss_methods.get_gloss_factor.m_call = cast(type_of(GLTFSpecGloss_methods.get_gloss_factor.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFSpecGloss_methods.set_gloss_factor.m_call = cast(type_of(GLTFSpecGloss_methods.set_gloss_factor.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFSpecGloss_methods.get_specular_factor.m_call = cast(type_of(GLTFSpecGloss_methods.get_specular_factor.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFSpecGloss_methods.set_specular_factor.m_call = cast(type_of(GLTFSpecGloss_methods.set_specular_factor.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFSpecGloss_methods.get_spec_gloss_img.m_call = cast(type_of(GLTFSpecGloss_methods.get_spec_gloss_img.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFSpecGloss_methods.set_spec_gloss_img.m_call = cast(type_of(GLTFSpecGloss_methods.set_spec_gloss_img.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
