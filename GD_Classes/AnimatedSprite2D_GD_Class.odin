...
AnimatedSprite2D_MethodBind_List :: struct {
  set_sprite_frames: ^GDW.MethodBind,
  get_sprite_frames: ^GDW.MethodBind,
  ...
  set_frame_progress: ^GDW.MethodBind,
  get_frame_progress: ^GDW.MethodBind,
  set_frame_and_progress: ^GDW.MethodBind,
...
AnimatedSprite2D_Init_ :: proc (AnimatedSprite2D_methods: ^AnimatedSprite2D_MethodBind_List, loc := #caller_location) {
  AnimatedSprite2D_methods.set_sprite_frames = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AnimatedSprite2D, "set_sprite_frames", 905781144, loc))
  AnimatedSprite2D_methods.get_sprite_frames = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AnimatedSprite2D, "get_sprite_frames", 3804851214, loc))
  AnimatedSprite2D_methods.set_animation = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AnimatedSprite2D, "set_animation", 3304788590, loc))
  AnimatedSprite2D_methods.get_animation = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AnimatedSprite2D, "get_animation", 2002593661, loc))
  AnimatedSprite2D_methods.set_autoplay = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AnimatedSprite2D, "set_autoplay", 83702148, loc))
  AnimatedSprite2D_methods.get_autoplay = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AnimatedSprite2D, "get_autoplay", 201670096, loc))
  AnimatedSprite2D_methods.is_playing = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AnimatedSprite2D, "is_playing", 36873697, loc))
  AnimatedSprite2D_methods.play = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AnimatedSprite2D, "play", 3269405555, loc))
  AnimatedSprite2D_methods.play_backwards = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AnimatedSprite2D, "play_backwards", 3323268493, loc))
  AnimatedSprite2D_methods.pause = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AnimatedSprite2D, "pause", 3218959716, loc))
  AnimatedSprite2D_methods.stop = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AnimatedSprite2D, "stop", 3218959716, loc))
  AnimatedSprite2D_methods.set_centered = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AnimatedSprite2D, "set_centered", 2586408642, loc))
  AnimatedSprite2D_methods.is_centered = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AnimatedSprite2D, "is_centered", 36873697, loc))
  AnimatedSprite2D_methods.set_offset = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AnimatedSprite2D, "set_offset", 743155724, loc))
  AnimatedSprite2D_methods.get_offset = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AnimatedSprite2D, "get_offset", 3341600327, loc))
  AnimatedSprite2D_methods.set_flip_h = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AnimatedSprite2D, "set_flip_h", 2586408642, loc))
  AnimatedSprite2D_methods.is_flipped_h = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AnimatedSprite2D, "is_flipped_h", 36873697, loc))
  AnimatedSprite2D_methods.set_flip_v = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AnimatedSprite2D, "set_flip_v", 2586408642, loc))
  AnimatedSprite2D_methods.is_flipped_v = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AnimatedSprite2D, "is_flipped_v", 36873697, loc))
  AnimatedSprite2D_methods.set_frame = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AnimatedSprite2D, "set_frame", 1286410249, loc))
  AnimatedSprite2D_methods.get_frame = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AnimatedSprite2D, "get_frame", 3905245786, loc))
  AnimatedSprite2D_methods.set_frame_progress = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AnimatedSprite2D, "set_frame_progress", 373806689, loc))
  AnimatedSprite2D_methods.get_frame_progress = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AnimatedSprite2D, "get_frame_progress", 1740695150, loc))
  AnimatedSprite2D_methods.set_frame_and_progress = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AnimatedSprite2D, "set_frame_and_progress", 1602489585, loc))
  AnimatedSprite2D_methods.set_speed_scale = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AnimatedSprite2D, "set_speed_scale", 373806689, loc))
  AnimatedSprite2D_methods.get_speed_scale = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AnimatedSprite2D, "get_speed_scale", 1740695150, loc))
  AnimatedSprite2D_methods.get_playing_speed = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AnimatedSprite2D, "get_playing_speed", 1740695150, loc))
};
