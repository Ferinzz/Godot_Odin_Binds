...
GPUParticlesAttractorSphere3D_MethodBind_List :: struct {
  set_radius: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: GPUParticlesAttractorSphere3D, #by_ptr args: struct{radius: ^GDW.float, }, r_ret: rawptr = nil)
  },
    get_radius: struct{
    using _get_radius: ^GDW.MethodBind,
    m_call: proc "c" (_:^GDW.MethodBind, obj: GPUParticlesAttractorSphere3D, args: rawptr = nil, r_ret: ^GDW.float)
  },
};
GPUParticlesAttractorSphere3D_Init_ :: proc (GPUParticlesAttractorSphere3D_methods: ^GPUParticlesAttractorSphere3D_MethodBind_List, loc := #caller_location) {
  ...
  GPUParticlesAttractorSphere3D_methods.set_radius._set_radius = (cast(^GDW.MethodBind)classDBGetMethodBind3(.GPUParticlesAttractorSphere3D, "set_radius", 373806689, loc))
  ...
  GPUParticlesAttractorSphere3D_methods.get_radius._get_radius = (cast(^GDW.MethodBind)classDBGetMethodBind3(.GPUParticlesAttractorSphere3D, "get_radius", 1740695150, loc))
