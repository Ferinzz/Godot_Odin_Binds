...
Qualifier_VisualShaderNodeParameter :: enum i64 {
  QUAL_NONE = 0,
  QUAL_GLOBAL = 1,
  QUAL_INSTANCE = 2,
...
VisualShaderNodeParameter_MethodBind_List :: struct {
  set_parameter_name: ^GDW.MethodBind,
  get_parameter_name: ^GDW.MethodBind,
  set_qualifier: ^GDW.MethodBind,
  get_qualifier: ^GDW.MethodBind,
  set_instance_index: ^GDW.MethodBind,
  get_instance_index: ^GDW.MethodBind,
};
VisualShaderNodeParameter_Init_ :: proc (VisualShaderNodeParameter_methods: ^VisualShaderNodeParameter_MethodBind_List, loc := #caller_location) {
  VisualShaderNodeParameter_methods.set_parameter_name = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.VisualShaderNodeParameter, "set_parameter_name", 83702148, loc))
  VisualShaderNodeParameter_methods.get_parameter_name = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.VisualShaderNodeParameter, "get_parameter_name", 201670096, loc))
  VisualShaderNodeParameter_methods.set_qualifier = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.VisualShaderNodeParameter, "set_qualifier", 1276489447, loc))
  VisualShaderNodeParameter_methods.get_qualifier = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.VisualShaderNodeParameter, "get_qualifier", 3558406205, loc))
  VisualShaderNodeParameter_methods.set_instance_index = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.VisualShaderNodeParameter, "set_instance_index", 1286410249, loc))
  VisualShaderNodeParameter_methods.get_instance_index = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.VisualShaderNodeParameter, "get_instance_index", 3905245786, loc))
};
