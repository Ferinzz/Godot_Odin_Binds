...
Image_Init_ :: proc (Image_methods: ^Image_MethodBind_List, loc := #caller_location) {
  ...
  Image_methods.get_width.m_call = cast(type_of(Image_methods.get_width.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Image_methods.get_height._get_height = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Image, "get_height", 3905245786, loc))
  Image_methods.get_height.m_call = cast(type_of(Image_methods.get_height.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Image_methods.get_size._get_size = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Image, "get_size", 3690982128, loc))
  Image_methods.get_size.m_call = cast(type_of(Image_methods.get_size.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Image_methods.has_mipmaps._has_mipmaps = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Image, "has_mipmaps", 36873697, loc))
  Image_methods.has_mipmaps.m_call = cast(type_of(Image_methods.has_mipmaps.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Image_methods.get_format._get_format = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Image, "get_format", 3847873762, loc))
  Image_methods.get_format.m_call = cast(type_of(Image_methods.get_format.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Image_methods.get_data._get_data = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Image, "get_data", 2362200018, loc))
  Image_methods.get_data.m_call = cast(type_of(Image_methods.get_data.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Image_methods.get_data_size.m_call = cast(type_of(Image_methods.get_data_size.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Image_methods.convert._convert = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Image, "convert", 2120693146, loc))
  Image_methods.convert.m_call = cast(type_of(Image_methods.convert.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Image_methods.get_mipmap_count.m_call = cast(type_of(Image_methods.get_mipmap_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Image_methods.get_mipmap_offset.m_call = cast(type_of(Image_methods.get_mipmap_offset.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Image_methods.resize_to_po2.m_call = cast(type_of(Image_methods.resize_to_po2.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Image_methods.resize._resize = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Image, "resize", 994498151, loc))
  Image_methods.resize.m_call = cast(type_of(Image_methods.resize.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Image_methods.shrink_x2._shrink_x2 = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Image, "shrink_x2", 3218959716, loc))
  Image_methods.shrink_x2.m_call = cast(type_of(Image_methods.shrink_x2.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Image_methods.crop._crop = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Image, "crop", 3937882851, loc))
  Image_methods.crop.m_call = cast(type_of(Image_methods.crop.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Image_methods.flip_x._flip_x = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Image, "flip_x", 3218959716, loc))
  Image_methods.flip_x.m_call = cast(type_of(Image_methods.flip_x.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Image_methods.flip_y._flip_y = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Image, "flip_y", 3218959716, loc))
  Image_methods.flip_y.m_call = cast(type_of(Image_methods.flip_y.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Image_methods.generate_mipmaps.m_call = cast(type_of(Image_methods.generate_mipmaps.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Image_methods.clear_mipmaps.m_call = cast(type_of(Image_methods.clear_mipmaps.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Image_methods.create._create = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Image, "create", 986942177, loc))
  Image_methods.create.m_call = cast(type_of(Image_methods.create.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Image_methods.create_empty._create_empty = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Image, "create_empty", 986942177, loc))
  Image_methods.create_empty.m_call = cast(type_of(Image_methods.create_empty.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Image_methods.create_from_data.m_call = cast(type_of(Image_methods.create_from_data.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Image_methods.set_data._set_data = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Image, "set_data", 2740482212, loc))
  Image_methods.set_data.m_call = cast(type_of(Image_methods.set_data.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Image_methods.is_empty._is_empty = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Image, "is_empty", 36873697, loc))
  Image_methods.is_empty.m_call = cast(type_of(Image_methods.is_empty.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Image_methods.load._load = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Image, "load", 166001499, loc))
  Image_methods.load.m_call = cast(type_of(Image_methods.load.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Image_methods.load_from_file.m_call = cast(type_of(Image_methods.load_from_file.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Image_methods.save_png._save_png = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Image, "save_png", 2113323047, loc))
  Image_methods.save_png.m_call = cast(type_of(Image_methods.save_png.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Image_methods.save_png_to_buffer.m_call = cast(type_of(Image_methods.save_png_to_buffer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Image_methods.save_jpg._save_jpg = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Image, "save_jpg", 2800019068, loc))
  Image_methods.save_jpg.m_call = cast(type_of(Image_methods.save_jpg.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Image_methods.save_jpg_to_buffer.m_call = cast(type_of(Image_methods.save_jpg_to_buffer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Image_methods.save_exr._save_exr = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Image, "save_exr", 3108122999, loc))
  Image_methods.save_exr.m_call = cast(type_of(Image_methods.save_exr.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Image_methods.save_exr_to_buffer.m_call = cast(type_of(Image_methods.save_exr_to_buffer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Image_methods.save_dds._save_dds = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Image, "save_dds", 2113323047, loc))
  Image_methods.save_dds.m_call = cast(type_of(Image_methods.save_dds.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Image_methods.save_dds_to_buffer.m_call = cast(type_of(Image_methods.save_dds_to_buffer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Image_methods.save_webp._save_webp = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Image, "save_webp", 2781156876, loc))
  Image_methods.save_webp.m_call = cast(type_of(Image_methods.save_webp.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Image_methods.save_webp_to_buffer.m_call = cast(type_of(Image_methods.save_webp_to_buffer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Image_methods.detect_alpha._detect_alpha = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Image, "detect_alpha", 2030116505, loc))
  Image_methods.detect_alpha.m_call = cast(type_of(Image_methods.detect_alpha.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Image_methods.is_invisible._is_invisible = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Image, "is_invisible", 36873697, loc))
  Image_methods.is_invisible.m_call = cast(type_of(Image_methods.is_invisible.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Image_methods.detect_used_channels.m_call = cast(type_of(Image_methods.detect_used_channels.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Image_methods.compress._compress = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Image, "compress", 2975424957, loc))
  Image_methods.compress.m_call = cast(type_of(Image_methods.compress.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Image_methods.compress_from_channels.m_call = cast(type_of(Image_methods.compress_from_channels.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Image_methods.decompress._decompress = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Image, "decompress", 166280745, loc))
  Image_methods.decompress.m_call = cast(type_of(Image_methods.decompress.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Image_methods.is_compressed.m_call = cast(type_of(Image_methods.is_compressed.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Image_methods.rotate_90._rotate_90 = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Image, "rotate_90", 1901204267, loc))
  Image_methods.rotate_90.m_call = cast(type_of(Image_methods.rotate_90.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Image_methods.rotate_180._rotate_180 = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Image, "rotate_180", 3218959716, loc))
  Image_methods.rotate_180.m_call = cast(type_of(Image_methods.rotate_180.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Image_methods.fix_alpha_edges.m_call = cast(type_of(Image_methods.fix_alpha_edges.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Image_methods.premultiply_alpha.m_call = cast(type_of(Image_methods.premultiply_alpha.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Image_methods.srgb_to_linear.m_call = cast(type_of(Image_methods.srgb_to_linear.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Image_methods.linear_to_srgb.m_call = cast(type_of(Image_methods.linear_to_srgb.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Image_methods.normal_map_to_xy.m_call = cast(type_of(Image_methods.normal_map_to_xy.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Image_methods.rgbe_to_srgb._rgbe_to_srgb = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Image, "rgbe_to_srgb", 564927088, loc))
  Image_methods.rgbe_to_srgb.m_call = cast(type_of(Image_methods.rgbe_to_srgb.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Image_methods.bump_map_to_normal_map.m_call = cast(type_of(Image_methods.bump_map_to_normal_map.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Image_methods.compute_image_metrics.m_call = cast(type_of(Image_methods.compute_image_metrics.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Image_methods.blit_rect._blit_rect = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Image, "blit_rect", 2903928755, loc))
  Image_methods.blit_rect.m_call = cast(type_of(Image_methods.blit_rect.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Image_methods.blit_rect_mask.m_call = cast(type_of(Image_methods.blit_rect_mask.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Image_methods.blend_rect._blend_rect = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Image, "blend_rect", 2903928755, loc))
  Image_methods.blend_rect.m_call = cast(type_of(Image_methods.blend_rect.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Image_methods.blend_rect_mask.m_call = cast(type_of(Image_methods.blend_rect_mask.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Image_methods.fill._fill = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Image, "fill", 2920490490, loc))
  Image_methods.fill.m_call = cast(type_of(Image_methods.fill.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Image_methods.fill_rect._fill_rect = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Image, "fill_rect", 514693913, loc))
  Image_methods.fill_rect.m_call = cast(type_of(Image_methods.fill_rect.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Image_methods.get_used_rect.m_call = cast(type_of(Image_methods.get_used_rect.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Image_methods.get_region._get_region = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Image, "get_region", 2601441065, loc))
  Image_methods.get_region.m_call = cast(type_of(Image_methods.get_region.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Image_methods.copy_from._copy_from = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Image, "copy_from", 532598488, loc))
  Image_methods.copy_from.m_call = cast(type_of(Image_methods.copy_from.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Image_methods.get_pixelv._get_pixelv = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Image, "get_pixelv", 1532707496, loc))
  Image_methods.get_pixelv.m_call = cast(type_of(Image_methods.get_pixelv.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Image_methods.get_pixel._get_pixel = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Image, "get_pixel", 2165839948, loc))
  Image_methods.get_pixel.m_call = cast(type_of(Image_methods.get_pixel.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Image_methods.set_pixelv._set_pixelv = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Image, "set_pixelv", 287851464, loc))
  Image_methods.set_pixelv.m_call = cast(type_of(Image_methods.set_pixelv.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Image_methods.set_pixel._set_pixel = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Image, "set_pixel", 3733378741, loc))
  Image_methods.set_pixel.m_call = cast(type_of(Image_methods.set_pixel.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Image_methods.adjust_bcs._adjust_bcs = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Image, "adjust_bcs", 2385087082, loc))
  Image_methods.adjust_bcs.m_call = cast(type_of(Image_methods.adjust_bcs.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Image_methods.load_png_from_buffer.m_call = cast(type_of(Image_methods.load_png_from_buffer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Image_methods.load_jpg_from_buffer.m_call = cast(type_of(Image_methods.load_jpg_from_buffer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Image_methods.load_webp_from_buffer.m_call = cast(type_of(Image_methods.load_webp_from_buffer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Image_methods.load_tga_from_buffer.m_call = cast(type_of(Image_methods.load_tga_from_buffer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Image_methods.load_bmp_from_buffer.m_call = cast(type_of(Image_methods.load_bmp_from_buffer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Image_methods.load_ktx_from_buffer.m_call = cast(type_of(Image_methods.load_ktx_from_buffer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Image_methods.load_dds_from_buffer.m_call = cast(type_of(Image_methods.load_dds_from_buffer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Image_methods.load_exr_from_buffer.m_call = cast(type_of(Image_methods.load_exr_from_buffer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Image_methods.load_svg_from_buffer.m_call = cast(type_of(Image_methods.load_svg_from_buffer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Image_methods.load_svg_from_string.m_call = cast(type_of(Image_methods.load_svg_from_string.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
