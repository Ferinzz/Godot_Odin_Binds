...
ShaderIncludeDB_Init_ :: proc (ShaderIncludeDB_methods: ^ShaderIncludeDB_MethodBind_List, loc := #caller_location) {
  ...
  ShaderIncludeDB_methods.list_built_in_include_files.m_call = cast(type_of(ShaderIncludeDB_methods.list_built_in_include_files.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ShaderIncludeDB_methods.has_built_in_include_file.m_call = cast(type_of(ShaderIncludeDB_methods.has_built_in_include_file.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ShaderIncludeDB_methods.get_built_in_include_file.m_call = cast(type_of(ShaderIncludeDB_methods.get_built_in_include_file.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
