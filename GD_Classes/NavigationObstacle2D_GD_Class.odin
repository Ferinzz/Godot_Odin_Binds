...
NavigationObstacle2D_MethodBind_List :: struct {
  get_rid: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: NavigationObstacle2D, #by_ptr args: i64 = 0, r_ret: ^GDW.RID)
  },
  set_avoidance_enabled: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: NavigationObstacle2D, #by_ptr args: i64 = 0, r_ret: ^GDW.Bool)
  },
  ...
  set_radius: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: NavigationObstacle2D, #by_ptr args: i64 = 0, r_ret: ^GDW.float)
  },
  set_velocity: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: NavigationObstacle2D, #by_ptr args: i64 = 0, r_ret: ^GDW.Vector2)
  },
  set_vertices: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: NavigationObstacle2D, #by_ptr args: i64 = 0, r_ret: ^GDW.PackedVector2Array)
  },
  set_avoidance_layers: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: NavigationObstacle2D, #by_ptr args: i64 = 0, r_ret: ^GDW.Int)
  },
...
NavigationObstacle2D_Init_ :: proc (NavigationObstacle2D_methods: ^NavigationObstacle2D_MethodBind_List, loc := #caller_location) {
  ...
  NavigationObstacle2D_methods.get_rid.m_call = cast(type_of(NavigationObstacle2D_methods.get_rid.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationObstacle2D_methods.set_avoidance_enabled.m_call = cast(type_of(NavigationObstacle2D_methods.set_avoidance_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationObstacle2D_methods.get_avoidance_enabled.m_call = cast(type_of(NavigationObstacle2D_methods.get_avoidance_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationObstacle2D_methods.set_navigation_map.m_call = cast(type_of(NavigationObstacle2D_methods.set_navigation_map.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationObstacle2D_methods.get_navigation_map.m_call = cast(type_of(NavigationObstacle2D_methods.get_navigation_map.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationObstacle2D_methods.set_radius.m_call = cast(type_of(NavigationObstacle2D_methods.set_radius.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationObstacle2D_methods.get_radius.m_call = cast(type_of(NavigationObstacle2D_methods.get_radius.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationObstacle2D_methods.set_velocity.m_call = cast(type_of(NavigationObstacle2D_methods.set_velocity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationObstacle2D_methods.get_velocity.m_call = cast(type_of(NavigationObstacle2D_methods.get_velocity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationObstacle2D_methods.set_vertices.m_call = cast(type_of(NavigationObstacle2D_methods.set_vertices.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationObstacle2D_methods.get_vertices.m_call = cast(type_of(NavigationObstacle2D_methods.get_vertices.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationObstacle2D_methods.set_avoidance_layers.m_call = cast(type_of(NavigationObstacle2D_methods.set_avoidance_layers.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationObstacle2D_methods.get_avoidance_layers.m_call = cast(type_of(NavigationObstacle2D_methods.get_avoidance_layers.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationObstacle2D_methods.set_avoidance_layer_value.m_call = cast(type_of(NavigationObstacle2D_methods.set_avoidance_layer_value.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationObstacle2D_methods.get_avoidance_layer_value.m_call = cast(type_of(NavigationObstacle2D_methods.get_avoidance_layer_value.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationObstacle2D_methods.set_affect_navigation_mesh.m_call = cast(type_of(NavigationObstacle2D_methods.set_affect_navigation_mesh.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationObstacle2D_methods.get_affect_navigation_mesh.m_call = cast(type_of(NavigationObstacle2D_methods.get_affect_navigation_mesh.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationObstacle2D_methods.set_carve_navigation_mesh.m_call = cast(type_of(NavigationObstacle2D_methods.set_carve_navigation_mesh.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationObstacle2D_methods.get_carve_navigation_mesh.m_call = cast(type_of(NavigationObstacle2D_methods.get_carve_navigation_mesh.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
