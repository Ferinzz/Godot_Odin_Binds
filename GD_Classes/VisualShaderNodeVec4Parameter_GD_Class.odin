...
VisualShaderNodeVec4Parameter_MethodBind_List :: struct {
  set_default_value_enabled: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: VisualShaderNodeVec4Parameter, #by_ptr args: i64 = 0, r_ret: ^GDW.Bool)
  },
  set_default_value: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: VisualShaderNodeVec4Parameter, #by_ptr args: i64 = 0, r_ret: ^GDW.Vector4)
  },
};
VisualShaderNodeVec4Parameter_Init_ :: proc (VisualShaderNodeVec4Parameter_methods: ^VisualShaderNodeVec4Parameter_MethodBind_List, loc := #caller_location) {
  ...
  VisualShaderNodeVec4Parameter_methods.set_default_value_enabled.m_call = cast(type_of(VisualShaderNodeVec4Parameter_methods.set_default_value_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeVec4Parameter_methods.is_default_value_enabled.m_call = cast(type_of(VisualShaderNodeVec4Parameter_methods.is_default_value_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeVec4Parameter_methods.set_default_value.m_call = cast(type_of(VisualShaderNodeVec4Parameter_methods.set_default_value.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeVec4Parameter_methods.get_default_value.m_call = cast(type_of(VisualShaderNodeVec4Parameter_methods.get_default_value.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
