...
Texture3DRD_Init_ :: proc (Texture3DRD_methods: ^Texture3DRD_MethodBind_List, loc := #caller_location) {
  ...
  Texture3DRD_methods.set_texture_rd_rid.m_call = cast(type_of(Texture3DRD_methods.set_texture_rd_rid.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Texture3DRD_methods.get_texture_rd_rid.m_call = cast(type_of(Texture3DRD_methods.get_texture_rd_rid.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
