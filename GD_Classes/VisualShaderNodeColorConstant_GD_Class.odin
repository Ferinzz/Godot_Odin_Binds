...
VisualShaderNodeColorConstant_Init_ :: proc (VisualShaderNodeColorConstant_methods: ^VisualShaderNodeColorConstant_MethodBind_List, loc := #caller_location) {
  ...
  VisualShaderNodeColorConstant_methods.set_constant.m_call = cast(type_of(VisualShaderNodeColorConstant_methods.set_constant.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeColorConstant_methods.get_constant.m_call = cast(type_of(VisualShaderNodeColorConstant_methods.get_constant.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
