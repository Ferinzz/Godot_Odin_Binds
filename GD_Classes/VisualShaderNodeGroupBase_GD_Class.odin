...
VisualShaderNodeGroupBase_Init_ :: proc (VisualShaderNodeGroupBase_methods: ^VisualShaderNodeGroupBase_MethodBind_List, loc := #caller_location) {
  ...
  VisualShaderNodeGroupBase_methods.set_inputs.m_call = cast(type_of(VisualShaderNodeGroupBase_methods.set_inputs.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeGroupBase_methods.get_inputs.m_call = cast(type_of(VisualShaderNodeGroupBase_methods.get_inputs.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeGroupBase_methods.set_outputs.m_call = cast(type_of(VisualShaderNodeGroupBase_methods.set_outputs.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeGroupBase_methods.get_outputs.m_call = cast(type_of(VisualShaderNodeGroupBase_methods.get_outputs.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeGroupBase_methods.is_valid_port_name.m_call = cast(type_of(VisualShaderNodeGroupBase_methods.is_valid_port_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeGroupBase_methods.add_input_port.m_call = cast(type_of(VisualShaderNodeGroupBase_methods.add_input_port.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeGroupBase_methods.remove_input_port.m_call = cast(type_of(VisualShaderNodeGroupBase_methods.remove_input_port.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeGroupBase_methods.get_input_port_count.m_call = cast(type_of(VisualShaderNodeGroupBase_methods.get_input_port_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeGroupBase_methods.has_input_port.m_call = cast(type_of(VisualShaderNodeGroupBase_methods.has_input_port.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeGroupBase_methods.clear_input_ports.m_call = cast(type_of(VisualShaderNodeGroupBase_methods.clear_input_ports.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeGroupBase_methods.add_output_port.m_call = cast(type_of(VisualShaderNodeGroupBase_methods.add_output_port.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeGroupBase_methods.remove_output_port.m_call = cast(type_of(VisualShaderNodeGroupBase_methods.remove_output_port.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeGroupBase_methods.get_output_port_count.m_call = cast(type_of(VisualShaderNodeGroupBase_methods.get_output_port_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeGroupBase_methods.has_output_port.m_call = cast(type_of(VisualShaderNodeGroupBase_methods.has_output_port.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeGroupBase_methods.clear_output_ports.m_call = cast(type_of(VisualShaderNodeGroupBase_methods.clear_output_ports.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeGroupBase_methods.set_input_port_name.m_call = cast(type_of(VisualShaderNodeGroupBase_methods.set_input_port_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeGroupBase_methods.set_input_port_type.m_call = cast(type_of(VisualShaderNodeGroupBase_methods.set_input_port_type.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeGroupBase_methods.set_output_port_name.m_call = cast(type_of(VisualShaderNodeGroupBase_methods.set_output_port_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeGroupBase_methods.set_output_port_type.m_call = cast(type_of(VisualShaderNodeGroupBase_methods.set_output_port_type.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeGroupBase_methods.get_free_input_port_id.m_call = cast(type_of(VisualShaderNodeGroupBase_methods.get_free_input_port_id.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeGroupBase_methods.get_free_output_port_id.m_call = cast(type_of(VisualShaderNodeGroupBase_methods.get_free_output_port_id.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
