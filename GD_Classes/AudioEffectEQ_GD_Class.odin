...
AudioEffectEQ_Init_ :: proc (AudioEffectEQ_methods: ^AudioEffectEQ_MethodBind_List, loc := #caller_location) {
  ...
  AudioEffectEQ_methods.set_band_gain_db.m_call = cast(type_of(AudioEffectEQ_methods.set_band_gain_db.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioEffectEQ_methods.get_band_gain_db.m_call = cast(type_of(AudioEffectEQ_methods.get_band_gain_db.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioEffectEQ_methods.get_band_count.m_call = cast(type_of(AudioEffectEQ_methods.get_band_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
