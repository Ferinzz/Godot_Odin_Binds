...
EditorSettings_Init_ :: proc (EditorSettings_methods: ^EditorSettings_MethodBind_List, loc := #caller_location) {
  ...
  EditorSettings_methods.has_setting.m_call = cast(type_of(EditorSettings_methods.has_setting.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorSettings_methods.set_setting.m_call = cast(type_of(EditorSettings_methods.set_setting.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorSettings_methods.get_setting.m_call = cast(type_of(EditorSettings_methods.get_setting.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  EditorSettings_methods.erase._erase = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.EditorSettings, "erase", 83702148, loc))
  EditorSettings_methods.erase.m_call = cast(type_of(EditorSettings_methods.erase.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorSettings_methods.set_initial_value.m_call = cast(type_of(EditorSettings_methods.set_initial_value.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorSettings_methods.add_property_info.m_call = cast(type_of(EditorSettings_methods.add_property_info.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorSettings_methods.set_project_metadata.m_call = cast(type_of(EditorSettings_methods.set_project_metadata.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorSettings_methods.get_project_metadata.m_call = cast(type_of(EditorSettings_methods.get_project_metadata.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorSettings_methods.set_favorites.m_call = cast(type_of(EditorSettings_methods.set_favorites.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorSettings_methods.get_favorites.m_call = cast(type_of(EditorSettings_methods.get_favorites.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorSettings_methods.set_recent_dirs.m_call = cast(type_of(EditorSettings_methods.set_recent_dirs.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorSettings_methods.get_recent_dirs.m_call = cast(type_of(EditorSettings_methods.get_recent_dirs.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorSettings_methods.set_builtin_action_override.m_call = cast(type_of(EditorSettings_methods.set_builtin_action_override.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorSettings_methods.add_shortcut.m_call = cast(type_of(EditorSettings_methods.add_shortcut.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorSettings_methods.remove_shortcut.m_call = cast(type_of(EditorSettings_methods.remove_shortcut.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorSettings_methods.is_shortcut.m_call = cast(type_of(EditorSettings_methods.is_shortcut.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorSettings_methods.has_shortcut.m_call = cast(type_of(EditorSettings_methods.has_shortcut.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorSettings_methods.get_shortcut.m_call = cast(type_of(EditorSettings_methods.get_shortcut.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorSettings_methods.get_shortcut_list.m_call = cast(type_of(EditorSettings_methods.get_shortcut_list.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorSettings_methods.check_changed_settings_in_group.m_call = cast(type_of(EditorSettings_methods.check_changed_settings_in_group.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorSettings_methods.get_changed_settings.m_call = cast(type_of(EditorSettings_methods.get_changed_settings.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorSettings_methods.mark_setting_changed.m_call = cast(type_of(EditorSettings_methods.mark_setting_changed.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
