...
FontFile_Init_ :: proc (FontFile_methods: ^FontFile_MethodBind_List, loc := #caller_location) {
  ...
  FontFile_methods.load_bitmap_font.m_call = cast(type_of(FontFile_methods.load_bitmap_font.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.load_dynamic_font.m_call = cast(type_of(FontFile_methods.load_dynamic_font.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  FontFile_methods.set_data._set_data = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.FontFile, "set_data", 2971499966, loc))
  FontFile_methods.set_data.m_call = cast(type_of(FontFile_methods.set_data.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  FontFile_methods.get_data._get_data = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.FontFile, "get_data", 2362200018, loc))
  FontFile_methods.get_data.m_call = cast(type_of(FontFile_methods.get_data.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.set_font_name.m_call = cast(type_of(FontFile_methods.set_font_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.set_font_style_name.m_call = cast(type_of(FontFile_methods.set_font_style_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.set_font_style.m_call = cast(type_of(FontFile_methods.set_font_style.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.set_font_weight.m_call = cast(type_of(FontFile_methods.set_font_weight.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.set_font_stretch.m_call = cast(type_of(FontFile_methods.set_font_stretch.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.set_antialiasing.m_call = cast(type_of(FontFile_methods.set_antialiasing.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.get_antialiasing.m_call = cast(type_of(FontFile_methods.get_antialiasing.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.set_disable_embedded_bitmaps.m_call = cast(type_of(FontFile_methods.set_disable_embedded_bitmaps.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.get_disable_embedded_bitmaps.m_call = cast(type_of(FontFile_methods.get_disable_embedded_bitmaps.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.set_generate_mipmaps.m_call = cast(type_of(FontFile_methods.set_generate_mipmaps.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.get_generate_mipmaps.m_call = cast(type_of(FontFile_methods.get_generate_mipmaps.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.set_multichannel_signed_distance_field.m_call = cast(type_of(FontFile_methods.set_multichannel_signed_distance_field.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.is_multichannel_signed_distance_field.m_call = cast(type_of(FontFile_methods.is_multichannel_signed_distance_field.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.set_msdf_pixel_range.m_call = cast(type_of(FontFile_methods.set_msdf_pixel_range.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.get_msdf_pixel_range.m_call = cast(type_of(FontFile_methods.get_msdf_pixel_range.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.set_msdf_size.m_call = cast(type_of(FontFile_methods.set_msdf_size.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.get_msdf_size.m_call = cast(type_of(FontFile_methods.get_msdf_size.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.set_fixed_size.m_call = cast(type_of(FontFile_methods.set_fixed_size.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.get_fixed_size.m_call = cast(type_of(FontFile_methods.get_fixed_size.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.set_fixed_size_scale_mode.m_call = cast(type_of(FontFile_methods.set_fixed_size_scale_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.get_fixed_size_scale_mode.m_call = cast(type_of(FontFile_methods.get_fixed_size_scale_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.set_allow_system_fallback.m_call = cast(type_of(FontFile_methods.set_allow_system_fallback.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.is_allow_system_fallback.m_call = cast(type_of(FontFile_methods.is_allow_system_fallback.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.set_force_autohinter.m_call = cast(type_of(FontFile_methods.set_force_autohinter.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.is_force_autohinter.m_call = cast(type_of(FontFile_methods.is_force_autohinter.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.set_modulate_color_glyphs.m_call = cast(type_of(FontFile_methods.set_modulate_color_glyphs.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.is_modulate_color_glyphs.m_call = cast(type_of(FontFile_methods.is_modulate_color_glyphs.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.set_hinting.m_call = cast(type_of(FontFile_methods.set_hinting.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.get_hinting.m_call = cast(type_of(FontFile_methods.get_hinting.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.set_subpixel_positioning.m_call = cast(type_of(FontFile_methods.set_subpixel_positioning.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.get_subpixel_positioning.m_call = cast(type_of(FontFile_methods.get_subpixel_positioning.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.set_keep_rounding_remainders.m_call = cast(type_of(FontFile_methods.set_keep_rounding_remainders.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.get_keep_rounding_remainders.m_call = cast(type_of(FontFile_methods.get_keep_rounding_remainders.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.set_oversampling.m_call = cast(type_of(FontFile_methods.set_oversampling.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.get_oversampling.m_call = cast(type_of(FontFile_methods.get_oversampling.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.get_cache_count.m_call = cast(type_of(FontFile_methods.get_cache_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.clear_cache.m_call = cast(type_of(FontFile_methods.clear_cache.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.remove_cache.m_call = cast(type_of(FontFile_methods.remove_cache.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.get_size_cache_list.m_call = cast(type_of(FontFile_methods.get_size_cache_list.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.clear_size_cache.m_call = cast(type_of(FontFile_methods.clear_size_cache.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.remove_size_cache.m_call = cast(type_of(FontFile_methods.remove_size_cache.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.set_variation_coordinates.m_call = cast(type_of(FontFile_methods.set_variation_coordinates.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.get_variation_coordinates.m_call = cast(type_of(FontFile_methods.get_variation_coordinates.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.set_embolden.m_call = cast(type_of(FontFile_methods.set_embolden.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.get_embolden.m_call = cast(type_of(FontFile_methods.get_embolden.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.set_transform.m_call = cast(type_of(FontFile_methods.set_transform.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.get_transform.m_call = cast(type_of(FontFile_methods.get_transform.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.set_extra_spacing.m_call = cast(type_of(FontFile_methods.set_extra_spacing.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.get_extra_spacing.m_call = cast(type_of(FontFile_methods.get_extra_spacing.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.set_extra_baseline_offset.m_call = cast(type_of(FontFile_methods.set_extra_baseline_offset.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.get_extra_baseline_offset.m_call = cast(type_of(FontFile_methods.get_extra_baseline_offset.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.set_face_index.m_call = cast(type_of(FontFile_methods.set_face_index.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.get_face_index.m_call = cast(type_of(FontFile_methods.get_face_index.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.set_cache_ascent.m_call = cast(type_of(FontFile_methods.set_cache_ascent.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.get_cache_ascent.m_call = cast(type_of(FontFile_methods.get_cache_ascent.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.set_cache_descent.m_call = cast(type_of(FontFile_methods.set_cache_descent.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.get_cache_descent.m_call = cast(type_of(FontFile_methods.get_cache_descent.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.set_cache_underline_position.m_call = cast(type_of(FontFile_methods.set_cache_underline_position.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.get_cache_underline_position.m_call = cast(type_of(FontFile_methods.get_cache_underline_position.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.set_cache_underline_thickness.m_call = cast(type_of(FontFile_methods.set_cache_underline_thickness.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.get_cache_underline_thickness.m_call = cast(type_of(FontFile_methods.get_cache_underline_thickness.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.set_cache_scale.m_call = cast(type_of(FontFile_methods.set_cache_scale.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.get_cache_scale.m_call = cast(type_of(FontFile_methods.get_cache_scale.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.get_texture_count.m_call = cast(type_of(FontFile_methods.get_texture_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.clear_textures.m_call = cast(type_of(FontFile_methods.clear_textures.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.remove_texture.m_call = cast(type_of(FontFile_methods.remove_texture.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.set_texture_image.m_call = cast(type_of(FontFile_methods.set_texture_image.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.get_texture_image.m_call = cast(type_of(FontFile_methods.get_texture_image.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.set_texture_offsets.m_call = cast(type_of(FontFile_methods.set_texture_offsets.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.get_texture_offsets.m_call = cast(type_of(FontFile_methods.get_texture_offsets.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.get_glyph_list.m_call = cast(type_of(FontFile_methods.get_glyph_list.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.clear_glyphs.m_call = cast(type_of(FontFile_methods.clear_glyphs.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.remove_glyph.m_call = cast(type_of(FontFile_methods.remove_glyph.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.set_glyph_advance.m_call = cast(type_of(FontFile_methods.set_glyph_advance.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.get_glyph_advance.m_call = cast(type_of(FontFile_methods.get_glyph_advance.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.set_glyph_offset.m_call = cast(type_of(FontFile_methods.set_glyph_offset.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.get_glyph_offset.m_call = cast(type_of(FontFile_methods.get_glyph_offset.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.set_glyph_size.m_call = cast(type_of(FontFile_methods.set_glyph_size.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.get_glyph_size.m_call = cast(type_of(FontFile_methods.get_glyph_size.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.set_glyph_uv_rect.m_call = cast(type_of(FontFile_methods.set_glyph_uv_rect.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.get_glyph_uv_rect.m_call = cast(type_of(FontFile_methods.get_glyph_uv_rect.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.set_glyph_texture_idx.m_call = cast(type_of(FontFile_methods.set_glyph_texture_idx.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.get_glyph_texture_idx.m_call = cast(type_of(FontFile_methods.get_glyph_texture_idx.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.get_kerning_list.m_call = cast(type_of(FontFile_methods.get_kerning_list.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.clear_kerning_map.m_call = cast(type_of(FontFile_methods.clear_kerning_map.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.remove_kerning.m_call = cast(type_of(FontFile_methods.remove_kerning.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.set_kerning.m_call = cast(type_of(FontFile_methods.set_kerning.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.get_kerning.m_call = cast(type_of(FontFile_methods.get_kerning.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.render_range.m_call = cast(type_of(FontFile_methods.render_range.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.render_glyph.m_call = cast(type_of(FontFile_methods.render_glyph.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.set_language_support_override.m_call = cast(type_of(FontFile_methods.set_language_support_override.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.get_language_support_override.m_call = cast(type_of(FontFile_methods.get_language_support_override.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.remove_language_support_override.m_call = cast(type_of(FontFile_methods.remove_language_support_override.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.get_language_support_overrides.m_call = cast(type_of(FontFile_methods.get_language_support_overrides.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.set_script_support_override.m_call = cast(type_of(FontFile_methods.set_script_support_override.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.get_script_support_override.m_call = cast(type_of(FontFile_methods.get_script_support_override.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.remove_script_support_override.m_call = cast(type_of(FontFile_methods.remove_script_support_override.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.get_script_support_overrides.m_call = cast(type_of(FontFile_methods.get_script_support_overrides.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.set_opentype_feature_overrides.m_call = cast(type_of(FontFile_methods.set_opentype_feature_overrides.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.get_opentype_feature_overrides.m_call = cast(type_of(FontFile_methods.get_opentype_feature_overrides.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.get_glyph_index.m_call = cast(type_of(FontFile_methods.get_glyph_index.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  FontFile_methods.get_char_from_glyph_index.m_call = cast(type_of(FontFile_methods.get_char_from_glyph_index.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
