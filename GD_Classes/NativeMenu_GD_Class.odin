...
NativeMenu_Init_ :: proc (NativeMenu_methods: ^NativeMenu_MethodBind_List, loc := #caller_location) {
  ...
  NativeMenu_methods.has_feature.m_call = cast(type_of(NativeMenu_methods.has_feature.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.has_system_menu.m_call = cast(type_of(NativeMenu_methods.has_system_menu.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.get_system_menu.m_call = cast(type_of(NativeMenu_methods.get_system_menu.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.get_system_menu_name.m_call = cast(type_of(NativeMenu_methods.get_system_menu_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.get_system_menu_text.m_call = cast(type_of(NativeMenu_methods.get_system_menu_text.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.set_system_menu_text.m_call = cast(type_of(NativeMenu_methods.set_system_menu_text.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.create_menu.m_call = cast(type_of(NativeMenu_methods.create_menu.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  NativeMenu_methods.has_menu._has_menu = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.NativeMenu, "has_menu", 4155700596, loc))
  NativeMenu_methods.has_menu.m_call = cast(type_of(NativeMenu_methods.has_menu.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.free_menu.m_call = cast(type_of(NativeMenu_methods.free_menu.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  NativeMenu_methods.get_size._get_size = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.NativeMenu, "get_size", 2440833711, loc))
  NativeMenu_methods.get_size.m_call = cast(type_of(NativeMenu_methods.get_size.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  NativeMenu_methods.popup._popup = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.NativeMenu, "popup", 2450610377, loc))
  NativeMenu_methods.popup.m_call = cast(type_of(NativeMenu_methods.popup.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.set_interface_direction.m_call = cast(type_of(NativeMenu_methods.set_interface_direction.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.set_popup_open_callback.m_call = cast(type_of(NativeMenu_methods.set_popup_open_callback.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.get_popup_open_callback.m_call = cast(type_of(NativeMenu_methods.get_popup_open_callback.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.set_popup_close_callback.m_call = cast(type_of(NativeMenu_methods.set_popup_close_callback.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.get_popup_close_callback.m_call = cast(type_of(NativeMenu_methods.get_popup_close_callback.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.set_minimum_width.m_call = cast(type_of(NativeMenu_methods.set_minimum_width.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.get_minimum_width.m_call = cast(type_of(NativeMenu_methods.get_minimum_width.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.is_opened.m_call = cast(type_of(NativeMenu_methods.is_opened.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.add_submenu_item.m_call = cast(type_of(NativeMenu_methods.add_submenu_item.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  NativeMenu_methods.add_item._add_item = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.NativeMenu, "add_item", 980552939, loc))
  NativeMenu_methods.add_item.m_call = cast(type_of(NativeMenu_methods.add_item.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.add_check_item.m_call = cast(type_of(NativeMenu_methods.add_check_item.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.add_icon_item.m_call = cast(type_of(NativeMenu_methods.add_icon_item.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.add_icon_check_item.m_call = cast(type_of(NativeMenu_methods.add_icon_check_item.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.add_radio_check_item.m_call = cast(type_of(NativeMenu_methods.add_radio_check_item.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.add_icon_radio_check_item.m_call = cast(type_of(NativeMenu_methods.add_icon_radio_check_item.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.add_multistate_item.m_call = cast(type_of(NativeMenu_methods.add_multistate_item.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.add_separator.m_call = cast(type_of(NativeMenu_methods.add_separator.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.find_item_index_with_text.m_call = cast(type_of(NativeMenu_methods.find_item_index_with_text.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.find_item_index_with_tag.m_call = cast(type_of(NativeMenu_methods.find_item_index_with_tag.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.find_item_index_with_submenu.m_call = cast(type_of(NativeMenu_methods.find_item_index_with_submenu.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.is_item_checked.m_call = cast(type_of(NativeMenu_methods.is_item_checked.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.is_item_checkable.m_call = cast(type_of(NativeMenu_methods.is_item_checkable.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.is_item_radio_checkable.m_call = cast(type_of(NativeMenu_methods.is_item_radio_checkable.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.get_item_callback.m_call = cast(type_of(NativeMenu_methods.get_item_callback.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.get_item_key_callback.m_call = cast(type_of(NativeMenu_methods.get_item_key_callback.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.get_item_tag.m_call = cast(type_of(NativeMenu_methods.get_item_tag.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.get_item_text.m_call = cast(type_of(NativeMenu_methods.get_item_text.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.get_item_submenu.m_call = cast(type_of(NativeMenu_methods.get_item_submenu.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.get_item_accelerator.m_call = cast(type_of(NativeMenu_methods.get_item_accelerator.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.is_item_disabled.m_call = cast(type_of(NativeMenu_methods.is_item_disabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.is_item_hidden.m_call = cast(type_of(NativeMenu_methods.is_item_hidden.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.get_item_tooltip.m_call = cast(type_of(NativeMenu_methods.get_item_tooltip.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.get_item_state.m_call = cast(type_of(NativeMenu_methods.get_item_state.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.get_item_max_states.m_call = cast(type_of(NativeMenu_methods.get_item_max_states.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.get_item_icon.m_call = cast(type_of(NativeMenu_methods.get_item_icon.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.get_item_indentation_level.m_call = cast(type_of(NativeMenu_methods.get_item_indentation_level.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.set_item_checked.m_call = cast(type_of(NativeMenu_methods.set_item_checked.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.set_item_checkable.m_call = cast(type_of(NativeMenu_methods.set_item_checkable.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.set_item_radio_checkable.m_call = cast(type_of(NativeMenu_methods.set_item_radio_checkable.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.set_item_callback.m_call = cast(type_of(NativeMenu_methods.set_item_callback.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.set_item_hover_callbacks.m_call = cast(type_of(NativeMenu_methods.set_item_hover_callbacks.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.set_item_key_callback.m_call = cast(type_of(NativeMenu_methods.set_item_key_callback.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.set_item_tag.m_call = cast(type_of(NativeMenu_methods.set_item_tag.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.set_item_text.m_call = cast(type_of(NativeMenu_methods.set_item_text.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.set_item_submenu.m_call = cast(type_of(NativeMenu_methods.set_item_submenu.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.set_item_accelerator.m_call = cast(type_of(NativeMenu_methods.set_item_accelerator.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.set_item_disabled.m_call = cast(type_of(NativeMenu_methods.set_item_disabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.set_item_hidden.m_call = cast(type_of(NativeMenu_methods.set_item_hidden.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.set_item_tooltip.m_call = cast(type_of(NativeMenu_methods.set_item_tooltip.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.set_item_state.m_call = cast(type_of(NativeMenu_methods.set_item_state.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.set_item_max_states.m_call = cast(type_of(NativeMenu_methods.set_item_max_states.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.set_item_icon.m_call = cast(type_of(NativeMenu_methods.set_item_icon.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.set_item_indentation_level.m_call = cast(type_of(NativeMenu_methods.set_item_indentation_level.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.get_item_count.m_call = cast(type_of(NativeMenu_methods.get_item_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.is_system_menu.m_call = cast(type_of(NativeMenu_methods.is_system_menu.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NativeMenu_methods.remove_item.m_call = cast(type_of(NativeMenu_methods.remove_item.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  NativeMenu_methods.clear._clear = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.NativeMenu, "clear", 2722037293, loc))
  NativeMenu_methods.clear.m_call = cast(type_of(NativeMenu_methods.clear.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
