...
Skeleton3D_Init_ :: proc (Skeleton3D_methods: ^Skeleton3D_MethodBind_List, loc := #caller_location) {
  ...
  Skeleton3D_methods.add_bone.m_call = cast(type_of(Skeleton3D_methods.add_bone.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.find_bone.m_call = cast(type_of(Skeleton3D_methods.find_bone.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.get_bone_name.m_call = cast(type_of(Skeleton3D_methods.get_bone_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.set_bone_name.m_call = cast(type_of(Skeleton3D_methods.set_bone_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.get_bone_meta.m_call = cast(type_of(Skeleton3D_methods.get_bone_meta.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.get_bone_meta_list.m_call = cast(type_of(Skeleton3D_methods.get_bone_meta_list.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.has_bone_meta.m_call = cast(type_of(Skeleton3D_methods.has_bone_meta.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.set_bone_meta.m_call = cast(type_of(Skeleton3D_methods.set_bone_meta.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.get_concatenated_bone_names.m_call = cast(type_of(Skeleton3D_methods.get_concatenated_bone_names.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.get_bone_parent.m_call = cast(type_of(Skeleton3D_methods.get_bone_parent.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.set_bone_parent.m_call = cast(type_of(Skeleton3D_methods.set_bone_parent.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.get_bone_count.m_call = cast(type_of(Skeleton3D_methods.get_bone_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.get_version.m_call = cast(type_of(Skeleton3D_methods.get_version.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.unparent_bone_and_rest.m_call = cast(type_of(Skeleton3D_methods.unparent_bone_and_rest.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.get_bone_children.m_call = cast(type_of(Skeleton3D_methods.get_bone_children.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.get_parentless_bones.m_call = cast(type_of(Skeleton3D_methods.get_parentless_bones.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.get_bone_rest.m_call = cast(type_of(Skeleton3D_methods.get_bone_rest.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.set_bone_rest.m_call = cast(type_of(Skeleton3D_methods.set_bone_rest.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.get_bone_global_rest.m_call = cast(type_of(Skeleton3D_methods.get_bone_global_rest.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.create_skin_from_rest_transforms.m_call = cast(type_of(Skeleton3D_methods.create_skin_from_rest_transforms.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.register_skin.m_call = cast(type_of(Skeleton3D_methods.register_skin.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.localize_rests.m_call = cast(type_of(Skeleton3D_methods.localize_rests.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.clear_bones.m_call = cast(type_of(Skeleton3D_methods.clear_bones.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.get_bone_pose.m_call = cast(type_of(Skeleton3D_methods.get_bone_pose.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.set_bone_pose.m_call = cast(type_of(Skeleton3D_methods.set_bone_pose.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.set_bone_pose_position.m_call = cast(type_of(Skeleton3D_methods.set_bone_pose_position.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.set_bone_pose_rotation.m_call = cast(type_of(Skeleton3D_methods.set_bone_pose_rotation.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.set_bone_pose_scale.m_call = cast(type_of(Skeleton3D_methods.set_bone_pose_scale.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.get_bone_pose_position.m_call = cast(type_of(Skeleton3D_methods.get_bone_pose_position.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.get_bone_pose_rotation.m_call = cast(type_of(Skeleton3D_methods.get_bone_pose_rotation.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.get_bone_pose_scale.m_call = cast(type_of(Skeleton3D_methods.get_bone_pose_scale.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.reset_bone_pose.m_call = cast(type_of(Skeleton3D_methods.reset_bone_pose.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.reset_bone_poses.m_call = cast(type_of(Skeleton3D_methods.reset_bone_poses.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.is_bone_enabled.m_call = cast(type_of(Skeleton3D_methods.is_bone_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.set_bone_enabled.m_call = cast(type_of(Skeleton3D_methods.set_bone_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.get_bone_global_pose.m_call = cast(type_of(Skeleton3D_methods.get_bone_global_pose.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.set_bone_global_pose.m_call = cast(type_of(Skeleton3D_methods.set_bone_global_pose.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.force_update_all_bone_transforms.m_call = cast(type_of(Skeleton3D_methods.force_update_all_bone_transforms.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.force_update_bone_child_transform.m_call = cast(type_of(Skeleton3D_methods.force_update_bone_child_transform.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.set_motion_scale.m_call = cast(type_of(Skeleton3D_methods.set_motion_scale.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.get_motion_scale.m_call = cast(type_of(Skeleton3D_methods.get_motion_scale.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.set_show_rest_only.m_call = cast(type_of(Skeleton3D_methods.set_show_rest_only.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.is_show_rest_only.m_call = cast(type_of(Skeleton3D_methods.is_show_rest_only.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.set_modifier_callback_mode_process.m_call = cast(type_of(Skeleton3D_methods.set_modifier_callback_mode_process.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.get_modifier_callback_mode_process.m_call = cast(type_of(Skeleton3D_methods.get_modifier_callback_mode_process.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Skeleton3D_methods.advance._advance = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Skeleton3D, "advance", 373806689, loc))
  Skeleton3D_methods.advance.m_call = cast(type_of(Skeleton3D_methods.advance.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.clear_bones_global_pose_override.m_call = cast(type_of(Skeleton3D_methods.clear_bones_global_pose_override.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.set_bone_global_pose_override.m_call = cast(type_of(Skeleton3D_methods.set_bone_global_pose_override.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.get_bone_global_pose_override.m_call = cast(type_of(Skeleton3D_methods.get_bone_global_pose_override.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.get_bone_global_pose_no_override.m_call = cast(type_of(Skeleton3D_methods.get_bone_global_pose_no_override.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.set_animate_physical_bones.m_call = cast(type_of(Skeleton3D_methods.set_animate_physical_bones.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.get_animate_physical_bones.m_call = cast(type_of(Skeleton3D_methods.get_animate_physical_bones.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.physical_bones_stop_simulation.m_call = cast(type_of(Skeleton3D_methods.physical_bones_stop_simulation.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.physical_bones_start_simulation.m_call = cast(type_of(Skeleton3D_methods.physical_bones_start_simulation.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.physical_bones_add_collision_exception.m_call = cast(type_of(Skeleton3D_methods.physical_bones_add_collision_exception.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Skeleton3D_methods.physical_bones_remove_collision_exception.m_call = cast(type_of(Skeleton3D_methods.physical_bones_remove_collision_exception.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
