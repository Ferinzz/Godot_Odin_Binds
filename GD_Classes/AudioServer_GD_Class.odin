...
AudioServer_Init_ :: proc (AudioServer_methods: ^AudioServer_MethodBind_List, loc := #caller_location) {
  ...
  AudioServer_methods.set_bus_count.m_call = cast(type_of(AudioServer_methods.set_bus_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioServer_methods.get_bus_count.m_call = cast(type_of(AudioServer_methods.get_bus_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioServer_methods.remove_bus.m_call = cast(type_of(AudioServer_methods.remove_bus.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  AudioServer_methods.add_bus._add_bus = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AudioServer, "add_bus", 1025054187, loc))
  AudioServer_methods.add_bus.m_call = cast(type_of(AudioServer_methods.add_bus.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  AudioServer_methods.move_bus._move_bus = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AudioServer, "move_bus", 3937882851, loc))
  AudioServer_methods.move_bus.m_call = cast(type_of(AudioServer_methods.move_bus.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioServer_methods.set_bus_name.m_call = cast(type_of(AudioServer_methods.set_bus_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioServer_methods.get_bus_name.m_call = cast(type_of(AudioServer_methods.get_bus_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioServer_methods.get_bus_index.m_call = cast(type_of(AudioServer_methods.get_bus_index.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioServer_methods.get_bus_channels.m_call = cast(type_of(AudioServer_methods.get_bus_channels.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioServer_methods.set_bus_volume_db.m_call = cast(type_of(AudioServer_methods.set_bus_volume_db.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioServer_methods.get_bus_volume_db.m_call = cast(type_of(AudioServer_methods.get_bus_volume_db.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioServer_methods.set_bus_volume_linear.m_call = cast(type_of(AudioServer_methods.set_bus_volume_linear.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioServer_methods.get_bus_volume_linear.m_call = cast(type_of(AudioServer_methods.get_bus_volume_linear.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioServer_methods.set_bus_send.m_call = cast(type_of(AudioServer_methods.set_bus_send.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioServer_methods.get_bus_send.m_call = cast(type_of(AudioServer_methods.get_bus_send.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioServer_methods.set_bus_solo.m_call = cast(type_of(AudioServer_methods.set_bus_solo.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioServer_methods.is_bus_solo.m_call = cast(type_of(AudioServer_methods.is_bus_solo.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioServer_methods.set_bus_mute.m_call = cast(type_of(AudioServer_methods.set_bus_mute.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioServer_methods.is_bus_mute.m_call = cast(type_of(AudioServer_methods.is_bus_mute.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioServer_methods.set_bus_bypass_effects.m_call = cast(type_of(AudioServer_methods.set_bus_bypass_effects.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioServer_methods.is_bus_bypassing_effects.m_call = cast(type_of(AudioServer_methods.is_bus_bypassing_effects.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioServer_methods.add_bus_effect.m_call = cast(type_of(AudioServer_methods.add_bus_effect.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioServer_methods.remove_bus_effect.m_call = cast(type_of(AudioServer_methods.remove_bus_effect.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioServer_methods.get_bus_effect_count.m_call = cast(type_of(AudioServer_methods.get_bus_effect_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioServer_methods.get_bus_effect.m_call = cast(type_of(AudioServer_methods.get_bus_effect.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioServer_methods.get_bus_effect_instance.m_call = cast(type_of(AudioServer_methods.get_bus_effect_instance.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioServer_methods.swap_bus_effects.m_call = cast(type_of(AudioServer_methods.swap_bus_effects.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioServer_methods.set_bus_effect_enabled.m_call = cast(type_of(AudioServer_methods.set_bus_effect_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioServer_methods.is_bus_effect_enabled.m_call = cast(type_of(AudioServer_methods.is_bus_effect_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioServer_methods.get_bus_peak_volume_left_db.m_call = cast(type_of(AudioServer_methods.get_bus_peak_volume_left_db.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioServer_methods.get_bus_peak_volume_right_db.m_call = cast(type_of(AudioServer_methods.get_bus_peak_volume_right_db.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioServer_methods.set_playback_speed_scale.m_call = cast(type_of(AudioServer_methods.set_playback_speed_scale.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioServer_methods.get_playback_speed_scale.m_call = cast(type_of(AudioServer_methods.get_playback_speed_scale.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  AudioServer_methods.lock._lock = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AudioServer, "lock", 3218959716, loc))
  AudioServer_methods.lock.m_call = cast(type_of(AudioServer_methods.lock.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  AudioServer_methods.unlock._unlock = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AudioServer, "unlock", 3218959716, loc))
  AudioServer_methods.unlock.m_call = cast(type_of(AudioServer_methods.unlock.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioServer_methods.get_speaker_mode.m_call = cast(type_of(AudioServer_methods.get_speaker_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioServer_methods.get_mix_rate.m_call = cast(type_of(AudioServer_methods.get_mix_rate.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioServer_methods.get_input_mix_rate.m_call = cast(type_of(AudioServer_methods.get_input_mix_rate.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioServer_methods.get_driver_name.m_call = cast(type_of(AudioServer_methods.get_driver_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioServer_methods.get_output_device_list.m_call = cast(type_of(AudioServer_methods.get_output_device_list.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioServer_methods.get_output_device.m_call = cast(type_of(AudioServer_methods.get_output_device.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioServer_methods.set_output_device.m_call = cast(type_of(AudioServer_methods.set_output_device.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioServer_methods.get_time_to_next_mix.m_call = cast(type_of(AudioServer_methods.get_time_to_next_mix.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioServer_methods.get_time_since_last_mix.m_call = cast(type_of(AudioServer_methods.get_time_since_last_mix.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioServer_methods.get_output_latency.m_call = cast(type_of(AudioServer_methods.get_output_latency.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioServer_methods.get_input_device_list.m_call = cast(type_of(AudioServer_methods.get_input_device_list.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioServer_methods.get_input_device.m_call = cast(type_of(AudioServer_methods.get_input_device.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioServer_methods.set_input_device.m_call = cast(type_of(AudioServer_methods.set_input_device.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioServer_methods.set_input_device_active.m_call = cast(type_of(AudioServer_methods.set_input_device_active.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioServer_methods.get_input_frames_available.m_call = cast(type_of(AudioServer_methods.get_input_frames_available.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioServer_methods.get_input_buffer_length_frames.m_call = cast(type_of(AudioServer_methods.get_input_buffer_length_frames.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioServer_methods.get_input_frames.m_call = cast(type_of(AudioServer_methods.get_input_frames.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioServer_methods.set_bus_layout.m_call = cast(type_of(AudioServer_methods.set_bus_layout.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioServer_methods.generate_bus_layout.m_call = cast(type_of(AudioServer_methods.generate_bus_layout.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioServer_methods.set_enable_tagging_used_audio_streams.m_call = cast(type_of(AudioServer_methods.set_enable_tagging_used_audio_streams.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioServer_methods.is_stream_registered_as_sample.m_call = cast(type_of(AudioServer_methods.is_stream_registered_as_sample.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioServer_methods.register_stream_as_sample.m_call = cast(type_of(AudioServer_methods.register_stream_as_sample.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
