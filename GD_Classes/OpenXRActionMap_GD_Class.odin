...
OpenXRActionMap_Init_ :: proc (OpenXRActionMap_methods: ^OpenXRActionMap_MethodBind_List, loc := #caller_location) {
  ...
  OpenXRActionMap_methods.set_action_sets.m_call = cast(type_of(OpenXRActionMap_methods.set_action_sets.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRActionMap_methods.get_action_sets.m_call = cast(type_of(OpenXRActionMap_methods.get_action_sets.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRActionMap_methods.get_action_set_count.m_call = cast(type_of(OpenXRActionMap_methods.get_action_set_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRActionMap_methods.find_action_set.m_call = cast(type_of(OpenXRActionMap_methods.find_action_set.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRActionMap_methods.get_action_set.m_call = cast(type_of(OpenXRActionMap_methods.get_action_set.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRActionMap_methods.add_action_set.m_call = cast(type_of(OpenXRActionMap_methods.add_action_set.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRActionMap_methods.remove_action_set.m_call = cast(type_of(OpenXRActionMap_methods.remove_action_set.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRActionMap_methods.set_interaction_profiles.m_call = cast(type_of(OpenXRActionMap_methods.set_interaction_profiles.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRActionMap_methods.get_interaction_profiles.m_call = cast(type_of(OpenXRActionMap_methods.get_interaction_profiles.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRActionMap_methods.get_interaction_profile_count.m_call = cast(type_of(OpenXRActionMap_methods.get_interaction_profile_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRActionMap_methods.find_interaction_profile.m_call = cast(type_of(OpenXRActionMap_methods.find_interaction_profile.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRActionMap_methods.get_interaction_profile.m_call = cast(type_of(OpenXRActionMap_methods.get_interaction_profile.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRActionMap_methods.add_interaction_profile.m_call = cast(type_of(OpenXRActionMap_methods.add_interaction_profile.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRActionMap_methods.remove_interaction_profile.m_call = cast(type_of(OpenXRActionMap_methods.remove_interaction_profile.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRActionMap_methods.create_default_action_sets.m_call = cast(type_of(OpenXRActionMap_methods.create_default_action_sets.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
