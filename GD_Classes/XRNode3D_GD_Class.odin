...
XRNode3D_Init_ :: proc (XRNode3D_methods: ^XRNode3D_MethodBind_List, loc := #caller_location) {
  ...
  XRNode3D_methods.set_tracker.m_call = cast(type_of(XRNode3D_methods.set_tracker.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  XRNode3D_methods.get_tracker.m_call = cast(type_of(XRNode3D_methods.get_tracker.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  XRNode3D_methods.set_pose_name.m_call = cast(type_of(XRNode3D_methods.set_pose_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  XRNode3D_methods.get_pose_name.m_call = cast(type_of(XRNode3D_methods.get_pose_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  XRNode3D_methods.set_show_when_tracked.m_call = cast(type_of(XRNode3D_methods.set_show_when_tracked.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  XRNode3D_methods.get_show_when_tracked.m_call = cast(type_of(XRNode3D_methods.get_show_when_tracked.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  XRNode3D_methods.get_is_active.m_call = cast(type_of(XRNode3D_methods.get_is_active.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  XRNode3D_methods.get_has_tracking_data.m_call = cast(type_of(XRNode3D_methods.get_has_tracking_data.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  XRNode3D_methods.get_pose._get_pose = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.XRNode3D, "get_pose", 2806551826, loc))
  XRNode3D_methods.get_pose.m_call = cast(type_of(XRNode3D_methods.get_pose.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  XRNode3D_methods.trigger_haptic_pulse.m_call = cast(type_of(XRNode3D_methods.trigger_haptic_pulse.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
