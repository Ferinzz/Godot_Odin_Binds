...
PopupMenu_Init_ :: proc (PopupMenu_methods: ^PopupMenu_MethodBind_List, loc := #caller_location) {
  ...
  PopupMenu_methods.activate_item_by_event.m_call = cast(type_of(PopupMenu_methods.activate_item_by_event.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.set_prefer_native_menu.m_call = cast(type_of(PopupMenu_methods.set_prefer_native_menu.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.is_prefer_native_menu.m_call = cast(type_of(PopupMenu_methods.is_prefer_native_menu.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.is_native_menu.m_call = cast(type_of(PopupMenu_methods.is_native_menu.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  PopupMenu_methods.add_item._add_item = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.PopupMenu, "add_item", 3674230041, loc))
  PopupMenu_methods.add_item.m_call = cast(type_of(PopupMenu_methods.add_item.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.add_icon_item.m_call = cast(type_of(PopupMenu_methods.add_icon_item.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.add_check_item.m_call = cast(type_of(PopupMenu_methods.add_check_item.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.add_icon_check_item.m_call = cast(type_of(PopupMenu_methods.add_icon_check_item.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.add_radio_check_item.m_call = cast(type_of(PopupMenu_methods.add_radio_check_item.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.add_icon_radio_check_item.m_call = cast(type_of(PopupMenu_methods.add_icon_radio_check_item.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.add_multistate_item.m_call = cast(type_of(PopupMenu_methods.add_multistate_item.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.add_shortcut.m_call = cast(type_of(PopupMenu_methods.add_shortcut.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.add_icon_shortcut.m_call = cast(type_of(PopupMenu_methods.add_icon_shortcut.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.add_check_shortcut.m_call = cast(type_of(PopupMenu_methods.add_check_shortcut.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.add_icon_check_shortcut.m_call = cast(type_of(PopupMenu_methods.add_icon_check_shortcut.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.add_radio_check_shortcut.m_call = cast(type_of(PopupMenu_methods.add_radio_check_shortcut.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.add_icon_radio_check_shortcut.m_call = cast(type_of(PopupMenu_methods.add_icon_radio_check_shortcut.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.add_submenu_item.m_call = cast(type_of(PopupMenu_methods.add_submenu_item.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.add_submenu_node_item.m_call = cast(type_of(PopupMenu_methods.add_submenu_node_item.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.set_item_text.m_call = cast(type_of(PopupMenu_methods.set_item_text.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.set_item_text_direction.m_call = cast(type_of(PopupMenu_methods.set_item_text_direction.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.set_item_language.m_call = cast(type_of(PopupMenu_methods.set_item_language.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.set_item_auto_translate_mode.m_call = cast(type_of(PopupMenu_methods.set_item_auto_translate_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.set_item_icon.m_call = cast(type_of(PopupMenu_methods.set_item_icon.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.set_item_icon_max_width.m_call = cast(type_of(PopupMenu_methods.set_item_icon_max_width.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.set_item_icon_modulate.m_call = cast(type_of(PopupMenu_methods.set_item_icon_modulate.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.set_item_checked.m_call = cast(type_of(PopupMenu_methods.set_item_checked.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.set_item_id.m_call = cast(type_of(PopupMenu_methods.set_item_id.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.set_item_accelerator.m_call = cast(type_of(PopupMenu_methods.set_item_accelerator.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.set_item_metadata.m_call = cast(type_of(PopupMenu_methods.set_item_metadata.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.set_item_disabled.m_call = cast(type_of(PopupMenu_methods.set_item_disabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.set_item_submenu.m_call = cast(type_of(PopupMenu_methods.set_item_submenu.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.set_item_submenu_node.m_call = cast(type_of(PopupMenu_methods.set_item_submenu_node.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.set_item_as_separator.m_call = cast(type_of(PopupMenu_methods.set_item_as_separator.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.set_item_as_checkable.m_call = cast(type_of(PopupMenu_methods.set_item_as_checkable.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.set_item_as_radio_checkable.m_call = cast(type_of(PopupMenu_methods.set_item_as_radio_checkable.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.set_item_tooltip.m_call = cast(type_of(PopupMenu_methods.set_item_tooltip.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.set_item_shortcut.m_call = cast(type_of(PopupMenu_methods.set_item_shortcut.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.set_item_indent.m_call = cast(type_of(PopupMenu_methods.set_item_indent.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.set_item_multistate.m_call = cast(type_of(PopupMenu_methods.set_item_multistate.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.set_item_multistate_max.m_call = cast(type_of(PopupMenu_methods.set_item_multistate_max.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.set_item_shortcut_disabled.m_call = cast(type_of(PopupMenu_methods.set_item_shortcut_disabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.toggle_item_checked.m_call = cast(type_of(PopupMenu_methods.toggle_item_checked.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.toggle_item_multistate.m_call = cast(type_of(PopupMenu_methods.toggle_item_multistate.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.get_item_text.m_call = cast(type_of(PopupMenu_methods.get_item_text.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.get_item_text_direction.m_call = cast(type_of(PopupMenu_methods.get_item_text_direction.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.get_item_language.m_call = cast(type_of(PopupMenu_methods.get_item_language.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.get_item_auto_translate_mode.m_call = cast(type_of(PopupMenu_methods.get_item_auto_translate_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.get_item_icon.m_call = cast(type_of(PopupMenu_methods.get_item_icon.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.get_item_icon_max_width.m_call = cast(type_of(PopupMenu_methods.get_item_icon_max_width.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.get_item_icon_modulate.m_call = cast(type_of(PopupMenu_methods.get_item_icon_modulate.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.is_item_checked.m_call = cast(type_of(PopupMenu_methods.is_item_checked.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.get_item_id.m_call = cast(type_of(PopupMenu_methods.get_item_id.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.get_item_index.m_call = cast(type_of(PopupMenu_methods.get_item_index.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.get_item_accelerator.m_call = cast(type_of(PopupMenu_methods.get_item_accelerator.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.get_item_metadata.m_call = cast(type_of(PopupMenu_methods.get_item_metadata.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.is_item_disabled.m_call = cast(type_of(PopupMenu_methods.is_item_disabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.get_item_submenu.m_call = cast(type_of(PopupMenu_methods.get_item_submenu.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.get_item_submenu_node.m_call = cast(type_of(PopupMenu_methods.get_item_submenu_node.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.is_item_separator.m_call = cast(type_of(PopupMenu_methods.is_item_separator.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.is_item_checkable.m_call = cast(type_of(PopupMenu_methods.is_item_checkable.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.is_item_radio_checkable.m_call = cast(type_of(PopupMenu_methods.is_item_radio_checkable.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.is_item_shortcut_disabled.m_call = cast(type_of(PopupMenu_methods.is_item_shortcut_disabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.get_item_tooltip.m_call = cast(type_of(PopupMenu_methods.get_item_tooltip.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.get_item_shortcut.m_call = cast(type_of(PopupMenu_methods.get_item_shortcut.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.get_item_indent.m_call = cast(type_of(PopupMenu_methods.get_item_indent.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.get_item_multistate_max.m_call = cast(type_of(PopupMenu_methods.get_item_multistate_max.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.get_item_multistate.m_call = cast(type_of(PopupMenu_methods.get_item_multistate.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.set_focused_item.m_call = cast(type_of(PopupMenu_methods.set_focused_item.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.get_focused_item.m_call = cast(type_of(PopupMenu_methods.get_focused_item.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.set_item_count.m_call = cast(type_of(PopupMenu_methods.set_item_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.get_item_count.m_call = cast(type_of(PopupMenu_methods.get_item_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.scroll_to_item.m_call = cast(type_of(PopupMenu_methods.scroll_to_item.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.remove_item.m_call = cast(type_of(PopupMenu_methods.remove_item.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.add_separator.m_call = cast(type_of(PopupMenu_methods.add_separator.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  PopupMenu_methods.clear._clear = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.PopupMenu, "clear", 107499316, loc))
  PopupMenu_methods.clear.m_call = cast(type_of(PopupMenu_methods.clear.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.set_hide_on_item_selection.m_call = cast(type_of(PopupMenu_methods.set_hide_on_item_selection.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.is_hide_on_item_selection.m_call = cast(type_of(PopupMenu_methods.is_hide_on_item_selection.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.set_hide_on_checkable_item_selection.m_call = cast(type_of(PopupMenu_methods.set_hide_on_checkable_item_selection.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.is_hide_on_checkable_item_selection.m_call = cast(type_of(PopupMenu_methods.is_hide_on_checkable_item_selection.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.set_hide_on_state_item_selection.m_call = cast(type_of(PopupMenu_methods.set_hide_on_state_item_selection.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.is_hide_on_state_item_selection.m_call = cast(type_of(PopupMenu_methods.is_hide_on_state_item_selection.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.set_submenu_popup_delay.m_call = cast(type_of(PopupMenu_methods.set_submenu_popup_delay.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.get_submenu_popup_delay.m_call = cast(type_of(PopupMenu_methods.get_submenu_popup_delay.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.set_allow_search.m_call = cast(type_of(PopupMenu_methods.set_allow_search.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.get_allow_search.m_call = cast(type_of(PopupMenu_methods.get_allow_search.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.is_system_menu.m_call = cast(type_of(PopupMenu_methods.is_system_menu.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.set_system_menu.m_call = cast(type_of(PopupMenu_methods.set_system_menu.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.get_system_menu.m_call = cast(type_of(PopupMenu_methods.get_system_menu.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.set_shrink_height.m_call = cast(type_of(PopupMenu_methods.set_shrink_height.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.get_shrink_height.m_call = cast(type_of(PopupMenu_methods.get_shrink_height.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.set_shrink_width.m_call = cast(type_of(PopupMenu_methods.set_shrink_width.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PopupMenu_methods.get_shrink_width.m_call = cast(type_of(PopupMenu_methods.get_shrink_width.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
