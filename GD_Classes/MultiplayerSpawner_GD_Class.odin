...
MultiplayerSpawner_Init_ :: proc (MultiplayerSpawner_methods: ^MultiplayerSpawner_MethodBind_List, loc := #caller_location) {
  ...
  MultiplayerSpawner_methods.add_spawnable_scene.m_call = cast(type_of(MultiplayerSpawner_methods.add_spawnable_scene.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MultiplayerSpawner_methods.get_spawnable_scene_count.m_call = cast(type_of(MultiplayerSpawner_methods.get_spawnable_scene_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MultiplayerSpawner_methods.get_spawnable_scene.m_call = cast(type_of(MultiplayerSpawner_methods.get_spawnable_scene.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MultiplayerSpawner_methods.clear_spawnable_scenes.m_call = cast(type_of(MultiplayerSpawner_methods.clear_spawnable_scenes.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MultiplayerSpawner_methods.spawn.m_call = cast(type_of(MultiplayerSpawner_methods.spawn.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MultiplayerSpawner_methods.get_spawn_path.m_call = cast(type_of(MultiplayerSpawner_methods.get_spawn_path.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MultiplayerSpawner_methods.set_spawn_path.m_call = cast(type_of(MultiplayerSpawner_methods.set_spawn_path.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MultiplayerSpawner_methods.get_spawn_limit.m_call = cast(type_of(MultiplayerSpawner_methods.get_spawn_limit.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MultiplayerSpawner_methods.set_spawn_limit.m_call = cast(type_of(MultiplayerSpawner_methods.set_spawn_limit.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MultiplayerSpawner_methods.get_spawn_function.m_call = cast(type_of(MultiplayerSpawner_methods.get_spawn_function.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MultiplayerSpawner_methods.set_spawn_function.m_call = cast(type_of(MultiplayerSpawner_methods.set_spawn_function.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
