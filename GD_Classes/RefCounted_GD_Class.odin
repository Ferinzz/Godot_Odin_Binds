...
RefCounted_MethodBind_List :: struct {
  init_ref: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: RefCounted, args: rawptr = nil, r_ret: ^GDW.Bool)
  },
  reference: struct{
  ...
  get_reference_count: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: RefCounted, args: rawptr = nil, r_ret: ^GDW.Int)
  },
};
RefCounted_Init_ :: proc (RefCounted_methods: ^RefCounted_MethodBind_List, loc := #caller_location) {
  MB_ptr_call:=gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  RefCounted_methods.init_ref._init_ref = (cast(^GDW.MethodBind)classDBGetMethodBind3(.RefCounted, "init_ref", 2240911060, loc))
  RefCounted_methods.init_ref.m_call = cast(type_of(RefCounted_methods.init_ref.m_call))MB_ptr_call
  RefCounted_methods.reference._reference = (cast(^GDW.MethodBind)classDBGetMethodBind3(.RefCounted, "reference", 2240911060, loc))
  RefCounted_methods.reference.m_call = cast(type_of(RefCounted_methods.reference.m_call))MB_ptr_call
  RefCounted_methods.unreference._unreference = (cast(^GDW.MethodBind)classDBGetMethodBind3(.RefCounted, "unreference", 2240911060, loc))
  RefCounted_methods.unreference.m_call = cast(type_of(RefCounted_methods.unreference.m_call))MB_ptr_call
  RefCounted_methods.get_reference_count._get_reference_count = (cast(^GDW.MethodBind)classDBGetMethodBind3(.RefCounted, "get_reference_count", 3905245786, loc))
