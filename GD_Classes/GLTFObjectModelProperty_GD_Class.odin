...
GLTFObjectModelProperty_Init_ :: proc (GLTFObjectModelProperty_methods: ^GLTFObjectModelProperty_MethodBind_List, loc := #caller_location) {
  ...
  GLTFObjectModelProperty_methods.append_node_path.m_call = cast(type_of(GLTFObjectModelProperty_methods.append_node_path.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFObjectModelProperty_methods.append_path_to_property.m_call = cast(type_of(GLTFObjectModelProperty_methods.append_path_to_property.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFObjectModelProperty_methods.get_accessor_type.m_call = cast(type_of(GLTFObjectModelProperty_methods.get_accessor_type.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFObjectModelProperty_methods.get_gltf_to_godot_expression.m_call = cast(type_of(GLTFObjectModelProperty_methods.get_gltf_to_godot_expression.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFObjectModelProperty_methods.set_gltf_to_godot_expression.m_call = cast(type_of(GLTFObjectModelProperty_methods.set_gltf_to_godot_expression.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFObjectModelProperty_methods.get_godot_to_gltf_expression.m_call = cast(type_of(GLTFObjectModelProperty_methods.get_godot_to_gltf_expression.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFObjectModelProperty_methods.set_godot_to_gltf_expression.m_call = cast(type_of(GLTFObjectModelProperty_methods.set_godot_to_gltf_expression.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFObjectModelProperty_methods.get_node_paths.m_call = cast(type_of(GLTFObjectModelProperty_methods.get_node_paths.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFObjectModelProperty_methods.has_node_paths.m_call = cast(type_of(GLTFObjectModelProperty_methods.has_node_paths.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFObjectModelProperty_methods.set_node_paths.m_call = cast(type_of(GLTFObjectModelProperty_methods.set_node_paths.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFObjectModelProperty_methods.get_object_model_type.m_call = cast(type_of(GLTFObjectModelProperty_methods.get_object_model_type.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFObjectModelProperty_methods.set_object_model_type.m_call = cast(type_of(GLTFObjectModelProperty_methods.set_object_model_type.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFObjectModelProperty_methods.get_json_pointers.m_call = cast(type_of(GLTFObjectModelProperty_methods.get_json_pointers.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFObjectModelProperty_methods.has_json_pointers.m_call = cast(type_of(GLTFObjectModelProperty_methods.has_json_pointers.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFObjectModelProperty_methods.set_json_pointers.m_call = cast(type_of(GLTFObjectModelProperty_methods.set_json_pointers.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFObjectModelProperty_methods.get_variant_type.m_call = cast(type_of(GLTFObjectModelProperty_methods.get_variant_type.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFObjectModelProperty_methods.set_variant_type.m_call = cast(type_of(GLTFObjectModelProperty_methods.set_variant_type.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFObjectModelProperty_methods.set_types.m_call = cast(type_of(GLTFObjectModelProperty_methods.set_types.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
