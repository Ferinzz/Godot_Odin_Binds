...
OpenXRAnalogThresholdModifier_Init_ :: proc (OpenXRAnalogThresholdModifier_methods: ^OpenXRAnalogThresholdModifier_MethodBind_List, loc := #caller_location) {
  ...
  OpenXRAnalogThresholdModifier_methods.set_on_threshold.m_call = cast(type_of(OpenXRAnalogThresholdModifier_methods.set_on_threshold.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRAnalogThresholdModifier_methods.get_on_threshold.m_call = cast(type_of(OpenXRAnalogThresholdModifier_methods.get_on_threshold.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRAnalogThresholdModifier_methods.set_off_threshold.m_call = cast(type_of(OpenXRAnalogThresholdModifier_methods.set_off_threshold.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRAnalogThresholdModifier_methods.get_off_threshold.m_call = cast(type_of(OpenXRAnalogThresholdModifier_methods.get_off_threshold.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRAnalogThresholdModifier_methods.set_on_haptic.m_call = cast(type_of(OpenXRAnalogThresholdModifier_methods.set_on_haptic.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRAnalogThresholdModifier_methods.get_on_haptic.m_call = cast(type_of(OpenXRAnalogThresholdModifier_methods.get_on_haptic.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRAnalogThresholdModifier_methods.set_off_haptic.m_call = cast(type_of(OpenXRAnalogThresholdModifier_methods.set_off_haptic.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRAnalogThresholdModifier_methods.get_off_haptic.m_call = cast(type_of(OpenXRAnalogThresholdModifier_methods.get_off_haptic.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
