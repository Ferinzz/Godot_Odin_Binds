...
CSGPrimitive3D_MethodBind_List :: struct {
  set_flip_faces: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: CSGPrimitive3D, #by_ptr args: struct{flip_faces: ^GDW.Bool, }, r_ret: rawptr = nil)
  },
    get_flip_faces: struct{
    using _get_flip_faces: ^GDW.MethodBind,
    m_call: proc "c" (_:^GDW.MethodBind, obj: CSGPrimitive3D, args: rawptr = nil, r_ret: ^GDW.Bool)
  },
};
CSGPrimitive3D_Init_ :: proc (CSGPrimitive3D_methods: ^CSGPrimitive3D_MethodBind_List, loc := #caller_location) {
  MB_ptr_call:=gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  CSGPrimitive3D_methods.set_flip_faces._set_flip_faces = (cast(^GDW.MethodBind)classDBGetMethodBind3(.CSGPrimitive3D, "set_flip_faces", 2586408642, loc))
  CSGPrimitive3D_methods.set_flip_faces.m_call = cast(type_of(CSGPrimitive3D_methods.set_flip_faces.m_call))MB_ptr_call
  CSGPrimitive3D_methods.get_flip_faces._get_flip_faces = (cast(^GDW.MethodBind)classDBGetMethodBind3(.CSGPrimitive3D, "get_flip_faces", 2240911060, loc))
