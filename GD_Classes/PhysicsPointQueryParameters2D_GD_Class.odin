...
PhysicsPointQueryParameters2D_Init_ :: proc (PhysicsPointQueryParameters2D_methods: ^PhysicsPointQueryParameters2D_MethodBind_List, loc := #caller_location) {
  ...
  PhysicsPointQueryParameters2D_methods.set_position.m_call = cast(type_of(PhysicsPointQueryParameters2D_methods.set_position.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsPointQueryParameters2D_methods.get_position.m_call = cast(type_of(PhysicsPointQueryParameters2D_methods.get_position.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsPointQueryParameters2D_methods.set_canvas_instance_id.m_call = cast(type_of(PhysicsPointQueryParameters2D_methods.set_canvas_instance_id.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsPointQueryParameters2D_methods.get_canvas_instance_id.m_call = cast(type_of(PhysicsPointQueryParameters2D_methods.get_canvas_instance_id.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsPointQueryParameters2D_methods.set_collision_mask.m_call = cast(type_of(PhysicsPointQueryParameters2D_methods.set_collision_mask.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsPointQueryParameters2D_methods.get_collision_mask.m_call = cast(type_of(PhysicsPointQueryParameters2D_methods.get_collision_mask.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsPointQueryParameters2D_methods.set_exclude.m_call = cast(type_of(PhysicsPointQueryParameters2D_methods.set_exclude.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsPointQueryParameters2D_methods.get_exclude.m_call = cast(type_of(PhysicsPointQueryParameters2D_methods.get_exclude.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsPointQueryParameters2D_methods.set_collide_with_bodies.m_call = cast(type_of(PhysicsPointQueryParameters2D_methods.set_collide_with_bodies.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsPointQueryParameters2D_methods.is_collide_with_bodies_enabled.m_call = cast(type_of(PhysicsPointQueryParameters2D_methods.is_collide_with_bodies_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsPointQueryParameters2D_methods.set_collide_with_areas.m_call = cast(type_of(PhysicsPointQueryParameters2D_methods.set_collide_with_areas.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsPointQueryParameters2D_methods.is_collide_with_areas_enabled.m_call = cast(type_of(PhysicsPointQueryParameters2D_methods.is_collide_with_areas_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
