...
InputEventJoypadButton_Init_ :: proc (InputEventJoypadButton_methods: ^InputEventJoypadButton_MethodBind_List, loc := #caller_location) {
  InputEventJoypadButton_methods.set_button_index = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.InputEventJoypadButton, "set_button_index", 1466368136, loc))
  InputEventJoypadButton_methods.get_button_index = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.InputEventJoypadButton, "get_button_index", 595588182, loc))
  InputEventJoypadButton_methods.set_pressure = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.InputEventJoypadButton, "set_pressure", 373806689, loc))
  InputEventJoypadButton_methods.get_pressure = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.InputEventJoypadButton, "get_pressure", 1740695150, loc))
  InputEventJoypadButton_methods.set_pressed = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.InputEventJoypadButton, "set_pressed", 2586408642, loc))
};
