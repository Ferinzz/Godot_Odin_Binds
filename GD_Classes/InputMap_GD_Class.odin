...
InputMap_Init_ :: proc (InputMap_methods: ^InputMap_MethodBind_List, loc := #caller_location) {
  ...
  InputMap_methods.has_action.m_call = cast(type_of(InputMap_methods.has_action.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  InputMap_methods.get_actions.m_call = cast(type_of(InputMap_methods.get_actions.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  InputMap_methods.add_action._add_action = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.InputMap, "add_action", 1195233573, loc))
  InputMap_methods.add_action.m_call = cast(type_of(InputMap_methods.add_action.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  InputMap_methods.erase_action.m_call = cast(type_of(InputMap_methods.erase_action.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  InputMap_methods.get_action_description.m_call = cast(type_of(InputMap_methods.get_action_description.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  InputMap_methods.action_set_deadzone.m_call = cast(type_of(InputMap_methods.action_set_deadzone.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  InputMap_methods.action_get_deadzone.m_call = cast(type_of(InputMap_methods.action_get_deadzone.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  InputMap_methods.action_add_event.m_call = cast(type_of(InputMap_methods.action_add_event.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  InputMap_methods.action_has_event.m_call = cast(type_of(InputMap_methods.action_has_event.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  InputMap_methods.action_erase_event.m_call = cast(type_of(InputMap_methods.action_erase_event.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  InputMap_methods.action_erase_events.m_call = cast(type_of(InputMap_methods.action_erase_events.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  InputMap_methods.action_get_events.m_call = cast(type_of(InputMap_methods.action_get_events.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  InputMap_methods.event_is_action.m_call = cast(type_of(InputMap_methods.event_is_action.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  InputMap_methods.load_from_project_settings.m_call = cast(type_of(InputMap_methods.load_from_project_settings.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
