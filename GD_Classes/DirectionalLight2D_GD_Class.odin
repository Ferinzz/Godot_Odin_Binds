...
DirectionalLight2D_Init_ :: proc (DirectionalLight2D_methods: ^DirectionalLight2D_MethodBind_List, loc := #caller_location) {
  ...
  DirectionalLight2D_methods.set_max_distance.m_call = cast(type_of(DirectionalLight2D_methods.set_max_distance.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  DirectionalLight2D_methods.get_max_distance.m_call = cast(type_of(DirectionalLight2D_methods.get_max_distance.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
