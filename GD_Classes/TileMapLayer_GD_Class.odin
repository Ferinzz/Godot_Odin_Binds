...
TileMapLayer_Init_ :: proc (TileMapLayer_methods: ^TileMapLayer_MethodBind_List, loc := #caller_location) {
  ...
  TileMapLayer_methods.set_cell.m_call = cast(type_of(TileMapLayer_methods.set_cell.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMapLayer_methods.erase_cell.m_call = cast(type_of(TileMapLayer_methods.erase_cell.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMapLayer_methods.fix_invalid_tiles.m_call = cast(type_of(TileMapLayer_methods.fix_invalid_tiles.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  TileMapLayer_methods.clear._clear = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TileMapLayer, "clear", 3218959716, loc))
  TileMapLayer_methods.clear.m_call = cast(type_of(TileMapLayer_methods.clear.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMapLayer_methods.get_cell_source_id.m_call = cast(type_of(TileMapLayer_methods.get_cell_source_id.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMapLayer_methods.get_cell_atlas_coords.m_call = cast(type_of(TileMapLayer_methods.get_cell_atlas_coords.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMapLayer_methods.get_cell_alternative_tile.m_call = cast(type_of(TileMapLayer_methods.get_cell_alternative_tile.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMapLayer_methods.get_cell_tile_data.m_call = cast(type_of(TileMapLayer_methods.get_cell_tile_data.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMapLayer_methods.is_cell_flipped_h.m_call = cast(type_of(TileMapLayer_methods.is_cell_flipped_h.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMapLayer_methods.is_cell_flipped_v.m_call = cast(type_of(TileMapLayer_methods.is_cell_flipped_v.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMapLayer_methods.is_cell_transposed.m_call = cast(type_of(TileMapLayer_methods.is_cell_transposed.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMapLayer_methods.get_used_cells.m_call = cast(type_of(TileMapLayer_methods.get_used_cells.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMapLayer_methods.get_used_cells_by_id.m_call = cast(type_of(TileMapLayer_methods.get_used_cells_by_id.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMapLayer_methods.get_used_rect.m_call = cast(type_of(TileMapLayer_methods.get_used_rect.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMapLayer_methods.get_pattern.m_call = cast(type_of(TileMapLayer_methods.get_pattern.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMapLayer_methods.set_pattern.m_call = cast(type_of(TileMapLayer_methods.set_pattern.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMapLayer_methods.set_cells_terrain_connect.m_call = cast(type_of(TileMapLayer_methods.set_cells_terrain_connect.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMapLayer_methods.set_cells_terrain_path.m_call = cast(type_of(TileMapLayer_methods.set_cells_terrain_path.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMapLayer_methods.has_body_rid.m_call = cast(type_of(TileMapLayer_methods.has_body_rid.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMapLayer_methods.get_coords_for_body_rid.m_call = cast(type_of(TileMapLayer_methods.get_coords_for_body_rid.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMapLayer_methods.update_internals.m_call = cast(type_of(TileMapLayer_methods.update_internals.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMapLayer_methods.notify_runtime_tile_data_update.m_call = cast(type_of(TileMapLayer_methods.notify_runtime_tile_data_update.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMapLayer_methods.map_pattern.m_call = cast(type_of(TileMapLayer_methods.map_pattern.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMapLayer_methods.get_surrounding_cells.m_call = cast(type_of(TileMapLayer_methods.get_surrounding_cells.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMapLayer_methods.get_neighbor_cell.m_call = cast(type_of(TileMapLayer_methods.get_neighbor_cell.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMapLayer_methods.map_to_local.m_call = cast(type_of(TileMapLayer_methods.map_to_local.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMapLayer_methods.local_to_map.m_call = cast(type_of(TileMapLayer_methods.local_to_map.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMapLayer_methods.set_tile_map_data_from_array.m_call = cast(type_of(TileMapLayer_methods.set_tile_map_data_from_array.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMapLayer_methods.get_tile_map_data_as_array.m_call = cast(type_of(TileMapLayer_methods.get_tile_map_data_as_array.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMapLayer_methods.set_enabled.m_call = cast(type_of(TileMapLayer_methods.set_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMapLayer_methods.is_enabled.m_call = cast(type_of(TileMapLayer_methods.is_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMapLayer_methods.set_tile_set.m_call = cast(type_of(TileMapLayer_methods.set_tile_set.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMapLayer_methods.get_tile_set.m_call = cast(type_of(TileMapLayer_methods.get_tile_set.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMapLayer_methods.set_y_sort_origin.m_call = cast(type_of(TileMapLayer_methods.set_y_sort_origin.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMapLayer_methods.get_y_sort_origin.m_call = cast(type_of(TileMapLayer_methods.get_y_sort_origin.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMapLayer_methods.set_x_draw_order_reversed.m_call = cast(type_of(TileMapLayer_methods.set_x_draw_order_reversed.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMapLayer_methods.is_x_draw_order_reversed.m_call = cast(type_of(TileMapLayer_methods.is_x_draw_order_reversed.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMapLayer_methods.set_rendering_quadrant_size.m_call = cast(type_of(TileMapLayer_methods.set_rendering_quadrant_size.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMapLayer_methods.get_rendering_quadrant_size.m_call = cast(type_of(TileMapLayer_methods.get_rendering_quadrant_size.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMapLayer_methods.set_collision_enabled.m_call = cast(type_of(TileMapLayer_methods.set_collision_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMapLayer_methods.is_collision_enabled.m_call = cast(type_of(TileMapLayer_methods.is_collision_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMapLayer_methods.set_use_kinematic_bodies.m_call = cast(type_of(TileMapLayer_methods.set_use_kinematic_bodies.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMapLayer_methods.is_using_kinematic_bodies.m_call = cast(type_of(TileMapLayer_methods.is_using_kinematic_bodies.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMapLayer_methods.set_collision_visibility_mode.m_call = cast(type_of(TileMapLayer_methods.set_collision_visibility_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMapLayer_methods.get_collision_visibility_mode.m_call = cast(type_of(TileMapLayer_methods.get_collision_visibility_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMapLayer_methods.set_physics_quadrant_size.m_call = cast(type_of(TileMapLayer_methods.set_physics_quadrant_size.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMapLayer_methods.get_physics_quadrant_size.m_call = cast(type_of(TileMapLayer_methods.get_physics_quadrant_size.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMapLayer_methods.set_occlusion_enabled.m_call = cast(type_of(TileMapLayer_methods.set_occlusion_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMapLayer_methods.is_occlusion_enabled.m_call = cast(type_of(TileMapLayer_methods.is_occlusion_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMapLayer_methods.set_navigation_enabled.m_call = cast(type_of(TileMapLayer_methods.set_navigation_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMapLayer_methods.is_navigation_enabled.m_call = cast(type_of(TileMapLayer_methods.is_navigation_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMapLayer_methods.set_navigation_map.m_call = cast(type_of(TileMapLayer_methods.set_navigation_map.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMapLayer_methods.get_navigation_map.m_call = cast(type_of(TileMapLayer_methods.get_navigation_map.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMapLayer_methods.set_navigation_visibility_mode.m_call = cast(type_of(TileMapLayer_methods.set_navigation_visibility_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMapLayer_methods.get_navigation_visibility_mode.m_call = cast(type_of(TileMapLayer_methods.get_navigation_visibility_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
