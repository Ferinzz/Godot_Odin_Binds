...
StreamPeerTCP_Init_ :: proc (StreamPeerTCP_methods: ^StreamPeerTCP_MethodBind_List, loc := #caller_location) {
  ...
  StreamPeerTCP_methods.bind.m_call = cast(type_of(StreamPeerTCP_methods.bind.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  StreamPeerTCP_methods.connect_to_host.m_call = cast(type_of(StreamPeerTCP_methods.connect_to_host.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  StreamPeerTCP_methods.get_connected_host.m_call = cast(type_of(StreamPeerTCP_methods.get_connected_host.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  StreamPeerTCP_methods.get_connected_port.m_call = cast(type_of(StreamPeerTCP_methods.get_connected_port.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  StreamPeerTCP_methods.get_local_port.m_call = cast(type_of(StreamPeerTCP_methods.get_local_port.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  StreamPeerTCP_methods.set_no_delay.m_call = cast(type_of(StreamPeerTCP_methods.set_no_delay.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
