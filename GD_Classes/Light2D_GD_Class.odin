...
Light2D_Init_ :: proc (Light2D_methods: ^Light2D_MethodBind_List, loc := #caller_location) {
  ...
  Light2D_methods.set_enabled.m_call = cast(type_of(Light2D_methods.set_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Light2D_methods.is_enabled._is_enabled = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Light2D, "is_enabled", 36873697, loc))
  Light2D_methods.is_enabled.m_call = cast(type_of(Light2D_methods.is_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Light2D_methods.set_editor_only.m_call = cast(type_of(Light2D_methods.set_editor_only.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Light2D_methods.is_editor_only.m_call = cast(type_of(Light2D_methods.is_editor_only.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Light2D_methods.set_color._set_color = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Light2D, "set_color", 2920490490, loc))
  Light2D_methods.set_color.m_call = cast(type_of(Light2D_methods.set_color.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Light2D_methods.get_color._get_color = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Light2D, "get_color", 3444240500, loc))
  Light2D_methods.get_color.m_call = cast(type_of(Light2D_methods.get_color.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Light2D_methods.set_energy._set_energy = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Light2D, "set_energy", 373806689, loc))
  Light2D_methods.set_energy.m_call = cast(type_of(Light2D_methods.set_energy.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Light2D_methods.get_energy._get_energy = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Light2D, "get_energy", 1740695150, loc))
  Light2D_methods.get_energy.m_call = cast(type_of(Light2D_methods.get_energy.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Light2D_methods.set_z_range_min.m_call = cast(type_of(Light2D_methods.set_z_range_min.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Light2D_methods.get_z_range_min.m_call = cast(type_of(Light2D_methods.get_z_range_min.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Light2D_methods.set_z_range_max.m_call = cast(type_of(Light2D_methods.set_z_range_max.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Light2D_methods.get_z_range_max.m_call = cast(type_of(Light2D_methods.get_z_range_max.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Light2D_methods.set_layer_range_min.m_call = cast(type_of(Light2D_methods.set_layer_range_min.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Light2D_methods.get_layer_range_min.m_call = cast(type_of(Light2D_methods.get_layer_range_min.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Light2D_methods.set_layer_range_max.m_call = cast(type_of(Light2D_methods.set_layer_range_max.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Light2D_methods.get_layer_range_max.m_call = cast(type_of(Light2D_methods.get_layer_range_max.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Light2D_methods.set_item_cull_mask.m_call = cast(type_of(Light2D_methods.set_item_cull_mask.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Light2D_methods.get_item_cull_mask.m_call = cast(type_of(Light2D_methods.get_item_cull_mask.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Light2D_methods.set_item_shadow_cull_mask.m_call = cast(type_of(Light2D_methods.set_item_shadow_cull_mask.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Light2D_methods.get_item_shadow_cull_mask.m_call = cast(type_of(Light2D_methods.get_item_shadow_cull_mask.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Light2D_methods.set_shadow_enabled.m_call = cast(type_of(Light2D_methods.set_shadow_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Light2D_methods.is_shadow_enabled.m_call = cast(type_of(Light2D_methods.is_shadow_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Light2D_methods.set_shadow_smooth.m_call = cast(type_of(Light2D_methods.set_shadow_smooth.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Light2D_methods.get_shadow_smooth.m_call = cast(type_of(Light2D_methods.get_shadow_smooth.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Light2D_methods.set_shadow_filter.m_call = cast(type_of(Light2D_methods.set_shadow_filter.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Light2D_methods.get_shadow_filter.m_call = cast(type_of(Light2D_methods.get_shadow_filter.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Light2D_methods.set_shadow_color.m_call = cast(type_of(Light2D_methods.set_shadow_color.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Light2D_methods.get_shadow_color.m_call = cast(type_of(Light2D_methods.get_shadow_color.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Light2D_methods.set_blend_mode.m_call = cast(type_of(Light2D_methods.set_blend_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Light2D_methods.get_blend_mode.m_call = cast(type_of(Light2D_methods.get_blend_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Light2D_methods.set_height._set_height = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Light2D, "set_height", 373806689, loc))
  Light2D_methods.set_height.m_call = cast(type_of(Light2D_methods.set_height.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Light2D_methods.get_height._get_height = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Light2D, "get_height", 1740695150, loc))
  Light2D_methods.get_height.m_call = cast(type_of(Light2D_methods.get_height.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
