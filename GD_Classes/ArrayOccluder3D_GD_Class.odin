...
ArrayOccluder3D_Init_ :: proc (ArrayOccluder3D_methods: ^ArrayOccluder3D_MethodBind_List, loc := #caller_location) {
  ...
  ArrayOccluder3D_methods.set_arrays.m_call = cast(type_of(ArrayOccluder3D_methods.set_arrays.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ArrayOccluder3D_methods.set_vertices.m_call = cast(type_of(ArrayOccluder3D_methods.set_vertices.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ArrayOccluder3D_methods.set_indices.m_call = cast(type_of(ArrayOccluder3D_methods.set_indices.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
