...
WebRTCPeerConnection_Init_ :: proc (WebRTCPeerConnection_methods: ^WebRTCPeerConnection_MethodBind_List, loc := #caller_location) {
  ...
  WebRTCPeerConnection_methods.set_default_extension.m_call = cast(type_of(WebRTCPeerConnection_methods.set_default_extension.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  WebRTCPeerConnection_methods.initialize.m_call = cast(type_of(WebRTCPeerConnection_methods.initialize.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  WebRTCPeerConnection_methods.create_data_channel.m_call = cast(type_of(WebRTCPeerConnection_methods.create_data_channel.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  WebRTCPeerConnection_methods.create_offer.m_call = cast(type_of(WebRTCPeerConnection_methods.create_offer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  WebRTCPeerConnection_methods.set_local_description.m_call = cast(type_of(WebRTCPeerConnection_methods.set_local_description.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  WebRTCPeerConnection_methods.set_remote_description.m_call = cast(type_of(WebRTCPeerConnection_methods.set_remote_description.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  WebRTCPeerConnection_methods.add_ice_candidate.m_call = cast(type_of(WebRTCPeerConnection_methods.add_ice_candidate.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  WebRTCPeerConnection_methods.poll.m_call = cast(type_of(WebRTCPeerConnection_methods.poll.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  WebRTCPeerConnection_methods.close.m_call = cast(type_of(WebRTCPeerConnection_methods.close.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  WebRTCPeerConnection_methods.get_connection_state.m_call = cast(type_of(WebRTCPeerConnection_methods.get_connection_state.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  WebRTCPeerConnection_methods.get_gathering_state.m_call = cast(type_of(WebRTCPeerConnection_methods.get_gathering_state.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  WebRTCPeerConnection_methods.get_signaling_state.m_call = cast(type_of(WebRTCPeerConnection_methods.get_signaling_state.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
