...
AudioListener3D_Init_ :: proc (AudioListener3D_methods: ^AudioListener3D_MethodBind_List, loc := #caller_location) {
  ...
  AudioListener3D_methods.make_current.m_call = cast(type_of(AudioListener3D_methods.make_current.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioListener3D_methods.clear_current.m_call = cast(type_of(AudioListener3D_methods.clear_current.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioListener3D_methods.is_current.m_call = cast(type_of(AudioListener3D_methods.is_current.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioListener3D_methods.get_listener_transform.m_call = cast(type_of(AudioListener3D_methods.get_listener_transform.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioListener3D_methods.set_doppler_tracking.m_call = cast(type_of(AudioListener3D_methods.set_doppler_tracking.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioListener3D_methods.get_doppler_tracking.m_call = cast(type_of(AudioListener3D_methods.get_doppler_tracking.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
