...
DPITexture_Init_ :: proc (DPITexture_methods: ^DPITexture_MethodBind_List, loc := #caller_location) {
  ...
  DPITexture_methods.create_from_string.m_call = cast(type_of(DPITexture_methods.create_from_string.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  DPITexture_methods.set_source.m_call = cast(type_of(DPITexture_methods.set_source.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  DPITexture_methods.get_source.m_call = cast(type_of(DPITexture_methods.get_source.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  DPITexture_methods.set_base_scale.m_call = cast(type_of(DPITexture_methods.set_base_scale.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  DPITexture_methods.get_base_scale.m_call = cast(type_of(DPITexture_methods.get_base_scale.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  DPITexture_methods.set_saturation.m_call = cast(type_of(DPITexture_methods.set_saturation.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  DPITexture_methods.get_saturation.m_call = cast(type_of(DPITexture_methods.get_saturation.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  DPITexture_methods.set_color_map.m_call = cast(type_of(DPITexture_methods.set_color_map.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  DPITexture_methods.get_color_map.m_call = cast(type_of(DPITexture_methods.get_color_map.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  DPITexture_methods.set_size_override.m_call = cast(type_of(DPITexture_methods.set_size_override.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  DPITexture_methods.get_scaled_rid.m_call = cast(type_of(DPITexture_methods.get_scaled_rid.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
