...
Node2D_Init_ :: proc (Node2D_methods: ^Node2D_MethodBind_List, loc := #caller_location) {
  ...
  Node2D_methods.set_position.m_call = cast(type_of(Node2D_methods.set_position.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Node2D_methods.set_rotation.m_call = cast(type_of(Node2D_methods.set_rotation.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Node2D_methods.set_rotation_degrees.m_call = cast(type_of(Node2D_methods.set_rotation_degrees.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Node2D_methods.set_skew._set_skew = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Node2D, "set_skew", 373806689, loc))
  Node2D_methods.set_skew.m_call = cast(type_of(Node2D_methods.set_skew.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Node2D_methods.set_scale._set_scale = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Node2D, "set_scale", 743155724, loc))
  Node2D_methods.set_scale.m_call = cast(type_of(Node2D_methods.set_scale.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Node2D_methods.get_position.m_call = cast(type_of(Node2D_methods.get_position.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Node2D_methods.get_rotation.m_call = cast(type_of(Node2D_methods.get_rotation.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Node2D_methods.get_rotation_degrees.m_call = cast(type_of(Node2D_methods.get_rotation_degrees.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Node2D_methods.get_skew._get_skew = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Node2D, "get_skew", 1740695150, loc))
  Node2D_methods.get_skew.m_call = cast(type_of(Node2D_methods.get_skew.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Node2D_methods.get_scale._get_scale = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Node2D, "get_scale", 3341600327, loc))
  Node2D_methods.get_scale.m_call = cast(type_of(Node2D_methods.get_scale.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Node2D_methods.rotate._rotate = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Node2D, "rotate", 373806689, loc))
  Node2D_methods.rotate.m_call = cast(type_of(Node2D_methods.rotate.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Node2D_methods.move_local_x.m_call = cast(type_of(Node2D_methods.move_local_x.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Node2D_methods.move_local_y.m_call = cast(type_of(Node2D_methods.move_local_y.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Node2D_methods.translate._translate = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Node2D, "translate", 743155724, loc))
  Node2D_methods.translate.m_call = cast(type_of(Node2D_methods.translate.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Node2D_methods.global_translate.m_call = cast(type_of(Node2D_methods.global_translate.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Node2D_methods.apply_scale._apply_scale = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Node2D, "apply_scale", 743155724, loc))
  Node2D_methods.apply_scale.m_call = cast(type_of(Node2D_methods.apply_scale.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Node2D_methods.set_global_position.m_call = cast(type_of(Node2D_methods.set_global_position.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Node2D_methods.get_global_position.m_call = cast(type_of(Node2D_methods.get_global_position.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Node2D_methods.set_global_rotation.m_call = cast(type_of(Node2D_methods.set_global_rotation.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Node2D_methods.set_global_rotation_degrees.m_call = cast(type_of(Node2D_methods.set_global_rotation_degrees.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Node2D_methods.get_global_rotation.m_call = cast(type_of(Node2D_methods.get_global_rotation.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Node2D_methods.get_global_rotation_degrees.m_call = cast(type_of(Node2D_methods.get_global_rotation_degrees.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Node2D_methods.set_global_skew.m_call = cast(type_of(Node2D_methods.set_global_skew.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Node2D_methods.get_global_skew.m_call = cast(type_of(Node2D_methods.get_global_skew.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Node2D_methods.set_global_scale.m_call = cast(type_of(Node2D_methods.set_global_scale.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Node2D_methods.get_global_scale.m_call = cast(type_of(Node2D_methods.get_global_scale.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Node2D_methods.set_transform.m_call = cast(type_of(Node2D_methods.set_transform.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Node2D_methods.set_global_transform.m_call = cast(type_of(Node2D_methods.set_global_transform.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Node2D_methods.look_at._look_at = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Node2D, "look_at", 743155724, loc))
  Node2D_methods.look_at.m_call = cast(type_of(Node2D_methods.look_at.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Node2D_methods.get_angle_to.m_call = cast(type_of(Node2D_methods.get_angle_to.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Node2D_methods.to_local._to_local = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Node2D, "to_local", 2656412154, loc))
  Node2D_methods.to_local.m_call = cast(type_of(Node2D_methods.to_local.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Node2D_methods.to_global._to_global = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Node2D, "to_global", 2656412154, loc))
  Node2D_methods.to_global.m_call = cast(type_of(Node2D_methods.to_global.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Node2D_methods.get_relative_transform_to_parent.m_call = cast(type_of(Node2D_methods.get_relative_transform_to_parent.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
