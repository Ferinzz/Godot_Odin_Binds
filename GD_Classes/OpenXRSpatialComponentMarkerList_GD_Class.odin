...
OpenXRSpatialComponentMarkerList_Init_ :: proc (OpenXRSpatialComponentMarkerList_methods: ^OpenXRSpatialComponentMarkerList_MethodBind_List, loc := #caller_location) {
  ...
  OpenXRSpatialComponentMarkerList_methods.get_marker_type.m_call = cast(type_of(OpenXRSpatialComponentMarkerList_methods.get_marker_type.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRSpatialComponentMarkerList_methods.get_marker_id.m_call = cast(type_of(OpenXRSpatialComponentMarkerList_methods.get_marker_id.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRSpatialComponentMarkerList_methods.get_marker_data.m_call = cast(type_of(OpenXRSpatialComponentMarkerList_methods.get_marker_data.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
