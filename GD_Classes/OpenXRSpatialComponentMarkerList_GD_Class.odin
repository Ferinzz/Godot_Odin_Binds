...
OpenXRSpatialComponentMarkerList_MethodBind_List :: struct {
  get_marker_type: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: OpenXRSpatialComponentMarkerList, #by_ptr args: struct{index: ^GDW.Int, }, r_ret: ^OpenXRSpatialComponentMarkerList_MarkerType)
  },
  get_marker_id: struct{
    using _get_marker_id: ^GDW.MethodBind,
    m_call: proc "c" (_:^GDW.MethodBind, obj: OpenXRSpatialComponentMarkerList, #by_ptr args: struct{index: ^GDW.Int, }, r_ret: ^GDW.Int)
  },
  get_marker_data: struct{
    using _get_marker_data: ^GDW.MethodBind,
    m_call: proc "c" (_:^GDW.MethodBind, obj: OpenXRSpatialComponentMarkerList, #by_ptr args: struct{snapshot: ^GDW.RID, index: ^GDW.Int, }, r_ret: ^GDW.Variant)
  },
};
OpenXRSpatialComponentMarkerList_Init_ :: proc (OpenXRSpatialComponentMarkerList_methods: ^OpenXRSpatialComponentMarkerList_MethodBind_List, loc := #caller_location) {
  ...
  OpenXRSpatialComponentMarkerList_methods.get_marker_type._get_marker_type = (cast(^GDW.MethodBind)classDBGetMethodBind3(.OpenXRSpatialComponentMarkerList, "get_marker_type", 2627847866, loc))
  ...
  OpenXRSpatialComponentMarkerList_methods.get_marker_id._get_marker_id = (cast(^GDW.MethodBind)classDBGetMethodBind3(.OpenXRSpatialComponentMarkerList, "get_marker_id", 923996154, loc))
  ...
  OpenXRSpatialComponentMarkerList_methods.get_marker_data._get_marker_data = (cast(^GDW.MethodBind)classDBGetMethodBind3(.OpenXRSpatialComponentMarkerList, "get_marker_data", 4069510997, loc))
