...
PackedScene_Init_ :: proc (PackedScene_methods: ^PackedScene_MethodBind_List, loc := #caller_location) {
  ...
  PackedScene_methods.pack.m_call = cast(type_of(PackedScene_methods.pack.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PackedScene_methods.instantiate.m_call = cast(type_of(PackedScene_methods.instantiate.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PackedScene_methods.can_instantiate.m_call = cast(type_of(PackedScene_methods.can_instantiate.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PackedScene_methods.get_state.m_call = cast(type_of(PackedScene_methods.get_state.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
