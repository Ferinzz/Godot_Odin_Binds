...
ConfigFile_Init_ :: proc (ConfigFile_methods: ^ConfigFile_MethodBind_List, loc := #caller_location) {
  ...
  ConfigFile_methods.set_value.m_call = cast(type_of(ConfigFile_methods.set_value.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ConfigFile_methods.get_value._get_value = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.ConfigFile, "get_value", 89809366, loc))
  ConfigFile_methods.get_value.m_call = cast(type_of(ConfigFile_methods.get_value.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ConfigFile_methods.has_section.m_call = cast(type_of(ConfigFile_methods.has_section.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ConfigFile_methods.has_section_key.m_call = cast(type_of(ConfigFile_methods.has_section_key.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ConfigFile_methods.get_sections.m_call = cast(type_of(ConfigFile_methods.get_sections.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ConfigFile_methods.get_section_keys.m_call = cast(type_of(ConfigFile_methods.get_section_keys.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ConfigFile_methods.erase_section.m_call = cast(type_of(ConfigFile_methods.erase_section.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ConfigFile_methods.erase_section_key.m_call = cast(type_of(ConfigFile_methods.erase_section_key.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ConfigFile_methods.load._load = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.ConfigFile, "load", 166001499, loc))
  ConfigFile_methods.load.m_call = cast(type_of(ConfigFile_methods.load.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ConfigFile_methods.parse._parse = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.ConfigFile, "parse", 166001499, loc))
  ConfigFile_methods.parse.m_call = cast(type_of(ConfigFile_methods.parse.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ConfigFile_methods.save._save = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.ConfigFile, "save", 166001499, loc))
  ConfigFile_methods.save.m_call = cast(type_of(ConfigFile_methods.save.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ConfigFile_methods.encode_to_text.m_call = cast(type_of(ConfigFile_methods.encode_to_text.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ConfigFile_methods.load_encrypted.m_call = cast(type_of(ConfigFile_methods.load_encrypted.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ConfigFile_methods.load_encrypted_pass.m_call = cast(type_of(ConfigFile_methods.load_encrypted_pass.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ConfigFile_methods.save_encrypted.m_call = cast(type_of(ConfigFile_methods.save_encrypted.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ConfigFile_methods.save_encrypted_pass.m_call = cast(type_of(ConfigFile_methods.save_encrypted_pass.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ConfigFile_methods.clear._clear = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.ConfigFile, "clear", 3218959716, loc))
  ConfigFile_methods.clear.m_call = cast(type_of(ConfigFile_methods.clear.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
