...
ZIPPacker_Init_ :: proc (ZIPPacker_methods: ^ZIPPacker_MethodBind_List, loc := #caller_location) {
  ...
  ZIPPacker_methods.open.m_call = cast(type_of(ZIPPacker_methods.open.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ZIPPacker_methods.set_compression_level.m_call = cast(type_of(ZIPPacker_methods.set_compression_level.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ZIPPacker_methods.get_compression_level.m_call = cast(type_of(ZIPPacker_methods.get_compression_level.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ZIPPacker_methods.start_file.m_call = cast(type_of(ZIPPacker_methods.start_file.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ZIPPacker_methods.write_file.m_call = cast(type_of(ZIPPacker_methods.write_file.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ZIPPacker_methods.close_file.m_call = cast(type_of(ZIPPacker_methods.close_file.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ZIPPacker_methods.close._close = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.ZIPPacker, "close", 166280745, loc))
  ZIPPacker_methods.close.m_call = cast(type_of(ZIPPacker_methods.close.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
