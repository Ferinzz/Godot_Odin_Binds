...
VisualShaderNodeParticleMeshEmitter_Init_ :: proc (VisualShaderNodeParticleMeshEmitter_methods: ^VisualShaderNodeParticleMeshEmitter_MethodBind_List, loc := #caller_location) {
  ...
  VisualShaderNodeParticleMeshEmitter_methods.set_mesh.m_call = cast(type_of(VisualShaderNodeParticleMeshEmitter_methods.set_mesh.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeParticleMeshEmitter_methods.get_mesh.m_call = cast(type_of(VisualShaderNodeParticleMeshEmitter_methods.get_mesh.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeParticleMeshEmitter_methods.set_use_all_surfaces.m_call = cast(type_of(VisualShaderNodeParticleMeshEmitter_methods.set_use_all_surfaces.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeParticleMeshEmitter_methods.is_use_all_surfaces.m_call = cast(type_of(VisualShaderNodeParticleMeshEmitter_methods.is_use_all_surfaces.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeParticleMeshEmitter_methods.set_surface_index.m_call = cast(type_of(VisualShaderNodeParticleMeshEmitter_methods.set_surface_index.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeParticleMeshEmitter_methods.get_surface_index.m_call = cast(type_of(VisualShaderNodeParticleMeshEmitter_methods.get_surface_index.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
