...
CenterContainer_Init_ :: proc (CenterContainer_methods: ^CenterContainer_MethodBind_List, loc := #caller_location) {
  ...
  CenterContainer_methods.set_use_top_left.m_call = cast(type_of(CenterContainer_methods.set_use_top_left.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CenterContainer_methods.is_using_top_left.m_call = cast(type_of(CenterContainer_methods.is_using_top_left.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
