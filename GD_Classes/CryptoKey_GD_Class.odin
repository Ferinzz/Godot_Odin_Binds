...
CryptoKey_Init_ :: proc (CryptoKey_methods: ^CryptoKey_MethodBind_List, loc := #caller_location) {
  ...
  CryptoKey_methods.save.m_call = cast(type_of(CryptoKey_methods.save.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  CryptoKey_methods.load._load = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.CryptoKey, "load", 885841341, loc))
  CryptoKey_methods.load.m_call = cast(type_of(CryptoKey_methods.load.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CryptoKey_methods.is_public_only.m_call = cast(type_of(CryptoKey_methods.is_public_only.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CryptoKey_methods.save_to_string.m_call = cast(type_of(CryptoKey_methods.save_to_string.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CryptoKey_methods.load_from_string.m_call = cast(type_of(CryptoKey_methods.load_from_string.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
