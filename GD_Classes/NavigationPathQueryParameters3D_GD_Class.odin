...
PathfindingAlgorithm_NavigationPathQueryParameters3D :: enum i64 {
  PATHFINDING_ALGORITHM_ASTAR = 0,
};

PathPostProcessing_NavigationPathQueryParameters3D :: enum i64 {
  PATH_POSTPROCESSING_CORRIDORFUNNEL = 0,
  PATH_POSTPROCESSING_EDGECENTERED = 1,
  PATH_POSTPROCESSING_NONE = 2,
};

PathMetadataFlags_NavigationPathQueryParameters3D_Flags :: bit_set [PathMetadataFlags_NavigationPathQueryParameters3D; i64]
PathMetadataFlags_NavigationPathQueryParameters3D :: enum i64 {
...
NavigationPathQueryParameters3D_Init_ :: proc (NavigationPathQueryParameters3D_methods: ^NavigationPathQueryParameters3D_MethodBind_List, loc := #caller_location) {
  NavigationPathQueryParameters3D_methods.set_pathfinding_algorithm = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.NavigationPathQueryParameters3D, "set_pathfinding_algorithm", 394560454, loc))
  NavigationPathQueryParameters3D_methods.get_pathfinding_algorithm = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.NavigationPathQueryParameters3D, "get_pathfinding_algorithm", 3398491350, loc))
  NavigationPathQueryParameters3D_methods.set_path_postprocessing = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.NavigationPathQueryParameters3D, "set_path_postprocessing", 2267362344, loc))
  NavigationPathQueryParameters3D_methods.get_path_postprocessing = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.NavigationPathQueryParameters3D, "get_path_postprocessing", 3883858360, loc))
  NavigationPathQueryParameters3D_methods.set_map = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.NavigationPathQueryParameters3D, "set_map", 2722037293, loc))
  NavigationPathQueryParameters3D_methods.get_map = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.NavigationPathQueryParameters3D, "get_map", 2944877500, loc))
  NavigationPathQueryParameters3D_methods.set_start_position = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.NavigationPathQueryParameters3D, "set_start_position", 3460891852, loc))
  NavigationPathQueryParameters3D_methods.get_start_position = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.NavigationPathQueryParameters3D, "get_start_position", 3360562783, loc))
  NavigationPathQueryParameters3D_methods.set_target_position = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.NavigationPathQueryParameters3D, "set_target_position", 3460891852, loc))
  NavigationPathQueryParameters3D_methods.get_target_position = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.NavigationPathQueryParameters3D, "get_target_position", 3360562783, loc))
  NavigationPathQueryParameters3D_methods.set_navigation_layers = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.NavigationPathQueryParameters3D, "set_navigation_layers", 1286410249, loc))
  NavigationPathQueryParameters3D_methods.get_navigation_layers = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.NavigationPathQueryParameters3D, "get_navigation_layers", 3905245786, loc))
  NavigationPathQueryParameters3D_methods.set_metadata_flags = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.NavigationPathQueryParameters3D, "set_metadata_flags", 2713846708, loc))
  NavigationPathQueryParameters3D_methods.get_metadata_flags = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.NavigationPathQueryParameters3D, "get_metadata_flags", 1582332802, loc))
  NavigationPathQueryParameters3D_methods.set_simplify_path = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.NavigationPathQueryParameters3D, "set_simplify_path", 2586408642, loc))
  NavigationPathQueryParameters3D_methods.get_simplify_path = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.NavigationPathQueryParameters3D, "get_simplify_path", 36873697, loc))
  NavigationPathQueryParameters3D_methods.set_simplify_epsilon = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.NavigationPathQueryParameters3D, "set_simplify_epsilon", 373806689, loc))
  NavigationPathQueryParameters3D_methods.get_simplify_epsilon = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.NavigationPathQueryParameters3D, "get_simplify_epsilon", 1740695150, loc))
  NavigationPathQueryParameters3D_methods.set_included_regions = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.NavigationPathQueryParameters3D, "set_included_regions", 381264803, loc))
  NavigationPathQueryParameters3D_methods.get_included_regions = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.NavigationPathQueryParameters3D, "get_included_regions", 3995934104, loc))
  NavigationPathQueryParameters3D_methods.set_excluded_regions = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.NavigationPathQueryParameters3D, "set_excluded_regions", 381264803, loc))
  NavigationPathQueryParameters3D_methods.get_excluded_regions = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.NavigationPathQueryParameters3D, "get_excluded_regions", 3995934104, loc))
  NavigationPathQueryParameters3D_methods.set_path_return_max_length = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.NavigationPathQueryParameters3D, "set_path_return_max_length", 373806689, loc))
  NavigationPathQueryParameters3D_methods.get_path_return_max_length = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.NavigationPathQueryParameters3D, "get_path_return_max_length", 1740695150, loc))
  NavigationPathQueryParameters3D_methods.set_path_return_max_radius = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.NavigationPathQueryParameters3D, "set_path_return_max_radius", 373806689, loc))
  NavigationPathQueryParameters3D_methods.get_path_return_max_radius = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.NavigationPathQueryParameters3D, "get_path_return_max_radius", 1740695150, loc))
  NavigationPathQueryParameters3D_methods.set_path_search_max_polygons = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.NavigationPathQueryParameters3D, "set_path_search_max_polygons", 1286410249, loc))
  NavigationPathQueryParameters3D_methods.get_path_search_max_polygons = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.NavigationPathQueryParameters3D, "get_path_search_max_polygons", 3905245786, loc))
  NavigationPathQueryParameters3D_methods.set_path_search_max_distance = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.NavigationPathQueryParameters3D, "set_path_search_max_distance", 373806689, loc))
  NavigationPathQueryParameters3D_methods.get_path_search_max_distance = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.NavigationPathQueryParameters3D, "get_path_search_max_distance", 1740695150, loc))
};
