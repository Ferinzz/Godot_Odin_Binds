...
AnimatedTexture_Init_ :: proc (AnimatedTexture_methods: ^AnimatedTexture_MethodBind_List, loc := #caller_location) {
  ...
  AnimatedTexture_methods.set_frames.m_call = cast(type_of(AnimatedTexture_methods.set_frames.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AnimatedTexture_methods.get_frames.m_call = cast(type_of(AnimatedTexture_methods.get_frames.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AnimatedTexture_methods.set_current_frame.m_call = cast(type_of(AnimatedTexture_methods.set_current_frame.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AnimatedTexture_methods.get_current_frame.m_call = cast(type_of(AnimatedTexture_methods.get_current_frame.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AnimatedTexture_methods.set_pause.m_call = cast(type_of(AnimatedTexture_methods.set_pause.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AnimatedTexture_methods.get_pause.m_call = cast(type_of(AnimatedTexture_methods.get_pause.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AnimatedTexture_methods.set_one_shot.m_call = cast(type_of(AnimatedTexture_methods.set_one_shot.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AnimatedTexture_methods.get_one_shot.m_call = cast(type_of(AnimatedTexture_methods.get_one_shot.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AnimatedTexture_methods.set_speed_scale.m_call = cast(type_of(AnimatedTexture_methods.set_speed_scale.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AnimatedTexture_methods.get_speed_scale.m_call = cast(type_of(AnimatedTexture_methods.get_speed_scale.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AnimatedTexture_methods.set_frame_texture.m_call = cast(type_of(AnimatedTexture_methods.set_frame_texture.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AnimatedTexture_methods.get_frame_texture.m_call = cast(type_of(AnimatedTexture_methods.get_frame_texture.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AnimatedTexture_methods.set_frame_duration.m_call = cast(type_of(AnimatedTexture_methods.set_frame_duration.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AnimatedTexture_methods.get_frame_duration.m_call = cast(type_of(AnimatedTexture_methods.get_frame_duration.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
