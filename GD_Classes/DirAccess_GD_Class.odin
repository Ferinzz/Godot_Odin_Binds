...
DirAccess_Init_ :: proc (DirAccess_methods: ^DirAccess_MethodBind_List, loc := #caller_location) {
  ...
  DirAccess_methods.open.m_call = cast(type_of(DirAccess_methods.open.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  DirAccess_methods.get_open_error.m_call = cast(type_of(DirAccess_methods.get_open_error.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  DirAccess_methods.create_temp.m_call = cast(type_of(DirAccess_methods.create_temp.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  DirAccess_methods.list_dir_begin.m_call = cast(type_of(DirAccess_methods.list_dir_begin.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  DirAccess_methods.get_next._get_next = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.DirAccess, "get_next", 2841200299, loc))
  DirAccess_methods.get_next.m_call = cast(type_of(DirAccess_methods.get_next.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  DirAccess_methods.current_is_dir.m_call = cast(type_of(DirAccess_methods.current_is_dir.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  DirAccess_methods.list_dir_end.m_call = cast(type_of(DirAccess_methods.list_dir_end.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  DirAccess_methods.get_files._get_files = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.DirAccess, "get_files", 2981934095, loc))
  DirAccess_methods.get_files.m_call = cast(type_of(DirAccess_methods.get_files.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  DirAccess_methods.get_files_at.m_call = cast(type_of(DirAccess_methods.get_files_at.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  DirAccess_methods.get_directories.m_call = cast(type_of(DirAccess_methods.get_directories.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  DirAccess_methods.get_directories_at.m_call = cast(type_of(DirAccess_methods.get_directories_at.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  DirAccess_methods.get_drive_count.m_call = cast(type_of(DirAccess_methods.get_drive_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  DirAccess_methods.get_drive_name.m_call = cast(type_of(DirAccess_methods.get_drive_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  DirAccess_methods.get_current_drive.m_call = cast(type_of(DirAccess_methods.get_current_drive.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  DirAccess_methods.change_dir.m_call = cast(type_of(DirAccess_methods.change_dir.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  DirAccess_methods.get_current_dir.m_call = cast(type_of(DirAccess_methods.get_current_dir.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  DirAccess_methods.make_dir._make_dir = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.DirAccess, "make_dir", 166001499, loc))
  DirAccess_methods.make_dir.m_call = cast(type_of(DirAccess_methods.make_dir.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  DirAccess_methods.make_dir_absolute.m_call = cast(type_of(DirAccess_methods.make_dir_absolute.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  DirAccess_methods.make_dir_recursive.m_call = cast(type_of(DirAccess_methods.make_dir_recursive.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  DirAccess_methods.make_dir_recursive_absolute.m_call = cast(type_of(DirAccess_methods.make_dir_recursive_absolute.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  DirAccess_methods.file_exists.m_call = cast(type_of(DirAccess_methods.file_exists.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  DirAccess_methods.dir_exists.m_call = cast(type_of(DirAccess_methods.dir_exists.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  DirAccess_methods.dir_exists_absolute.m_call = cast(type_of(DirAccess_methods.dir_exists_absolute.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  DirAccess_methods.get_space_left.m_call = cast(type_of(DirAccess_methods.get_space_left.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  DirAccess_methods.copy._copy = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.DirAccess, "copy", 1063198817, loc))
  DirAccess_methods.copy.m_call = cast(type_of(DirAccess_methods.copy.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  DirAccess_methods.copy_absolute.m_call = cast(type_of(DirAccess_methods.copy_absolute.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  DirAccess_methods.rename._rename = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.DirAccess, "rename", 852856452, loc))
  DirAccess_methods.rename.m_call = cast(type_of(DirAccess_methods.rename.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  DirAccess_methods.rename_absolute.m_call = cast(type_of(DirAccess_methods.rename_absolute.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  DirAccess_methods.remove._remove = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.DirAccess, "remove", 166001499, loc))
  DirAccess_methods.remove.m_call = cast(type_of(DirAccess_methods.remove.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  DirAccess_methods.remove_absolute.m_call = cast(type_of(DirAccess_methods.remove_absolute.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  DirAccess_methods.is_link._is_link = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.DirAccess, "is_link", 2323990056, loc))
  DirAccess_methods.is_link.m_call = cast(type_of(DirAccess_methods.is_link.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  DirAccess_methods.read_link._read_link = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.DirAccess, "read_link", 1703090593, loc))
  DirAccess_methods.read_link.m_call = cast(type_of(DirAccess_methods.read_link.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  DirAccess_methods.create_link.m_call = cast(type_of(DirAccess_methods.create_link.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  DirAccess_methods.is_bundle._is_bundle = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.DirAccess, "is_bundle", 3927539163, loc))
  DirAccess_methods.is_bundle.m_call = cast(type_of(DirAccess_methods.is_bundle.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  DirAccess_methods.set_include_navigational.m_call = cast(type_of(DirAccess_methods.set_include_navigational.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  DirAccess_methods.get_include_navigational.m_call = cast(type_of(DirAccess_methods.get_include_navigational.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  DirAccess_methods.set_include_hidden.m_call = cast(type_of(DirAccess_methods.set_include_hidden.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  DirAccess_methods.get_include_hidden.m_call = cast(type_of(DirAccess_methods.get_include_hidden.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  DirAccess_methods.get_filesystem_type.m_call = cast(type_of(DirAccess_methods.get_filesystem_type.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  DirAccess_methods.is_case_sensitive.m_call = cast(type_of(DirAccess_methods.is_case_sensitive.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  DirAccess_methods.is_equivalent.m_call = cast(type_of(DirAccess_methods.is_equivalent.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
