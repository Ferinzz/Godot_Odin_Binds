...
Light3D_Init_ :: proc (Light3D_methods: ^Light3D_MethodBind_List, loc := #caller_location) {
  ...
  Light3D_methods.set_editor_only.m_call = cast(type_of(Light3D_methods.set_editor_only.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Light3D_methods.is_editor_only.m_call = cast(type_of(Light3D_methods.is_editor_only.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Light3D_methods.set_param._set_param = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Light3D, "set_param", 1722734213, loc))
  Light3D_methods.set_param.m_call = cast(type_of(Light3D_methods.set_param.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Light3D_methods.get_param._get_param = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Light3D, "get_param", 1844084987, loc))
  Light3D_methods.get_param.m_call = cast(type_of(Light3D_methods.get_param.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Light3D_methods.set_shadow._set_shadow = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Light3D, "set_shadow", 2586408642, loc))
  Light3D_methods.set_shadow.m_call = cast(type_of(Light3D_methods.set_shadow.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Light3D_methods.has_shadow._has_shadow = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Light3D, "has_shadow", 36873697, loc))
  Light3D_methods.has_shadow.m_call = cast(type_of(Light3D_methods.has_shadow.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Light3D_methods.set_negative.m_call = cast(type_of(Light3D_methods.set_negative.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Light3D_methods.is_negative._is_negative = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Light3D, "is_negative", 36873697, loc))
  Light3D_methods.is_negative.m_call = cast(type_of(Light3D_methods.is_negative.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Light3D_methods.set_cull_mask.m_call = cast(type_of(Light3D_methods.set_cull_mask.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Light3D_methods.get_cull_mask.m_call = cast(type_of(Light3D_methods.get_cull_mask.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Light3D_methods.set_enable_distance_fade.m_call = cast(type_of(Light3D_methods.set_enable_distance_fade.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Light3D_methods.is_distance_fade_enabled.m_call = cast(type_of(Light3D_methods.is_distance_fade_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Light3D_methods.set_distance_fade_begin.m_call = cast(type_of(Light3D_methods.set_distance_fade_begin.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Light3D_methods.get_distance_fade_begin.m_call = cast(type_of(Light3D_methods.get_distance_fade_begin.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Light3D_methods.set_distance_fade_shadow.m_call = cast(type_of(Light3D_methods.set_distance_fade_shadow.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Light3D_methods.get_distance_fade_shadow.m_call = cast(type_of(Light3D_methods.get_distance_fade_shadow.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Light3D_methods.set_distance_fade_length.m_call = cast(type_of(Light3D_methods.set_distance_fade_length.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Light3D_methods.get_distance_fade_length.m_call = cast(type_of(Light3D_methods.get_distance_fade_length.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Light3D_methods.set_color._set_color = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Light3D, "set_color", 2920490490, loc))
  Light3D_methods.set_color.m_call = cast(type_of(Light3D_methods.set_color.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Light3D_methods.get_color._get_color = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Light3D, "get_color", 3444240500, loc))
  Light3D_methods.get_color.m_call = cast(type_of(Light3D_methods.get_color.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Light3D_methods.set_shadow_reverse_cull_face.m_call = cast(type_of(Light3D_methods.set_shadow_reverse_cull_face.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Light3D_methods.get_shadow_reverse_cull_face.m_call = cast(type_of(Light3D_methods.get_shadow_reverse_cull_face.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Light3D_methods.set_shadow_caster_mask.m_call = cast(type_of(Light3D_methods.set_shadow_caster_mask.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Light3D_methods.get_shadow_caster_mask.m_call = cast(type_of(Light3D_methods.get_shadow_caster_mask.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Light3D_methods.set_bake_mode.m_call = cast(type_of(Light3D_methods.set_bake_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Light3D_methods.get_bake_mode.m_call = cast(type_of(Light3D_methods.get_bake_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Light3D_methods.set_projector.m_call = cast(type_of(Light3D_methods.set_projector.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Light3D_methods.get_projector.m_call = cast(type_of(Light3D_methods.get_projector.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Light3D_methods.set_temperature.m_call = cast(type_of(Light3D_methods.set_temperature.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Light3D_methods.get_temperature.m_call = cast(type_of(Light3D_methods.get_temperature.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Light3D_methods.get_correlated_color.m_call = cast(type_of(Light3D_methods.get_correlated_color.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
