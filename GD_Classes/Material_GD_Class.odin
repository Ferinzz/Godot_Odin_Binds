...
Material_Init_ :: proc (Material_methods: ^Material_MethodBind_List, loc := #caller_location) {
  ...
  Material_methods.set_next_pass.m_call = cast(type_of(Material_methods.set_next_pass.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Material_methods.get_next_pass.m_call = cast(type_of(Material_methods.get_next_pass.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Material_methods.set_render_priority.m_call = cast(type_of(Material_methods.set_render_priority.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Material_methods.get_render_priority.m_call = cast(type_of(Material_methods.get_render_priority.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Material_methods.inspect_native_shader_code.m_call = cast(type_of(Material_methods.inspect_native_shader_code.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Material_methods.create_placeholder.m_call = cast(type_of(Material_methods.create_placeholder.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
