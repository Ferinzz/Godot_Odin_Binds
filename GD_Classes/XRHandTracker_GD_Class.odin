...
HandTrackingSource_XRHandTracker :: enum i64 {
...
HandJoint_XRHandTracker :: enum i64 {
  HAND_JOINT_PALM = 0,
  HAND_JOINT_WRIST = 1,
...
HandJointFlags_XRHandTracker_Flags :: bit_set [HandJointFlags_XRHandTracker; i64]
HandJointFlags_XRHandTracker :: enum i64 {
...
XRHandTracker_MethodBind_List :: struct {
  ...
  set_hand_tracking_source: ^GDW.MethodBind,
  get_hand_tracking_source: ^GDW.MethodBind,
  set_hand_joint_flags: ^GDW.MethodBind,
  get_hand_joint_flags: ^GDW.MethodBind,
  set_hand_joint_transform: ^GDW.MethodBind,
  get_hand_joint_transform: ^GDW.MethodBind,
  set_hand_joint_radius: ^GDW.MethodBind,
  get_hand_joint_radius: ^GDW.MethodBind,
  set_hand_joint_linear_velocity: ^GDW.MethodBind,
  get_hand_joint_linear_velocity: ^GDW.MethodBind,
  set_hand_joint_angular_velocity: ^GDW.MethodBind,
...
XRHandTracker_Init_ :: proc (XRHandTracker_methods: ^XRHandTracker_MethodBind_List, loc := #caller_location) {
  XRHandTracker_methods.set_has_tracking_data = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.XRHandTracker, "set_has_tracking_data", 2586408642, loc))
  XRHandTracker_methods.get_has_tracking_data = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.XRHandTracker, "get_has_tracking_data", 36873697, loc))
  XRHandTracker_methods.set_hand_tracking_source = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.XRHandTracker, "set_hand_tracking_source", 2958308861, loc))
  XRHandTracker_methods.get_hand_tracking_source = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.XRHandTracker, "get_hand_tracking_source", 2475045250, loc))
  XRHandTracker_methods.set_hand_joint_flags = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.XRHandTracker, "set_hand_joint_flags", 3028437365, loc))
  XRHandTracker_methods.get_hand_joint_flags = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.XRHandTracker, "get_hand_joint_flags", 1730972401, loc))
  XRHandTracker_methods.set_hand_joint_transform = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.XRHandTracker, "set_hand_joint_transform", 2529959613, loc))
  XRHandTracker_methods.get_hand_joint_transform = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.XRHandTracker, "get_hand_joint_transform", 1090840196, loc))
  XRHandTracker_methods.set_hand_joint_radius = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.XRHandTracker, "set_hand_joint_radius", 2723659615, loc))
  XRHandTracker_methods.get_hand_joint_radius = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.XRHandTracker, "get_hand_joint_radius", 3400025734, loc))
  XRHandTracker_methods.set_hand_joint_linear_velocity = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.XRHandTracker, "set_hand_joint_linear_velocity", 1978646737, loc))
  XRHandTracker_methods.get_hand_joint_linear_velocity = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.XRHandTracker, "get_hand_joint_linear_velocity", 547240792, loc))
  XRHandTracker_methods.set_hand_joint_angular_velocity = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.XRHandTracker, "set_hand_joint_angular_velocity", 1978646737, loc))
  XRHandTracker_methods.get_hand_joint_angular_velocity = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.XRHandTracker, "get_hand_joint_angular_velocity", 547240792, loc))
};
