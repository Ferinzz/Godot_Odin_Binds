...
VisualShaderNodeBooleanConstant_Init_ :: proc (VisualShaderNodeBooleanConstant_methods: ^VisualShaderNodeBooleanConstant_MethodBind_List, loc := #caller_location) {
  VisualShaderNodeBooleanConstant_methods.set_constant = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.VisualShaderNodeBooleanConstant, "set_constant", 2586408642, loc))
  VisualShaderNodeBooleanConstant_methods.get_constant = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.VisualShaderNodeBooleanConstant, "get_constant", 36873697, loc))
};
