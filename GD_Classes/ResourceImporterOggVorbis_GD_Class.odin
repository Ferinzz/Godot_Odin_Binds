...
ResourceImporterOggVorbis_Init_ :: proc (ResourceImporterOggVorbis_methods: ^ResourceImporterOggVorbis_MethodBind_List, loc := #caller_location) {
  ...
  ResourceImporterOggVorbis_methods.load_from_buffer.m_call = cast(type_of(ResourceImporterOggVorbis_methods.load_from_buffer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ResourceImporterOggVorbis_methods.load_from_file.m_call = cast(type_of(ResourceImporterOggVorbis_methods.load_from_file.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
