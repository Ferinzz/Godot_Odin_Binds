...
Marker3D_MethodBind_List :: struct {
  set_gizmo_extents: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: Marker3D, #by_ptr args: i64 = 0, r_ret: ^GDW.float)
  },
};
Marker3D_Init_ :: proc (Marker3D_methods: ^Marker3D_MethodBind_List, loc := #caller_location) {
  ...
  Marker3D_methods.set_gizmo_extents.m_call = cast(type_of(Marker3D_methods.set_gizmo_extents.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Marker3D_methods.get_gizmo_extents.m_call = cast(type_of(Marker3D_methods.get_gizmo_extents.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
