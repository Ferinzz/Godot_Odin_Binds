...
PCKPacker_Init_ :: proc (PCKPacker_methods: ^PCKPacker_MethodBind_List, loc := #caller_location) {
  ...
  PCKPacker_methods.pck_start.m_call = cast(type_of(PCKPacker_methods.pck_start.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  PCKPacker_methods.add_file._add_file = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.PCKPacker, "add_file", 2215643711, loc))
  PCKPacker_methods.add_file.m_call = cast(type_of(PCKPacker_methods.add_file.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PCKPacker_methods.add_file_removal.m_call = cast(type_of(PCKPacker_methods.add_file_removal.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  PCKPacker_methods.flush._flush = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.PCKPacker, "flush", 1633102583, loc))
  PCKPacker_methods.flush.m_call = cast(type_of(PCKPacker_methods.flush.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
