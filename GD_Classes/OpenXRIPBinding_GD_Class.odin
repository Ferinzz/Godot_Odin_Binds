...
OpenXRIPBinding_Init_ :: proc (OpenXRIPBinding_methods: ^OpenXRIPBinding_MethodBind_List, loc := #caller_location) {
  ...
  OpenXRIPBinding_methods.set_action.m_call = cast(type_of(OpenXRIPBinding_methods.set_action.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRIPBinding_methods.get_action.m_call = cast(type_of(OpenXRIPBinding_methods.get_action.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRIPBinding_methods.set_binding_path.m_call = cast(type_of(OpenXRIPBinding_methods.set_binding_path.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRIPBinding_methods.get_binding_path.m_call = cast(type_of(OpenXRIPBinding_methods.get_binding_path.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRIPBinding_methods.get_binding_modifier_count.m_call = cast(type_of(OpenXRIPBinding_methods.get_binding_modifier_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRIPBinding_methods.get_binding_modifier.m_call = cast(type_of(OpenXRIPBinding_methods.get_binding_modifier.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRIPBinding_methods.set_binding_modifiers.m_call = cast(type_of(OpenXRIPBinding_methods.set_binding_modifiers.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRIPBinding_methods.get_binding_modifiers.m_call = cast(type_of(OpenXRIPBinding_methods.get_binding_modifiers.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRIPBinding_methods.set_paths.m_call = cast(type_of(OpenXRIPBinding_methods.set_paths.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRIPBinding_methods.get_paths.m_call = cast(type_of(OpenXRIPBinding_methods.get_paths.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRIPBinding_methods.get_path_count.m_call = cast(type_of(OpenXRIPBinding_methods.get_path_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRIPBinding_methods.has_path.m_call = cast(type_of(OpenXRIPBinding_methods.has_path.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRIPBinding_methods.add_path.m_call = cast(type_of(OpenXRIPBinding_methods.add_path.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRIPBinding_methods.remove_path.m_call = cast(type_of(OpenXRIPBinding_methods.remove_path.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
