...
SkeletonModification2DLookAt_Init_ :: proc (SkeletonModification2DLookAt_methods: ^SkeletonModification2DLookAt_MethodBind_List, loc := #caller_location) {
  ...
  SkeletonModification2DLookAt_methods.set_bone2d_node.m_call = cast(type_of(SkeletonModification2DLookAt_methods.set_bone2d_node.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DLookAt_methods.get_bone2d_node.m_call = cast(type_of(SkeletonModification2DLookAt_methods.get_bone2d_node.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DLookAt_methods.set_bone_index.m_call = cast(type_of(SkeletonModification2DLookAt_methods.set_bone_index.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DLookAt_methods.get_bone_index.m_call = cast(type_of(SkeletonModification2DLookAt_methods.get_bone_index.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DLookAt_methods.set_target_node.m_call = cast(type_of(SkeletonModification2DLookAt_methods.set_target_node.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DLookAt_methods.get_target_node.m_call = cast(type_of(SkeletonModification2DLookAt_methods.get_target_node.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DLookAt_methods.set_additional_rotation.m_call = cast(type_of(SkeletonModification2DLookAt_methods.set_additional_rotation.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DLookAt_methods.get_additional_rotation.m_call = cast(type_of(SkeletonModification2DLookAt_methods.get_additional_rotation.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DLookAt_methods.set_enable_constraint.m_call = cast(type_of(SkeletonModification2DLookAt_methods.set_enable_constraint.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DLookAt_methods.get_enable_constraint.m_call = cast(type_of(SkeletonModification2DLookAt_methods.get_enable_constraint.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DLookAt_methods.set_constraint_angle_min.m_call = cast(type_of(SkeletonModification2DLookAt_methods.set_constraint_angle_min.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DLookAt_methods.get_constraint_angle_min.m_call = cast(type_of(SkeletonModification2DLookAt_methods.get_constraint_angle_min.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DLookAt_methods.set_constraint_angle_max.m_call = cast(type_of(SkeletonModification2DLookAt_methods.set_constraint_angle_max.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DLookAt_methods.get_constraint_angle_max.m_call = cast(type_of(SkeletonModification2DLookAt_methods.get_constraint_angle_max.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DLookAt_methods.set_constraint_angle_invert.m_call = cast(type_of(SkeletonModification2DLookAt_methods.set_constraint_angle_invert.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DLookAt_methods.get_constraint_angle_invert.m_call = cast(type_of(SkeletonModification2DLookAt_methods.get_constraint_angle_invert.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
