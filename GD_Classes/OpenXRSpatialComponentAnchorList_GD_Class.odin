...
OpenXRSpatialComponentAnchorList_MethodBind_List :: struct {
  get_entity_pose: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: OpenXRSpatialComponentAnchorList, #by_ptr args: struct{index: ^GDW.Int, }, r_ret: ^GDW.Transform3D)
  },
};
OpenXRSpatialComponentAnchorList_Init_ :: proc (OpenXRSpatialComponentAnchorList_methods: ^OpenXRSpatialComponentAnchorList_MethodBind_List, loc := #caller_location) {
  ...
  OpenXRSpatialComponentAnchorList_methods.get_entity_pose._get_entity_pose = (cast(^GDW.MethodBind)classDBGetMethodBind3(.OpenXRSpatialComponentAnchorList, "get_entity_pose", 1965739696, loc))
