...
Noise_Init_ :: proc (Noise_methods: ^Noise_MethodBind_List, loc := #caller_location) {
  ...
  Noise_methods.get_noise_1d.m_call = cast(type_of(Noise_methods.get_noise_1d.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Noise_methods.get_noise_2d._get_noise_2d = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Noise, "get_noise_2d", 2753205203, loc))
  Noise_methods.get_noise_2d.m_call = cast(type_of(Noise_methods.get_noise_2d.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Noise_methods.get_noise_2dv.m_call = cast(type_of(Noise_methods.get_noise_2dv.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Noise_methods.get_noise_3d._get_noise_3d = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Noise, "get_noise_3d", 973811851, loc))
  Noise_methods.get_noise_3d.m_call = cast(type_of(Noise_methods.get_noise_3d.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Noise_methods.get_noise_3dv.m_call = cast(type_of(Noise_methods.get_noise_3dv.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Noise_methods.get_image._get_image = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Noise, "get_image", 3180683109, loc))
  Noise_methods.get_image.m_call = cast(type_of(Noise_methods.get_image.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Noise_methods.get_seamless_image.m_call = cast(type_of(Noise_methods.get_seamless_image.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Noise_methods.get_image_3d._get_image_3d = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Noise, "get_image_3d", 3977814329, loc))
  Noise_methods.get_image_3d.m_call = cast(type_of(Noise_methods.get_image_3d.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Noise_methods.get_seamless_image_3d.m_call = cast(type_of(Noise_methods.get_seamless_image_3d.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
