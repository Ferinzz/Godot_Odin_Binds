...
OptionButton_Init_ :: proc (OptionButton_methods: ^OptionButton_MethodBind_List, loc := #caller_location) {
  ...
  OptionButton_methods.add_item.m_call = cast(type_of(OptionButton_methods.add_item.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OptionButton_methods.add_icon_item.m_call = cast(type_of(OptionButton_methods.add_icon_item.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OptionButton_methods.set_item_text.m_call = cast(type_of(OptionButton_methods.set_item_text.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OptionButton_methods.set_item_icon.m_call = cast(type_of(OptionButton_methods.set_item_icon.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OptionButton_methods.set_item_disabled.m_call = cast(type_of(OptionButton_methods.set_item_disabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OptionButton_methods.set_item_id.m_call = cast(type_of(OptionButton_methods.set_item_id.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OptionButton_methods.set_item_metadata.m_call = cast(type_of(OptionButton_methods.set_item_metadata.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OptionButton_methods.set_item_tooltip.m_call = cast(type_of(OptionButton_methods.set_item_tooltip.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OptionButton_methods.set_item_auto_translate_mode.m_call = cast(type_of(OptionButton_methods.set_item_auto_translate_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OptionButton_methods.get_item_text.m_call = cast(type_of(OptionButton_methods.get_item_text.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OptionButton_methods.get_item_icon.m_call = cast(type_of(OptionButton_methods.get_item_icon.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OptionButton_methods.get_item_id.m_call = cast(type_of(OptionButton_methods.get_item_id.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OptionButton_methods.get_item_index.m_call = cast(type_of(OptionButton_methods.get_item_index.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OptionButton_methods.get_item_metadata.m_call = cast(type_of(OptionButton_methods.get_item_metadata.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OptionButton_methods.get_item_tooltip.m_call = cast(type_of(OptionButton_methods.get_item_tooltip.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OptionButton_methods.get_item_auto_translate_mode.m_call = cast(type_of(OptionButton_methods.get_item_auto_translate_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OptionButton_methods.is_item_disabled.m_call = cast(type_of(OptionButton_methods.is_item_disabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OptionButton_methods.is_item_separator.m_call = cast(type_of(OptionButton_methods.is_item_separator.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OptionButton_methods.add_separator.m_call = cast(type_of(OptionButton_methods.add_separator.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  OptionButton_methods.clear._clear = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.OptionButton, "clear", 3218959716, loc))
  OptionButton_methods.clear.m_call = cast(type_of(OptionButton_methods.clear.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  OptionButton_methods.select._select = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.OptionButton, "select", 1286410249, loc))
  OptionButton_methods.select.m_call = cast(type_of(OptionButton_methods.select.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OptionButton_methods.get_selected.m_call = cast(type_of(OptionButton_methods.get_selected.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OptionButton_methods.get_selected_id.m_call = cast(type_of(OptionButton_methods.get_selected_id.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OptionButton_methods.get_selected_metadata.m_call = cast(type_of(OptionButton_methods.get_selected_metadata.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OptionButton_methods.remove_item.m_call = cast(type_of(OptionButton_methods.remove_item.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OptionButton_methods.get_popup.m_call = cast(type_of(OptionButton_methods.get_popup.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OptionButton_methods.show_popup.m_call = cast(type_of(OptionButton_methods.show_popup.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OptionButton_methods.set_item_count.m_call = cast(type_of(OptionButton_methods.set_item_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OptionButton_methods.get_item_count.m_call = cast(type_of(OptionButton_methods.get_item_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OptionButton_methods.has_selectable_items.m_call = cast(type_of(OptionButton_methods.has_selectable_items.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OptionButton_methods.get_selectable_item.m_call = cast(type_of(OptionButton_methods.get_selectable_item.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OptionButton_methods.set_fit_to_longest_item.m_call = cast(type_of(OptionButton_methods.set_fit_to_longest_item.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OptionButton_methods.is_fit_to_longest_item.m_call = cast(type_of(OptionButton_methods.is_fit_to_longest_item.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OptionButton_methods.set_allow_reselect.m_call = cast(type_of(OptionButton_methods.set_allow_reselect.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OptionButton_methods.get_allow_reselect.m_call = cast(type_of(OptionButton_methods.get_allow_reselect.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OptionButton_methods.set_disable_shortcuts.m_call = cast(type_of(OptionButton_methods.set_disable_shortcuts.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
