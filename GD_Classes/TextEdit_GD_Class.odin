...
TextEdit_Init_ :: proc (TextEdit_methods: ^TextEdit_MethodBind_List, loc := #caller_location) {
  ...
  TextEdit_methods.has_ime_text.m_call = cast(type_of(TextEdit_methods.has_ime_text.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  TextEdit_methods.cancel_ime._cancel_ime = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TextEdit, "cancel_ime", 3218959716, loc))
  TextEdit_methods.cancel_ime.m_call = cast(type_of(TextEdit_methods.cancel_ime.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  TextEdit_methods.apply_ime._apply_ime = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TextEdit, "apply_ime", 3218959716, loc))
  TextEdit_methods.apply_ime.m_call = cast(type_of(TextEdit_methods.apply_ime.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_editable.m_call = cast(type_of(TextEdit_methods.set_editable.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.is_editable.m_call = cast(type_of(TextEdit_methods.is_editable.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_text_direction.m_call = cast(type_of(TextEdit_methods.set_text_direction.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_text_direction.m_call = cast(type_of(TextEdit_methods.get_text_direction.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_language.m_call = cast(type_of(TextEdit_methods.set_language.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_language.m_call = cast(type_of(TextEdit_methods.get_language.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_structured_text_bidi_override.m_call = cast(type_of(TextEdit_methods.set_structured_text_bidi_override.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_structured_text_bidi_override.m_call = cast(type_of(TextEdit_methods.get_structured_text_bidi_override.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_structured_text_bidi_override_options.m_call = cast(type_of(TextEdit_methods.set_structured_text_bidi_override_options.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_structured_text_bidi_override_options.m_call = cast(type_of(TextEdit_methods.get_structured_text_bidi_override_options.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_tab_size.m_call = cast(type_of(TextEdit_methods.set_tab_size.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_tab_size.m_call = cast(type_of(TextEdit_methods.get_tab_size.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_indent_wrapped_lines.m_call = cast(type_of(TextEdit_methods.set_indent_wrapped_lines.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.is_indent_wrapped_lines.m_call = cast(type_of(TextEdit_methods.is_indent_wrapped_lines.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_tab_input_mode.m_call = cast(type_of(TextEdit_methods.set_tab_input_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_tab_input_mode.m_call = cast(type_of(TextEdit_methods.get_tab_input_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_overtype_mode_enabled.m_call = cast(type_of(TextEdit_methods.set_overtype_mode_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.is_overtype_mode_enabled.m_call = cast(type_of(TextEdit_methods.is_overtype_mode_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_context_menu_enabled.m_call = cast(type_of(TextEdit_methods.set_context_menu_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.is_context_menu_enabled.m_call = cast(type_of(TextEdit_methods.is_context_menu_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_emoji_menu_enabled.m_call = cast(type_of(TextEdit_methods.set_emoji_menu_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.is_emoji_menu_enabled.m_call = cast(type_of(TextEdit_methods.is_emoji_menu_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_backspace_deletes_composite_character_enabled.m_call = cast(type_of(TextEdit_methods.set_backspace_deletes_composite_character_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.is_backspace_deletes_composite_character_enabled.m_call = cast(type_of(TextEdit_methods.is_backspace_deletes_composite_character_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_shortcut_keys_enabled.m_call = cast(type_of(TextEdit_methods.set_shortcut_keys_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.is_shortcut_keys_enabled.m_call = cast(type_of(TextEdit_methods.is_shortcut_keys_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_virtual_keyboard_enabled.m_call = cast(type_of(TextEdit_methods.set_virtual_keyboard_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.is_virtual_keyboard_enabled.m_call = cast(type_of(TextEdit_methods.is_virtual_keyboard_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_virtual_keyboard_show_on_focus.m_call = cast(type_of(TextEdit_methods.set_virtual_keyboard_show_on_focus.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_virtual_keyboard_show_on_focus.m_call = cast(type_of(TextEdit_methods.get_virtual_keyboard_show_on_focus.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_middle_mouse_paste_enabled.m_call = cast(type_of(TextEdit_methods.set_middle_mouse_paste_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.is_middle_mouse_paste_enabled.m_call = cast(type_of(TextEdit_methods.is_middle_mouse_paste_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_empty_selection_clipboard_enabled.m_call = cast(type_of(TextEdit_methods.set_empty_selection_clipboard_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.is_empty_selection_clipboard_enabled.m_call = cast(type_of(TextEdit_methods.is_empty_selection_clipboard_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  TextEdit_methods.clear._clear = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TextEdit, "clear", 3218959716, loc))
  TextEdit_methods.clear.m_call = cast(type_of(TextEdit_methods.clear.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  TextEdit_methods.set_text._set_text = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TextEdit, "set_text", 83702148, loc))
  TextEdit_methods.set_text.m_call = cast(type_of(TextEdit_methods.set_text.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  TextEdit_methods.get_text._get_text = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TextEdit, "get_text", 201670096, loc))
  TextEdit_methods.get_text.m_call = cast(type_of(TextEdit_methods.get_text.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_line_count.m_call = cast(type_of(TextEdit_methods.get_line_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_placeholder.m_call = cast(type_of(TextEdit_methods.set_placeholder.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_placeholder.m_call = cast(type_of(TextEdit_methods.get_placeholder.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  TextEdit_methods.set_line._set_line = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TextEdit, "set_line", 501894301, loc))
  TextEdit_methods.set_line.m_call = cast(type_of(TextEdit_methods.set_line.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  TextEdit_methods.get_line._get_line = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TextEdit, "get_line", 844755477, loc))
  TextEdit_methods.get_line.m_call = cast(type_of(TextEdit_methods.get_line.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_line_with_ime.m_call = cast(type_of(TextEdit_methods.get_line_with_ime.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_line_width.m_call = cast(type_of(TextEdit_methods.get_line_width.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_line_height.m_call = cast(type_of(TextEdit_methods.get_line_height.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_indent_level.m_call = cast(type_of(TextEdit_methods.get_indent_level.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_first_non_whitespace_column.m_call = cast(type_of(TextEdit_methods.get_first_non_whitespace_column.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  TextEdit_methods.swap_lines._swap_lines = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TextEdit, "swap_lines", 3937882851, loc))
  TextEdit_methods.swap_lines.m_call = cast(type_of(TextEdit_methods.swap_lines.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.insert_line_at.m_call = cast(type_of(TextEdit_methods.insert_line_at.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.remove_line_at.m_call = cast(type_of(TextEdit_methods.remove_line_at.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.insert_text_at_caret.m_call = cast(type_of(TextEdit_methods.insert_text_at_caret.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.insert_text.m_call = cast(type_of(TextEdit_methods.insert_text.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.remove_text.m_call = cast(type_of(TextEdit_methods.remove_text.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_last_unhidden_line.m_call = cast(type_of(TextEdit_methods.get_last_unhidden_line.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_next_visible_line_offset_from.m_call = cast(type_of(TextEdit_methods.get_next_visible_line_offset_from.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_next_visible_line_index_offset_from.m_call = cast(type_of(TextEdit_methods.get_next_visible_line_index_offset_from.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  TextEdit_methods.backspace._backspace = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TextEdit, "backspace", 1025054187, loc))
  TextEdit_methods.backspace.m_call = cast(type_of(TextEdit_methods.backspace.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  TextEdit_methods.cut._cut = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TextEdit, "cut", 1025054187, loc))
  TextEdit_methods.cut.m_call = cast(type_of(TextEdit_methods.cut.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  TextEdit_methods.copy._copy = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TextEdit, "copy", 1025054187, loc))
  TextEdit_methods.copy.m_call = cast(type_of(TextEdit_methods.copy.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  TextEdit_methods.paste._paste = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TextEdit, "paste", 1025054187, loc))
  TextEdit_methods.paste.m_call = cast(type_of(TextEdit_methods.paste.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.paste_primary_clipboard.m_call = cast(type_of(TextEdit_methods.paste_primary_clipboard.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.start_action.m_call = cast(type_of(TextEdit_methods.start_action.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  TextEdit_methods.end_action._end_action = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TextEdit, "end_action", 3218959716, loc))
  TextEdit_methods.end_action.m_call = cast(type_of(TextEdit_methods.end_action.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.begin_complex_operation.m_call = cast(type_of(TextEdit_methods.begin_complex_operation.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.end_complex_operation.m_call = cast(type_of(TextEdit_methods.end_complex_operation.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  TextEdit_methods.has_undo._has_undo = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TextEdit, "has_undo", 36873697, loc))
  TextEdit_methods.has_undo.m_call = cast(type_of(TextEdit_methods.has_undo.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  TextEdit_methods.has_redo._has_redo = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TextEdit, "has_redo", 36873697, loc))
  TextEdit_methods.has_redo.m_call = cast(type_of(TextEdit_methods.has_redo.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  TextEdit_methods.undo._undo = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TextEdit, "undo", 3218959716, loc))
  TextEdit_methods.undo.m_call = cast(type_of(TextEdit_methods.undo.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  TextEdit_methods.redo._redo = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TextEdit, "redo", 3218959716, loc))
  TextEdit_methods.redo.m_call = cast(type_of(TextEdit_methods.redo.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.clear_undo_history.m_call = cast(type_of(TextEdit_methods.clear_undo_history.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.tag_saved_version.m_call = cast(type_of(TextEdit_methods.tag_saved_version.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_version.m_call = cast(type_of(TextEdit_methods.get_version.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_saved_version.m_call = cast(type_of(TextEdit_methods.get_saved_version.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_search_text.m_call = cast(type_of(TextEdit_methods.set_search_text.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_search_flags.m_call = cast(type_of(TextEdit_methods.set_search_flags.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  TextEdit_methods.search._search = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TextEdit, "search", 1203739136, loc))
  TextEdit_methods.search.m_call = cast(type_of(TextEdit_methods.search.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_tooltip_request_func.m_call = cast(type_of(TextEdit_methods.set_tooltip_request_func.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_local_mouse_pos.m_call = cast(type_of(TextEdit_methods.get_local_mouse_pos.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_word_at_pos.m_call = cast(type_of(TextEdit_methods.get_word_at_pos.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_line_column_at_pos.m_call = cast(type_of(TextEdit_methods.get_line_column_at_pos.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_pos_at_line_column.m_call = cast(type_of(TextEdit_methods.get_pos_at_line_column.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_rect_at_line_column.m_call = cast(type_of(TextEdit_methods.get_rect_at_line_column.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_minimap_line_at_pos.m_call = cast(type_of(TextEdit_methods.get_minimap_line_at_pos.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.is_dragging_cursor.m_call = cast(type_of(TextEdit_methods.is_dragging_cursor.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.is_mouse_over_selection.m_call = cast(type_of(TextEdit_methods.is_mouse_over_selection.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_caret_type.m_call = cast(type_of(TextEdit_methods.set_caret_type.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_caret_type.m_call = cast(type_of(TextEdit_methods.get_caret_type.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_caret_blink_enabled.m_call = cast(type_of(TextEdit_methods.set_caret_blink_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.is_caret_blink_enabled.m_call = cast(type_of(TextEdit_methods.is_caret_blink_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_caret_blink_interval.m_call = cast(type_of(TextEdit_methods.set_caret_blink_interval.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_caret_blink_interval.m_call = cast(type_of(TextEdit_methods.get_caret_blink_interval.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_draw_caret_when_editable_disabled.m_call = cast(type_of(TextEdit_methods.set_draw_caret_when_editable_disabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.is_drawing_caret_when_editable_disabled.m_call = cast(type_of(TextEdit_methods.is_drawing_caret_when_editable_disabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_move_caret_on_right_click_enabled.m_call = cast(type_of(TextEdit_methods.set_move_caret_on_right_click_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.is_move_caret_on_right_click_enabled.m_call = cast(type_of(TextEdit_methods.is_move_caret_on_right_click_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_caret_mid_grapheme_enabled.m_call = cast(type_of(TextEdit_methods.set_caret_mid_grapheme_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.is_caret_mid_grapheme_enabled.m_call = cast(type_of(TextEdit_methods.is_caret_mid_grapheme_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_multiple_carets_enabled.m_call = cast(type_of(TextEdit_methods.set_multiple_carets_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.is_multiple_carets_enabled.m_call = cast(type_of(TextEdit_methods.is_multiple_carets_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  TextEdit_methods.add_caret._add_caret = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TextEdit, "add_caret", 50157827, loc))
  TextEdit_methods.add_caret.m_call = cast(type_of(TextEdit_methods.add_caret.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.remove_caret.m_call = cast(type_of(TextEdit_methods.remove_caret.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.remove_secondary_carets.m_call = cast(type_of(TextEdit_methods.remove_secondary_carets.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_caret_count.m_call = cast(type_of(TextEdit_methods.get_caret_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.add_caret_at_carets.m_call = cast(type_of(TextEdit_methods.add_caret_at_carets.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_sorted_carets.m_call = cast(type_of(TextEdit_methods.get_sorted_carets.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.collapse_carets.m_call = cast(type_of(TextEdit_methods.collapse_carets.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.merge_overlapping_carets.m_call = cast(type_of(TextEdit_methods.merge_overlapping_carets.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.begin_multicaret_edit.m_call = cast(type_of(TextEdit_methods.begin_multicaret_edit.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.end_multicaret_edit.m_call = cast(type_of(TextEdit_methods.end_multicaret_edit.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.is_in_mulitcaret_edit.m_call = cast(type_of(TextEdit_methods.is_in_mulitcaret_edit.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.multicaret_edit_ignore_caret.m_call = cast(type_of(TextEdit_methods.multicaret_edit_ignore_caret.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.is_caret_visible.m_call = cast(type_of(TextEdit_methods.is_caret_visible.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_caret_draw_pos.m_call = cast(type_of(TextEdit_methods.get_caret_draw_pos.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_caret_line.m_call = cast(type_of(TextEdit_methods.set_caret_line.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_caret_line.m_call = cast(type_of(TextEdit_methods.get_caret_line.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_caret_column.m_call = cast(type_of(TextEdit_methods.set_caret_column.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_caret_column.m_call = cast(type_of(TextEdit_methods.get_caret_column.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_next_composite_character_column.m_call = cast(type_of(TextEdit_methods.get_next_composite_character_column.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_previous_composite_character_column.m_call = cast(type_of(TextEdit_methods.get_previous_composite_character_column.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_caret_wrap_index.m_call = cast(type_of(TextEdit_methods.get_caret_wrap_index.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_word_under_caret.m_call = cast(type_of(TextEdit_methods.get_word_under_caret.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_use_default_word_separators.m_call = cast(type_of(TextEdit_methods.set_use_default_word_separators.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.is_default_word_separators_enabled.m_call = cast(type_of(TextEdit_methods.is_default_word_separators_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_use_custom_word_separators.m_call = cast(type_of(TextEdit_methods.set_use_custom_word_separators.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.is_custom_word_separators_enabled.m_call = cast(type_of(TextEdit_methods.is_custom_word_separators_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_custom_word_separators.m_call = cast(type_of(TextEdit_methods.set_custom_word_separators.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_custom_word_separators.m_call = cast(type_of(TextEdit_methods.get_custom_word_separators.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_selecting_enabled.m_call = cast(type_of(TextEdit_methods.set_selecting_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.is_selecting_enabled.m_call = cast(type_of(TextEdit_methods.is_selecting_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_deselect_on_focus_loss_enabled.m_call = cast(type_of(TextEdit_methods.set_deselect_on_focus_loss_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.is_deselect_on_focus_loss_enabled.m_call = cast(type_of(TextEdit_methods.is_deselect_on_focus_loss_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_drag_and_drop_selection_enabled.m_call = cast(type_of(TextEdit_methods.set_drag_and_drop_selection_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.is_drag_and_drop_selection_enabled.m_call = cast(type_of(TextEdit_methods.is_drag_and_drop_selection_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_selection_mode.m_call = cast(type_of(TextEdit_methods.set_selection_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_selection_mode.m_call = cast(type_of(TextEdit_methods.get_selection_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  TextEdit_methods.select_all._select_all = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TextEdit, "select_all", 3218959716, loc))
  TextEdit_methods.select_all.m_call = cast(type_of(TextEdit_methods.select_all.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.select_word_under_caret.m_call = cast(type_of(TextEdit_methods.select_word_under_caret.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.add_selection_for_next_occurrence.m_call = cast(type_of(TextEdit_methods.add_selection_for_next_occurrence.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.skip_selection_for_next_occurrence.m_call = cast(type_of(TextEdit_methods.skip_selection_for_next_occurrence.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  TextEdit_methods.select._select = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TextEdit, "select", 2560984452, loc))
  TextEdit_methods.select.m_call = cast(type_of(TextEdit_methods.select.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.has_selection.m_call = cast(type_of(TextEdit_methods.has_selection.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_selected_text.m_call = cast(type_of(TextEdit_methods.get_selected_text.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_selection_at_line_column.m_call = cast(type_of(TextEdit_methods.get_selection_at_line_column.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_line_ranges_from_carets.m_call = cast(type_of(TextEdit_methods.get_line_ranges_from_carets.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_selection_origin_line.m_call = cast(type_of(TextEdit_methods.get_selection_origin_line.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_selection_origin_column.m_call = cast(type_of(TextEdit_methods.get_selection_origin_column.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_selection_origin_line.m_call = cast(type_of(TextEdit_methods.set_selection_origin_line.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_selection_origin_column.m_call = cast(type_of(TextEdit_methods.set_selection_origin_column.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_selection_from_line.m_call = cast(type_of(TextEdit_methods.get_selection_from_line.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_selection_from_column.m_call = cast(type_of(TextEdit_methods.get_selection_from_column.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_selection_to_line.m_call = cast(type_of(TextEdit_methods.get_selection_to_line.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_selection_to_column.m_call = cast(type_of(TextEdit_methods.get_selection_to_column.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.is_caret_after_selection_origin.m_call = cast(type_of(TextEdit_methods.is_caret_after_selection_origin.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  TextEdit_methods.deselect._deselect = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TextEdit, "deselect", 1025054187, loc))
  TextEdit_methods.deselect.m_call = cast(type_of(TextEdit_methods.deselect.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.delete_selection.m_call = cast(type_of(TextEdit_methods.delete_selection.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_line_wrapping_mode.m_call = cast(type_of(TextEdit_methods.set_line_wrapping_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_line_wrapping_mode.m_call = cast(type_of(TextEdit_methods.get_line_wrapping_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_autowrap_mode.m_call = cast(type_of(TextEdit_methods.set_autowrap_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_autowrap_mode.m_call = cast(type_of(TextEdit_methods.get_autowrap_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.is_line_wrapped.m_call = cast(type_of(TextEdit_methods.is_line_wrapped.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_line_wrap_count.m_call = cast(type_of(TextEdit_methods.get_line_wrap_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_line_wrap_index_at_column.m_call = cast(type_of(TextEdit_methods.get_line_wrap_index_at_column.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_line_wrapped_text.m_call = cast(type_of(TextEdit_methods.get_line_wrapped_text.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_smooth_scroll_enabled.m_call = cast(type_of(TextEdit_methods.set_smooth_scroll_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.is_smooth_scroll_enabled.m_call = cast(type_of(TextEdit_methods.is_smooth_scroll_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_v_scroll_bar.m_call = cast(type_of(TextEdit_methods.get_v_scroll_bar.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_h_scroll_bar.m_call = cast(type_of(TextEdit_methods.get_h_scroll_bar.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_v_scroll.m_call = cast(type_of(TextEdit_methods.set_v_scroll.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_v_scroll.m_call = cast(type_of(TextEdit_methods.get_v_scroll.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_h_scroll.m_call = cast(type_of(TextEdit_methods.set_h_scroll.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_h_scroll.m_call = cast(type_of(TextEdit_methods.get_h_scroll.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_scroll_past_end_of_file_enabled.m_call = cast(type_of(TextEdit_methods.set_scroll_past_end_of_file_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.is_scroll_past_end_of_file_enabled.m_call = cast(type_of(TextEdit_methods.is_scroll_past_end_of_file_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_v_scroll_speed.m_call = cast(type_of(TextEdit_methods.set_v_scroll_speed.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_v_scroll_speed.m_call = cast(type_of(TextEdit_methods.get_v_scroll_speed.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_fit_content_height_enabled.m_call = cast(type_of(TextEdit_methods.set_fit_content_height_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.is_fit_content_height_enabled.m_call = cast(type_of(TextEdit_methods.is_fit_content_height_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_fit_content_width_enabled.m_call = cast(type_of(TextEdit_methods.set_fit_content_width_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.is_fit_content_width_enabled.m_call = cast(type_of(TextEdit_methods.is_fit_content_width_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_scroll_pos_for_line.m_call = cast(type_of(TextEdit_methods.get_scroll_pos_for_line.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_line_as_first_visible.m_call = cast(type_of(TextEdit_methods.set_line_as_first_visible.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_first_visible_line.m_call = cast(type_of(TextEdit_methods.get_first_visible_line.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_line_as_center_visible.m_call = cast(type_of(TextEdit_methods.set_line_as_center_visible.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_line_as_last_visible.m_call = cast(type_of(TextEdit_methods.set_line_as_last_visible.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_last_full_visible_line.m_call = cast(type_of(TextEdit_methods.get_last_full_visible_line.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_last_full_visible_line_wrap_index.m_call = cast(type_of(TextEdit_methods.get_last_full_visible_line_wrap_index.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_visible_line_count.m_call = cast(type_of(TextEdit_methods.get_visible_line_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_visible_line_count_in_range.m_call = cast(type_of(TextEdit_methods.get_visible_line_count_in_range.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_total_visible_line_count.m_call = cast(type_of(TextEdit_methods.get_total_visible_line_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.adjust_viewport_to_caret.m_call = cast(type_of(TextEdit_methods.adjust_viewport_to_caret.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.center_viewport_to_caret.m_call = cast(type_of(TextEdit_methods.center_viewport_to_caret.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_draw_minimap.m_call = cast(type_of(TextEdit_methods.set_draw_minimap.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.is_drawing_minimap.m_call = cast(type_of(TextEdit_methods.is_drawing_minimap.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_minimap_width.m_call = cast(type_of(TextEdit_methods.set_minimap_width.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_minimap_width.m_call = cast(type_of(TextEdit_methods.get_minimap_width.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_minimap_visible_lines.m_call = cast(type_of(TextEdit_methods.get_minimap_visible_lines.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  TextEdit_methods.add_gutter._add_gutter = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TextEdit, "add_gutter", 1025054187, loc))
  TextEdit_methods.add_gutter.m_call = cast(type_of(TextEdit_methods.add_gutter.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.remove_gutter.m_call = cast(type_of(TextEdit_methods.remove_gutter.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_gutter_count.m_call = cast(type_of(TextEdit_methods.get_gutter_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_gutter_name.m_call = cast(type_of(TextEdit_methods.set_gutter_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_gutter_name.m_call = cast(type_of(TextEdit_methods.get_gutter_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_gutter_type.m_call = cast(type_of(TextEdit_methods.set_gutter_type.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_gutter_type.m_call = cast(type_of(TextEdit_methods.get_gutter_type.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_gutter_width.m_call = cast(type_of(TextEdit_methods.set_gutter_width.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_gutter_width.m_call = cast(type_of(TextEdit_methods.get_gutter_width.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_gutter_draw.m_call = cast(type_of(TextEdit_methods.set_gutter_draw.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.is_gutter_drawn.m_call = cast(type_of(TextEdit_methods.is_gutter_drawn.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_gutter_clickable.m_call = cast(type_of(TextEdit_methods.set_gutter_clickable.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.is_gutter_clickable.m_call = cast(type_of(TextEdit_methods.is_gutter_clickable.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_gutter_overwritable.m_call = cast(type_of(TextEdit_methods.set_gutter_overwritable.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.is_gutter_overwritable.m_call = cast(type_of(TextEdit_methods.is_gutter_overwritable.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.merge_gutters.m_call = cast(type_of(TextEdit_methods.merge_gutters.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_gutter_custom_draw.m_call = cast(type_of(TextEdit_methods.set_gutter_custom_draw.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_total_gutter_width.m_call = cast(type_of(TextEdit_methods.get_total_gutter_width.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_line_gutter_metadata.m_call = cast(type_of(TextEdit_methods.set_line_gutter_metadata.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_line_gutter_metadata.m_call = cast(type_of(TextEdit_methods.get_line_gutter_metadata.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_line_gutter_text.m_call = cast(type_of(TextEdit_methods.set_line_gutter_text.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_line_gutter_text.m_call = cast(type_of(TextEdit_methods.get_line_gutter_text.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_line_gutter_icon.m_call = cast(type_of(TextEdit_methods.set_line_gutter_icon.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_line_gutter_icon.m_call = cast(type_of(TextEdit_methods.get_line_gutter_icon.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_line_gutter_item_color.m_call = cast(type_of(TextEdit_methods.set_line_gutter_item_color.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_line_gutter_item_color.m_call = cast(type_of(TextEdit_methods.get_line_gutter_item_color.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_line_gutter_clickable.m_call = cast(type_of(TextEdit_methods.set_line_gutter_clickable.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.is_line_gutter_clickable.m_call = cast(type_of(TextEdit_methods.is_line_gutter_clickable.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_line_background_color.m_call = cast(type_of(TextEdit_methods.set_line_background_color.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_line_background_color.m_call = cast(type_of(TextEdit_methods.get_line_background_color.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_syntax_highlighter.m_call = cast(type_of(TextEdit_methods.set_syntax_highlighter.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_syntax_highlighter.m_call = cast(type_of(TextEdit_methods.get_syntax_highlighter.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_highlight_current_line.m_call = cast(type_of(TextEdit_methods.set_highlight_current_line.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.is_highlight_current_line_enabled.m_call = cast(type_of(TextEdit_methods.is_highlight_current_line_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_highlight_all_occurrences.m_call = cast(type_of(TextEdit_methods.set_highlight_all_occurrences.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.is_highlight_all_occurrences_enabled.m_call = cast(type_of(TextEdit_methods.is_highlight_all_occurrences_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_draw_control_chars.m_call = cast(type_of(TextEdit_methods.get_draw_control_chars.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_draw_control_chars.m_call = cast(type_of(TextEdit_methods.set_draw_control_chars.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_draw_tabs.m_call = cast(type_of(TextEdit_methods.set_draw_tabs.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.is_drawing_tabs.m_call = cast(type_of(TextEdit_methods.is_drawing_tabs.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.set_draw_spaces.m_call = cast(type_of(TextEdit_methods.set_draw_spaces.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.is_drawing_spaces.m_call = cast(type_of(TextEdit_methods.is_drawing_spaces.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  TextEdit_methods.get_menu._get_menu = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TextEdit, "get_menu", 229722558, loc))
  TextEdit_methods.get_menu.m_call = cast(type_of(TextEdit_methods.get_menu.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.is_menu_visible.m_call = cast(type_of(TextEdit_methods.is_menu_visible.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.menu_option.m_call = cast(type_of(TextEdit_methods.menu_option.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.adjust_carets_after_edit.m_call = cast(type_of(TextEdit_methods.adjust_carets_after_edit.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_caret_index_edit_order.m_call = cast(type_of(TextEdit_methods.get_caret_index_edit_order.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_selection_line.m_call = cast(type_of(TextEdit_methods.get_selection_line.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextEdit_methods.get_selection_column.m_call = cast(type_of(TextEdit_methods.get_selection_column.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
