...
FillMode_TextureProgressBar :: enum i64 {
...
TextureProgressBar_MethodBind_List :: struct {
  set_under_texture: ^GDW.MethodBind,
  get_under_texture: ^GDW.MethodBind,
  set_progress_texture: ^GDW.MethodBind,
  get_progress_texture: ^GDW.MethodBind,
  set_over_texture: ^GDW.MethodBind,
  get_over_texture: ^GDW.MethodBind,
  set_fill_mode: ^GDW.MethodBind,
  get_fill_mode: ^GDW.MethodBind,
  set_tint_under: ^GDW.MethodBind,
  get_tint_under: ^GDW.MethodBind,
  set_tint_progress: ^GDW.MethodBind,
  get_tint_progress: ^GDW.MethodBind,
  set_tint_over: ^GDW.MethodBind,
  get_tint_over: ^GDW.MethodBind,
  set_texture_progress_offset: ^GDW.MethodBind,
  get_texture_progress_offset: ^GDW.MethodBind,
  set_radial_initial_angle: ^GDW.MethodBind,
  get_radial_initial_angle: ^GDW.MethodBind,
  set_radial_center_offset: ^GDW.MethodBind,
  get_radial_center_offset: ^GDW.MethodBind,
  set_fill_degrees: ^GDW.MethodBind,
  get_fill_degrees: ^GDW.MethodBind,
  set_stretch_margin: ^GDW.MethodBind,
  get_stretch_margin: ^GDW.MethodBind,
  set_nine_patch_stretch: ^GDW.MethodBind,
  get_nine_patch_stretch: ^GDW.MethodBind,
};
TextureProgressBar_Init_ :: proc (TextureProgressBar_methods: ^TextureProgressBar_MethodBind_List, loc := #caller_location) {
  TextureProgressBar_methods.set_under_texture = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TextureProgressBar, "set_under_texture", 4051416890, loc))
  TextureProgressBar_methods.get_under_texture = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TextureProgressBar, "get_under_texture", 3635182373, loc))
  TextureProgressBar_methods.set_progress_texture = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TextureProgressBar, "set_progress_texture", 4051416890, loc))
  TextureProgressBar_methods.get_progress_texture = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TextureProgressBar, "get_progress_texture", 3635182373, loc))
  TextureProgressBar_methods.set_over_texture = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TextureProgressBar, "set_over_texture", 4051416890, loc))
  TextureProgressBar_methods.get_over_texture = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TextureProgressBar, "get_over_texture", 3635182373, loc))
  TextureProgressBar_methods.set_fill_mode = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TextureProgressBar, "set_fill_mode", 1286410249, loc))
  TextureProgressBar_methods.get_fill_mode = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TextureProgressBar, "get_fill_mode", 2455072627, loc))
  TextureProgressBar_methods.set_tint_under = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TextureProgressBar, "set_tint_under", 2920490490, loc))
  TextureProgressBar_methods.get_tint_under = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TextureProgressBar, "get_tint_under", 3444240500, loc))
  TextureProgressBar_methods.set_tint_progress = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TextureProgressBar, "set_tint_progress", 2920490490, loc))
  TextureProgressBar_methods.get_tint_progress = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TextureProgressBar, "get_tint_progress", 3444240500, loc))
  TextureProgressBar_methods.set_tint_over = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TextureProgressBar, "set_tint_over", 2920490490, loc))
  TextureProgressBar_methods.get_tint_over = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TextureProgressBar, "get_tint_over", 3444240500, loc))
  TextureProgressBar_methods.set_texture_progress_offset = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TextureProgressBar, "set_texture_progress_offset", 743155724, loc))
  TextureProgressBar_methods.get_texture_progress_offset = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TextureProgressBar, "get_texture_progress_offset", 3341600327, loc))
  TextureProgressBar_methods.set_radial_initial_angle = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TextureProgressBar, "set_radial_initial_angle", 373806689, loc))
  TextureProgressBar_methods.get_radial_initial_angle = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TextureProgressBar, "get_radial_initial_angle", 191475506, loc))
  TextureProgressBar_methods.set_radial_center_offset = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TextureProgressBar, "set_radial_center_offset", 743155724, loc))
  TextureProgressBar_methods.get_radial_center_offset = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TextureProgressBar, "get_radial_center_offset", 1497962370, loc))
  TextureProgressBar_methods.set_fill_degrees = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TextureProgressBar, "set_fill_degrees", 373806689, loc))
  TextureProgressBar_methods.get_fill_degrees = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TextureProgressBar, "get_fill_degrees", 191475506, loc))
  TextureProgressBar_methods.set_stretch_margin = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TextureProgressBar, "set_stretch_margin", 437707142, loc))
  TextureProgressBar_methods.get_stretch_margin = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TextureProgressBar, "get_stretch_margin", 1983885014, loc))
  TextureProgressBar_methods.set_nine_patch_stretch = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TextureProgressBar, "set_nine_patch_stretch", 2586408642, loc))
  TextureProgressBar_methods.get_nine_patch_stretch = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TextureProgressBar, "get_nine_patch_stretch", 36873697, loc))
};
