...
RDPipelineDepthStencilState_MethodBind_List :: struct {
  set_enable_depth_test: ^GDW.MethodBind,
  get_enable_depth_test: ^GDW.MethodBind,
  set_enable_depth_write: ^GDW.MethodBind,
  get_enable_depth_write: ^GDW.MethodBind,
  set_depth_compare_operator: ^GDW.MethodBind,
  get_depth_compare_operator: ^GDW.MethodBind,
  set_enable_depth_range: ^GDW.MethodBind,
  get_enable_depth_range: ^GDW.MethodBind,
  set_depth_range_min: ^GDW.MethodBind,
  get_depth_range_min: ^GDW.MethodBind,
  set_depth_range_max: ^GDW.MethodBind,
  get_depth_range_max: ^GDW.MethodBind,
  set_enable_stencil: ^GDW.MethodBind,
  get_enable_stencil: ^GDW.MethodBind,
  set_front_op_fail: ^GDW.MethodBind,
  get_front_op_fail: ^GDW.MethodBind,
  set_front_op_pass: ^GDW.MethodBind,
  get_front_op_pass: ^GDW.MethodBind,
  set_front_op_depth_fail: ^GDW.MethodBind,
  get_front_op_depth_fail: ^GDW.MethodBind,
  set_front_op_compare: ^GDW.MethodBind,
  get_front_op_compare: ^GDW.MethodBind,
  set_front_op_compare_mask: ^GDW.MethodBind,
  get_front_op_compare_mask: ^GDW.MethodBind,
  set_front_op_write_mask: ^GDW.MethodBind,
  get_front_op_write_mask: ^GDW.MethodBind,
  set_front_op_reference: ^GDW.MethodBind,
  get_front_op_reference: ^GDW.MethodBind,
  set_back_op_fail: ^GDW.MethodBind,
  get_back_op_fail: ^GDW.MethodBind,
  set_back_op_pass: ^GDW.MethodBind,
  get_back_op_pass: ^GDW.MethodBind,
  set_back_op_depth_fail: ^GDW.MethodBind,
  get_back_op_depth_fail: ^GDW.MethodBind,
  set_back_op_compare: ^GDW.MethodBind,
  get_back_op_compare: ^GDW.MethodBind,
  set_back_op_compare_mask: ^GDW.MethodBind,
  get_back_op_compare_mask: ^GDW.MethodBind,
  set_back_op_write_mask: ^GDW.MethodBind,
  get_back_op_write_mask: ^GDW.MethodBind,
  set_back_op_reference: ^GDW.MethodBind,
  get_back_op_reference: ^GDW.MethodBind,
};
RDPipelineDepthStencilState_Init_ :: proc (RDPipelineDepthStencilState_methods: ^RDPipelineDepthStencilState_MethodBind_List, loc := #caller_location) {
  RDPipelineDepthStencilState_methods.set_enable_depth_test = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RDPipelineDepthStencilState, "set_enable_depth_test", 2586408642, loc))
  RDPipelineDepthStencilState_methods.get_enable_depth_test = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RDPipelineDepthStencilState, "get_enable_depth_test", 36873697, loc))
  RDPipelineDepthStencilState_methods.set_enable_depth_write = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RDPipelineDepthStencilState, "set_enable_depth_write", 2586408642, loc))
  RDPipelineDepthStencilState_methods.get_enable_depth_write = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RDPipelineDepthStencilState, "get_enable_depth_write", 36873697, loc))
  RDPipelineDepthStencilState_methods.set_depth_compare_operator = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RDPipelineDepthStencilState, "set_depth_compare_operator", 2573711505, loc))
  RDPipelineDepthStencilState_methods.get_depth_compare_operator = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RDPipelineDepthStencilState, "get_depth_compare_operator", 269730778, loc))
  RDPipelineDepthStencilState_methods.set_enable_depth_range = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RDPipelineDepthStencilState, "set_enable_depth_range", 2586408642, loc))
  RDPipelineDepthStencilState_methods.get_enable_depth_range = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RDPipelineDepthStencilState, "get_enable_depth_range", 36873697, loc))
  RDPipelineDepthStencilState_methods.set_depth_range_min = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RDPipelineDepthStencilState, "set_depth_range_min", 373806689, loc))
  RDPipelineDepthStencilState_methods.get_depth_range_min = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RDPipelineDepthStencilState, "get_depth_range_min", 1740695150, loc))
  RDPipelineDepthStencilState_methods.set_depth_range_max = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RDPipelineDepthStencilState, "set_depth_range_max", 373806689, loc))
  RDPipelineDepthStencilState_methods.get_depth_range_max = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RDPipelineDepthStencilState, "get_depth_range_max", 1740695150, loc))
  RDPipelineDepthStencilState_methods.set_enable_stencil = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RDPipelineDepthStencilState, "set_enable_stencil", 2586408642, loc))
  RDPipelineDepthStencilState_methods.get_enable_stencil = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RDPipelineDepthStencilState, "get_enable_stencil", 36873697, loc))
  RDPipelineDepthStencilState_methods.set_front_op_fail = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RDPipelineDepthStencilState, "set_front_op_fail", 2092799566, loc))
  RDPipelineDepthStencilState_methods.get_front_op_fail = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RDPipelineDepthStencilState, "get_front_op_fail", 1714732389, loc))
  RDPipelineDepthStencilState_methods.set_front_op_pass = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RDPipelineDepthStencilState, "set_front_op_pass", 2092799566, loc))
  RDPipelineDepthStencilState_methods.get_front_op_pass = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RDPipelineDepthStencilState, "get_front_op_pass", 1714732389, loc))
  RDPipelineDepthStencilState_methods.set_front_op_depth_fail = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RDPipelineDepthStencilState, "set_front_op_depth_fail", 2092799566, loc))
  RDPipelineDepthStencilState_methods.get_front_op_depth_fail = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RDPipelineDepthStencilState, "get_front_op_depth_fail", 1714732389, loc))
  RDPipelineDepthStencilState_methods.set_front_op_compare = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RDPipelineDepthStencilState, "set_front_op_compare", 2573711505, loc))
  RDPipelineDepthStencilState_methods.get_front_op_compare = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RDPipelineDepthStencilState, "get_front_op_compare", 269730778, loc))
  RDPipelineDepthStencilState_methods.set_front_op_compare_mask = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RDPipelineDepthStencilState, "set_front_op_compare_mask", 1286410249, loc))
  RDPipelineDepthStencilState_methods.get_front_op_compare_mask = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RDPipelineDepthStencilState, "get_front_op_compare_mask", 3905245786, loc))
  RDPipelineDepthStencilState_methods.set_front_op_write_mask = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RDPipelineDepthStencilState, "set_front_op_write_mask", 1286410249, loc))
  RDPipelineDepthStencilState_methods.get_front_op_write_mask = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RDPipelineDepthStencilState, "get_front_op_write_mask", 3905245786, loc))
  RDPipelineDepthStencilState_methods.set_front_op_reference = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RDPipelineDepthStencilState, "set_front_op_reference", 1286410249, loc))
  RDPipelineDepthStencilState_methods.get_front_op_reference = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RDPipelineDepthStencilState, "get_front_op_reference", 3905245786, loc))
  RDPipelineDepthStencilState_methods.set_back_op_fail = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RDPipelineDepthStencilState, "set_back_op_fail", 2092799566, loc))
  RDPipelineDepthStencilState_methods.get_back_op_fail = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RDPipelineDepthStencilState, "get_back_op_fail", 1714732389, loc))
  RDPipelineDepthStencilState_methods.set_back_op_pass = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RDPipelineDepthStencilState, "set_back_op_pass", 2092799566, loc))
  RDPipelineDepthStencilState_methods.get_back_op_pass = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RDPipelineDepthStencilState, "get_back_op_pass", 1714732389, loc))
  RDPipelineDepthStencilState_methods.set_back_op_depth_fail = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RDPipelineDepthStencilState, "set_back_op_depth_fail", 2092799566, loc))
  RDPipelineDepthStencilState_methods.get_back_op_depth_fail = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RDPipelineDepthStencilState, "get_back_op_depth_fail", 1714732389, loc))
  RDPipelineDepthStencilState_methods.set_back_op_compare = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RDPipelineDepthStencilState, "set_back_op_compare", 2573711505, loc))
  RDPipelineDepthStencilState_methods.get_back_op_compare = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RDPipelineDepthStencilState, "get_back_op_compare", 269730778, loc))
  RDPipelineDepthStencilState_methods.set_back_op_compare_mask = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RDPipelineDepthStencilState, "set_back_op_compare_mask", 1286410249, loc))
  RDPipelineDepthStencilState_methods.get_back_op_compare_mask = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RDPipelineDepthStencilState, "get_back_op_compare_mask", 3905245786, loc))
  RDPipelineDepthStencilState_methods.set_back_op_write_mask = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RDPipelineDepthStencilState, "set_back_op_write_mask", 1286410249, loc))
  RDPipelineDepthStencilState_methods.get_back_op_write_mask = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RDPipelineDepthStencilState, "get_back_op_write_mask", 3905245786, loc))
  RDPipelineDepthStencilState_methods.set_back_op_reference = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RDPipelineDepthStencilState, "set_back_op_reference", 1286410249, loc))
  RDPipelineDepthStencilState_methods.get_back_op_reference = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RDPipelineDepthStencilState, "get_back_op_reference", 3905245786, loc))
};
