...
Thread_Init_ :: proc (Thread_methods: ^Thread_MethodBind_List, loc := #caller_location) {
  ...
  Thread_methods.start.m_call = cast(type_of(Thread_methods.start.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Thread_methods.get_id._get_id = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Thread, "get_id", 201670096, loc))
  Thread_methods.get_id.m_call = cast(type_of(Thread_methods.get_id.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Thread_methods.is_started._is_started = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Thread, "is_started", 36873697, loc))
  Thread_methods.is_started.m_call = cast(type_of(Thread_methods.is_started.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Thread_methods.is_alive._is_alive = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Thread, "is_alive", 36873697, loc))
  Thread_methods.is_alive.m_call = cast(type_of(Thread_methods.is_alive.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Thread_methods.wait_to_finish.m_call = cast(type_of(Thread_methods.wait_to_finish.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Thread_methods.set_thread_safety_checks_enabled.m_call = cast(type_of(Thread_methods.set_thread_safety_checks_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Thread_methods.is_main_thread.m_call = cast(type_of(Thread_methods.is_main_thread.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
