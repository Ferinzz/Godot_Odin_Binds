...
OpenXRStructureBase_MethodBind_List :: struct {
  get_structure_type: ^GDW.MethodBind,
  set_next: ^GDW.MethodBind,
...
OpenXRStructureBase_Init_ :: proc (OpenXRStructureBase_methods: ^OpenXRStructureBase_MethodBind_List, loc := #caller_location) {
  OpenXRStructureBase_methods.get_structure_type = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.OpenXRStructureBase, "get_structure_type", 2455072627, loc))
  OpenXRStructureBase_methods.set_next = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.OpenXRStructureBase, "set_next", 334698771, loc))
  OpenXRStructureBase_methods.get_next = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.OpenXRStructureBase, "get_next", 2798796760, loc))
};
