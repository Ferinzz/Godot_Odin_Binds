...
AudioStreamPlaylist_MethodBind_List :: struct {
  ...
  set_list_stream: ^GDW.MethodBind,
  get_list_stream: ^GDW.MethodBind,
  set_shuffle: ^GDW.MethodBind,
  get_shuffle: ^GDW.MethodBind,
  set_fade_time: ^GDW.MethodBind,
  get_fade_time: ^GDW.MethodBind,
...
AudioStreamPlaylist_Init_ :: proc (AudioStreamPlaylist_methods: ^AudioStreamPlaylist_MethodBind_List, loc := #caller_location) {
  AudioStreamPlaylist_methods.set_stream_count = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AudioStreamPlaylist, "set_stream_count", 1286410249, loc))
  AudioStreamPlaylist_methods.get_stream_count = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AudioStreamPlaylist, "get_stream_count", 3905245786, loc))
  AudioStreamPlaylist_methods.get_bpm = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AudioStreamPlaylist, "get_bpm", 1740695150, loc))
  AudioStreamPlaylist_methods.set_list_stream = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AudioStreamPlaylist, "set_list_stream", 111075094, loc))
  AudioStreamPlaylist_methods.get_list_stream = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AudioStreamPlaylist, "get_list_stream", 2739380747, loc))
  AudioStreamPlaylist_methods.set_shuffle = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AudioStreamPlaylist, "set_shuffle", 2586408642, loc))
  AudioStreamPlaylist_methods.get_shuffle = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AudioStreamPlaylist, "get_shuffle", 36873697, loc))
  AudioStreamPlaylist_methods.set_fade_time = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AudioStreamPlaylist, "set_fade_time", 373806689, loc))
  AudioStreamPlaylist_methods.get_fade_time = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AudioStreamPlaylist, "get_fade_time", 1740695150, loc))
  AudioStreamPlaylist_methods.set_loop = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AudioStreamPlaylist, "set_loop", 2586408642, loc))
  AudioStreamPlaylist_methods.has_loop = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AudioStreamPlaylist, "has_loop", 36873697, loc))
};
