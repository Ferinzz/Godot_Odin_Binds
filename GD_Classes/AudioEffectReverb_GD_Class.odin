...
AudioEffectReverb_Init_ :: proc (AudioEffectReverb_methods: ^AudioEffectReverb_MethodBind_List, loc := #caller_location) {
  ...
  AudioEffectReverb_methods.set_predelay_msec.m_call = cast(type_of(AudioEffectReverb_methods.set_predelay_msec.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioEffectReverb_methods.get_predelay_msec.m_call = cast(type_of(AudioEffectReverb_methods.get_predelay_msec.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioEffectReverb_methods.set_predelay_feedback.m_call = cast(type_of(AudioEffectReverb_methods.set_predelay_feedback.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioEffectReverb_methods.get_predelay_feedback.m_call = cast(type_of(AudioEffectReverb_methods.get_predelay_feedback.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioEffectReverb_methods.set_room_size.m_call = cast(type_of(AudioEffectReverb_methods.set_room_size.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioEffectReverb_methods.get_room_size.m_call = cast(type_of(AudioEffectReverb_methods.get_room_size.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioEffectReverb_methods.set_damping.m_call = cast(type_of(AudioEffectReverb_methods.set_damping.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioEffectReverb_methods.get_damping.m_call = cast(type_of(AudioEffectReverb_methods.get_damping.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioEffectReverb_methods.set_spread.m_call = cast(type_of(AudioEffectReverb_methods.set_spread.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioEffectReverb_methods.get_spread.m_call = cast(type_of(AudioEffectReverb_methods.get_spread.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioEffectReverb_methods.set_dry.m_call = cast(type_of(AudioEffectReverb_methods.set_dry.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioEffectReverb_methods.get_dry.m_call = cast(type_of(AudioEffectReverb_methods.get_dry.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioEffectReverb_methods.set_wet.m_call = cast(type_of(AudioEffectReverb_methods.set_wet.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioEffectReverb_methods.get_wet.m_call = cast(type_of(AudioEffectReverb_methods.get_wet.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioEffectReverb_methods.set_hpf.m_call = cast(type_of(AudioEffectReverb_methods.set_hpf.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioEffectReverb_methods.get_hpf.m_call = cast(type_of(AudioEffectReverb_methods.get_hpf.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
