...
OpenXRSpatialComponentParentList_Init_ :: proc (OpenXRSpatialComponentParentList_methods: ^OpenXRSpatialComponentParentList_MethodBind_List, loc := #caller_location) {
  ...
  OpenXRSpatialComponentParentList_methods.get_parent.m_call = cast(type_of(OpenXRSpatialComponentParentList_methods.get_parent.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
