...
VisualShaderNodeTextureParameter_MethodBind_List :: struct {
  set_texture_type: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: VisualShaderNodeTextureParameter, #by_ptr args: i64 = 0, r_ret: ^VisualShaderNodeTextureParameter_TextureType)
  },
  set_color_default: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: VisualShaderNodeTextureParameter, #by_ptr args: i64 = 0, r_ret: ^VisualShaderNodeTextureParameter_ColorDefault)
  },
  set_texture_filter: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: VisualShaderNodeTextureParameter, #by_ptr args: i64 = 0, r_ret: ^VisualShaderNodeTextureParameter_TextureFilter)
  },
  set_texture_repeat: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: VisualShaderNodeTextureParameter, #by_ptr args: i64 = 0, r_ret: ^VisualShaderNodeTextureParameter_TextureRepeat)
  },
  set_texture_source: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: VisualShaderNodeTextureParameter, #by_ptr args: i64 = 0, r_ret: ^VisualShaderNodeTextureParameter_TextureSource)
  },
};
VisualShaderNodeTextureParameter_Init_ :: proc (VisualShaderNodeTextureParameter_methods: ^VisualShaderNodeTextureParameter_MethodBind_List, loc := #caller_location) {
  ...
  VisualShaderNodeTextureParameter_methods.set_texture_type.m_call = cast(type_of(VisualShaderNodeTextureParameter_methods.set_texture_type.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeTextureParameter_methods.get_texture_type.m_call = cast(type_of(VisualShaderNodeTextureParameter_methods.get_texture_type.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeTextureParameter_methods.set_color_default.m_call = cast(type_of(VisualShaderNodeTextureParameter_methods.set_color_default.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeTextureParameter_methods.get_color_default.m_call = cast(type_of(VisualShaderNodeTextureParameter_methods.get_color_default.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeTextureParameter_methods.set_texture_filter.m_call = cast(type_of(VisualShaderNodeTextureParameter_methods.set_texture_filter.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeTextureParameter_methods.get_texture_filter.m_call = cast(type_of(VisualShaderNodeTextureParameter_methods.get_texture_filter.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeTextureParameter_methods.set_texture_repeat.m_call = cast(type_of(VisualShaderNodeTextureParameter_methods.set_texture_repeat.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeTextureParameter_methods.get_texture_repeat.m_call = cast(type_of(VisualShaderNodeTextureParameter_methods.get_texture_repeat.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeTextureParameter_methods.set_texture_source.m_call = cast(type_of(VisualShaderNodeTextureParameter_methods.set_texture_source.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeTextureParameter_methods.get_texture_source.m_call = cast(type_of(VisualShaderNodeTextureParameter_methods.get_texture_source.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
