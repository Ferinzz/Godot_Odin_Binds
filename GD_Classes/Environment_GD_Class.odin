...
Environment_Init_ :: proc (Environment_methods: ^Environment_MethodBind_List, loc := #caller_location) {
  ...
  Environment_methods.set_background.m_call = cast(type_of(Environment_methods.set_background.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_background.m_call = cast(type_of(Environment_methods.get_background.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Environment_methods.set_sky._set_sky = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Environment, "set_sky", 3336722921, loc))
  Environment_methods.set_sky.m_call = cast(type_of(Environment_methods.set_sky.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Environment_methods.get_sky._get_sky = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Environment, "get_sky", 1177136966, loc))
  Environment_methods.get_sky.m_call = cast(type_of(Environment_methods.get_sky.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_sky_custom_fov.m_call = cast(type_of(Environment_methods.set_sky_custom_fov.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_sky_custom_fov.m_call = cast(type_of(Environment_methods.get_sky_custom_fov.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_sky_rotation.m_call = cast(type_of(Environment_methods.set_sky_rotation.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_sky_rotation.m_call = cast(type_of(Environment_methods.get_sky_rotation.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_bg_color.m_call = cast(type_of(Environment_methods.set_bg_color.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_bg_color.m_call = cast(type_of(Environment_methods.get_bg_color.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_bg_energy_multiplier.m_call = cast(type_of(Environment_methods.set_bg_energy_multiplier.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_bg_energy_multiplier.m_call = cast(type_of(Environment_methods.get_bg_energy_multiplier.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_bg_intensity.m_call = cast(type_of(Environment_methods.set_bg_intensity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_bg_intensity.m_call = cast(type_of(Environment_methods.get_bg_intensity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_canvas_max_layer.m_call = cast(type_of(Environment_methods.set_canvas_max_layer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_canvas_max_layer.m_call = cast(type_of(Environment_methods.get_canvas_max_layer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_camera_feed_id.m_call = cast(type_of(Environment_methods.set_camera_feed_id.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_camera_feed_id.m_call = cast(type_of(Environment_methods.get_camera_feed_id.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_ambient_light_color.m_call = cast(type_of(Environment_methods.set_ambient_light_color.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_ambient_light_color.m_call = cast(type_of(Environment_methods.get_ambient_light_color.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_ambient_source.m_call = cast(type_of(Environment_methods.set_ambient_source.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_ambient_source.m_call = cast(type_of(Environment_methods.get_ambient_source.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_ambient_light_energy.m_call = cast(type_of(Environment_methods.set_ambient_light_energy.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_ambient_light_energy.m_call = cast(type_of(Environment_methods.get_ambient_light_energy.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_ambient_light_sky_contribution.m_call = cast(type_of(Environment_methods.set_ambient_light_sky_contribution.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_ambient_light_sky_contribution.m_call = cast(type_of(Environment_methods.get_ambient_light_sky_contribution.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_reflection_source.m_call = cast(type_of(Environment_methods.set_reflection_source.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_reflection_source.m_call = cast(type_of(Environment_methods.get_reflection_source.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_tonemapper.m_call = cast(type_of(Environment_methods.set_tonemapper.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_tonemapper.m_call = cast(type_of(Environment_methods.get_tonemapper.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_tonemap_exposure.m_call = cast(type_of(Environment_methods.set_tonemap_exposure.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_tonemap_exposure.m_call = cast(type_of(Environment_methods.get_tonemap_exposure.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_tonemap_white.m_call = cast(type_of(Environment_methods.set_tonemap_white.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_tonemap_white.m_call = cast(type_of(Environment_methods.get_tonemap_white.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_tonemap_agx_white.m_call = cast(type_of(Environment_methods.set_tonemap_agx_white.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_tonemap_agx_white.m_call = cast(type_of(Environment_methods.get_tonemap_agx_white.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_tonemap_agx_contrast.m_call = cast(type_of(Environment_methods.set_tonemap_agx_contrast.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_tonemap_agx_contrast.m_call = cast(type_of(Environment_methods.get_tonemap_agx_contrast.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_ssr_enabled.m_call = cast(type_of(Environment_methods.set_ssr_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.is_ssr_enabled.m_call = cast(type_of(Environment_methods.is_ssr_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_ssr_max_steps.m_call = cast(type_of(Environment_methods.set_ssr_max_steps.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_ssr_max_steps.m_call = cast(type_of(Environment_methods.get_ssr_max_steps.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_ssr_fade_in.m_call = cast(type_of(Environment_methods.set_ssr_fade_in.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_ssr_fade_in.m_call = cast(type_of(Environment_methods.get_ssr_fade_in.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_ssr_fade_out.m_call = cast(type_of(Environment_methods.set_ssr_fade_out.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_ssr_fade_out.m_call = cast(type_of(Environment_methods.get_ssr_fade_out.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_ssr_depth_tolerance.m_call = cast(type_of(Environment_methods.set_ssr_depth_tolerance.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_ssr_depth_tolerance.m_call = cast(type_of(Environment_methods.get_ssr_depth_tolerance.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_ssao_enabled.m_call = cast(type_of(Environment_methods.set_ssao_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.is_ssao_enabled.m_call = cast(type_of(Environment_methods.is_ssao_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_ssao_radius.m_call = cast(type_of(Environment_methods.set_ssao_radius.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_ssao_radius.m_call = cast(type_of(Environment_methods.get_ssao_radius.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_ssao_intensity.m_call = cast(type_of(Environment_methods.set_ssao_intensity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_ssao_intensity.m_call = cast(type_of(Environment_methods.get_ssao_intensity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_ssao_power.m_call = cast(type_of(Environment_methods.set_ssao_power.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_ssao_power.m_call = cast(type_of(Environment_methods.get_ssao_power.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_ssao_detail.m_call = cast(type_of(Environment_methods.set_ssao_detail.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_ssao_detail.m_call = cast(type_of(Environment_methods.get_ssao_detail.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_ssao_horizon.m_call = cast(type_of(Environment_methods.set_ssao_horizon.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_ssao_horizon.m_call = cast(type_of(Environment_methods.get_ssao_horizon.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_ssao_sharpness.m_call = cast(type_of(Environment_methods.set_ssao_sharpness.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_ssao_sharpness.m_call = cast(type_of(Environment_methods.get_ssao_sharpness.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_ssao_direct_light_affect.m_call = cast(type_of(Environment_methods.set_ssao_direct_light_affect.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_ssao_direct_light_affect.m_call = cast(type_of(Environment_methods.get_ssao_direct_light_affect.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_ssao_ao_channel_affect.m_call = cast(type_of(Environment_methods.set_ssao_ao_channel_affect.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_ssao_ao_channel_affect.m_call = cast(type_of(Environment_methods.get_ssao_ao_channel_affect.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_ssil_enabled.m_call = cast(type_of(Environment_methods.set_ssil_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.is_ssil_enabled.m_call = cast(type_of(Environment_methods.is_ssil_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_ssil_radius.m_call = cast(type_of(Environment_methods.set_ssil_radius.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_ssil_radius.m_call = cast(type_of(Environment_methods.get_ssil_radius.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_ssil_intensity.m_call = cast(type_of(Environment_methods.set_ssil_intensity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_ssil_intensity.m_call = cast(type_of(Environment_methods.get_ssil_intensity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_ssil_sharpness.m_call = cast(type_of(Environment_methods.set_ssil_sharpness.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_ssil_sharpness.m_call = cast(type_of(Environment_methods.get_ssil_sharpness.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_ssil_normal_rejection.m_call = cast(type_of(Environment_methods.set_ssil_normal_rejection.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_ssil_normal_rejection.m_call = cast(type_of(Environment_methods.get_ssil_normal_rejection.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_sdfgi_enabled.m_call = cast(type_of(Environment_methods.set_sdfgi_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.is_sdfgi_enabled.m_call = cast(type_of(Environment_methods.is_sdfgi_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_sdfgi_cascades.m_call = cast(type_of(Environment_methods.set_sdfgi_cascades.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_sdfgi_cascades.m_call = cast(type_of(Environment_methods.get_sdfgi_cascades.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_sdfgi_min_cell_size.m_call = cast(type_of(Environment_methods.set_sdfgi_min_cell_size.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_sdfgi_min_cell_size.m_call = cast(type_of(Environment_methods.get_sdfgi_min_cell_size.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_sdfgi_max_distance.m_call = cast(type_of(Environment_methods.set_sdfgi_max_distance.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_sdfgi_max_distance.m_call = cast(type_of(Environment_methods.get_sdfgi_max_distance.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_sdfgi_cascade0_distance.m_call = cast(type_of(Environment_methods.set_sdfgi_cascade0_distance.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_sdfgi_cascade0_distance.m_call = cast(type_of(Environment_methods.get_sdfgi_cascade0_distance.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_sdfgi_y_scale.m_call = cast(type_of(Environment_methods.set_sdfgi_y_scale.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_sdfgi_y_scale.m_call = cast(type_of(Environment_methods.get_sdfgi_y_scale.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_sdfgi_use_occlusion.m_call = cast(type_of(Environment_methods.set_sdfgi_use_occlusion.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.is_sdfgi_using_occlusion.m_call = cast(type_of(Environment_methods.is_sdfgi_using_occlusion.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_sdfgi_bounce_feedback.m_call = cast(type_of(Environment_methods.set_sdfgi_bounce_feedback.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_sdfgi_bounce_feedback.m_call = cast(type_of(Environment_methods.get_sdfgi_bounce_feedback.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_sdfgi_read_sky_light.m_call = cast(type_of(Environment_methods.set_sdfgi_read_sky_light.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.is_sdfgi_reading_sky_light.m_call = cast(type_of(Environment_methods.is_sdfgi_reading_sky_light.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_sdfgi_energy.m_call = cast(type_of(Environment_methods.set_sdfgi_energy.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_sdfgi_energy.m_call = cast(type_of(Environment_methods.get_sdfgi_energy.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_sdfgi_normal_bias.m_call = cast(type_of(Environment_methods.set_sdfgi_normal_bias.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_sdfgi_normal_bias.m_call = cast(type_of(Environment_methods.get_sdfgi_normal_bias.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_sdfgi_probe_bias.m_call = cast(type_of(Environment_methods.set_sdfgi_probe_bias.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_sdfgi_probe_bias.m_call = cast(type_of(Environment_methods.get_sdfgi_probe_bias.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_glow_enabled.m_call = cast(type_of(Environment_methods.set_glow_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.is_glow_enabled.m_call = cast(type_of(Environment_methods.is_glow_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_glow_level.m_call = cast(type_of(Environment_methods.set_glow_level.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_glow_level.m_call = cast(type_of(Environment_methods.get_glow_level.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_glow_normalized.m_call = cast(type_of(Environment_methods.set_glow_normalized.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.is_glow_normalized.m_call = cast(type_of(Environment_methods.is_glow_normalized.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_glow_intensity.m_call = cast(type_of(Environment_methods.set_glow_intensity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_glow_intensity.m_call = cast(type_of(Environment_methods.get_glow_intensity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_glow_strength.m_call = cast(type_of(Environment_methods.set_glow_strength.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_glow_strength.m_call = cast(type_of(Environment_methods.get_glow_strength.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_glow_mix.m_call = cast(type_of(Environment_methods.set_glow_mix.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_glow_mix.m_call = cast(type_of(Environment_methods.get_glow_mix.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_glow_bloom.m_call = cast(type_of(Environment_methods.set_glow_bloom.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_glow_bloom.m_call = cast(type_of(Environment_methods.get_glow_bloom.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_glow_blend_mode.m_call = cast(type_of(Environment_methods.set_glow_blend_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_glow_blend_mode.m_call = cast(type_of(Environment_methods.get_glow_blend_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_glow_hdr_bleed_threshold.m_call = cast(type_of(Environment_methods.set_glow_hdr_bleed_threshold.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_glow_hdr_bleed_threshold.m_call = cast(type_of(Environment_methods.get_glow_hdr_bleed_threshold.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_glow_hdr_bleed_scale.m_call = cast(type_of(Environment_methods.set_glow_hdr_bleed_scale.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_glow_hdr_bleed_scale.m_call = cast(type_of(Environment_methods.get_glow_hdr_bleed_scale.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_glow_hdr_luminance_cap.m_call = cast(type_of(Environment_methods.set_glow_hdr_luminance_cap.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_glow_hdr_luminance_cap.m_call = cast(type_of(Environment_methods.get_glow_hdr_luminance_cap.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_glow_map_strength.m_call = cast(type_of(Environment_methods.set_glow_map_strength.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_glow_map_strength.m_call = cast(type_of(Environment_methods.get_glow_map_strength.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_glow_map.m_call = cast(type_of(Environment_methods.set_glow_map.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_glow_map.m_call = cast(type_of(Environment_methods.get_glow_map.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_fog_enabled.m_call = cast(type_of(Environment_methods.set_fog_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.is_fog_enabled.m_call = cast(type_of(Environment_methods.is_fog_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_fog_mode.m_call = cast(type_of(Environment_methods.set_fog_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_fog_mode.m_call = cast(type_of(Environment_methods.get_fog_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_fog_light_color.m_call = cast(type_of(Environment_methods.set_fog_light_color.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_fog_light_color.m_call = cast(type_of(Environment_methods.get_fog_light_color.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_fog_light_energy.m_call = cast(type_of(Environment_methods.set_fog_light_energy.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_fog_light_energy.m_call = cast(type_of(Environment_methods.get_fog_light_energy.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_fog_sun_scatter.m_call = cast(type_of(Environment_methods.set_fog_sun_scatter.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_fog_sun_scatter.m_call = cast(type_of(Environment_methods.get_fog_sun_scatter.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_fog_density.m_call = cast(type_of(Environment_methods.set_fog_density.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_fog_density.m_call = cast(type_of(Environment_methods.get_fog_density.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_fog_height.m_call = cast(type_of(Environment_methods.set_fog_height.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_fog_height.m_call = cast(type_of(Environment_methods.get_fog_height.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_fog_height_density.m_call = cast(type_of(Environment_methods.set_fog_height_density.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_fog_height_density.m_call = cast(type_of(Environment_methods.get_fog_height_density.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_fog_aerial_perspective.m_call = cast(type_of(Environment_methods.set_fog_aerial_perspective.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_fog_aerial_perspective.m_call = cast(type_of(Environment_methods.get_fog_aerial_perspective.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_fog_sky_affect.m_call = cast(type_of(Environment_methods.set_fog_sky_affect.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_fog_sky_affect.m_call = cast(type_of(Environment_methods.get_fog_sky_affect.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_fog_depth_curve.m_call = cast(type_of(Environment_methods.set_fog_depth_curve.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_fog_depth_curve.m_call = cast(type_of(Environment_methods.get_fog_depth_curve.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_fog_depth_begin.m_call = cast(type_of(Environment_methods.set_fog_depth_begin.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_fog_depth_begin.m_call = cast(type_of(Environment_methods.get_fog_depth_begin.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_fog_depth_end.m_call = cast(type_of(Environment_methods.set_fog_depth_end.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_fog_depth_end.m_call = cast(type_of(Environment_methods.get_fog_depth_end.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_volumetric_fog_enabled.m_call = cast(type_of(Environment_methods.set_volumetric_fog_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.is_volumetric_fog_enabled.m_call = cast(type_of(Environment_methods.is_volumetric_fog_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_volumetric_fog_emission.m_call = cast(type_of(Environment_methods.set_volumetric_fog_emission.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_volumetric_fog_emission.m_call = cast(type_of(Environment_methods.get_volumetric_fog_emission.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_volumetric_fog_albedo.m_call = cast(type_of(Environment_methods.set_volumetric_fog_albedo.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_volumetric_fog_albedo.m_call = cast(type_of(Environment_methods.get_volumetric_fog_albedo.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_volumetric_fog_density.m_call = cast(type_of(Environment_methods.set_volumetric_fog_density.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_volumetric_fog_density.m_call = cast(type_of(Environment_methods.get_volumetric_fog_density.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_volumetric_fog_emission_energy.m_call = cast(type_of(Environment_methods.set_volumetric_fog_emission_energy.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_volumetric_fog_emission_energy.m_call = cast(type_of(Environment_methods.get_volumetric_fog_emission_energy.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_volumetric_fog_anisotropy.m_call = cast(type_of(Environment_methods.set_volumetric_fog_anisotropy.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_volumetric_fog_anisotropy.m_call = cast(type_of(Environment_methods.get_volumetric_fog_anisotropy.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_volumetric_fog_length.m_call = cast(type_of(Environment_methods.set_volumetric_fog_length.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_volumetric_fog_length.m_call = cast(type_of(Environment_methods.get_volumetric_fog_length.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_volumetric_fog_detail_spread.m_call = cast(type_of(Environment_methods.set_volumetric_fog_detail_spread.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_volumetric_fog_detail_spread.m_call = cast(type_of(Environment_methods.get_volumetric_fog_detail_spread.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_volumetric_fog_gi_inject.m_call = cast(type_of(Environment_methods.set_volumetric_fog_gi_inject.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_volumetric_fog_gi_inject.m_call = cast(type_of(Environment_methods.get_volumetric_fog_gi_inject.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_volumetric_fog_ambient_inject.m_call = cast(type_of(Environment_methods.set_volumetric_fog_ambient_inject.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_volumetric_fog_ambient_inject.m_call = cast(type_of(Environment_methods.get_volumetric_fog_ambient_inject.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_volumetric_fog_sky_affect.m_call = cast(type_of(Environment_methods.set_volumetric_fog_sky_affect.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_volumetric_fog_sky_affect.m_call = cast(type_of(Environment_methods.get_volumetric_fog_sky_affect.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_volumetric_fog_temporal_reprojection_enabled.m_call = cast(type_of(Environment_methods.set_volumetric_fog_temporal_reprojection_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.is_volumetric_fog_temporal_reprojection_enabled.m_call = cast(type_of(Environment_methods.is_volumetric_fog_temporal_reprojection_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_volumetric_fog_temporal_reprojection_amount.m_call = cast(type_of(Environment_methods.set_volumetric_fog_temporal_reprojection_amount.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_volumetric_fog_temporal_reprojection_amount.m_call = cast(type_of(Environment_methods.get_volumetric_fog_temporal_reprojection_amount.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_adjustment_enabled.m_call = cast(type_of(Environment_methods.set_adjustment_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.is_adjustment_enabled.m_call = cast(type_of(Environment_methods.is_adjustment_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_adjustment_brightness.m_call = cast(type_of(Environment_methods.set_adjustment_brightness.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_adjustment_brightness.m_call = cast(type_of(Environment_methods.get_adjustment_brightness.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_adjustment_contrast.m_call = cast(type_of(Environment_methods.set_adjustment_contrast.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_adjustment_contrast.m_call = cast(type_of(Environment_methods.get_adjustment_contrast.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_adjustment_saturation.m_call = cast(type_of(Environment_methods.set_adjustment_saturation.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_adjustment_saturation.m_call = cast(type_of(Environment_methods.get_adjustment_saturation.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.set_adjustment_color_correction.m_call = cast(type_of(Environment_methods.set_adjustment_color_correction.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Environment_methods.get_adjustment_color_correction.m_call = cast(type_of(Environment_methods.get_adjustment_color_correction.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
