...
RemoteTransform3D_MethodBind_List :: struct {
  set_remote_node: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: RemoteTransform3D, #by_ptr args: i64 = 0, r_ret: ^GDW.NodePath)
  },
  force_update_cache: struct{
    using _force_update_cache: ^GDW.MethodBind,
    m_call: proc(_:^GDW.MethodBind, obj: RemoteTransform3D, #by_ptr args: i64 = 0, r_ret: rawptr = nil)
  },
    ...
    m_call: proc(_:^GDW.MethodBind, obj: RemoteTransform3D, #by_ptr args: i64 = 0, r_ret: ^GDW.Bool)
  },
...
RemoteTransform3D_Init_ :: proc (RemoteTransform3D_methods: ^RemoteTransform3D_MethodBind_List, loc := #caller_location) {
  ...
  RemoteTransform3D_methods.set_remote_node.m_call = cast(type_of(RemoteTransform3D_methods.set_remote_node.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RemoteTransform3D_methods.get_remote_node.m_call = cast(type_of(RemoteTransform3D_methods.get_remote_node.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RemoteTransform3D_methods.force_update_cache.m_call = cast(type_of(RemoteTransform3D_methods.force_update_cache.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RemoteTransform3D_methods.set_use_global_coordinates.m_call = cast(type_of(RemoteTransform3D_methods.set_use_global_coordinates.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RemoteTransform3D_methods.get_use_global_coordinates.m_call = cast(type_of(RemoteTransform3D_methods.get_use_global_coordinates.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RemoteTransform3D_methods.set_update_position.m_call = cast(type_of(RemoteTransform3D_methods.set_update_position.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RemoteTransform3D_methods.get_update_position.m_call = cast(type_of(RemoteTransform3D_methods.get_update_position.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RemoteTransform3D_methods.set_update_rotation.m_call = cast(type_of(RemoteTransform3D_methods.set_update_rotation.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RemoteTransform3D_methods.get_update_rotation.m_call = cast(type_of(RemoteTransform3D_methods.get_update_rotation.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RemoteTransform3D_methods.set_update_scale.m_call = cast(type_of(RemoteTransform3D_methods.set_update_scale.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RemoteTransform3D_methods.get_update_scale.m_call = cast(type_of(RemoteTransform3D_methods.get_update_scale.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
