...
PhysicsTestMotionParameters2D_Init_ :: proc (PhysicsTestMotionParameters2D_methods: ^PhysicsTestMotionParameters2D_MethodBind_List, loc := #caller_location) {
  ...
  PhysicsTestMotionParameters2D_methods.get_from.m_call = cast(type_of(PhysicsTestMotionParameters2D_methods.get_from.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsTestMotionParameters2D_methods.set_from.m_call = cast(type_of(PhysicsTestMotionParameters2D_methods.set_from.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsTestMotionParameters2D_methods.get_motion.m_call = cast(type_of(PhysicsTestMotionParameters2D_methods.get_motion.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsTestMotionParameters2D_methods.set_motion.m_call = cast(type_of(PhysicsTestMotionParameters2D_methods.set_motion.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsTestMotionParameters2D_methods.get_margin.m_call = cast(type_of(PhysicsTestMotionParameters2D_methods.get_margin.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsTestMotionParameters2D_methods.set_margin.m_call = cast(type_of(PhysicsTestMotionParameters2D_methods.set_margin.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsTestMotionParameters2D_methods.is_collide_separation_ray_enabled.m_call = cast(type_of(PhysicsTestMotionParameters2D_methods.is_collide_separation_ray_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsTestMotionParameters2D_methods.set_collide_separation_ray_enabled.m_call = cast(type_of(PhysicsTestMotionParameters2D_methods.set_collide_separation_ray_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsTestMotionParameters2D_methods.get_exclude_bodies.m_call = cast(type_of(PhysicsTestMotionParameters2D_methods.get_exclude_bodies.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsTestMotionParameters2D_methods.set_exclude_bodies.m_call = cast(type_of(PhysicsTestMotionParameters2D_methods.set_exclude_bodies.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsTestMotionParameters2D_methods.get_exclude_objects.m_call = cast(type_of(PhysicsTestMotionParameters2D_methods.get_exclude_objects.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsTestMotionParameters2D_methods.set_exclude_objects.m_call = cast(type_of(PhysicsTestMotionParameters2D_methods.set_exclude_objects.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsTestMotionParameters2D_methods.is_recovery_as_collision_enabled.m_call = cast(type_of(PhysicsTestMotionParameters2D_methods.is_recovery_as_collision_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsTestMotionParameters2D_methods.set_recovery_as_collision_enabled.m_call = cast(type_of(PhysicsTestMotionParameters2D_methods.set_recovery_as_collision_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
