...
VisualShaderNodeRemap_Init_ :: proc (VisualShaderNodeRemap_methods: ^VisualShaderNodeRemap_MethodBind_List, loc := #caller_location) {
  ...
  VisualShaderNodeRemap_methods.set_op_type.m_call = cast(type_of(VisualShaderNodeRemap_methods.set_op_type.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeRemap_methods.get_op_type.m_call = cast(type_of(VisualShaderNodeRemap_methods.get_op_type.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
