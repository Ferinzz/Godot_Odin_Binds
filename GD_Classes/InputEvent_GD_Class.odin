...
InputEvent_Init_ :: proc (InputEvent_methods: ^InputEvent_MethodBind_List, loc := #caller_location) {
  ...
  InputEvent_methods.set_device.m_call = cast(type_of(InputEvent_methods.set_device.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  InputEvent_methods.get_device.m_call = cast(type_of(InputEvent_methods.get_device.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  InputEvent_methods.is_action.m_call = cast(type_of(InputEvent_methods.is_action.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  InputEvent_methods.is_action_pressed.m_call = cast(type_of(InputEvent_methods.is_action_pressed.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  InputEvent_methods.is_action_released.m_call = cast(type_of(InputEvent_methods.is_action_released.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  InputEvent_methods.get_action_strength.m_call = cast(type_of(InputEvent_methods.get_action_strength.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  InputEvent_methods.is_canceled.m_call = cast(type_of(InputEvent_methods.is_canceled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  InputEvent_methods.is_pressed.m_call = cast(type_of(InputEvent_methods.is_pressed.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  InputEvent_methods.is_released.m_call = cast(type_of(InputEvent_methods.is_released.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  InputEvent_methods.is_echo._is_echo = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.InputEvent, "is_echo", 36873697, loc))
  InputEvent_methods.is_echo.m_call = cast(type_of(InputEvent_methods.is_echo.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  InputEvent_methods.as_text._as_text = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.InputEvent, "as_text", 201670096, loc))
  InputEvent_methods.as_text.m_call = cast(type_of(InputEvent_methods.as_text.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  InputEvent_methods.is_match._is_match = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.InputEvent, "is_match", 1754951977, loc))
  InputEvent_methods.is_match.m_call = cast(type_of(InputEvent_methods.is_match.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  InputEvent_methods.is_action_type.m_call = cast(type_of(InputEvent_methods.is_action_type.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  InputEvent_methods.accumulate.m_call = cast(type_of(InputEvent_methods.accumulate.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  InputEvent_methods.xformed_by.m_call = cast(type_of(InputEvent_methods.xformed_by.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
