...
ImmediateMesh_Init_ :: proc (ImmediateMesh_methods: ^ImmediateMesh_MethodBind_List, loc := #caller_location) {
  ...
  ImmediateMesh_methods.surface_begin.m_call = cast(type_of(ImmediateMesh_methods.surface_begin.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ImmediateMesh_methods.surface_set_color.m_call = cast(type_of(ImmediateMesh_methods.surface_set_color.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ImmediateMesh_methods.surface_set_normal.m_call = cast(type_of(ImmediateMesh_methods.surface_set_normal.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ImmediateMesh_methods.surface_set_tangent.m_call = cast(type_of(ImmediateMesh_methods.surface_set_tangent.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ImmediateMesh_methods.surface_set_uv.m_call = cast(type_of(ImmediateMesh_methods.surface_set_uv.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ImmediateMesh_methods.surface_set_uv2.m_call = cast(type_of(ImmediateMesh_methods.surface_set_uv2.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ImmediateMesh_methods.surface_add_vertex.m_call = cast(type_of(ImmediateMesh_methods.surface_add_vertex.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ImmediateMesh_methods.surface_add_vertex_2d.m_call = cast(type_of(ImmediateMesh_methods.surface_add_vertex_2d.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ImmediateMesh_methods.surface_end.m_call = cast(type_of(ImmediateMesh_methods.surface_end.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ImmediateMesh_methods.clear_surfaces.m_call = cast(type_of(ImmediateMesh_methods.clear_surfaces.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
