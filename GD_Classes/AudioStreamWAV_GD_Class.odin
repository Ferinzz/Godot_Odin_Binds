...
AudioStreamWAV_Init_ :: proc (AudioStreamWAV_methods: ^AudioStreamWAV_MethodBind_List, loc := #caller_location) {
  ...
  AudioStreamWAV_methods.load_from_buffer.m_call = cast(type_of(AudioStreamWAV_methods.load_from_buffer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioStreamWAV_methods.load_from_file.m_call = cast(type_of(AudioStreamWAV_methods.load_from_file.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioStreamWAV_methods.set_data.m_call = cast(type_of(AudioStreamWAV_methods.set_data.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioStreamWAV_methods.get_data.m_call = cast(type_of(AudioStreamWAV_methods.get_data.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioStreamWAV_methods.set_format.m_call = cast(type_of(AudioStreamWAV_methods.set_format.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioStreamWAV_methods.get_format.m_call = cast(type_of(AudioStreamWAV_methods.get_format.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioStreamWAV_methods.set_loop_mode.m_call = cast(type_of(AudioStreamWAV_methods.set_loop_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioStreamWAV_methods.get_loop_mode.m_call = cast(type_of(AudioStreamWAV_methods.get_loop_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioStreamWAV_methods.set_loop_begin.m_call = cast(type_of(AudioStreamWAV_methods.set_loop_begin.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioStreamWAV_methods.get_loop_begin.m_call = cast(type_of(AudioStreamWAV_methods.get_loop_begin.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioStreamWAV_methods.set_loop_end.m_call = cast(type_of(AudioStreamWAV_methods.set_loop_end.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioStreamWAV_methods.get_loop_end.m_call = cast(type_of(AudioStreamWAV_methods.get_loop_end.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioStreamWAV_methods.set_mix_rate.m_call = cast(type_of(AudioStreamWAV_methods.set_mix_rate.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioStreamWAV_methods.get_mix_rate.m_call = cast(type_of(AudioStreamWAV_methods.get_mix_rate.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioStreamWAV_methods.set_stereo.m_call = cast(type_of(AudioStreamWAV_methods.set_stereo.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioStreamWAV_methods.is_stereo.m_call = cast(type_of(AudioStreamWAV_methods.is_stereo.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioStreamWAV_methods.set_tags.m_call = cast(type_of(AudioStreamWAV_methods.set_tags.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioStreamWAV_methods.get_tags.m_call = cast(type_of(AudioStreamWAV_methods.get_tags.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioStreamWAV_methods.save_to_wav.m_call = cast(type_of(AudioStreamWAV_methods.save_to_wav.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
