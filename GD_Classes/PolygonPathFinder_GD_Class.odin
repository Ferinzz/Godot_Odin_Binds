...
PolygonPathFinder_Init_ :: proc (PolygonPathFinder_methods: ^PolygonPathFinder_MethodBind_List, loc := #caller_location) {
  ...
  PolygonPathFinder_methods.setup.m_call = cast(type_of(PolygonPathFinder_methods.setup.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PolygonPathFinder_methods.find_path.m_call = cast(type_of(PolygonPathFinder_methods.find_path.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PolygonPathFinder_methods.get_intersections.m_call = cast(type_of(PolygonPathFinder_methods.get_intersections.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PolygonPathFinder_methods.get_closest_point.m_call = cast(type_of(PolygonPathFinder_methods.get_closest_point.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PolygonPathFinder_methods.is_point_inside.m_call = cast(type_of(PolygonPathFinder_methods.is_point_inside.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PolygonPathFinder_methods.set_point_penalty.m_call = cast(type_of(PolygonPathFinder_methods.set_point_penalty.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PolygonPathFinder_methods.get_point_penalty.m_call = cast(type_of(PolygonPathFinder_methods.get_point_penalty.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PolygonPathFinder_methods.get_bounds.m_call = cast(type_of(PolygonPathFinder_methods.get_bounds.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
