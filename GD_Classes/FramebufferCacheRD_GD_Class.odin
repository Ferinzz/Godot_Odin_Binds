...
FramebufferCacheRD_MethodBind_List :: struct {
  get_cache_multipass: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: FramebufferCacheRD, #by_ptr args: struct{textures: ^GDW.Array, passes: ^GDW.Array, views: ^GDW.Int, }, r_ret: ^GDW.RID)
  },
};
FramebufferCacheRD_Init_ :: proc (FramebufferCacheRD_methods: ^FramebufferCacheRD_MethodBind_List, loc := #caller_location) {
  ...
  FramebufferCacheRD_methods.get_cache_multipass._get_cache_multipass = (cast(^GDW.MethodBind)classDBGetMethodBind3(.FramebufferCacheRD, "get_cache_multipass", 3437881813, loc))
