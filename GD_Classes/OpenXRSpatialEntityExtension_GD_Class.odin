...
OpenXRSpatialEntityExtension_Init_ :: proc (OpenXRSpatialEntityExtension_methods: ^OpenXRSpatialEntityExtension_MethodBind_List, loc := #caller_location) {
  ...
  OpenXRSpatialEntityExtension_methods.supports_capability.m_call = cast(type_of(OpenXRSpatialEntityExtension_methods.supports_capability.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRSpatialEntityExtension_methods.supports_component_type.m_call = cast(type_of(OpenXRSpatialEntityExtension_methods.supports_component_type.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRSpatialEntityExtension_methods.create_spatial_context.m_call = cast(type_of(OpenXRSpatialEntityExtension_methods.create_spatial_context.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRSpatialEntityExtension_methods.get_spatial_context_ready.m_call = cast(type_of(OpenXRSpatialEntityExtension_methods.get_spatial_context_ready.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRSpatialEntityExtension_methods.free_spatial_context.m_call = cast(type_of(OpenXRSpatialEntityExtension_methods.free_spatial_context.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRSpatialEntityExtension_methods.get_spatial_context_handle.m_call = cast(type_of(OpenXRSpatialEntityExtension_methods.get_spatial_context_handle.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRSpatialEntityExtension_methods.discover_spatial_entities.m_call = cast(type_of(OpenXRSpatialEntityExtension_methods.discover_spatial_entities.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRSpatialEntityExtension_methods.update_spatial_entities.m_call = cast(type_of(OpenXRSpatialEntityExtension_methods.update_spatial_entities.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRSpatialEntityExtension_methods.free_spatial_snapshot.m_call = cast(type_of(OpenXRSpatialEntityExtension_methods.free_spatial_snapshot.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRSpatialEntityExtension_methods.get_spatial_snapshot_handle.m_call = cast(type_of(OpenXRSpatialEntityExtension_methods.get_spatial_snapshot_handle.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRSpatialEntityExtension_methods.get_spatial_snapshot_context.m_call = cast(type_of(OpenXRSpatialEntityExtension_methods.get_spatial_snapshot_context.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRSpatialEntityExtension_methods.query_snapshot.m_call = cast(type_of(OpenXRSpatialEntityExtension_methods.query_snapshot.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRSpatialEntityExtension_methods.get_string.m_call = cast(type_of(OpenXRSpatialEntityExtension_methods.get_string.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRSpatialEntityExtension_methods.get_uint8_buffer.m_call = cast(type_of(OpenXRSpatialEntityExtension_methods.get_uint8_buffer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRSpatialEntityExtension_methods.get_uint16_buffer.m_call = cast(type_of(OpenXRSpatialEntityExtension_methods.get_uint16_buffer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRSpatialEntityExtension_methods.get_uint32_buffer.m_call = cast(type_of(OpenXRSpatialEntityExtension_methods.get_uint32_buffer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRSpatialEntityExtension_methods.get_float_buffer.m_call = cast(type_of(OpenXRSpatialEntityExtension_methods.get_float_buffer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRSpatialEntityExtension_methods.get_vector2_buffer.m_call = cast(type_of(OpenXRSpatialEntityExtension_methods.get_vector2_buffer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRSpatialEntityExtension_methods.get_vector3_buffer.m_call = cast(type_of(OpenXRSpatialEntityExtension_methods.get_vector3_buffer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRSpatialEntityExtension_methods.find_spatial_entity.m_call = cast(type_of(OpenXRSpatialEntityExtension_methods.find_spatial_entity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRSpatialEntityExtension_methods.add_spatial_entity.m_call = cast(type_of(OpenXRSpatialEntityExtension_methods.add_spatial_entity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRSpatialEntityExtension_methods.make_spatial_entity.m_call = cast(type_of(OpenXRSpatialEntityExtension_methods.make_spatial_entity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRSpatialEntityExtension_methods.get_spatial_entity_id.m_call = cast(type_of(OpenXRSpatialEntityExtension_methods.get_spatial_entity_id.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRSpatialEntityExtension_methods.get_spatial_entity_context.m_call = cast(type_of(OpenXRSpatialEntityExtension_methods.get_spatial_entity_context.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRSpatialEntityExtension_methods.free_spatial_entity.m_call = cast(type_of(OpenXRSpatialEntityExtension_methods.free_spatial_entity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
