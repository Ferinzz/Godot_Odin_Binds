...
PointLight2D_Init_ :: proc (PointLight2D_methods: ^PointLight2D_MethodBind_List, loc := #caller_location) {
  ...
  PointLight2D_methods.set_texture.m_call = cast(type_of(PointLight2D_methods.set_texture.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PointLight2D_methods.get_texture.m_call = cast(type_of(PointLight2D_methods.get_texture.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PointLight2D_methods.set_texture_offset.m_call = cast(type_of(PointLight2D_methods.set_texture_offset.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PointLight2D_methods.get_texture_offset.m_call = cast(type_of(PointLight2D_methods.get_texture_offset.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PointLight2D_methods.set_texture_scale.m_call = cast(type_of(PointLight2D_methods.set_texture_scale.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PointLight2D_methods.get_texture_scale.m_call = cast(type_of(PointLight2D_methods.get_texture_scale.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
