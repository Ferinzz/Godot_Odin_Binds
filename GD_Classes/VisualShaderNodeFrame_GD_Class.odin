...
VisualShaderNodeFrame_Init_ :: proc (VisualShaderNodeFrame_methods: ^VisualShaderNodeFrame_MethodBind_List, loc := #caller_location) {
  ...
  VisualShaderNodeFrame_methods.set_title.m_call = cast(type_of(VisualShaderNodeFrame_methods.set_title.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeFrame_methods.get_title.m_call = cast(type_of(VisualShaderNodeFrame_methods.get_title.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeFrame_methods.set_tint_color_enabled.m_call = cast(type_of(VisualShaderNodeFrame_methods.set_tint_color_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeFrame_methods.is_tint_color_enabled.m_call = cast(type_of(VisualShaderNodeFrame_methods.is_tint_color_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeFrame_methods.set_tint_color.m_call = cast(type_of(VisualShaderNodeFrame_methods.set_tint_color.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeFrame_methods.get_tint_color.m_call = cast(type_of(VisualShaderNodeFrame_methods.get_tint_color.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeFrame_methods.set_autoshrink_enabled.m_call = cast(type_of(VisualShaderNodeFrame_methods.set_autoshrink_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeFrame_methods.is_autoshrink_enabled.m_call = cast(type_of(VisualShaderNodeFrame_methods.is_autoshrink_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeFrame_methods.add_attached_node.m_call = cast(type_of(VisualShaderNodeFrame_methods.add_attached_node.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeFrame_methods.remove_attached_node.m_call = cast(type_of(VisualShaderNodeFrame_methods.remove_attached_node.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeFrame_methods.set_attached_nodes.m_call = cast(type_of(VisualShaderNodeFrame_methods.set_attached_nodes.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeFrame_methods.get_attached_nodes.m_call = cast(type_of(VisualShaderNodeFrame_methods.get_attached_nodes.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
