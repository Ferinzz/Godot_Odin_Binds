...
VisualShaderNodeComment_MethodBind_List :: struct {
  set_description: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: VisualShaderNodeComment, #by_ptr args: struct{description: ^GDW.gdstring, }, r_ret: rawptr = nil)
  },
    get_description: struct{
    using _get_description: ^GDW.MethodBind,
    m_call: proc "c" (_:^GDW.MethodBind, obj: VisualShaderNodeComment, args: rawptr = nil, r_ret: ^GDW.gdstring)
  },
};
VisualShaderNodeComment_Init_ :: proc (VisualShaderNodeComment_methods: ^VisualShaderNodeComment_MethodBind_List, loc := #caller_location) {
  ...
  VisualShaderNodeComment_methods.set_description._set_description = (cast(^GDW.MethodBind)classDBGetMethodBind3(.VisualShaderNodeComment, "set_description", 83702148, loc))
  ...
  VisualShaderNodeComment_methods.get_description._get_description = (cast(^GDW.MethodBind)classDBGetMethodBind3(.VisualShaderNodeComment, "get_description", 201670096, loc))
