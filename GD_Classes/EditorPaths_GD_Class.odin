...
EditorPaths_Init_ :: proc (EditorPaths_methods: ^EditorPaths_MethodBind_List, loc := #caller_location) {
  ...
  EditorPaths_methods.get_data_dir.m_call = cast(type_of(EditorPaths_methods.get_data_dir.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPaths_methods.get_config_dir.m_call = cast(type_of(EditorPaths_methods.get_config_dir.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPaths_methods.get_cache_dir.m_call = cast(type_of(EditorPaths_methods.get_cache_dir.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPaths_methods.is_self_contained.m_call = cast(type_of(EditorPaths_methods.is_self_contained.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPaths_methods.get_self_contained_file.m_call = cast(type_of(EditorPaths_methods.get_self_contained_file.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPaths_methods.get_project_settings_dir.m_call = cast(type_of(EditorPaths_methods.get_project_settings_dir.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
