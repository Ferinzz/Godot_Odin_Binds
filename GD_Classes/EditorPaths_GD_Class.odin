...
EditorPaths_MethodBind_List :: struct {
  get_data_dir: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: EditorPaths, args: rawptr = nil, r_ret: ^GDW.gdstring)
  },
  ...
  is_self_contained: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: EditorPaths, args: rawptr = nil, r_ret: ^GDW.Bool)
  },
...
EditorPaths_Init_ :: proc (EditorPaths_methods: ^EditorPaths_MethodBind_List, loc := #caller_location) {
  ...
  EditorPaths_methods.get_data_dir._get_data_dir = (cast(^GDW.MethodBind)classDBGetMethodBind3(.EditorPaths, "get_data_dir", 201670096, loc))
  EditorPaths_methods.get_data_dir.m_call = cast(type_of(EditorPaths_methods.get_data_dir.m_call))MB_ptr_call
  EditorPaths_methods.get_config_dir._get_config_dir = (cast(^GDW.MethodBind)classDBGetMethodBind3(.EditorPaths, "get_config_dir", 201670096, loc))
  EditorPaths_methods.get_config_dir.m_call = cast(type_of(EditorPaths_methods.get_config_dir.m_call))MB_ptr_call
  EditorPaths_methods.get_cache_dir._get_cache_dir = (cast(^GDW.MethodBind)classDBGetMethodBind3(.EditorPaths, "get_cache_dir", 201670096, loc))
  EditorPaths_methods.get_cache_dir.m_call = cast(type_of(EditorPaths_methods.get_cache_dir.m_call))MB_ptr_call
  EditorPaths_methods.is_self_contained._is_self_contained = (cast(^GDW.MethodBind)classDBGetMethodBind3(.EditorPaths, "is_self_contained", 36873697, loc))
  EditorPaths_methods.is_self_contained.m_call = cast(type_of(EditorPaths_methods.is_self_contained.m_call))MB_ptr_call
  EditorPaths_methods.get_self_contained_file._get_self_contained_file = (cast(^GDW.MethodBind)classDBGetMethodBind3(.EditorPaths, "get_self_contained_file", 201670096, loc))
  ...
  EditorPaths_methods.get_project_settings_dir._get_project_settings_dir = (cast(^GDW.MethodBind)classDBGetMethodBind3(.EditorPaths, "get_project_settings_dir", 201670096, loc))
