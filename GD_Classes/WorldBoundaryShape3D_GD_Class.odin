...
WorldBoundaryShape3D_MethodBind_List :: struct {
  set_plane: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: WorldBoundaryShape3D, #by_ptr args: i64 = 0, r_ret: ^GDW.Plane)
  },
};
WorldBoundaryShape3D_Init_ :: proc (WorldBoundaryShape3D_methods: ^WorldBoundaryShape3D_MethodBind_List, loc := #caller_location) {
  ...
  WorldBoundaryShape3D_methods.set_plane.m_call = cast(type_of(WorldBoundaryShape3D_methods.set_plane.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  WorldBoundaryShape3D_methods.get_plane.m_call = cast(type_of(WorldBoundaryShape3D_methods.get_plane.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
