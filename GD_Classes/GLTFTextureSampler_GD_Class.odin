...
GLTFTextureSampler_MethodBind_List :: struct {
  ...
  get_wrap_s: ^GDW.MethodBind,
  set_wrap_s: ^GDW.MethodBind,
  get_wrap_t: ^GDW.MethodBind,
  set_wrap_t: ^GDW.MethodBind,
};
GLTFTextureSampler_Init_ :: proc (GLTFTextureSampler_methods: ^GLTFTextureSampler_MethodBind_List, loc := #caller_location) {
  GLTFTextureSampler_methods.get_mag_filter = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GLTFTextureSampler, "get_mag_filter", 3905245786, loc))
  GLTFTextureSampler_methods.set_mag_filter = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GLTFTextureSampler, "set_mag_filter", 1286410249, loc))
  GLTFTextureSampler_methods.get_min_filter = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GLTFTextureSampler, "get_min_filter", 3905245786, loc))
  GLTFTextureSampler_methods.set_min_filter = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GLTFTextureSampler, "set_min_filter", 1286410249, loc))
  GLTFTextureSampler_methods.get_wrap_s = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GLTFTextureSampler, "get_wrap_s", 3905245786, loc))
  GLTFTextureSampler_methods.set_wrap_s = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GLTFTextureSampler, "set_wrap_s", 1286410249, loc))
  GLTFTextureSampler_methods.get_wrap_t = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GLTFTextureSampler, "get_wrap_t", 3905245786, loc))
  GLTFTextureSampler_methods.set_wrap_t = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GLTFTextureSampler, "set_wrap_t", 1286410249, loc))
};
