...
VisibleOnScreenEnabler3D_MethodBind_List :: struct {
  set_enable_mode: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: VisibleOnScreenEnabler3D, args: rawptr = nil, r_ret: ^VisibleOnScreenEnabler3D_EnableMode)
  },
  set_enable_node_path: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: VisibleOnScreenEnabler3D, args: rawptr = nil, r_ret: ^GDW.NodePath)
  },
};
