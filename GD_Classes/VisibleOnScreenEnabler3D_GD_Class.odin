...
EnableMode_VisibleOnScreenEnabler3D :: enum i64 {
...
VisibleOnScreenEnabler3D_Init_ :: proc (VisibleOnScreenEnabler3D_methods: ^VisibleOnScreenEnabler3D_MethodBind_List, loc := #caller_location) {
  VisibleOnScreenEnabler3D_methods.set_enable_mode = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.VisibleOnScreenEnabler3D, "set_enable_mode", 320303646, loc))
  VisibleOnScreenEnabler3D_methods.get_enable_mode = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.VisibleOnScreenEnabler3D, "get_enable_mode", 3352990031, loc))
  VisibleOnScreenEnabler3D_methods.set_enable_node_path = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.VisibleOnScreenEnabler3D, "set_enable_node_path", 1348162250, loc))
  VisibleOnScreenEnabler3D_methods.get_enable_node_path = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.VisibleOnScreenEnabler3D, "get_enable_node_path", 277076166, loc))
};
