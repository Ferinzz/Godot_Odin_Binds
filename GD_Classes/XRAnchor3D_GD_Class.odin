...
XRAnchor3D_Init_ :: proc (XRAnchor3D_methods: ^XRAnchor3D_MethodBind_List, loc := #caller_location) {
  ...
  XRAnchor3D_methods.get_size.m_call = cast(type_of(XRAnchor3D_methods.get_size.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  XRAnchor3D_methods.get_plane.m_call = cast(type_of(XRAnchor3D_methods.get_plane.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
