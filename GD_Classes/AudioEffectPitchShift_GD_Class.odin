...
FFTSize_AudioEffectPitchShift :: enum i64 {
  FFT_SIZE_256 = 0,
  FFT_SIZE_512 = 1,
  FFT_SIZE_1024 = 2,
  FFT_SIZE_2048 = 3,
...
AudioEffectPitchShift_Init_ :: proc (AudioEffectPitchShift_methods: ^AudioEffectPitchShift_MethodBind_List, loc := #caller_location) {
  AudioEffectPitchShift_methods.set_pitch_scale = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AudioEffectPitchShift, "set_pitch_scale", 373806689, loc))
  AudioEffectPitchShift_methods.get_pitch_scale = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AudioEffectPitchShift, "get_pitch_scale", 1740695150, loc))
  AudioEffectPitchShift_methods.set_oversampling = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AudioEffectPitchShift, "set_oversampling", 1286410249, loc))
  AudioEffectPitchShift_methods.get_oversampling = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AudioEffectPitchShift, "get_oversampling", 3905245786, loc))
  AudioEffectPitchShift_methods.set_fft_size = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AudioEffectPitchShift, "set_fft_size", 2323518741, loc))
  AudioEffectPitchShift_methods.get_fft_size = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AudioEffectPitchShift, "get_fft_size", 2361246789, loc))
};
