...
SubViewportContainer_Init_ :: proc (SubViewportContainer_methods: ^SubViewportContainer_MethodBind_List, loc := #caller_location) {
  ...
  SubViewportContainer_methods.set_stretch.m_call = cast(type_of(SubViewportContainer_methods.set_stretch.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SubViewportContainer_methods.is_stretch_enabled.m_call = cast(type_of(SubViewportContainer_methods.is_stretch_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SubViewportContainer_methods.set_stretch_shrink.m_call = cast(type_of(SubViewportContainer_methods.set_stretch_shrink.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SubViewportContainer_methods.get_stretch_shrink.m_call = cast(type_of(SubViewportContainer_methods.get_stretch_shrink.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SubViewportContainer_methods.set_mouse_target.m_call = cast(type_of(SubViewportContainer_methods.set_mouse_target.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SubViewportContainer_methods.is_mouse_target_enabled.m_call = cast(type_of(SubViewportContainer_methods.is_mouse_target_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
