...
EditorDebuggerPlugin_MethodBind_List :: struct {
  ...
  get_sessions: ^GDW.MethodBind,
};
EditorDebuggerPlugin_Init_ :: proc (EditorDebuggerPlugin_methods: ^EditorDebuggerPlugin_MethodBind_List, loc := #caller_location) {
  EditorDebuggerPlugin_methods.get_session = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.EditorDebuggerPlugin, "get_session", 3061968499, loc))
  EditorDebuggerPlugin_methods.get_sessions = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.EditorDebuggerPlugin, "get_sessions", 2915620761, loc))
};
