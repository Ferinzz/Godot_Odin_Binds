...
NavigationServer2DManager_Init_ :: proc (NavigationServer2DManager_methods: ^NavigationServer2DManager_MethodBind_List, loc := #caller_location) {
  ...
  NavigationServer2DManager_methods.register_server.m_call = cast(type_of(NavigationServer2DManager_methods.register_server.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationServer2DManager_methods.set_default_server.m_call = cast(type_of(NavigationServer2DManager_methods.set_default_server.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
