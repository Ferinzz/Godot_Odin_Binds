...
ScriptEditorBase_Init_ :: proc (ScriptEditorBase_methods: ^ScriptEditorBase_MethodBind_List, loc := #caller_location) {
  ...
  ScriptEditorBase_methods.get_base_editor.m_call = cast(type_of(ScriptEditorBase_methods.get_base_editor.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ScriptEditorBase_methods.add_syntax_highlighter.m_call = cast(type_of(ScriptEditorBase_methods.add_syntax_highlighter.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
