...
MissingResource_Init_ :: proc (MissingResource_methods: ^MissingResource_MethodBind_List, loc := #caller_location) {
  MissingResource_methods.set_original_class = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.MissingResource, "set_original_class", 83702148, loc))
  MissingResource_methods.get_original_class = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.MissingResource, "get_original_class", 201670096, loc))
  MissingResource_methods.set_recording_properties = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.MissingResource, "set_recording_properties", 2586408642, loc))
  MissingResource_methods.is_recording_properties = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.MissingResource, "is_recording_properties", 36873697, loc))
};
