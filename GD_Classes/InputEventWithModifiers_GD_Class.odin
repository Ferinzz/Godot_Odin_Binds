...
InputEventWithModifiers_Init_ :: proc (InputEventWithModifiers_methods: ^InputEventWithModifiers_MethodBind_List, loc := #caller_location) {
  ...
  InputEventWithModifiers_methods.set_command_or_control_autoremap.m_call = cast(type_of(InputEventWithModifiers_methods.set_command_or_control_autoremap.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  InputEventWithModifiers_methods.is_command_or_control_autoremap.m_call = cast(type_of(InputEventWithModifiers_methods.is_command_or_control_autoremap.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  InputEventWithModifiers_methods.is_command_or_control_pressed.m_call = cast(type_of(InputEventWithModifiers_methods.is_command_or_control_pressed.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  InputEventWithModifiers_methods.set_alt_pressed.m_call = cast(type_of(InputEventWithModifiers_methods.set_alt_pressed.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  InputEventWithModifiers_methods.is_alt_pressed.m_call = cast(type_of(InputEventWithModifiers_methods.is_alt_pressed.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  InputEventWithModifiers_methods.set_shift_pressed.m_call = cast(type_of(InputEventWithModifiers_methods.set_shift_pressed.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  InputEventWithModifiers_methods.is_shift_pressed.m_call = cast(type_of(InputEventWithModifiers_methods.is_shift_pressed.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  InputEventWithModifiers_methods.set_ctrl_pressed.m_call = cast(type_of(InputEventWithModifiers_methods.set_ctrl_pressed.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  InputEventWithModifiers_methods.is_ctrl_pressed.m_call = cast(type_of(InputEventWithModifiers_methods.is_ctrl_pressed.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  InputEventWithModifiers_methods.set_meta_pressed.m_call = cast(type_of(InputEventWithModifiers_methods.set_meta_pressed.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  InputEventWithModifiers_methods.is_meta_pressed.m_call = cast(type_of(InputEventWithModifiers_methods.is_meta_pressed.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  InputEventWithModifiers_methods.get_modifiers_mask.m_call = cast(type_of(InputEventWithModifiers_methods.get_modifiers_mask.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
