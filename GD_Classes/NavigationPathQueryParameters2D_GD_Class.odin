...
NavigationPathQueryParameters2D_MethodBind_List :: struct {
  set_pathfinding_algorithm: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: NavigationPathQueryParameters2D, args: rawptr = nil, r_ret: ^NavigationPathQueryParameters2D_PathfindingAlgorithm)
  },
  set_path_postprocessing: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: NavigationPathQueryParameters2D, args: rawptr = nil, r_ret: ^NavigationPathQueryParameters2D_PathPostProcessing)
  },
  set_map: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: NavigationPathQueryParameters2D, args: rawptr = nil, r_ret: ^GDW.RID)
  },
  set_start_position: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: NavigationPathQueryParameters2D, args: rawptr = nil, r_ret: ^GDW.Vector2)
  },
  ...
  set_navigation_layers: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: NavigationPathQueryParameters2D, args: rawptr = nil, r_ret: ^GDW.Int)
  },
  set_metadata_flags: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: NavigationPathQueryParameters2D, args: rawptr = nil, r_ret: ^NavigationPathQueryParameters2D_PathMetadataFlags)
  },
  set_simplify_path: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: NavigationPathQueryParameters2D, args: rawptr = nil, r_ret: ^GDW.Bool)
  },
  set_simplify_epsilon: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: NavigationPathQueryParameters2D, args: rawptr = nil, r_ret: ^GDW.float)
  },
  set_included_regions: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: NavigationPathQueryParameters2D, args: rawptr = nil, r_ret: ^GDW.Array)
  },
