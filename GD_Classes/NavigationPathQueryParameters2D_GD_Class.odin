...
NavigationPathQueryParameters2D_Init_ :: proc (NavigationPathQueryParameters2D_methods: ^NavigationPathQueryParameters2D_MethodBind_List, loc := #caller_location) {
  ...
  NavigationPathQueryParameters2D_methods.set_pathfinding_algorithm.m_call = cast(type_of(NavigationPathQueryParameters2D_methods.set_pathfinding_algorithm.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationPathQueryParameters2D_methods.get_pathfinding_algorithm.m_call = cast(type_of(NavigationPathQueryParameters2D_methods.get_pathfinding_algorithm.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationPathQueryParameters2D_methods.set_path_postprocessing.m_call = cast(type_of(NavigationPathQueryParameters2D_methods.set_path_postprocessing.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationPathQueryParameters2D_methods.get_path_postprocessing.m_call = cast(type_of(NavigationPathQueryParameters2D_methods.get_path_postprocessing.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationPathQueryParameters2D_methods.set_map.m_call = cast(type_of(NavigationPathQueryParameters2D_methods.set_map.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationPathQueryParameters2D_methods.get_map.m_call = cast(type_of(NavigationPathQueryParameters2D_methods.get_map.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationPathQueryParameters2D_methods.set_start_position.m_call = cast(type_of(NavigationPathQueryParameters2D_methods.set_start_position.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationPathQueryParameters2D_methods.get_start_position.m_call = cast(type_of(NavigationPathQueryParameters2D_methods.get_start_position.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationPathQueryParameters2D_methods.set_target_position.m_call = cast(type_of(NavigationPathQueryParameters2D_methods.set_target_position.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationPathQueryParameters2D_methods.get_target_position.m_call = cast(type_of(NavigationPathQueryParameters2D_methods.get_target_position.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationPathQueryParameters2D_methods.set_navigation_layers.m_call = cast(type_of(NavigationPathQueryParameters2D_methods.set_navigation_layers.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationPathQueryParameters2D_methods.get_navigation_layers.m_call = cast(type_of(NavigationPathQueryParameters2D_methods.get_navigation_layers.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationPathQueryParameters2D_methods.set_metadata_flags.m_call = cast(type_of(NavigationPathQueryParameters2D_methods.set_metadata_flags.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationPathQueryParameters2D_methods.get_metadata_flags.m_call = cast(type_of(NavigationPathQueryParameters2D_methods.get_metadata_flags.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationPathQueryParameters2D_methods.set_simplify_path.m_call = cast(type_of(NavigationPathQueryParameters2D_methods.set_simplify_path.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationPathQueryParameters2D_methods.get_simplify_path.m_call = cast(type_of(NavigationPathQueryParameters2D_methods.get_simplify_path.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationPathQueryParameters2D_methods.set_simplify_epsilon.m_call = cast(type_of(NavigationPathQueryParameters2D_methods.set_simplify_epsilon.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationPathQueryParameters2D_methods.get_simplify_epsilon.m_call = cast(type_of(NavigationPathQueryParameters2D_methods.get_simplify_epsilon.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationPathQueryParameters2D_methods.set_included_regions.m_call = cast(type_of(NavigationPathQueryParameters2D_methods.set_included_regions.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationPathQueryParameters2D_methods.get_included_regions.m_call = cast(type_of(NavigationPathQueryParameters2D_methods.get_included_regions.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationPathQueryParameters2D_methods.set_excluded_regions.m_call = cast(type_of(NavigationPathQueryParameters2D_methods.set_excluded_regions.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationPathQueryParameters2D_methods.get_excluded_regions.m_call = cast(type_of(NavigationPathQueryParameters2D_methods.get_excluded_regions.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationPathQueryParameters2D_methods.set_path_return_max_length.m_call = cast(type_of(NavigationPathQueryParameters2D_methods.set_path_return_max_length.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationPathQueryParameters2D_methods.get_path_return_max_length.m_call = cast(type_of(NavigationPathQueryParameters2D_methods.get_path_return_max_length.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationPathQueryParameters2D_methods.set_path_return_max_radius.m_call = cast(type_of(NavigationPathQueryParameters2D_methods.set_path_return_max_radius.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationPathQueryParameters2D_methods.get_path_return_max_radius.m_call = cast(type_of(NavigationPathQueryParameters2D_methods.get_path_return_max_radius.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationPathQueryParameters2D_methods.set_path_search_max_polygons.m_call = cast(type_of(NavigationPathQueryParameters2D_methods.set_path_search_max_polygons.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationPathQueryParameters2D_methods.get_path_search_max_polygons.m_call = cast(type_of(NavigationPathQueryParameters2D_methods.get_path_search_max_polygons.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationPathQueryParameters2D_methods.set_path_search_max_distance.m_call = cast(type_of(NavigationPathQueryParameters2D_methods.set_path_search_max_distance.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationPathQueryParameters2D_methods.get_path_search_max_distance.m_call = cast(type_of(NavigationPathQueryParameters2D_methods.get_path_search_max_distance.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
