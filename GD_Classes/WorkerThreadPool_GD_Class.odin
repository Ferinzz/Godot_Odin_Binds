...
WorkerThreadPool_Init_ :: proc (WorkerThreadPool_methods: ^WorkerThreadPool_MethodBind_List, loc := #caller_location) {
  ...
  WorkerThreadPool_methods.add_task.m_call = cast(type_of(WorkerThreadPool_methods.add_task.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  WorkerThreadPool_methods.is_task_completed.m_call = cast(type_of(WorkerThreadPool_methods.is_task_completed.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  WorkerThreadPool_methods.wait_for_task_completion.m_call = cast(type_of(WorkerThreadPool_methods.wait_for_task_completion.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  WorkerThreadPool_methods.get_caller_task_id.m_call = cast(type_of(WorkerThreadPool_methods.get_caller_task_id.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  WorkerThreadPool_methods.add_group_task.m_call = cast(type_of(WorkerThreadPool_methods.add_group_task.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  WorkerThreadPool_methods.is_group_task_completed.m_call = cast(type_of(WorkerThreadPool_methods.is_group_task_completed.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  WorkerThreadPool_methods.get_group_processed_element_count.m_call = cast(type_of(WorkerThreadPool_methods.get_group_processed_element_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  WorkerThreadPool_methods.wait_for_group_task_completion.m_call = cast(type_of(WorkerThreadPool_methods.wait_for_group_task_completion.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  WorkerThreadPool_methods.get_caller_group_id.m_call = cast(type_of(WorkerThreadPool_methods.get_caller_group_id.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
