...
TabContainer_Init_ :: proc (TabContainer_methods: ^TabContainer_MethodBind_List, loc := #caller_location) {
  ...
  TabContainer_methods.get_tab_count.m_call = cast(type_of(TabContainer_methods.get_tab_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TabContainer_methods.set_current_tab.m_call = cast(type_of(TabContainer_methods.set_current_tab.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TabContainer_methods.get_current_tab.m_call = cast(type_of(TabContainer_methods.get_current_tab.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TabContainer_methods.get_previous_tab.m_call = cast(type_of(TabContainer_methods.get_previous_tab.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TabContainer_methods.select_previous_available.m_call = cast(type_of(TabContainer_methods.select_previous_available.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TabContainer_methods.select_next_available.m_call = cast(type_of(TabContainer_methods.select_next_available.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TabContainer_methods.get_current_tab_control.m_call = cast(type_of(TabContainer_methods.get_current_tab_control.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TabContainer_methods.get_tab_bar.m_call = cast(type_of(TabContainer_methods.get_tab_bar.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TabContainer_methods.get_tab_control.m_call = cast(type_of(TabContainer_methods.get_tab_control.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TabContainer_methods.set_tab_alignment.m_call = cast(type_of(TabContainer_methods.set_tab_alignment.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TabContainer_methods.get_tab_alignment.m_call = cast(type_of(TabContainer_methods.get_tab_alignment.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TabContainer_methods.set_tabs_position.m_call = cast(type_of(TabContainer_methods.set_tabs_position.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TabContainer_methods.get_tabs_position.m_call = cast(type_of(TabContainer_methods.get_tabs_position.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TabContainer_methods.set_clip_tabs.m_call = cast(type_of(TabContainer_methods.set_clip_tabs.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TabContainer_methods.get_clip_tabs.m_call = cast(type_of(TabContainer_methods.get_clip_tabs.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TabContainer_methods.set_tabs_visible.m_call = cast(type_of(TabContainer_methods.set_tabs_visible.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TabContainer_methods.are_tabs_visible.m_call = cast(type_of(TabContainer_methods.are_tabs_visible.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TabContainer_methods.set_all_tabs_in_front.m_call = cast(type_of(TabContainer_methods.set_all_tabs_in_front.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TabContainer_methods.is_all_tabs_in_front.m_call = cast(type_of(TabContainer_methods.is_all_tabs_in_front.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TabContainer_methods.set_tab_title.m_call = cast(type_of(TabContainer_methods.set_tab_title.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TabContainer_methods.get_tab_title.m_call = cast(type_of(TabContainer_methods.get_tab_title.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TabContainer_methods.set_tab_tooltip.m_call = cast(type_of(TabContainer_methods.set_tab_tooltip.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TabContainer_methods.get_tab_tooltip.m_call = cast(type_of(TabContainer_methods.get_tab_tooltip.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TabContainer_methods.set_tab_icon.m_call = cast(type_of(TabContainer_methods.set_tab_icon.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TabContainer_methods.get_tab_icon.m_call = cast(type_of(TabContainer_methods.get_tab_icon.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TabContainer_methods.set_tab_icon_max_width.m_call = cast(type_of(TabContainer_methods.set_tab_icon_max_width.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TabContainer_methods.get_tab_icon_max_width.m_call = cast(type_of(TabContainer_methods.get_tab_icon_max_width.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TabContainer_methods.set_tab_disabled.m_call = cast(type_of(TabContainer_methods.set_tab_disabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TabContainer_methods.is_tab_disabled.m_call = cast(type_of(TabContainer_methods.is_tab_disabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TabContainer_methods.set_tab_hidden.m_call = cast(type_of(TabContainer_methods.set_tab_hidden.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TabContainer_methods.is_tab_hidden.m_call = cast(type_of(TabContainer_methods.is_tab_hidden.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TabContainer_methods.set_tab_metadata.m_call = cast(type_of(TabContainer_methods.set_tab_metadata.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TabContainer_methods.get_tab_metadata.m_call = cast(type_of(TabContainer_methods.get_tab_metadata.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TabContainer_methods.set_tab_button_icon.m_call = cast(type_of(TabContainer_methods.set_tab_button_icon.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TabContainer_methods.get_tab_button_icon.m_call = cast(type_of(TabContainer_methods.get_tab_button_icon.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TabContainer_methods.get_tab_idx_at_point.m_call = cast(type_of(TabContainer_methods.get_tab_idx_at_point.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TabContainer_methods.get_tab_idx_from_control.m_call = cast(type_of(TabContainer_methods.get_tab_idx_from_control.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TabContainer_methods.set_popup.m_call = cast(type_of(TabContainer_methods.set_popup.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TabContainer_methods.get_popup.m_call = cast(type_of(TabContainer_methods.get_popup.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TabContainer_methods.set_switch_on_drag_hover.m_call = cast(type_of(TabContainer_methods.set_switch_on_drag_hover.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TabContainer_methods.get_switch_on_drag_hover.m_call = cast(type_of(TabContainer_methods.get_switch_on_drag_hover.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TabContainer_methods.set_drag_to_rearrange_enabled.m_call = cast(type_of(TabContainer_methods.set_drag_to_rearrange_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TabContainer_methods.get_drag_to_rearrange_enabled.m_call = cast(type_of(TabContainer_methods.get_drag_to_rearrange_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TabContainer_methods.set_tabs_rearrange_group.m_call = cast(type_of(TabContainer_methods.set_tabs_rearrange_group.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TabContainer_methods.get_tabs_rearrange_group.m_call = cast(type_of(TabContainer_methods.get_tabs_rearrange_group.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TabContainer_methods.set_use_hidden_tabs_for_min_size.m_call = cast(type_of(TabContainer_methods.set_use_hidden_tabs_for_min_size.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TabContainer_methods.get_use_hidden_tabs_for_min_size.m_call = cast(type_of(TabContainer_methods.get_use_hidden_tabs_for_min_size.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TabContainer_methods.set_tab_focus_mode.m_call = cast(type_of(TabContainer_methods.set_tab_focus_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TabContainer_methods.get_tab_focus_mode.m_call = cast(type_of(TabContainer_methods.get_tab_focus_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TabContainer_methods.set_deselect_enabled.m_call = cast(type_of(TabContainer_methods.set_deselect_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TabContainer_methods.get_deselect_enabled.m_call = cast(type_of(TabContainer_methods.get_deselect_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
