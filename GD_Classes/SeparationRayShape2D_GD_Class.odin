...
SeparationRayShape2D_Init_ :: proc (SeparationRayShape2D_methods: ^SeparationRayShape2D_MethodBind_List, loc := #caller_location) {
  ...
  SeparationRayShape2D_methods.set_length.m_call = cast(type_of(SeparationRayShape2D_methods.set_length.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SeparationRayShape2D_methods.get_length.m_call = cast(type_of(SeparationRayShape2D_methods.get_length.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SeparationRayShape2D_methods.set_slide_on_slope.m_call = cast(type_of(SeparationRayShape2D_methods.set_slide_on_slope.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SeparationRayShape2D_methods.get_slide_on_slope.m_call = cast(type_of(SeparationRayShape2D_methods.get_slide_on_slope.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
