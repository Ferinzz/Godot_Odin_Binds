...
Bone2D_Init_ :: proc (Bone2D_methods: ^Bone2D_MethodBind_List, loc := #caller_location) {
  ...
  Bone2D_methods.set_rest.m_call = cast(type_of(Bone2D_methods.set_rest.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Bone2D_methods.get_rest._get_rest = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Bone2D, "get_rest", 3814499831, loc))
  Bone2D_methods.get_rest.m_call = cast(type_of(Bone2D_methods.get_rest.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Bone2D_methods.apply_rest._apply_rest = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Bone2D, "apply_rest", 3218959716, loc))
  Bone2D_methods.apply_rest.m_call = cast(type_of(Bone2D_methods.apply_rest.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Bone2D_methods.get_skeleton_rest.m_call = cast(type_of(Bone2D_methods.get_skeleton_rest.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Bone2D_methods.get_index_in_skeleton.m_call = cast(type_of(Bone2D_methods.get_index_in_skeleton.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Bone2D_methods.set_autocalculate_length_and_angle.m_call = cast(type_of(Bone2D_methods.set_autocalculate_length_and_angle.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Bone2D_methods.get_autocalculate_length_and_angle.m_call = cast(type_of(Bone2D_methods.get_autocalculate_length_and_angle.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Bone2D_methods.set_length._set_length = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Bone2D, "set_length", 373806689, loc))
  Bone2D_methods.set_length.m_call = cast(type_of(Bone2D_methods.set_length.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Bone2D_methods.get_length._get_length = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Bone2D, "get_length", 1740695150, loc))
  Bone2D_methods.get_length.m_call = cast(type_of(Bone2D_methods.get_length.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Bone2D_methods.set_bone_angle.m_call = cast(type_of(Bone2D_methods.set_bone_angle.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Bone2D_methods.get_bone_angle.m_call = cast(type_of(Bone2D_methods.get_bone_angle.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
