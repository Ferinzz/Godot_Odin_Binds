...
RDFramebufferPass_MethodBind_List :: struct {
  set_color_attachments: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: RDFramebufferPass, #by_ptr args: struct{p_member: ^GDW.PackedInt32Array, }, r_ret: rawptr = nil)
  },
    get_color_attachments: struct{
    using _get_color_attachments: ^GDW.MethodBind,
    m_call: proc "c" (_:^GDW.MethodBind, obj: RDFramebufferPass, args: rawptr = nil, r_ret: ^GDW.PackedInt32Array)
  },
  ...
  set_depth_attachment: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: RDFramebufferPass, #by_ptr args: struct{p_member: ^GDW.Int, }, r_ret: rawptr = nil)
  },
    get_depth_attachment: struct{
    using _get_depth_attachment: ^GDW.MethodBind,
    m_call: proc "c" (_:^GDW.MethodBind, obj: RDFramebufferPass, args: rawptr = nil, r_ret: ^GDW.Int)
  },
};
RDFramebufferPass_Init_ :: proc (RDFramebufferPass_methods: ^RDFramebufferPass_MethodBind_List, loc := #caller_location) {
  ...
  RDFramebufferPass_methods.set_color_attachments._set_color_attachments = (cast(^GDW.MethodBind)classDBGetMethodBind3(.RDFramebufferPass, "set_color_attachments", 3614634198, loc))
  ...
  RDFramebufferPass_methods.get_color_attachments._get_color_attachments = (cast(^GDW.MethodBind)classDBGetMethodBind3(.RDFramebufferPass, "get_color_attachments", 1930428628, loc))
  ...
  RDFramebufferPass_methods.set_input_attachments._set_input_attachments = (cast(^GDW.MethodBind)classDBGetMethodBind3(.RDFramebufferPass, "set_input_attachments", 3614634198, loc))
  ...
  RDFramebufferPass_methods.get_input_attachments._get_input_attachments = (cast(^GDW.MethodBind)classDBGetMethodBind3(.RDFramebufferPass, "get_input_attachments", 1930428628, loc))
  ...
  RDFramebufferPass_methods.set_resolve_attachments._set_resolve_attachments = (cast(^GDW.MethodBind)classDBGetMethodBind3(.RDFramebufferPass, "set_resolve_attachments", 3614634198, loc))
  ...
  RDFramebufferPass_methods.get_resolve_attachments._get_resolve_attachments = (cast(^GDW.MethodBind)classDBGetMethodBind3(.RDFramebufferPass, "get_resolve_attachments", 1930428628, loc))
  ...
  RDFramebufferPass_methods.set_preserve_attachments._set_preserve_attachments = (cast(^GDW.MethodBind)classDBGetMethodBind3(.RDFramebufferPass, "set_preserve_attachments", 3614634198, loc))
  ...
  RDFramebufferPass_methods.get_preserve_attachments._get_preserve_attachments = (cast(^GDW.MethodBind)classDBGetMethodBind3(.RDFramebufferPass, "get_preserve_attachments", 1930428628, loc))
  ...
  RDFramebufferPass_methods.set_depth_attachment._set_depth_attachment = (cast(^GDW.MethodBind)classDBGetMethodBind3(.RDFramebufferPass, "set_depth_attachment", 1286410249, loc))
  ...
  RDFramebufferPass_methods.get_depth_attachment._get_depth_attachment = (cast(^GDW.MethodBind)classDBGetMethodBind3(.RDFramebufferPass, "get_depth_attachment", 3905245786, loc))
