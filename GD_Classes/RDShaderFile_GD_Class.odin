...
RDShaderFile_Init_ :: proc (RDShaderFile_methods: ^RDShaderFile_MethodBind_List, loc := #caller_location) {
  ...
  RDShaderFile_methods.set_bytecode.m_call = cast(type_of(RDShaderFile_methods.set_bytecode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RDShaderFile_methods.get_spirv.m_call = cast(type_of(RDShaderFile_methods.get_spirv.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RDShaderFile_methods.get_version_list.m_call = cast(type_of(RDShaderFile_methods.get_version_list.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RDShaderFile_methods.set_base_error.m_call = cast(type_of(RDShaderFile_methods.set_base_error.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RDShaderFile_methods.get_base_error.m_call = cast(type_of(RDShaderFile_methods.get_base_error.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
