...
LookupResultType_ScriptLanguageExtension :: enum i64 {
...
CodeCompletionLocation_ScriptLanguageExtension :: enum i64 {
  LOCATION_LOCAL = 0,
...
CodeCompletionKind_ScriptLanguageExtension :: enum i64 {
