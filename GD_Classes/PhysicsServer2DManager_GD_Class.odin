...
PhysicsServer2DManager_Init_ :: proc (PhysicsServer2DManager_methods: ^PhysicsServer2DManager_MethodBind_List, loc := #caller_location) {
  ...
  PhysicsServer2DManager_methods.register_server.m_call = cast(type_of(PhysicsServer2DManager_methods.register_server.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsServer2DManager_methods.set_default_server.m_call = cast(type_of(PhysicsServer2DManager_methods.set_default_server.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
