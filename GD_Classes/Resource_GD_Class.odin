...
Resource_Init_ :: proc (Resource_methods: ^Resource_MethodBind_List, loc := #caller_location) {
  ...
  Resource_methods.set_path.m_call = cast(type_of(Resource_methods.set_path.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Resource_methods.take_over_path.m_call = cast(type_of(Resource_methods.take_over_path.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Resource_methods.get_path._get_path = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Resource, "get_path", 201670096, loc))
  Resource_methods.get_path.m_call = cast(type_of(Resource_methods.get_path.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Resource_methods.set_path_cache.m_call = cast(type_of(Resource_methods.set_path_cache.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Resource_methods.set_name._set_name = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Resource, "set_name", 83702148, loc))
  Resource_methods.set_name.m_call = cast(type_of(Resource_methods.set_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Resource_methods.get_name._get_name = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Resource, "get_name", 201670096, loc))
  Resource_methods.get_name.m_call = cast(type_of(Resource_methods.get_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Resource_methods.get_rid._get_rid = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Resource, "get_rid", 2944877500, loc))
  Resource_methods.get_rid.m_call = cast(type_of(Resource_methods.get_rid.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Resource_methods.set_local_to_scene.m_call = cast(type_of(Resource_methods.set_local_to_scene.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Resource_methods.is_local_to_scene.m_call = cast(type_of(Resource_methods.is_local_to_scene.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Resource_methods.get_local_scene.m_call = cast(type_of(Resource_methods.get_local_scene.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Resource_methods.setup_local_to_scene.m_call = cast(type_of(Resource_methods.setup_local_to_scene.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Resource_methods.reset_state.m_call = cast(type_of(Resource_methods.reset_state.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Resource_methods.set_id_for_path.m_call = cast(type_of(Resource_methods.set_id_for_path.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Resource_methods.get_id_for_path.m_call = cast(type_of(Resource_methods.get_id_for_path.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Resource_methods.is_built_in.m_call = cast(type_of(Resource_methods.is_built_in.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Resource_methods.generate_scene_unique_id.m_call = cast(type_of(Resource_methods.generate_scene_unique_id.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Resource_methods.set_scene_unique_id.m_call = cast(type_of(Resource_methods.set_scene_unique_id.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Resource_methods.get_scene_unique_id.m_call = cast(type_of(Resource_methods.get_scene_unique_id.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Resource_methods.emit_changed.m_call = cast(type_of(Resource_methods.emit_changed.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Resource_methods.duplicate._duplicate = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Resource, "duplicate", 482882304, loc))
  Resource_methods.duplicate.m_call = cast(type_of(Resource_methods.duplicate.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Resource_methods.duplicate_deep.m_call = cast(type_of(Resource_methods.duplicate_deep.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
