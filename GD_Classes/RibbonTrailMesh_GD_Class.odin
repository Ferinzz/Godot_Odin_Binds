...
Shape_RibbonTrailMesh :: enum i64 {
  SHAPE_FLAT = 0,
  SHAPE_CROSS = 1,
};
RibbonTrailMesh_MethodBind_List :: struct {
  ...
  set_section_segments: ^GDW.MethodBind,
  get_section_segments: ^GDW.MethodBind,
...
RibbonTrailMesh_Init_ :: proc (RibbonTrailMesh_methods: ^RibbonTrailMesh_MethodBind_List, loc := #caller_location) {
  RibbonTrailMesh_methods.set_size = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RibbonTrailMesh, "set_size", 373806689, loc))
  RibbonTrailMesh_methods.get_size = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RibbonTrailMesh, "get_size", 1740695150, loc))
  RibbonTrailMesh_methods.set_sections = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RibbonTrailMesh, "set_sections", 1286410249, loc))
  RibbonTrailMesh_methods.get_sections = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RibbonTrailMesh, "get_sections", 3905245786, loc))
  RibbonTrailMesh_methods.set_section_length = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RibbonTrailMesh, "set_section_length", 373806689, loc))
  RibbonTrailMesh_methods.get_section_length = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RibbonTrailMesh, "get_section_length", 1740695150, loc))
  RibbonTrailMesh_methods.set_section_segments = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RibbonTrailMesh, "set_section_segments", 1286410249, loc))
  RibbonTrailMesh_methods.get_section_segments = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RibbonTrailMesh, "get_section_segments", 3905245786, loc))
  RibbonTrailMesh_methods.set_curve = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RibbonTrailMesh, "set_curve", 270443179, loc))
  RibbonTrailMesh_methods.get_curve = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RibbonTrailMesh, "get_curve", 2460114913, loc))
  RibbonTrailMesh_methods.set_shape = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RibbonTrailMesh, "set_shape", 1684440262, loc))
  RibbonTrailMesh_methods.get_shape = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RibbonTrailMesh, "get_shape", 1317484155, loc))
};
