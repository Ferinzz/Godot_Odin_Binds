...
ENetMultiplayerPeer_Init_ :: proc (ENetMultiplayerPeer_methods: ^ENetMultiplayerPeer_MethodBind_List, loc := #caller_location) {
  ...
  ENetMultiplayerPeer_methods.create_server.m_call = cast(type_of(ENetMultiplayerPeer_methods.create_server.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ENetMultiplayerPeer_methods.create_client.m_call = cast(type_of(ENetMultiplayerPeer_methods.create_client.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ENetMultiplayerPeer_methods.create_mesh.m_call = cast(type_of(ENetMultiplayerPeer_methods.create_mesh.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ENetMultiplayerPeer_methods.add_mesh_peer.m_call = cast(type_of(ENetMultiplayerPeer_methods.add_mesh_peer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ENetMultiplayerPeer_methods.set_bind_ip.m_call = cast(type_of(ENetMultiplayerPeer_methods.set_bind_ip.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ENetMultiplayerPeer_methods.get_host.m_call = cast(type_of(ENetMultiplayerPeer_methods.get_host.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ENetMultiplayerPeer_methods.get_peer.m_call = cast(type_of(ENetMultiplayerPeer_methods.get_peer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
