...
OpenXRSpatialMarkerTrackingCapability_MethodBind_List :: struct {
  is_qrcode_supported: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: OpenXRSpatialMarkerTrackingCapability, args: rawptr = nil, r_ret: ^GDW.Bool)
  },
...
OpenXRSpatialMarkerTrackingCapability_Init_ :: proc (OpenXRSpatialMarkerTrackingCapability_methods: ^OpenXRSpatialMarkerTrackingCapability_MethodBind_List, loc := #caller_location) {
  ...
  OpenXRSpatialMarkerTrackingCapability_methods.is_qrcode_supported._is_qrcode_supported = (cast(^GDW.MethodBind)classDBGetMethodBind3(.OpenXRSpatialMarkerTrackingCapability, "is_qrcode_supported", 2240911060, loc))
  ...
  OpenXRSpatialMarkerTrackingCapability_methods.is_micro_qrcode_supported._is_micro_qrcode_supported = (cast(^GDW.MethodBind)classDBGetMethodBind3(.OpenXRSpatialMarkerTrackingCapability, "is_micro_qrcode_supported", 2240911060, loc))
  ...
  OpenXRSpatialMarkerTrackingCapability_methods.is_aruco_supported._is_aruco_supported = (cast(^GDW.MethodBind)classDBGetMethodBind3(.OpenXRSpatialMarkerTrackingCapability, "is_aruco_supported", 2240911060, loc))
  ...
  OpenXRSpatialMarkerTrackingCapability_methods.is_april_tag_supported._is_april_tag_supported = (cast(^GDW.MethodBind)classDBGetMethodBind3(.OpenXRSpatialMarkerTrackingCapability, "is_april_tag_supported", 2240911060, loc))
