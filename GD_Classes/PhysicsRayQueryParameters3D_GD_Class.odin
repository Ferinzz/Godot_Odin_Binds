...
PhysicsRayQueryParameters3D_Init_ :: proc (PhysicsRayQueryParameters3D_methods: ^PhysicsRayQueryParameters3D_MethodBind_List, loc := #caller_location) {
  ...
  PhysicsRayQueryParameters3D_methods.create.m_call = cast(type_of(PhysicsRayQueryParameters3D_methods.create.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsRayQueryParameters3D_methods.set_from.m_call = cast(type_of(PhysicsRayQueryParameters3D_methods.set_from.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsRayQueryParameters3D_methods.get_from.m_call = cast(type_of(PhysicsRayQueryParameters3D_methods.get_from.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsRayQueryParameters3D_methods.set_to.m_call = cast(type_of(PhysicsRayQueryParameters3D_methods.set_to.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsRayQueryParameters3D_methods.get_to.m_call = cast(type_of(PhysicsRayQueryParameters3D_methods.get_to.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsRayQueryParameters3D_methods.set_collision_mask.m_call = cast(type_of(PhysicsRayQueryParameters3D_methods.set_collision_mask.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsRayQueryParameters3D_methods.get_collision_mask.m_call = cast(type_of(PhysicsRayQueryParameters3D_methods.get_collision_mask.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsRayQueryParameters3D_methods.set_exclude.m_call = cast(type_of(PhysicsRayQueryParameters3D_methods.set_exclude.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsRayQueryParameters3D_methods.get_exclude.m_call = cast(type_of(PhysicsRayQueryParameters3D_methods.get_exclude.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsRayQueryParameters3D_methods.set_collide_with_bodies.m_call = cast(type_of(PhysicsRayQueryParameters3D_methods.set_collide_with_bodies.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsRayQueryParameters3D_methods.is_collide_with_bodies_enabled.m_call = cast(type_of(PhysicsRayQueryParameters3D_methods.is_collide_with_bodies_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsRayQueryParameters3D_methods.set_collide_with_areas.m_call = cast(type_of(PhysicsRayQueryParameters3D_methods.set_collide_with_areas.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsRayQueryParameters3D_methods.is_collide_with_areas_enabled.m_call = cast(type_of(PhysicsRayQueryParameters3D_methods.is_collide_with_areas_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsRayQueryParameters3D_methods.set_hit_from_inside.m_call = cast(type_of(PhysicsRayQueryParameters3D_methods.set_hit_from_inside.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsRayQueryParameters3D_methods.is_hit_from_inside_enabled.m_call = cast(type_of(PhysicsRayQueryParameters3D_methods.is_hit_from_inside_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsRayQueryParameters3D_methods.set_hit_back_faces.m_call = cast(type_of(PhysicsRayQueryParameters3D_methods.set_hit_back_faces.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsRayQueryParameters3D_methods.is_hit_back_faces_enabled.m_call = cast(type_of(PhysicsRayQueryParameters3D_methods.is_hit_back_faces_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
