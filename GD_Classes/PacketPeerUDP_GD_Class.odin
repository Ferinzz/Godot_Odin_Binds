...
PacketPeerUDP_Init_ :: proc (PacketPeerUDP_methods: ^PacketPeerUDP_MethodBind_List, loc := #caller_location) {
  ...
  PacketPeerUDP_methods.bind.m_call = cast(type_of(PacketPeerUDP_methods.bind.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  PacketPeerUDP_methods.close._close = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.PacketPeerUDP, "close", 3218959716, loc))
  PacketPeerUDP_methods.close.m_call = cast(type_of(PacketPeerUDP_methods.close.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  PacketPeerUDP_methods.wait._wait = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.PacketPeerUDP, "wait", 166280745, loc))
  PacketPeerUDP_methods.wait.m_call = cast(type_of(PacketPeerUDP_methods.wait.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PacketPeerUDP_methods.is_bound.m_call = cast(type_of(PacketPeerUDP_methods.is_bound.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PacketPeerUDP_methods.connect_to_host.m_call = cast(type_of(PacketPeerUDP_methods.connect_to_host.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PacketPeerUDP_methods.is_socket_connected.m_call = cast(type_of(PacketPeerUDP_methods.is_socket_connected.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PacketPeerUDP_methods.get_packet_ip.m_call = cast(type_of(PacketPeerUDP_methods.get_packet_ip.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PacketPeerUDP_methods.get_packet_port.m_call = cast(type_of(PacketPeerUDP_methods.get_packet_port.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PacketPeerUDP_methods.get_local_port.m_call = cast(type_of(PacketPeerUDP_methods.get_local_port.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PacketPeerUDP_methods.set_dest_address.m_call = cast(type_of(PacketPeerUDP_methods.set_dest_address.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PacketPeerUDP_methods.set_broadcast_enabled.m_call = cast(type_of(PacketPeerUDP_methods.set_broadcast_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PacketPeerUDP_methods.join_multicast_group.m_call = cast(type_of(PacketPeerUDP_methods.join_multicast_group.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PacketPeerUDP_methods.leave_multicast_group.m_call = cast(type_of(PacketPeerUDP_methods.leave_multicast_group.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
