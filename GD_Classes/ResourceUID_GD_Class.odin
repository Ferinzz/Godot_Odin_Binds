...
ResourceUID_Init_ :: proc (ResourceUID_methods: ^ResourceUID_MethodBind_List, loc := #caller_location) {
  ...
  ResourceUID_methods.id_to_text.m_call = cast(type_of(ResourceUID_methods.id_to_text.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ResourceUID_methods.text_to_id.m_call = cast(type_of(ResourceUID_methods.text_to_id.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ResourceUID_methods.create_id.m_call = cast(type_of(ResourceUID_methods.create_id.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ResourceUID_methods.create_id_for_path.m_call = cast(type_of(ResourceUID_methods.create_id_for_path.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ResourceUID_methods.has_id._has_id = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.ResourceUID, "has_id", 1116898809, loc))
  ResourceUID_methods.has_id.m_call = cast(type_of(ResourceUID_methods.has_id.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ResourceUID_methods.add_id._add_id = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.ResourceUID, "add_id", 501894301, loc))
  ResourceUID_methods.add_id.m_call = cast(type_of(ResourceUID_methods.add_id.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ResourceUID_methods.set_id._set_id = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.ResourceUID, "set_id", 501894301, loc))
  ResourceUID_methods.set_id.m_call = cast(type_of(ResourceUID_methods.set_id.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ResourceUID_methods.get_id_path.m_call = cast(type_of(ResourceUID_methods.get_id_path.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ResourceUID_methods.remove_id.m_call = cast(type_of(ResourceUID_methods.remove_id.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ResourceUID_methods.uid_to_path.m_call = cast(type_of(ResourceUID_methods.uid_to_path.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ResourceUID_methods.path_to_uid.m_call = cast(type_of(ResourceUID_methods.path_to_uid.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ResourceUID_methods.ensure_path.m_call = cast(type_of(ResourceUID_methods.ensure_path.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
