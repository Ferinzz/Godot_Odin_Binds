...
InstancePlaceholder_Init_ :: proc (InstancePlaceholder_methods: ^InstancePlaceholder_MethodBind_List, loc := #caller_location) {
  ...
  InstancePlaceholder_methods.get_stored_values.m_call = cast(type_of(InstancePlaceholder_methods.get_stored_values.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  InstancePlaceholder_methods.create_instance.m_call = cast(type_of(InstancePlaceholder_methods.create_instance.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  InstancePlaceholder_methods.get_instance_path.m_call = cast(type_of(InstancePlaceholder_methods.get_instance_path.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
