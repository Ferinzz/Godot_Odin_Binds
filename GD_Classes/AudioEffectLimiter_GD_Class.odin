...
AudioEffectLimiter_MethodBind_List :: struct {
  ...
  set_threshold_db: ^GDW.MethodBind,
  get_threshold_db: ^GDW.MethodBind,
  set_soft_clip_db: ^GDW.MethodBind,
  get_soft_clip_db: ^GDW.MethodBind,
  set_soft_clip_ratio: ^GDW.MethodBind,
  get_soft_clip_ratio: ^GDW.MethodBind,
};
AudioEffectLimiter_Init_ :: proc (AudioEffectLimiter_methods: ^AudioEffectLimiter_MethodBind_List, loc := #caller_location) {
  AudioEffectLimiter_methods.set_ceiling_db = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AudioEffectLimiter, "set_ceiling_db", 373806689, loc))
  AudioEffectLimiter_methods.get_ceiling_db = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AudioEffectLimiter, "get_ceiling_db", 1740695150, loc))
  AudioEffectLimiter_methods.set_threshold_db = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AudioEffectLimiter, "set_threshold_db", 373806689, loc))
  AudioEffectLimiter_methods.get_threshold_db = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AudioEffectLimiter, "get_threshold_db", 1740695150, loc))
  AudioEffectLimiter_methods.set_soft_clip_db = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AudioEffectLimiter, "set_soft_clip_db", 373806689, loc))
  AudioEffectLimiter_methods.get_soft_clip_db = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AudioEffectLimiter, "get_soft_clip_db", 1740695150, loc))
  AudioEffectLimiter_methods.set_soft_clip_ratio = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AudioEffectLimiter, "set_soft_clip_ratio", 373806689, loc))
  AudioEffectLimiter_methods.get_soft_clip_ratio = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AudioEffectLimiter, "get_soft_clip_ratio", 1740695150, loc))
};
