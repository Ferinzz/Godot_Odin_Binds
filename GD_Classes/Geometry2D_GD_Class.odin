...
Geometry2D_Init_ :: proc (Geometry2D_methods: ^Geometry2D_MethodBind_List, loc := #caller_location) {
  ...
  Geometry2D_methods.is_point_in_circle.m_call = cast(type_of(Geometry2D_methods.is_point_in_circle.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Geometry2D_methods.segment_intersects_circle.m_call = cast(type_of(Geometry2D_methods.segment_intersects_circle.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Geometry2D_methods.segment_intersects_segment.m_call = cast(type_of(Geometry2D_methods.segment_intersects_segment.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Geometry2D_methods.line_intersects_line.m_call = cast(type_of(Geometry2D_methods.line_intersects_line.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Geometry2D_methods.get_closest_points_between_segments.m_call = cast(type_of(Geometry2D_methods.get_closest_points_between_segments.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Geometry2D_methods.get_closest_point_to_segment.m_call = cast(type_of(Geometry2D_methods.get_closest_point_to_segment.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Geometry2D_methods.get_closest_point_to_segment_uncapped.m_call = cast(type_of(Geometry2D_methods.get_closest_point_to_segment_uncapped.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Geometry2D_methods.point_is_inside_triangle.m_call = cast(type_of(Geometry2D_methods.point_is_inside_triangle.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Geometry2D_methods.is_polygon_clockwise.m_call = cast(type_of(Geometry2D_methods.is_polygon_clockwise.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Geometry2D_methods.is_point_in_polygon.m_call = cast(type_of(Geometry2D_methods.is_point_in_polygon.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Geometry2D_methods.triangulate_polygon.m_call = cast(type_of(Geometry2D_methods.triangulate_polygon.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Geometry2D_methods.triangulate_delaunay.m_call = cast(type_of(Geometry2D_methods.triangulate_delaunay.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Geometry2D_methods.convex_hull.m_call = cast(type_of(Geometry2D_methods.convex_hull.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Geometry2D_methods.decompose_polygon_in_convex.m_call = cast(type_of(Geometry2D_methods.decompose_polygon_in_convex.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Geometry2D_methods.merge_polygons.m_call = cast(type_of(Geometry2D_methods.merge_polygons.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Geometry2D_methods.clip_polygons.m_call = cast(type_of(Geometry2D_methods.clip_polygons.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Geometry2D_methods.intersect_polygons.m_call = cast(type_of(Geometry2D_methods.intersect_polygons.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Geometry2D_methods.exclude_polygons.m_call = cast(type_of(Geometry2D_methods.exclude_polygons.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Geometry2D_methods.clip_polyline_with_polygon.m_call = cast(type_of(Geometry2D_methods.clip_polyline_with_polygon.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Geometry2D_methods.intersect_polyline_with_polygon.m_call = cast(type_of(Geometry2D_methods.intersect_polyline_with_polygon.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Geometry2D_methods.offset_polygon.m_call = cast(type_of(Geometry2D_methods.offset_polygon.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Geometry2D_methods.offset_polyline.m_call = cast(type_of(Geometry2D_methods.offset_polyline.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Geometry2D_methods.make_atlas.m_call = cast(type_of(Geometry2D_methods.make_atlas.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Geometry2D_methods.bresenham_line.m_call = cast(type_of(Geometry2D_methods.bresenham_line.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
