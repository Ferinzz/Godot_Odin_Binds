...
NoiseTexture2D_Init_ :: proc (NoiseTexture2D_methods: ^NoiseTexture2D_MethodBind_List, loc := #caller_location) {
  ...
  NoiseTexture2D_methods.set_width.m_call = cast(type_of(NoiseTexture2D_methods.set_width.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NoiseTexture2D_methods.set_height.m_call = cast(type_of(NoiseTexture2D_methods.set_height.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NoiseTexture2D_methods.set_generate_mipmaps.m_call = cast(type_of(NoiseTexture2D_methods.set_generate_mipmaps.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NoiseTexture2D_methods.is_generating_mipmaps.m_call = cast(type_of(NoiseTexture2D_methods.is_generating_mipmaps.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NoiseTexture2D_methods.set_noise.m_call = cast(type_of(NoiseTexture2D_methods.set_noise.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NoiseTexture2D_methods.get_noise.m_call = cast(type_of(NoiseTexture2D_methods.get_noise.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NoiseTexture2D_methods.set_color_ramp.m_call = cast(type_of(NoiseTexture2D_methods.set_color_ramp.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NoiseTexture2D_methods.get_color_ramp.m_call = cast(type_of(NoiseTexture2D_methods.get_color_ramp.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NoiseTexture2D_methods.set_seamless.m_call = cast(type_of(NoiseTexture2D_methods.set_seamless.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NoiseTexture2D_methods.get_seamless.m_call = cast(type_of(NoiseTexture2D_methods.get_seamless.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NoiseTexture2D_methods.set_invert.m_call = cast(type_of(NoiseTexture2D_methods.set_invert.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NoiseTexture2D_methods.get_invert.m_call = cast(type_of(NoiseTexture2D_methods.get_invert.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NoiseTexture2D_methods.set_in_3d_space.m_call = cast(type_of(NoiseTexture2D_methods.set_in_3d_space.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NoiseTexture2D_methods.is_in_3d_space.m_call = cast(type_of(NoiseTexture2D_methods.is_in_3d_space.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NoiseTexture2D_methods.set_as_normal_map.m_call = cast(type_of(NoiseTexture2D_methods.set_as_normal_map.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NoiseTexture2D_methods.is_normal_map.m_call = cast(type_of(NoiseTexture2D_methods.is_normal_map.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NoiseTexture2D_methods.set_normalize.m_call = cast(type_of(NoiseTexture2D_methods.set_normalize.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NoiseTexture2D_methods.is_normalized.m_call = cast(type_of(NoiseTexture2D_methods.is_normalized.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NoiseTexture2D_methods.set_seamless_blend_skirt.m_call = cast(type_of(NoiseTexture2D_methods.set_seamless_blend_skirt.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NoiseTexture2D_methods.get_seamless_blend_skirt.m_call = cast(type_of(NoiseTexture2D_methods.get_seamless_blend_skirt.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NoiseTexture2D_methods.set_bump_strength.m_call = cast(type_of(NoiseTexture2D_methods.set_bump_strength.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NoiseTexture2D_methods.get_bump_strength.m_call = cast(type_of(NoiseTexture2D_methods.get_bump_strength.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
