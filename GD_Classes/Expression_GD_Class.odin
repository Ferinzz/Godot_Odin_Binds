...
Expression_Init_ :: proc (Expression_methods: ^Expression_MethodBind_List, loc := #caller_location) {
  ...
  Expression_methods.parse.m_call = cast(type_of(Expression_methods.parse.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Expression_methods.execute._execute = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Expression, "execute", 3712471238, loc))
  Expression_methods.execute.m_call = cast(type_of(Expression_methods.execute.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Expression_methods.has_execute_failed.m_call = cast(type_of(Expression_methods.has_execute_failed.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Expression_methods.get_error_text.m_call = cast(type_of(Expression_methods.get_error_text.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
