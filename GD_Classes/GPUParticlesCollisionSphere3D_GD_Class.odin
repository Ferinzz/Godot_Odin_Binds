...
GPUParticlesCollisionSphere3D_MethodBind_List :: struct {
  set_radius: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: GPUParticlesCollisionSphere3D, #by_ptr args: struct{radius: ^GDW.float, }, r_ret: rawptr = nil)
  },
    get_radius: struct{
    using _get_radius: ^GDW.MethodBind,
    m_call: proc "c" (_:^GDW.MethodBind, obj: GPUParticlesCollisionSphere3D, args: rawptr = nil, r_ret: ^GDW.float)
  },
};
GPUParticlesCollisionSphere3D_Init_ :: proc (GPUParticlesCollisionSphere3D_methods: ^GPUParticlesCollisionSphere3D_MethodBind_List, loc := #caller_location) {
  ...
  GPUParticlesCollisionSphere3D_methods.set_radius._set_radius = (cast(^GDW.MethodBind)classDBGetMethodBind3(.GPUParticlesCollisionSphere3D, "set_radius", 373806689, loc))
  ...
  GPUParticlesCollisionSphere3D_methods.get_radius._get_radius = (cast(^GDW.MethodBind)classDBGetMethodBind3(.GPUParticlesCollisionSphere3D, "get_radius", 1740695150, loc))
