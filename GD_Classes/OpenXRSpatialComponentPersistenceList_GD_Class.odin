...
OpenXRSpatialComponentPersistenceList_MethodBind_List :: struct {
  get_persistent_uuid: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: OpenXRSpatialComponentPersistenceList, #by_ptr args: struct{index: ^GDW.Int, }, r_ret: ^GDW.gdstring)
  },
  get_persistent_state: struct{
    using _get_persistent_state: ^GDW.MethodBind,
    m_call: proc "c" (_:^GDW.MethodBind, obj: OpenXRSpatialComponentPersistenceList, #by_ptr args: struct{index: ^GDW.Int, }, r_ret: ^GDW.Int)
  },
};
OpenXRSpatialComponentPersistenceList_Init_ :: proc (OpenXRSpatialComponentPersistenceList_methods: ^OpenXRSpatialComponentPersistenceList_MethodBind_List, loc := #caller_location) {
  ...
  OpenXRSpatialComponentPersistenceList_methods.get_persistent_uuid._get_persistent_uuid = (cast(^GDW.MethodBind)classDBGetMethodBind3(.OpenXRSpatialComponentPersistenceList, "get_persistent_uuid", 844755477, loc))
  ...
  OpenXRSpatialComponentPersistenceList_methods.get_persistent_state._get_persistent_state = (cast(^GDW.MethodBind)classDBGetMethodBind3(.OpenXRSpatialComponentPersistenceList, "get_persistent_state", 923996154, loc))
