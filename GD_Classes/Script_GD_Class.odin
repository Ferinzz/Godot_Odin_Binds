...
Script_Init_ :: proc (Script_methods: ^Script_MethodBind_List, loc := #caller_location) {
  ...
  Script_methods.can_instantiate.m_call = cast(type_of(Script_methods.can_instantiate.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Script_methods.instance_has.m_call = cast(type_of(Script_methods.instance_has.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Script_methods.has_source_code.m_call = cast(type_of(Script_methods.has_source_code.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Script_methods.get_source_code.m_call = cast(type_of(Script_methods.get_source_code.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Script_methods.set_source_code.m_call = cast(type_of(Script_methods.set_source_code.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Script_methods.reload._reload = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Script, "reload", 1633102583, loc))
  Script_methods.reload.m_call = cast(type_of(Script_methods.reload.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Script_methods.get_base_script.m_call = cast(type_of(Script_methods.get_base_script.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Script_methods.get_instance_base_type.m_call = cast(type_of(Script_methods.get_instance_base_type.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Script_methods.get_global_name.m_call = cast(type_of(Script_methods.get_global_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Script_methods.has_script_signal.m_call = cast(type_of(Script_methods.has_script_signal.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Script_methods.get_script_property_list.m_call = cast(type_of(Script_methods.get_script_property_list.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Script_methods.get_script_method_list.m_call = cast(type_of(Script_methods.get_script_method_list.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Script_methods.get_script_signal_list.m_call = cast(type_of(Script_methods.get_script_signal_list.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Script_methods.get_script_constant_map.m_call = cast(type_of(Script_methods.get_script_constant_map.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Script_methods.get_property_default_value.m_call = cast(type_of(Script_methods.get_property_default_value.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Script_methods.is_tool._is_tool = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Script, "is_tool", 36873697, loc))
  Script_methods.is_tool.m_call = cast(type_of(Script_methods.is_tool.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Script_methods.is_abstract._is_abstract = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Script, "is_abstract", 36873697, loc))
  Script_methods.is_abstract.m_call = cast(type_of(Script_methods.is_abstract.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Script_methods.get_rpc_config.m_call = cast(type_of(Script_methods.get_rpc_config.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
