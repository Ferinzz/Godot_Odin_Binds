...
RDVertexAttribute_Init_ :: proc (RDVertexAttribute_methods: ^RDVertexAttribute_MethodBind_List, loc := #caller_location) {
  ...
  RDVertexAttribute_methods.set_binding.m_call = cast(type_of(RDVertexAttribute_methods.set_binding.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RDVertexAttribute_methods.get_binding.m_call = cast(type_of(RDVertexAttribute_methods.get_binding.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RDVertexAttribute_methods.set_location.m_call = cast(type_of(RDVertexAttribute_methods.set_location.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RDVertexAttribute_methods.get_location.m_call = cast(type_of(RDVertexAttribute_methods.get_location.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RDVertexAttribute_methods.set_offset.m_call = cast(type_of(RDVertexAttribute_methods.set_offset.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RDVertexAttribute_methods.get_offset.m_call = cast(type_of(RDVertexAttribute_methods.get_offset.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RDVertexAttribute_methods.set_format.m_call = cast(type_of(RDVertexAttribute_methods.set_format.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RDVertexAttribute_methods.get_format.m_call = cast(type_of(RDVertexAttribute_methods.get_format.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RDVertexAttribute_methods.set_stride.m_call = cast(type_of(RDVertexAttribute_methods.set_stride.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RDVertexAttribute_methods.get_stride.m_call = cast(type_of(RDVertexAttribute_methods.get_stride.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RDVertexAttribute_methods.set_frequency.m_call = cast(type_of(RDVertexAttribute_methods.set_frequency.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RDVertexAttribute_methods.get_frequency.m_call = cast(type_of(RDVertexAttribute_methods.get_frequency.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
