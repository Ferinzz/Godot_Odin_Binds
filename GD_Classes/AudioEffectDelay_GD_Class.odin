...
AudioEffectDelay_Init_ :: proc (AudioEffectDelay_methods: ^AudioEffectDelay_MethodBind_List, loc := #caller_location) {
  ...
  AudioEffectDelay_methods.set_dry.m_call = cast(type_of(AudioEffectDelay_methods.set_dry.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioEffectDelay_methods.get_dry.m_call = cast(type_of(AudioEffectDelay_methods.get_dry.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioEffectDelay_methods.set_tap1_active.m_call = cast(type_of(AudioEffectDelay_methods.set_tap1_active.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioEffectDelay_methods.is_tap1_active.m_call = cast(type_of(AudioEffectDelay_methods.is_tap1_active.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioEffectDelay_methods.set_tap1_delay_ms.m_call = cast(type_of(AudioEffectDelay_methods.set_tap1_delay_ms.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioEffectDelay_methods.get_tap1_delay_ms.m_call = cast(type_of(AudioEffectDelay_methods.get_tap1_delay_ms.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioEffectDelay_methods.set_tap1_level_db.m_call = cast(type_of(AudioEffectDelay_methods.set_tap1_level_db.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioEffectDelay_methods.get_tap1_level_db.m_call = cast(type_of(AudioEffectDelay_methods.get_tap1_level_db.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioEffectDelay_methods.set_tap1_pan.m_call = cast(type_of(AudioEffectDelay_methods.set_tap1_pan.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioEffectDelay_methods.get_tap1_pan.m_call = cast(type_of(AudioEffectDelay_methods.get_tap1_pan.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioEffectDelay_methods.set_tap2_active.m_call = cast(type_of(AudioEffectDelay_methods.set_tap2_active.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioEffectDelay_methods.is_tap2_active.m_call = cast(type_of(AudioEffectDelay_methods.is_tap2_active.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioEffectDelay_methods.set_tap2_delay_ms.m_call = cast(type_of(AudioEffectDelay_methods.set_tap2_delay_ms.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioEffectDelay_methods.get_tap2_delay_ms.m_call = cast(type_of(AudioEffectDelay_methods.get_tap2_delay_ms.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioEffectDelay_methods.set_tap2_level_db.m_call = cast(type_of(AudioEffectDelay_methods.set_tap2_level_db.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioEffectDelay_methods.get_tap2_level_db.m_call = cast(type_of(AudioEffectDelay_methods.get_tap2_level_db.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioEffectDelay_methods.set_tap2_pan.m_call = cast(type_of(AudioEffectDelay_methods.set_tap2_pan.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioEffectDelay_methods.get_tap2_pan.m_call = cast(type_of(AudioEffectDelay_methods.get_tap2_pan.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioEffectDelay_methods.set_feedback_active.m_call = cast(type_of(AudioEffectDelay_methods.set_feedback_active.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioEffectDelay_methods.is_feedback_active.m_call = cast(type_of(AudioEffectDelay_methods.is_feedback_active.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioEffectDelay_methods.set_feedback_delay_ms.m_call = cast(type_of(AudioEffectDelay_methods.set_feedback_delay_ms.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioEffectDelay_methods.get_feedback_delay_ms.m_call = cast(type_of(AudioEffectDelay_methods.get_feedback_delay_ms.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioEffectDelay_methods.set_feedback_level_db.m_call = cast(type_of(AudioEffectDelay_methods.set_feedback_level_db.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioEffectDelay_methods.get_feedback_level_db.m_call = cast(type_of(AudioEffectDelay_methods.get_feedback_level_db.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioEffectDelay_methods.set_feedback_lowpass.m_call = cast(type_of(AudioEffectDelay_methods.set_feedback_lowpass.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioEffectDelay_methods.get_feedback_lowpass.m_call = cast(type_of(AudioEffectDelay_methods.get_feedback_lowpass.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
