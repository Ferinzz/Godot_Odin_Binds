...
AnimatableBody3D_Init_ :: proc (AnimatableBody3D_methods: ^AnimatableBody3D_MethodBind_List, loc := #caller_location) {
  ...
  AnimatableBody3D_methods.set_sync_to_physics.m_call = cast(type_of(AnimatableBody3D_methods.set_sync_to_physics.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AnimatableBody3D_methods.is_sync_to_physics_enabled.m_call = cast(type_of(AnimatableBody3D_methods.is_sync_to_physics_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
