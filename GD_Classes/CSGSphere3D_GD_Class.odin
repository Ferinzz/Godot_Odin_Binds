...
CSGSphere3D_Init_ :: proc (CSGSphere3D_methods: ^CSGSphere3D_MethodBind_List, loc := #caller_location) {
  CSGSphere3D_methods.set_radius = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.CSGSphere3D, "set_radius", 373806689, loc))
  CSGSphere3D_methods.get_radius = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.CSGSphere3D, "get_radius", 1740695150, loc))
  CSGSphere3D_methods.set_radial_segments = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.CSGSphere3D, "set_radial_segments", 1286410249, loc))
  CSGSphere3D_methods.get_radial_segments = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.CSGSphere3D, "get_radial_segments", 3905245786, loc))
  CSGSphere3D_methods.set_rings = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.CSGSphere3D, "set_rings", 1286410249, loc))
  CSGSphere3D_methods.get_rings = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.CSGSphere3D, "get_rings", 3905245786, loc))
  CSGSphere3D_methods.set_smooth_faces = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.CSGSphere3D, "set_smooth_faces", 2586408642, loc))
  CSGSphere3D_methods.get_smooth_faces = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.CSGSphere3D, "get_smooth_faces", 36873697, loc))
  CSGSphere3D_methods.set_material = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.CSGSphere3D, "set_material", 2757459619, loc))
  CSGSphere3D_methods.get_material = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.CSGSphere3D, "get_material", 5934680, loc))
};
