...
RDPipelineColorBlendStateAttachment_MethodBind_List :: struct {
  set_as_mix: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: RDPipelineColorBlendStateAttachment, #by_ptr args: i64 = 0, r_ret: rawptr = nil)
  },
    ...
    m_call: proc(_:^GDW.MethodBind, obj: RDPipelineColorBlendStateAttachment, #by_ptr args: i64 = 0, r_ret: ^GDW.Bool)
  },
  set_src_color_blend_factor: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: RDPipelineColorBlendStateAttachment, #by_ptr args: i64 = 0, r_ret: ^RenderingDevice_BlendFactor)
  },
  ...
  set_color_blend_op: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: RDPipelineColorBlendStateAttachment, #by_ptr args: i64 = 0, r_ret: ^RenderingDevice_BlendOperation)
  },
...
RDPipelineColorBlendStateAttachment_Init_ :: proc (RDPipelineColorBlendStateAttachment_methods: ^RDPipelineColorBlendStateAttachment_MethodBind_List, loc := #caller_location) {
  ...
  RDPipelineColorBlendStateAttachment_methods.set_as_mix.m_call = cast(type_of(RDPipelineColorBlendStateAttachment_methods.set_as_mix.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RDPipelineColorBlendStateAttachment_methods.set_enable_blend.m_call = cast(type_of(RDPipelineColorBlendStateAttachment_methods.set_enable_blend.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RDPipelineColorBlendStateAttachment_methods.get_enable_blend.m_call = cast(type_of(RDPipelineColorBlendStateAttachment_methods.get_enable_blend.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RDPipelineColorBlendStateAttachment_methods.set_src_color_blend_factor.m_call = cast(type_of(RDPipelineColorBlendStateAttachment_methods.set_src_color_blend_factor.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RDPipelineColorBlendStateAttachment_methods.get_src_color_blend_factor.m_call = cast(type_of(RDPipelineColorBlendStateAttachment_methods.get_src_color_blend_factor.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RDPipelineColorBlendStateAttachment_methods.set_dst_color_blend_factor.m_call = cast(type_of(RDPipelineColorBlendStateAttachment_methods.set_dst_color_blend_factor.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RDPipelineColorBlendStateAttachment_methods.get_dst_color_blend_factor.m_call = cast(type_of(RDPipelineColorBlendStateAttachment_methods.get_dst_color_blend_factor.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RDPipelineColorBlendStateAttachment_methods.set_color_blend_op.m_call = cast(type_of(RDPipelineColorBlendStateAttachment_methods.set_color_blend_op.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RDPipelineColorBlendStateAttachment_methods.get_color_blend_op.m_call = cast(type_of(RDPipelineColorBlendStateAttachment_methods.get_color_blend_op.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RDPipelineColorBlendStateAttachment_methods.set_src_alpha_blend_factor.m_call = cast(type_of(RDPipelineColorBlendStateAttachment_methods.set_src_alpha_blend_factor.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RDPipelineColorBlendStateAttachment_methods.get_src_alpha_blend_factor.m_call = cast(type_of(RDPipelineColorBlendStateAttachment_methods.get_src_alpha_blend_factor.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RDPipelineColorBlendStateAttachment_methods.set_dst_alpha_blend_factor.m_call = cast(type_of(RDPipelineColorBlendStateAttachment_methods.set_dst_alpha_blend_factor.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RDPipelineColorBlendStateAttachment_methods.get_dst_alpha_blend_factor.m_call = cast(type_of(RDPipelineColorBlendStateAttachment_methods.get_dst_alpha_blend_factor.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RDPipelineColorBlendStateAttachment_methods.set_alpha_blend_op.m_call = cast(type_of(RDPipelineColorBlendStateAttachment_methods.set_alpha_blend_op.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RDPipelineColorBlendStateAttachment_methods.get_alpha_blend_op.m_call = cast(type_of(RDPipelineColorBlendStateAttachment_methods.get_alpha_blend_op.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RDPipelineColorBlendStateAttachment_methods.set_write_r.m_call = cast(type_of(RDPipelineColorBlendStateAttachment_methods.set_write_r.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RDPipelineColorBlendStateAttachment_methods.get_write_r.m_call = cast(type_of(RDPipelineColorBlendStateAttachment_methods.get_write_r.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RDPipelineColorBlendStateAttachment_methods.set_write_g.m_call = cast(type_of(RDPipelineColorBlendStateAttachment_methods.set_write_g.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RDPipelineColorBlendStateAttachment_methods.get_write_g.m_call = cast(type_of(RDPipelineColorBlendStateAttachment_methods.get_write_g.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RDPipelineColorBlendStateAttachment_methods.set_write_b.m_call = cast(type_of(RDPipelineColorBlendStateAttachment_methods.set_write_b.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RDPipelineColorBlendStateAttachment_methods.get_write_b.m_call = cast(type_of(RDPipelineColorBlendStateAttachment_methods.get_write_b.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RDPipelineColorBlendStateAttachment_methods.set_write_a.m_call = cast(type_of(RDPipelineColorBlendStateAttachment_methods.set_write_a.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RDPipelineColorBlendStateAttachment_methods.get_write_a.m_call = cast(type_of(RDPipelineColorBlendStateAttachment_methods.get_write_a.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
