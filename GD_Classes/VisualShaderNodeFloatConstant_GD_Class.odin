...
VisualShaderNodeFloatConstant_MethodBind_List :: struct {
  set_constant: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: VisualShaderNodeFloatConstant, #by_ptr args: struct{constant: ^GDW.float, }, r_ret: rawptr = nil)
  },
    get_constant: struct{
    using _get_constant: ^GDW.MethodBind,
    m_call: proc "c" (_:^GDW.MethodBind, obj: VisualShaderNodeFloatConstant, args: rawptr = nil, r_ret: ^GDW.float)
  },
};
VisualShaderNodeFloatConstant_Init_ :: proc (VisualShaderNodeFloatConstant_methods: ^VisualShaderNodeFloatConstant_MethodBind_List, loc := #caller_location) {
  ...
  VisualShaderNodeFloatConstant_methods.set_constant._set_constant = (cast(^GDW.MethodBind)classDBGetMethodBind3(.VisualShaderNodeFloatConstant, "set_constant", 373806689, loc))
  ...
  VisualShaderNodeFloatConstant_methods.get_constant._get_constant = (cast(^GDW.MethodBind)classDBGetMethodBind3(.VisualShaderNodeFloatConstant, "get_constant", 1740695150, loc))
