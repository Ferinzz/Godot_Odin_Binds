...
VisibleOnScreenNotifier3D_MethodBind_List :: struct {
  set_aabb: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: VisibleOnScreenNotifier3D, #by_ptr args: struct{rect: ^GDW.AABB, }, r_ret: rawptr = nil)
  },
    is_on_screen: struct{
    using _is_on_screen: ^GDW.MethodBind,
    m_call: proc "c" (_:^GDW.MethodBind, obj: VisibleOnScreenNotifier3D, args: rawptr = nil, r_ret: ^GDW.Bool)
  },
};
VisibleOnScreenNotifier3D_Init_ :: proc (VisibleOnScreenNotifier3D_methods: ^VisibleOnScreenNotifier3D_MethodBind_List, loc := #caller_location) {
  ...
  VisibleOnScreenNotifier3D_methods.set_aabb._set_aabb = (cast(^GDW.MethodBind)classDBGetMethodBind3(.VisibleOnScreenNotifier3D, "set_aabb", 259215842, loc))
  ...
  VisibleOnScreenNotifier3D_methods.is_on_screen._is_on_screen = (cast(^GDW.MethodBind)classDBGetMethodBind3(.VisibleOnScreenNotifier3D, "is_on_screen", 36873697, loc))
