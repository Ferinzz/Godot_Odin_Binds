...
ReferenceRect_Init_ :: proc (ReferenceRect_methods: ^ReferenceRect_MethodBind_List, loc := #caller_location) {
  ...
  ReferenceRect_methods.get_border_color.m_call = cast(type_of(ReferenceRect_methods.get_border_color.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ReferenceRect_methods.set_border_color.m_call = cast(type_of(ReferenceRect_methods.set_border_color.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ReferenceRect_methods.get_border_width.m_call = cast(type_of(ReferenceRect_methods.get_border_width.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ReferenceRect_methods.set_border_width.m_call = cast(type_of(ReferenceRect_methods.set_border_width.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ReferenceRect_methods.get_editor_only.m_call = cast(type_of(ReferenceRect_methods.get_editor_only.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ReferenceRect_methods.set_editor_only.m_call = cast(type_of(ReferenceRect_methods.set_editor_only.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
