...
EditorProperty_Init_ :: proc (EditorProperty_methods: ^EditorProperty_MethodBind_List, loc := #caller_location) {
  ...
  EditorProperty_methods.set_label.m_call = cast(type_of(EditorProperty_methods.set_label.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorProperty_methods.get_label.m_call = cast(type_of(EditorProperty_methods.get_label.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorProperty_methods.set_read_only.m_call = cast(type_of(EditorProperty_methods.set_read_only.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorProperty_methods.is_read_only.m_call = cast(type_of(EditorProperty_methods.is_read_only.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorProperty_methods.set_draw_label.m_call = cast(type_of(EditorProperty_methods.set_draw_label.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorProperty_methods.is_draw_label.m_call = cast(type_of(EditorProperty_methods.is_draw_label.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorProperty_methods.set_draw_background.m_call = cast(type_of(EditorProperty_methods.set_draw_background.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorProperty_methods.is_draw_background.m_call = cast(type_of(EditorProperty_methods.is_draw_background.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorProperty_methods.set_checkable.m_call = cast(type_of(EditorProperty_methods.set_checkable.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorProperty_methods.is_checkable.m_call = cast(type_of(EditorProperty_methods.is_checkable.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorProperty_methods.set_checked.m_call = cast(type_of(EditorProperty_methods.set_checked.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorProperty_methods.is_checked.m_call = cast(type_of(EditorProperty_methods.is_checked.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorProperty_methods.set_draw_warning.m_call = cast(type_of(EditorProperty_methods.set_draw_warning.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorProperty_methods.is_draw_warning.m_call = cast(type_of(EditorProperty_methods.is_draw_warning.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorProperty_methods.set_keying.m_call = cast(type_of(EditorProperty_methods.set_keying.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorProperty_methods.is_keying.m_call = cast(type_of(EditorProperty_methods.is_keying.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorProperty_methods.set_deletable.m_call = cast(type_of(EditorProperty_methods.set_deletable.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorProperty_methods.is_deletable.m_call = cast(type_of(EditorProperty_methods.is_deletable.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorProperty_methods.get_edited_property.m_call = cast(type_of(EditorProperty_methods.get_edited_property.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorProperty_methods.get_edited_object.m_call = cast(type_of(EditorProperty_methods.get_edited_object.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorProperty_methods.update_property.m_call = cast(type_of(EditorProperty_methods.update_property.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorProperty_methods.add_focusable.m_call = cast(type_of(EditorProperty_methods.add_focusable.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorProperty_methods.set_bottom_editor.m_call = cast(type_of(EditorProperty_methods.set_bottom_editor.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorProperty_methods.set_selectable.m_call = cast(type_of(EditorProperty_methods.set_selectable.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorProperty_methods.is_selectable.m_call = cast(type_of(EditorProperty_methods.is_selectable.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorProperty_methods.set_use_folding.m_call = cast(type_of(EditorProperty_methods.set_use_folding.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorProperty_methods.is_using_folding.m_call = cast(type_of(EditorProperty_methods.is_using_folding.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorProperty_methods.set_name_split_ratio.m_call = cast(type_of(EditorProperty_methods.set_name_split_ratio.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorProperty_methods.get_name_split_ratio.m_call = cast(type_of(EditorProperty_methods.get_name_split_ratio.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorProperty_methods.deselect.m_call = cast(type_of(EditorProperty_methods.deselect.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorProperty_methods.is_selected.m_call = cast(type_of(EditorProperty_methods.is_selected.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  EditorProperty_methods.select._select = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.EditorProperty, "select", 1025054187, loc))
  EditorProperty_methods.select.m_call = cast(type_of(EditorProperty_methods.select.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorProperty_methods.set_object_and_property.m_call = cast(type_of(EditorProperty_methods.set_object_and_property.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorProperty_methods.set_label_reference.m_call = cast(type_of(EditorProperty_methods.set_label_reference.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorProperty_methods.emit_changed.m_call = cast(type_of(EditorProperty_methods.emit_changed.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
