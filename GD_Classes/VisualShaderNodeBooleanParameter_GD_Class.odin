...
VisualShaderNodeBooleanParameter_Init_ :: proc (VisualShaderNodeBooleanParameter_methods: ^VisualShaderNodeBooleanParameter_MethodBind_List, loc := #caller_location) {
  ...
  VisualShaderNodeBooleanParameter_methods.set_default_value_enabled.m_call = cast(type_of(VisualShaderNodeBooleanParameter_methods.set_default_value_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeBooleanParameter_methods.is_default_value_enabled.m_call = cast(type_of(VisualShaderNodeBooleanParameter_methods.is_default_value_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeBooleanParameter_methods.set_default_value.m_call = cast(type_of(VisualShaderNodeBooleanParameter_methods.set_default_value.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeBooleanParameter_methods.get_default_value.m_call = cast(type_of(VisualShaderNodeBooleanParameter_methods.get_default_value.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
