...
EditorNode3DGizmoPlugin_MethodBind_List :: struct {
  create_material: ^GDW.MethodBind,
  create_icon_material: ^GDW.MethodBind,
  create_handle_material: ^GDW.MethodBind,
  add_material: ^GDW.MethodBind,
...
EditorNode3DGizmoPlugin_Init_ :: proc (EditorNode3DGizmoPlugin_methods: ^EditorNode3DGizmoPlugin_MethodBind_List, loc := #caller_location) {
  EditorNode3DGizmoPlugin_methods.create_material = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.EditorNode3DGizmoPlugin, "create_material", 3486012546, loc))
  EditorNode3DGizmoPlugin_methods.create_icon_material = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.EditorNode3DGizmoPlugin, "create_icon_material", 3804976916, loc))
  EditorNode3DGizmoPlugin_methods.create_handle_material = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.EditorNode3DGizmoPlugin, "create_handle_material", 2486475223, loc))
  EditorNode3DGizmoPlugin_methods.add_material = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.EditorNode3DGizmoPlugin, "add_material", 1374068695, loc))
  EditorNode3DGizmoPlugin_methods.get_material = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.EditorNode3DGizmoPlugin, "get_material", 974464017, loc))
};
