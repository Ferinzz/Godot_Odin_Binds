...
TileSet_Init_ :: proc (TileSet_methods: ^TileSet_MethodBind_List, loc := #caller_location) {
  ...
  TileSet_methods.get_next_source_id.m_call = cast(type_of(TileSet_methods.get_next_source_id.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  TileSet_methods.add_source._add_source = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TileSet, "add_source", 1059186179, loc))
  TileSet_methods.add_source.m_call = cast(type_of(TileSet_methods.add_source.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.remove_source.m_call = cast(type_of(TileSet_methods.remove_source.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.set_source_id.m_call = cast(type_of(TileSet_methods.set_source_id.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.get_source_count.m_call = cast(type_of(TileSet_methods.get_source_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.get_source_id.m_call = cast(type_of(TileSet_methods.get_source_id.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  TileSet_methods.has_source._has_source = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TileSet, "has_source", 1116898809, loc))
  TileSet_methods.has_source.m_call = cast(type_of(TileSet_methods.has_source.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  TileSet_methods.get_source._get_source = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TileSet, "get_source", 1763540252, loc))
  TileSet_methods.get_source.m_call = cast(type_of(TileSet_methods.get_source.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.set_tile_shape.m_call = cast(type_of(TileSet_methods.set_tile_shape.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.get_tile_shape.m_call = cast(type_of(TileSet_methods.get_tile_shape.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.set_tile_layout.m_call = cast(type_of(TileSet_methods.set_tile_layout.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.get_tile_layout.m_call = cast(type_of(TileSet_methods.get_tile_layout.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.set_tile_offset_axis.m_call = cast(type_of(TileSet_methods.set_tile_offset_axis.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.get_tile_offset_axis.m_call = cast(type_of(TileSet_methods.get_tile_offset_axis.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.set_tile_size.m_call = cast(type_of(TileSet_methods.set_tile_size.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.get_tile_size.m_call = cast(type_of(TileSet_methods.get_tile_size.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.set_uv_clipping.m_call = cast(type_of(TileSet_methods.set_uv_clipping.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.is_uv_clipping.m_call = cast(type_of(TileSet_methods.is_uv_clipping.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.get_occlusion_layers_count.m_call = cast(type_of(TileSet_methods.get_occlusion_layers_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.add_occlusion_layer.m_call = cast(type_of(TileSet_methods.add_occlusion_layer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.move_occlusion_layer.m_call = cast(type_of(TileSet_methods.move_occlusion_layer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.remove_occlusion_layer.m_call = cast(type_of(TileSet_methods.remove_occlusion_layer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.set_occlusion_layer_light_mask.m_call = cast(type_of(TileSet_methods.set_occlusion_layer_light_mask.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.get_occlusion_layer_light_mask.m_call = cast(type_of(TileSet_methods.get_occlusion_layer_light_mask.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.set_occlusion_layer_sdf_collision.m_call = cast(type_of(TileSet_methods.set_occlusion_layer_sdf_collision.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.get_occlusion_layer_sdf_collision.m_call = cast(type_of(TileSet_methods.get_occlusion_layer_sdf_collision.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.get_physics_layers_count.m_call = cast(type_of(TileSet_methods.get_physics_layers_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.add_physics_layer.m_call = cast(type_of(TileSet_methods.add_physics_layer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.move_physics_layer.m_call = cast(type_of(TileSet_methods.move_physics_layer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.remove_physics_layer.m_call = cast(type_of(TileSet_methods.remove_physics_layer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.set_physics_layer_collision_layer.m_call = cast(type_of(TileSet_methods.set_physics_layer_collision_layer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.get_physics_layer_collision_layer.m_call = cast(type_of(TileSet_methods.get_physics_layer_collision_layer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.set_physics_layer_collision_mask.m_call = cast(type_of(TileSet_methods.set_physics_layer_collision_mask.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.get_physics_layer_collision_mask.m_call = cast(type_of(TileSet_methods.get_physics_layer_collision_mask.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.set_physics_layer_collision_priority.m_call = cast(type_of(TileSet_methods.set_physics_layer_collision_priority.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.get_physics_layer_collision_priority.m_call = cast(type_of(TileSet_methods.get_physics_layer_collision_priority.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.set_physics_layer_physics_material.m_call = cast(type_of(TileSet_methods.set_physics_layer_physics_material.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.get_physics_layer_physics_material.m_call = cast(type_of(TileSet_methods.get_physics_layer_physics_material.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.get_terrain_sets_count.m_call = cast(type_of(TileSet_methods.get_terrain_sets_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.add_terrain_set.m_call = cast(type_of(TileSet_methods.add_terrain_set.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.move_terrain_set.m_call = cast(type_of(TileSet_methods.move_terrain_set.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.remove_terrain_set.m_call = cast(type_of(TileSet_methods.remove_terrain_set.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.set_terrain_set_mode.m_call = cast(type_of(TileSet_methods.set_terrain_set_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.get_terrain_set_mode.m_call = cast(type_of(TileSet_methods.get_terrain_set_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.get_terrains_count.m_call = cast(type_of(TileSet_methods.get_terrains_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.add_terrain.m_call = cast(type_of(TileSet_methods.add_terrain.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.move_terrain.m_call = cast(type_of(TileSet_methods.move_terrain.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.remove_terrain.m_call = cast(type_of(TileSet_methods.remove_terrain.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.set_terrain_name.m_call = cast(type_of(TileSet_methods.set_terrain_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.get_terrain_name.m_call = cast(type_of(TileSet_methods.get_terrain_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.set_terrain_color.m_call = cast(type_of(TileSet_methods.set_terrain_color.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.get_terrain_color.m_call = cast(type_of(TileSet_methods.get_terrain_color.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.get_navigation_layers_count.m_call = cast(type_of(TileSet_methods.get_navigation_layers_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.add_navigation_layer.m_call = cast(type_of(TileSet_methods.add_navigation_layer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.move_navigation_layer.m_call = cast(type_of(TileSet_methods.move_navigation_layer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.remove_navigation_layer.m_call = cast(type_of(TileSet_methods.remove_navigation_layer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.set_navigation_layer_layers.m_call = cast(type_of(TileSet_methods.set_navigation_layer_layers.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.get_navigation_layer_layers.m_call = cast(type_of(TileSet_methods.get_navigation_layer_layers.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.set_navigation_layer_layer_value.m_call = cast(type_of(TileSet_methods.set_navigation_layer_layer_value.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.get_navigation_layer_layer_value.m_call = cast(type_of(TileSet_methods.get_navigation_layer_layer_value.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.get_custom_data_layers_count.m_call = cast(type_of(TileSet_methods.get_custom_data_layers_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.add_custom_data_layer.m_call = cast(type_of(TileSet_methods.add_custom_data_layer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.move_custom_data_layer.m_call = cast(type_of(TileSet_methods.move_custom_data_layer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.remove_custom_data_layer.m_call = cast(type_of(TileSet_methods.remove_custom_data_layer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.get_custom_data_layer_by_name.m_call = cast(type_of(TileSet_methods.get_custom_data_layer_by_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.set_custom_data_layer_name.m_call = cast(type_of(TileSet_methods.set_custom_data_layer_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.has_custom_data_layer_by_name.m_call = cast(type_of(TileSet_methods.has_custom_data_layer_by_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.get_custom_data_layer_name.m_call = cast(type_of(TileSet_methods.get_custom_data_layer_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.set_custom_data_layer_type.m_call = cast(type_of(TileSet_methods.set_custom_data_layer_type.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.get_custom_data_layer_type.m_call = cast(type_of(TileSet_methods.get_custom_data_layer_type.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.set_source_level_tile_proxy.m_call = cast(type_of(TileSet_methods.set_source_level_tile_proxy.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.get_source_level_tile_proxy.m_call = cast(type_of(TileSet_methods.get_source_level_tile_proxy.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.has_source_level_tile_proxy.m_call = cast(type_of(TileSet_methods.has_source_level_tile_proxy.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.remove_source_level_tile_proxy.m_call = cast(type_of(TileSet_methods.remove_source_level_tile_proxy.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.set_coords_level_tile_proxy.m_call = cast(type_of(TileSet_methods.set_coords_level_tile_proxy.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.get_coords_level_tile_proxy.m_call = cast(type_of(TileSet_methods.get_coords_level_tile_proxy.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.has_coords_level_tile_proxy.m_call = cast(type_of(TileSet_methods.has_coords_level_tile_proxy.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.remove_coords_level_tile_proxy.m_call = cast(type_of(TileSet_methods.remove_coords_level_tile_proxy.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.set_alternative_level_tile_proxy.m_call = cast(type_of(TileSet_methods.set_alternative_level_tile_proxy.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.get_alternative_level_tile_proxy.m_call = cast(type_of(TileSet_methods.get_alternative_level_tile_proxy.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.has_alternative_level_tile_proxy.m_call = cast(type_of(TileSet_methods.has_alternative_level_tile_proxy.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.remove_alternative_level_tile_proxy.m_call = cast(type_of(TileSet_methods.remove_alternative_level_tile_proxy.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.map_tile_proxy.m_call = cast(type_of(TileSet_methods.map_tile_proxy.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.cleanup_invalid_tile_proxies.m_call = cast(type_of(TileSet_methods.cleanup_invalid_tile_proxies.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.clear_tile_proxies.m_call = cast(type_of(TileSet_methods.clear_tile_proxies.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  TileSet_methods.add_pattern._add_pattern = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TileSet, "add_pattern", 763712015, loc))
  TileSet_methods.add_pattern.m_call = cast(type_of(TileSet_methods.add_pattern.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.get_pattern.m_call = cast(type_of(TileSet_methods.get_pattern.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.remove_pattern.m_call = cast(type_of(TileSet_methods.remove_pattern.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileSet_methods.get_patterns_count.m_call = cast(type_of(TileSet_methods.get_patterns_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
