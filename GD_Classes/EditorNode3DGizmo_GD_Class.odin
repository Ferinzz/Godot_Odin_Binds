...
EditorNode3DGizmo_MethodBind_List :: struct {
  add_lines: ^GDW.MethodBind,
  add_mesh: ^GDW.MethodBind,
  add_collision_segments: ^GDW.MethodBind,
  add_collision_triangles: ^GDW.MethodBind,
  add_unscaled_billboard: ^GDW.MethodBind,
  add_handles: ^GDW.MethodBind,
  set_node_3d: ^GDW.MethodBind,
  get_node_3d: ^GDW.MethodBind,
  get_plugin: ^GDW.MethodBind,
  clear: ^GDW.MethodBind,
  set_hidden: ^GDW.MethodBind,
  is_subgizmo_selected: ^GDW.MethodBind,
  get_subgizmo_selection: ^GDW.MethodBind,
};
EditorNode3DGizmo_Init_ :: proc (EditorNode3DGizmo_methods: ^EditorNode3DGizmo_MethodBind_List, loc := #caller_location) {
  EditorNode3DGizmo_methods.add_lines = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.EditorNode3DGizmo, "add_lines", 2910971437, loc))
  EditorNode3DGizmo_methods.add_mesh = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.EditorNode3DGizmo, "add_mesh", 1579955111, loc))
  EditorNode3DGizmo_methods.add_collision_segments = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.EditorNode3DGizmo, "add_collision_segments", 334873810, loc))
  EditorNode3DGizmo_methods.add_collision_triangles = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.EditorNode3DGizmo, "add_collision_triangles", 54901064, loc))
  EditorNode3DGizmo_methods.add_unscaled_billboard = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.EditorNode3DGizmo, "add_unscaled_billboard", 520007164, loc))
  EditorNode3DGizmo_methods.add_handles = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.EditorNode3DGizmo, "add_handles", 2254560097, loc))
  EditorNode3DGizmo_methods.set_node_3d = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.EditorNode3DGizmo, "set_node_3d", 1078189570, loc))
  EditorNode3DGizmo_methods.get_node_3d = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.EditorNode3DGizmo, "get_node_3d", 151077316, loc))
  EditorNode3DGizmo_methods.get_plugin = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.EditorNode3DGizmo, "get_plugin", 4250544552, loc))
  EditorNode3DGizmo_methods.clear = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.EditorNode3DGizmo, "clear", 3218959716, loc))
  EditorNode3DGizmo_methods.set_hidden = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.EditorNode3DGizmo, "set_hidden", 2586408642, loc))
  EditorNode3DGizmo_methods.is_subgizmo_selected = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.EditorNode3DGizmo, "is_subgizmo_selected", 1116898809, loc))
  EditorNode3DGizmo_methods.get_subgizmo_selection = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.EditorNode3DGizmo, "get_subgizmo_selection", 1930428628, loc))
};
