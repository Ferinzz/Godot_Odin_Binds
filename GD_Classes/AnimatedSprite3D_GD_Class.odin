...
AnimatedSprite3D_Init_ :: proc (AnimatedSprite3D_methods: ^AnimatedSprite3D_MethodBind_List, loc := #caller_location) {
  AnimatedSprite3D_methods.set_sprite_frames = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AnimatedSprite3D, "set_sprite_frames", 905781144, loc))
  AnimatedSprite3D_methods.get_sprite_frames = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AnimatedSprite3D, "get_sprite_frames", 3804851214, loc))
  AnimatedSprite3D_methods.set_animation = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AnimatedSprite3D, "set_animation", 3304788590, loc))
  AnimatedSprite3D_methods.get_animation = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AnimatedSprite3D, "get_animation", 2002593661, loc))
  AnimatedSprite3D_methods.set_autoplay = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AnimatedSprite3D, "set_autoplay", 83702148, loc))
  AnimatedSprite3D_methods.get_autoplay = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AnimatedSprite3D, "get_autoplay", 201670096, loc))
  AnimatedSprite3D_methods.is_playing = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AnimatedSprite3D, "is_playing", 36873697, loc))
  AnimatedSprite3D_methods.play = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AnimatedSprite3D, "play", 3269405555, loc))
  AnimatedSprite3D_methods.play_backwards = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AnimatedSprite3D, "play_backwards", 3323268493, loc))
  AnimatedSprite3D_methods.pause = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AnimatedSprite3D, "pause", 3218959716, loc))
  AnimatedSprite3D_methods.stop = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AnimatedSprite3D, "stop", 3218959716, loc))
  AnimatedSprite3D_methods.set_frame = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AnimatedSprite3D, "set_frame", 1286410249, loc))
  AnimatedSprite3D_methods.get_frame = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AnimatedSprite3D, "get_frame", 3905245786, loc))
  AnimatedSprite3D_methods.set_frame_progress = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AnimatedSprite3D, "set_frame_progress", 373806689, loc))
  AnimatedSprite3D_methods.get_frame_progress = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AnimatedSprite3D, "get_frame_progress", 1740695150, loc))
  AnimatedSprite3D_methods.set_frame_and_progress = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AnimatedSprite3D, "set_frame_and_progress", 1602489585, loc))
  AnimatedSprite3D_methods.set_speed_scale = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AnimatedSprite3D, "set_speed_scale", 373806689, loc))
  AnimatedSprite3D_methods.get_speed_scale = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AnimatedSprite3D, "get_speed_scale", 1740695150, loc))
  AnimatedSprite3D_methods.get_playing_speed = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AnimatedSprite3D, "get_playing_speed", 1740695150, loc))
};
