...
RegEx_Init_ :: proc (RegEx_methods: ^RegEx_MethodBind_List, loc := #caller_location) {
  ...
  RegEx_methods.create_from_string.m_call = cast(type_of(RegEx_methods.create_from_string.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  RegEx_methods.clear._clear = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RegEx, "clear", 3218959716, loc))
  RegEx_methods.clear.m_call = cast(type_of(RegEx_methods.clear.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  RegEx_methods.compile._compile = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RegEx, "compile", 3565188097, loc))
  RegEx_methods.compile.m_call = cast(type_of(RegEx_methods.compile.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  RegEx_methods.search._search = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RegEx, "search", 3365977994, loc))
  RegEx_methods.search.m_call = cast(type_of(RegEx_methods.search.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  RegEx_methods.search_all._search_all = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RegEx, "search_all", 849021363, loc))
  RegEx_methods.search_all.m_call = cast(type_of(RegEx_methods.search_all.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  RegEx_methods.sub._sub = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RegEx, "sub", 54019702, loc))
  RegEx_methods.sub.m_call = cast(type_of(RegEx_methods.sub.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  RegEx_methods.is_valid._is_valid = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RegEx, "is_valid", 36873697, loc))
  RegEx_methods.is_valid.m_call = cast(type_of(RegEx_methods.is_valid.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  RegEx_methods.get_pattern._get_pattern = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RegEx, "get_pattern", 201670096, loc))
  RegEx_methods.get_pattern.m_call = cast(type_of(RegEx_methods.get_pattern.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RegEx_methods.get_group_count.m_call = cast(type_of(RegEx_methods.get_group_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  RegEx_methods.get_names._get_names = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RegEx, "get_names", 1139954409, loc))
  RegEx_methods.get_names.m_call = cast(type_of(RegEx_methods.get_names.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
