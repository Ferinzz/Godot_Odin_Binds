...
EditorFileSystemDirectory_Init_ :: proc (EditorFileSystemDirectory_methods: ^EditorFileSystemDirectory_MethodBind_List, loc := #caller_location) {
  ...
  EditorFileSystemDirectory_methods.get_subdir_count.m_call = cast(type_of(EditorFileSystemDirectory_methods.get_subdir_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorFileSystemDirectory_methods.get_subdir.m_call = cast(type_of(EditorFileSystemDirectory_methods.get_subdir.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorFileSystemDirectory_methods.get_file_count.m_call = cast(type_of(EditorFileSystemDirectory_methods.get_file_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorFileSystemDirectory_methods.get_file.m_call = cast(type_of(EditorFileSystemDirectory_methods.get_file.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorFileSystemDirectory_methods.get_file_path.m_call = cast(type_of(EditorFileSystemDirectory_methods.get_file_path.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorFileSystemDirectory_methods.get_file_type.m_call = cast(type_of(EditorFileSystemDirectory_methods.get_file_type.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorFileSystemDirectory_methods.get_file_script_class_name.m_call = cast(type_of(EditorFileSystemDirectory_methods.get_file_script_class_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorFileSystemDirectory_methods.get_file_script_class_extends.m_call = cast(type_of(EditorFileSystemDirectory_methods.get_file_script_class_extends.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorFileSystemDirectory_methods.get_file_import_is_valid.m_call = cast(type_of(EditorFileSystemDirectory_methods.get_file_import_is_valid.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorFileSystemDirectory_methods.get_name.m_call = cast(type_of(EditorFileSystemDirectory_methods.get_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorFileSystemDirectory_methods.get_path.m_call = cast(type_of(EditorFileSystemDirectory_methods.get_path.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorFileSystemDirectory_methods.get_parent.m_call = cast(type_of(EditorFileSystemDirectory_methods.get_parent.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorFileSystemDirectory_methods.find_file_index.m_call = cast(type_of(EditorFileSystemDirectory_methods.find_file_index.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorFileSystemDirectory_methods.find_dir_index.m_call = cast(type_of(EditorFileSystemDirectory_methods.find_dir_index.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
