...
VisualShaderNodeTexture2DArray_MethodBind_List :: struct {
  set_texture_array: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: VisualShaderNodeTexture2DArray, #by_ptr args: struct{value: ^TextureLayered, }, r_ret: rawptr = nil)
  },
    get_texture_array: struct{
    using _get_texture_array: ^GDW.MethodBind,
    m_call: proc "c" (_:^GDW.MethodBind, obj: VisualShaderNodeTexture2DArray, args: rawptr = nil, r_ret: ^TextureLayered)
  },
};
VisualShaderNodeTexture2DArray_Init_ :: proc (VisualShaderNodeTexture2DArray_methods: ^VisualShaderNodeTexture2DArray_MethodBind_List, loc := #caller_location) {
  ...
  VisualShaderNodeTexture2DArray_methods.set_texture_array._set_texture_array = (cast(^GDW.MethodBind)classDBGetMethodBind3(.VisualShaderNodeTexture2DArray, "set_texture_array", 1278366092, loc))
  ...
  VisualShaderNodeTexture2DArray_methods.get_texture_array._get_texture_array = (cast(^GDW.MethodBind)classDBGetMethodBind3(.VisualShaderNodeTexture2DArray, "get_texture_array", 3984243839, loc))
