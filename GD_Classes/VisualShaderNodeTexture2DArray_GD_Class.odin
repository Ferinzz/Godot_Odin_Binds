...
VisualShaderNodeTexture2DArray_MethodBind_List :: struct {
  set_texture_array: ^GDW.MethodBind,
  get_texture_array: ^GDW.MethodBind,
};
VisualShaderNodeTexture2DArray_Init_ :: proc (VisualShaderNodeTexture2DArray_methods: ^VisualShaderNodeTexture2DArray_MethodBind_List, loc := #caller_location) {
  VisualShaderNodeTexture2DArray_methods.set_texture_array = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.VisualShaderNodeTexture2DArray, "set_texture_array", 1278366092, loc))
  VisualShaderNodeTexture2DArray_methods.get_texture_array = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.VisualShaderNodeTexture2DArray, "get_texture_array", 3984243839, loc))
};
