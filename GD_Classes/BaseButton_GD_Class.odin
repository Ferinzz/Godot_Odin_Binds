...
BaseButton_Init_ :: proc (BaseButton_methods: ^BaseButton_MethodBind_List, loc := #caller_location) {
  ...
  BaseButton_methods.set_pressed.m_call = cast(type_of(BaseButton_methods.set_pressed.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BaseButton_methods.is_pressed.m_call = cast(type_of(BaseButton_methods.is_pressed.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BaseButton_methods.set_pressed_no_signal.m_call = cast(type_of(BaseButton_methods.set_pressed_no_signal.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BaseButton_methods.is_hovered.m_call = cast(type_of(BaseButton_methods.is_hovered.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BaseButton_methods.set_toggle_mode.m_call = cast(type_of(BaseButton_methods.set_toggle_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BaseButton_methods.is_toggle_mode.m_call = cast(type_of(BaseButton_methods.is_toggle_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BaseButton_methods.set_shortcut_in_tooltip.m_call = cast(type_of(BaseButton_methods.set_shortcut_in_tooltip.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BaseButton_methods.is_shortcut_in_tooltip_enabled.m_call = cast(type_of(BaseButton_methods.is_shortcut_in_tooltip_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BaseButton_methods.set_disabled.m_call = cast(type_of(BaseButton_methods.set_disabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BaseButton_methods.is_disabled.m_call = cast(type_of(BaseButton_methods.is_disabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BaseButton_methods.set_action_mode.m_call = cast(type_of(BaseButton_methods.set_action_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BaseButton_methods.get_action_mode.m_call = cast(type_of(BaseButton_methods.get_action_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BaseButton_methods.set_button_mask.m_call = cast(type_of(BaseButton_methods.set_button_mask.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BaseButton_methods.get_button_mask.m_call = cast(type_of(BaseButton_methods.get_button_mask.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BaseButton_methods.get_draw_mode.m_call = cast(type_of(BaseButton_methods.get_draw_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BaseButton_methods.set_keep_pressed_outside.m_call = cast(type_of(BaseButton_methods.set_keep_pressed_outside.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BaseButton_methods.is_keep_pressed_outside.m_call = cast(type_of(BaseButton_methods.is_keep_pressed_outside.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BaseButton_methods.set_shortcut_feedback.m_call = cast(type_of(BaseButton_methods.set_shortcut_feedback.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BaseButton_methods.is_shortcut_feedback.m_call = cast(type_of(BaseButton_methods.is_shortcut_feedback.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BaseButton_methods.set_shortcut.m_call = cast(type_of(BaseButton_methods.set_shortcut.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BaseButton_methods.get_shortcut.m_call = cast(type_of(BaseButton_methods.get_shortcut.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BaseButton_methods.set_button_group.m_call = cast(type_of(BaseButton_methods.set_button_group.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BaseButton_methods.get_button_group.m_call = cast(type_of(BaseButton_methods.get_button_group.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
