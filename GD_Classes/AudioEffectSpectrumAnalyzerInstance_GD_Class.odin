...
AudioEffectSpectrumAnalyzerInstance_MethodBind_List :: struct {
  get_magnitude_for_frequency_range: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: AudioEffectSpectrumAnalyzerInstance, #by_ptr args: struct{from_hz: ^GDW.float, to_hz: ^GDW.float, mode: ^AudioEffectSpectrumAnalyzerInstance_MagnitudeMode, }, r_ret: ^GDW.Vector2)
  },
};
AudioEffectSpectrumAnalyzerInstance_Init_ :: proc (AudioEffectSpectrumAnalyzerInstance_methods: ^AudioEffectSpectrumAnalyzerInstance_MethodBind_List, loc := #caller_location) {
  ...
  AudioEffectSpectrumAnalyzerInstance_methods.get_magnitude_for_frequency_range._get_magnitude_for_frequency_range = (cast(^GDW.MethodBind)classDBGetMethodBind3(.AudioEffectSpectrumAnalyzerInstance, "get_magnitude_for_frequency_range", 797993915, loc))
