...
BoneAxis_SkeletonModifier3D :: enum i64 {
  BONE_AXIS_PLUS_X = 0,
  BONE_AXIS_MINUS_X = 1,
  BONE_AXIS_PLUS_Y = 2,
  BONE_AXIS_MINUS_Y = 3,
...
BoneDirection_SkeletonModifier3D :: enum i64 {
...
SecondaryDirection_SkeletonModifier3D :: enum i64 {
...
RotationAxis_SkeletonModifier3D :: enum i64 {
  ROTATION_AXIS_X = 0,
  ROTATION_AXIS_Y = 1,
  ROTATION_AXIS_Z = 2,
  ROTATION_AXIS_ALL = 3,
...
SkeletonModifier3D_MethodBind_List :: struct {
  ...
  set_influence: ^GDW.MethodBind,
  get_influence: ^GDW.MethodBind,
};
SkeletonModifier3D_Init_ :: proc (SkeletonModifier3D_methods: ^SkeletonModifier3D_MethodBind_List, loc := #caller_location) {
  SkeletonModifier3D_methods.get_skeleton = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.SkeletonModifier3D, "get_skeleton", 1488626673, loc))
  SkeletonModifier3D_methods.set_active = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.SkeletonModifier3D, "set_active", 2586408642, loc))
  SkeletonModifier3D_methods.is_active = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.SkeletonModifier3D, "is_active", 36873697, loc))
  SkeletonModifier3D_methods.set_influence = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.SkeletonModifier3D, "set_influence", 373806689, loc))
  SkeletonModifier3D_methods.get_influence = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.SkeletonModifier3D, "get_influence", 1740695150, loc))
};
