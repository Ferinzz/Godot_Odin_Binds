...
PlaceholderTexture3D_Init_ :: proc (PlaceholderTexture3D_methods: ^PlaceholderTexture3D_MethodBind_List, loc := #caller_location) {
  PlaceholderTexture3D_methods.set_size = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.PlaceholderTexture3D, "set_size", 560364750, loc))
  PlaceholderTexture3D_methods.get_size = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.PlaceholderTexture3D, "get_size", 2785653706, loc))
};
