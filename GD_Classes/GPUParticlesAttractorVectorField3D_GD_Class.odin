...
GPUParticlesAttractorVectorField3D_Init_ :: proc (GPUParticlesAttractorVectorField3D_methods: ^GPUParticlesAttractorVectorField3D_MethodBind_List, loc := #caller_location) {
  ...
  GPUParticlesAttractorVectorField3D_methods.set_size.m_call = cast(type_of(GPUParticlesAttractorVectorField3D_methods.set_size.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GPUParticlesAttractorVectorField3D_methods.get_size.m_call = cast(type_of(GPUParticlesAttractorVectorField3D_methods.get_size.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GPUParticlesAttractorVectorField3D_methods.set_texture.m_call = cast(type_of(GPUParticlesAttractorVectorField3D_methods.set_texture.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GPUParticlesAttractorVectorField3D_methods.get_texture.m_call = cast(type_of(GPUParticlesAttractorVectorField3D_methods.get_texture.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
