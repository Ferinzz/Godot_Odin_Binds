...
MeshLibrary_Init_ :: proc (MeshLibrary_methods: ^MeshLibrary_MethodBind_List, loc := #caller_location) {
  ...
  MeshLibrary_methods.create_item.m_call = cast(type_of(MeshLibrary_methods.create_item.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshLibrary_methods.set_item_name.m_call = cast(type_of(MeshLibrary_methods.set_item_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshLibrary_methods.set_item_mesh.m_call = cast(type_of(MeshLibrary_methods.set_item_mesh.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshLibrary_methods.set_item_mesh_transform.m_call = cast(type_of(MeshLibrary_methods.set_item_mesh_transform.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshLibrary_methods.set_item_mesh_cast_shadow.m_call = cast(type_of(MeshLibrary_methods.set_item_mesh_cast_shadow.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshLibrary_methods.set_item_navigation_mesh.m_call = cast(type_of(MeshLibrary_methods.set_item_navigation_mesh.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshLibrary_methods.set_item_navigation_mesh_transform.m_call = cast(type_of(MeshLibrary_methods.set_item_navigation_mesh_transform.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshLibrary_methods.set_item_navigation_layers.m_call = cast(type_of(MeshLibrary_methods.set_item_navigation_layers.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshLibrary_methods.set_item_shapes.m_call = cast(type_of(MeshLibrary_methods.set_item_shapes.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshLibrary_methods.set_item_preview.m_call = cast(type_of(MeshLibrary_methods.set_item_preview.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshLibrary_methods.get_item_name.m_call = cast(type_of(MeshLibrary_methods.get_item_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshLibrary_methods.get_item_mesh.m_call = cast(type_of(MeshLibrary_methods.get_item_mesh.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshLibrary_methods.get_item_mesh_transform.m_call = cast(type_of(MeshLibrary_methods.get_item_mesh_transform.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshLibrary_methods.get_item_mesh_cast_shadow.m_call = cast(type_of(MeshLibrary_methods.get_item_mesh_cast_shadow.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshLibrary_methods.get_item_navigation_mesh.m_call = cast(type_of(MeshLibrary_methods.get_item_navigation_mesh.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshLibrary_methods.get_item_navigation_mesh_transform.m_call = cast(type_of(MeshLibrary_methods.get_item_navigation_mesh_transform.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshLibrary_methods.get_item_navigation_layers.m_call = cast(type_of(MeshLibrary_methods.get_item_navigation_layers.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshLibrary_methods.get_item_shapes.m_call = cast(type_of(MeshLibrary_methods.get_item_shapes.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshLibrary_methods.get_item_preview.m_call = cast(type_of(MeshLibrary_methods.get_item_preview.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshLibrary_methods.remove_item.m_call = cast(type_of(MeshLibrary_methods.remove_item.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshLibrary_methods.find_item_by_name.m_call = cast(type_of(MeshLibrary_methods.find_item_by_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  MeshLibrary_methods.clear._clear = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.MeshLibrary, "clear", 3218959716, loc))
  MeshLibrary_methods.clear.m_call = cast(type_of(MeshLibrary_methods.clear.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshLibrary_methods.get_item_list.m_call = cast(type_of(MeshLibrary_methods.get_item_list.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshLibrary_methods.get_last_unused_item_id.m_call = cast(type_of(MeshLibrary_methods.get_last_unused_item_id.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
