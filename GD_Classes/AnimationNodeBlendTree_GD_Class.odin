...
AnimationNodeBlendTree_Init_ :: proc (AnimationNodeBlendTree_methods: ^AnimationNodeBlendTree_MethodBind_List, loc := #caller_location) {
  ...
  AnimationNodeBlendTree_methods.add_node.m_call = cast(type_of(AnimationNodeBlendTree_methods.add_node.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AnimationNodeBlendTree_methods.get_node.m_call = cast(type_of(AnimationNodeBlendTree_methods.get_node.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AnimationNodeBlendTree_methods.remove_node.m_call = cast(type_of(AnimationNodeBlendTree_methods.remove_node.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AnimationNodeBlendTree_methods.rename_node.m_call = cast(type_of(AnimationNodeBlendTree_methods.rename_node.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AnimationNodeBlendTree_methods.has_node.m_call = cast(type_of(AnimationNodeBlendTree_methods.has_node.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AnimationNodeBlendTree_methods.connect_node.m_call = cast(type_of(AnimationNodeBlendTree_methods.connect_node.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AnimationNodeBlendTree_methods.disconnect_node.m_call = cast(type_of(AnimationNodeBlendTree_methods.disconnect_node.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AnimationNodeBlendTree_methods.get_node_list.m_call = cast(type_of(AnimationNodeBlendTree_methods.get_node_list.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AnimationNodeBlendTree_methods.set_node_position.m_call = cast(type_of(AnimationNodeBlendTree_methods.set_node_position.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AnimationNodeBlendTree_methods.get_node_position.m_call = cast(type_of(AnimationNodeBlendTree_methods.get_node_position.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AnimationNodeBlendTree_methods.set_graph_offset.m_call = cast(type_of(AnimationNodeBlendTree_methods.set_graph_offset.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AnimationNodeBlendTree_methods.get_graph_offset.m_call = cast(type_of(AnimationNodeBlendTree_methods.get_graph_offset.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
