...
GLTFCamera_Init_ :: proc (GLTFCamera_methods: ^GLTFCamera_MethodBind_List, loc := #caller_location) {
  ...
  GLTFCamera_methods.from_node.m_call = cast(type_of(GLTFCamera_methods.from_node.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  GLTFCamera_methods.to_node._to_node = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GLTFCamera, "to_node", 2285090890, loc))
  GLTFCamera_methods.to_node.m_call = cast(type_of(GLTFCamera_methods.to_node.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFCamera_methods.from_dictionary.m_call = cast(type_of(GLTFCamera_methods.from_dictionary.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFCamera_methods.to_dictionary.m_call = cast(type_of(GLTFCamera_methods.to_dictionary.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFCamera_methods.get_perspective.m_call = cast(type_of(GLTFCamera_methods.get_perspective.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFCamera_methods.set_perspective.m_call = cast(type_of(GLTFCamera_methods.set_perspective.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  GLTFCamera_methods.get_fov._get_fov = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GLTFCamera, "get_fov", 1740695150, loc))
  GLTFCamera_methods.get_fov.m_call = cast(type_of(GLTFCamera_methods.get_fov.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  GLTFCamera_methods.set_fov._set_fov = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GLTFCamera, "set_fov", 373806689, loc))
  GLTFCamera_methods.set_fov.m_call = cast(type_of(GLTFCamera_methods.set_fov.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFCamera_methods.get_size_mag.m_call = cast(type_of(GLTFCamera_methods.get_size_mag.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFCamera_methods.set_size_mag.m_call = cast(type_of(GLTFCamera_methods.set_size_mag.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFCamera_methods.get_depth_far.m_call = cast(type_of(GLTFCamera_methods.get_depth_far.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFCamera_methods.set_depth_far.m_call = cast(type_of(GLTFCamera_methods.set_depth_far.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFCamera_methods.get_depth_near.m_call = cast(type_of(GLTFCamera_methods.get_depth_near.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFCamera_methods.set_depth_near.m_call = cast(type_of(GLTFCamera_methods.set_depth_near.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
