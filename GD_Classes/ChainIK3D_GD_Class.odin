...
ChainIK3D_Init_ :: proc (ChainIK3D_methods: ^ChainIK3D_MethodBind_List, loc := #caller_location) {
  ...
  ChainIK3D_methods.set_root_bone_name.m_call = cast(type_of(ChainIK3D_methods.set_root_bone_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ChainIK3D_methods.get_root_bone_name.m_call = cast(type_of(ChainIK3D_methods.get_root_bone_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ChainIK3D_methods.set_root_bone.m_call = cast(type_of(ChainIK3D_methods.set_root_bone.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ChainIK3D_methods.get_root_bone.m_call = cast(type_of(ChainIK3D_methods.get_root_bone.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ChainIK3D_methods.set_end_bone_name.m_call = cast(type_of(ChainIK3D_methods.set_end_bone_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ChainIK3D_methods.get_end_bone_name.m_call = cast(type_of(ChainIK3D_methods.get_end_bone_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ChainIK3D_methods.set_end_bone.m_call = cast(type_of(ChainIK3D_methods.set_end_bone.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ChainIK3D_methods.get_end_bone.m_call = cast(type_of(ChainIK3D_methods.get_end_bone.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ChainIK3D_methods.set_extend_end_bone.m_call = cast(type_of(ChainIK3D_methods.set_extend_end_bone.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ChainIK3D_methods.is_end_bone_extended.m_call = cast(type_of(ChainIK3D_methods.is_end_bone_extended.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ChainIK3D_methods.set_end_bone_direction.m_call = cast(type_of(ChainIK3D_methods.set_end_bone_direction.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ChainIK3D_methods.get_end_bone_direction.m_call = cast(type_of(ChainIK3D_methods.get_end_bone_direction.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ChainIK3D_methods.set_end_bone_length.m_call = cast(type_of(ChainIK3D_methods.set_end_bone_length.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ChainIK3D_methods.get_end_bone_length.m_call = cast(type_of(ChainIK3D_methods.get_end_bone_length.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ChainIK3D_methods.get_joint_bone_name.m_call = cast(type_of(ChainIK3D_methods.get_joint_bone_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ChainIK3D_methods.get_joint_bone.m_call = cast(type_of(ChainIK3D_methods.get_joint_bone.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ChainIK3D_methods.get_joint_count.m_call = cast(type_of(ChainIK3D_methods.get_joint_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
