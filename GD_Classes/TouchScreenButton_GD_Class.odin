...
TouchScreenButton_Init_ :: proc (TouchScreenButton_methods: ^TouchScreenButton_MethodBind_List, loc := #caller_location) {
  ...
  TouchScreenButton_methods.set_texture_normal.m_call = cast(type_of(TouchScreenButton_methods.set_texture_normal.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TouchScreenButton_methods.get_texture_normal.m_call = cast(type_of(TouchScreenButton_methods.get_texture_normal.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TouchScreenButton_methods.set_texture_pressed.m_call = cast(type_of(TouchScreenButton_methods.set_texture_pressed.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TouchScreenButton_methods.get_texture_pressed.m_call = cast(type_of(TouchScreenButton_methods.get_texture_pressed.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TouchScreenButton_methods.set_bitmask.m_call = cast(type_of(TouchScreenButton_methods.set_bitmask.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TouchScreenButton_methods.get_bitmask.m_call = cast(type_of(TouchScreenButton_methods.get_bitmask.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TouchScreenButton_methods.set_shape.m_call = cast(type_of(TouchScreenButton_methods.set_shape.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TouchScreenButton_methods.get_shape.m_call = cast(type_of(TouchScreenButton_methods.get_shape.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TouchScreenButton_methods.set_shape_centered.m_call = cast(type_of(TouchScreenButton_methods.set_shape_centered.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TouchScreenButton_methods.is_shape_centered.m_call = cast(type_of(TouchScreenButton_methods.is_shape_centered.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TouchScreenButton_methods.set_shape_visible.m_call = cast(type_of(TouchScreenButton_methods.set_shape_visible.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TouchScreenButton_methods.is_shape_visible.m_call = cast(type_of(TouchScreenButton_methods.is_shape_visible.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TouchScreenButton_methods.set_action.m_call = cast(type_of(TouchScreenButton_methods.set_action.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TouchScreenButton_methods.get_action.m_call = cast(type_of(TouchScreenButton_methods.get_action.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TouchScreenButton_methods.set_visibility_mode.m_call = cast(type_of(TouchScreenButton_methods.set_visibility_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TouchScreenButton_methods.get_visibility_mode.m_call = cast(type_of(TouchScreenButton_methods.get_visibility_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TouchScreenButton_methods.set_passby_press.m_call = cast(type_of(TouchScreenButton_methods.set_passby_press.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TouchScreenButton_methods.is_passby_press_enabled.m_call = cast(type_of(TouchScreenButton_methods.is_passby_press_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TouchScreenButton_methods.is_pressed.m_call = cast(type_of(TouchScreenButton_methods.is_pressed.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
