...
SkeletonModification2DPhysicalBones_Init_ :: proc (SkeletonModification2DPhysicalBones_methods: ^SkeletonModification2DPhysicalBones_MethodBind_List, loc := #caller_location) {
  ...
  SkeletonModification2DPhysicalBones_methods.set_physical_bone_chain_length.m_call = cast(type_of(SkeletonModification2DPhysicalBones_methods.set_physical_bone_chain_length.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DPhysicalBones_methods.get_physical_bone_chain_length.m_call = cast(type_of(SkeletonModification2DPhysicalBones_methods.get_physical_bone_chain_length.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DPhysicalBones_methods.set_physical_bone_node.m_call = cast(type_of(SkeletonModification2DPhysicalBones_methods.set_physical_bone_node.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DPhysicalBones_methods.get_physical_bone_node.m_call = cast(type_of(SkeletonModification2DPhysicalBones_methods.get_physical_bone_node.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DPhysicalBones_methods.fetch_physical_bones.m_call = cast(type_of(SkeletonModification2DPhysicalBones_methods.fetch_physical_bones.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DPhysicalBones_methods.start_simulation.m_call = cast(type_of(SkeletonModification2DPhysicalBones_methods.start_simulation.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DPhysicalBones_methods.stop_simulation.m_call = cast(type_of(SkeletonModification2DPhysicalBones_methods.stop_simulation.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
