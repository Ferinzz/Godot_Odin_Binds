...
CodeEdit_Init_ :: proc (CodeEdit_methods: ^CodeEdit_MethodBind_List, loc := #caller_location) {
  ...
  CodeEdit_methods.set_indent_size.m_call = cast(type_of(CodeEdit_methods.set_indent_size.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.get_indent_size.m_call = cast(type_of(CodeEdit_methods.get_indent_size.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.set_indent_using_spaces.m_call = cast(type_of(CodeEdit_methods.set_indent_using_spaces.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.is_indent_using_spaces.m_call = cast(type_of(CodeEdit_methods.is_indent_using_spaces.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.set_auto_indent_enabled.m_call = cast(type_of(CodeEdit_methods.set_auto_indent_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.is_auto_indent_enabled.m_call = cast(type_of(CodeEdit_methods.is_auto_indent_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.set_auto_indent_prefixes.m_call = cast(type_of(CodeEdit_methods.set_auto_indent_prefixes.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.get_auto_indent_prefixes.m_call = cast(type_of(CodeEdit_methods.get_auto_indent_prefixes.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  CodeEdit_methods.do_indent._do_indent = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.CodeEdit, "do_indent", 3218959716, loc))
  CodeEdit_methods.do_indent.m_call = cast(type_of(CodeEdit_methods.do_indent.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.indent_lines.m_call = cast(type_of(CodeEdit_methods.indent_lines.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.unindent_lines.m_call = cast(type_of(CodeEdit_methods.unindent_lines.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.convert_indent.m_call = cast(type_of(CodeEdit_methods.convert_indent.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.set_auto_brace_completion_enabled.m_call = cast(type_of(CodeEdit_methods.set_auto_brace_completion_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.is_auto_brace_completion_enabled.m_call = cast(type_of(CodeEdit_methods.is_auto_brace_completion_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.set_highlight_matching_braces_enabled.m_call = cast(type_of(CodeEdit_methods.set_highlight_matching_braces_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.is_highlight_matching_braces_enabled.m_call = cast(type_of(CodeEdit_methods.is_highlight_matching_braces_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.add_auto_brace_completion_pair.m_call = cast(type_of(CodeEdit_methods.add_auto_brace_completion_pair.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.set_auto_brace_completion_pairs.m_call = cast(type_of(CodeEdit_methods.set_auto_brace_completion_pairs.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.get_auto_brace_completion_pairs.m_call = cast(type_of(CodeEdit_methods.get_auto_brace_completion_pairs.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.has_auto_brace_completion_open_key.m_call = cast(type_of(CodeEdit_methods.has_auto_brace_completion_open_key.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.has_auto_brace_completion_close_key.m_call = cast(type_of(CodeEdit_methods.has_auto_brace_completion_close_key.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.get_auto_brace_completion_close_key.m_call = cast(type_of(CodeEdit_methods.get_auto_brace_completion_close_key.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.set_draw_breakpoints_gutter.m_call = cast(type_of(CodeEdit_methods.set_draw_breakpoints_gutter.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.is_drawing_breakpoints_gutter.m_call = cast(type_of(CodeEdit_methods.is_drawing_breakpoints_gutter.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.set_draw_bookmarks_gutter.m_call = cast(type_of(CodeEdit_methods.set_draw_bookmarks_gutter.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.is_drawing_bookmarks_gutter.m_call = cast(type_of(CodeEdit_methods.is_drawing_bookmarks_gutter.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.set_draw_executing_lines_gutter.m_call = cast(type_of(CodeEdit_methods.set_draw_executing_lines_gutter.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.is_drawing_executing_lines_gutter.m_call = cast(type_of(CodeEdit_methods.is_drawing_executing_lines_gutter.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.set_line_as_breakpoint.m_call = cast(type_of(CodeEdit_methods.set_line_as_breakpoint.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.is_line_breakpointed.m_call = cast(type_of(CodeEdit_methods.is_line_breakpointed.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.clear_breakpointed_lines.m_call = cast(type_of(CodeEdit_methods.clear_breakpointed_lines.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.get_breakpointed_lines.m_call = cast(type_of(CodeEdit_methods.get_breakpointed_lines.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.set_line_as_bookmarked.m_call = cast(type_of(CodeEdit_methods.set_line_as_bookmarked.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.is_line_bookmarked.m_call = cast(type_of(CodeEdit_methods.is_line_bookmarked.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.clear_bookmarked_lines.m_call = cast(type_of(CodeEdit_methods.clear_bookmarked_lines.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.get_bookmarked_lines.m_call = cast(type_of(CodeEdit_methods.get_bookmarked_lines.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.set_line_as_executing.m_call = cast(type_of(CodeEdit_methods.set_line_as_executing.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.is_line_executing.m_call = cast(type_of(CodeEdit_methods.is_line_executing.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.clear_executing_lines.m_call = cast(type_of(CodeEdit_methods.clear_executing_lines.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.get_executing_lines.m_call = cast(type_of(CodeEdit_methods.get_executing_lines.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.set_draw_line_numbers.m_call = cast(type_of(CodeEdit_methods.set_draw_line_numbers.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.is_draw_line_numbers_enabled.m_call = cast(type_of(CodeEdit_methods.is_draw_line_numbers_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.set_line_numbers_zero_padded.m_call = cast(type_of(CodeEdit_methods.set_line_numbers_zero_padded.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.is_line_numbers_zero_padded.m_call = cast(type_of(CodeEdit_methods.is_line_numbers_zero_padded.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.set_line_numbers_min_digits.m_call = cast(type_of(CodeEdit_methods.set_line_numbers_min_digits.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.get_line_numbers_min_digits.m_call = cast(type_of(CodeEdit_methods.get_line_numbers_min_digits.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.set_draw_fold_gutter.m_call = cast(type_of(CodeEdit_methods.set_draw_fold_gutter.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.is_drawing_fold_gutter.m_call = cast(type_of(CodeEdit_methods.is_drawing_fold_gutter.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.set_line_folding_enabled.m_call = cast(type_of(CodeEdit_methods.set_line_folding_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.is_line_folding_enabled.m_call = cast(type_of(CodeEdit_methods.is_line_folding_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.can_fold_line.m_call = cast(type_of(CodeEdit_methods.can_fold_line.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  CodeEdit_methods.fold_line._fold_line = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.CodeEdit, "fold_line", 1286410249, loc))
  CodeEdit_methods.fold_line.m_call = cast(type_of(CodeEdit_methods.fold_line.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.unfold_line.m_call = cast(type_of(CodeEdit_methods.unfold_line.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.fold_all_lines.m_call = cast(type_of(CodeEdit_methods.fold_all_lines.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.unfold_all_lines.m_call = cast(type_of(CodeEdit_methods.unfold_all_lines.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.toggle_foldable_line.m_call = cast(type_of(CodeEdit_methods.toggle_foldable_line.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.toggle_foldable_lines_at_carets.m_call = cast(type_of(CodeEdit_methods.toggle_foldable_lines_at_carets.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.is_line_folded.m_call = cast(type_of(CodeEdit_methods.is_line_folded.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.get_folded_lines.m_call = cast(type_of(CodeEdit_methods.get_folded_lines.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.create_code_region.m_call = cast(type_of(CodeEdit_methods.create_code_region.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.get_code_region_start_tag.m_call = cast(type_of(CodeEdit_methods.get_code_region_start_tag.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.get_code_region_end_tag.m_call = cast(type_of(CodeEdit_methods.get_code_region_end_tag.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.set_code_region_tags.m_call = cast(type_of(CodeEdit_methods.set_code_region_tags.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.is_line_code_region_start.m_call = cast(type_of(CodeEdit_methods.is_line_code_region_start.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.is_line_code_region_end.m_call = cast(type_of(CodeEdit_methods.is_line_code_region_end.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.add_string_delimiter.m_call = cast(type_of(CodeEdit_methods.add_string_delimiter.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.remove_string_delimiter.m_call = cast(type_of(CodeEdit_methods.remove_string_delimiter.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.has_string_delimiter.m_call = cast(type_of(CodeEdit_methods.has_string_delimiter.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.set_string_delimiters.m_call = cast(type_of(CodeEdit_methods.set_string_delimiters.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.clear_string_delimiters.m_call = cast(type_of(CodeEdit_methods.clear_string_delimiters.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.get_string_delimiters.m_call = cast(type_of(CodeEdit_methods.get_string_delimiters.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.is_in_string.m_call = cast(type_of(CodeEdit_methods.is_in_string.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.add_comment_delimiter.m_call = cast(type_of(CodeEdit_methods.add_comment_delimiter.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.remove_comment_delimiter.m_call = cast(type_of(CodeEdit_methods.remove_comment_delimiter.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.has_comment_delimiter.m_call = cast(type_of(CodeEdit_methods.has_comment_delimiter.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.set_comment_delimiters.m_call = cast(type_of(CodeEdit_methods.set_comment_delimiters.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.clear_comment_delimiters.m_call = cast(type_of(CodeEdit_methods.clear_comment_delimiters.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.get_comment_delimiters.m_call = cast(type_of(CodeEdit_methods.get_comment_delimiters.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.is_in_comment.m_call = cast(type_of(CodeEdit_methods.is_in_comment.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.get_delimiter_start_key.m_call = cast(type_of(CodeEdit_methods.get_delimiter_start_key.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.get_delimiter_end_key.m_call = cast(type_of(CodeEdit_methods.get_delimiter_end_key.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.get_delimiter_start_position.m_call = cast(type_of(CodeEdit_methods.get_delimiter_start_position.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.get_delimiter_end_position.m_call = cast(type_of(CodeEdit_methods.get_delimiter_end_position.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.set_code_hint.m_call = cast(type_of(CodeEdit_methods.set_code_hint.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.set_code_hint_draw_below.m_call = cast(type_of(CodeEdit_methods.set_code_hint_draw_below.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.get_text_for_code_completion.m_call = cast(type_of(CodeEdit_methods.get_text_for_code_completion.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.request_code_completion.m_call = cast(type_of(CodeEdit_methods.request_code_completion.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.add_code_completion_option.m_call = cast(type_of(CodeEdit_methods.add_code_completion_option.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.update_code_completion_options.m_call = cast(type_of(CodeEdit_methods.update_code_completion_options.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.get_code_completion_options.m_call = cast(type_of(CodeEdit_methods.get_code_completion_options.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.get_code_completion_option.m_call = cast(type_of(CodeEdit_methods.get_code_completion_option.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.get_code_completion_selected_index.m_call = cast(type_of(CodeEdit_methods.get_code_completion_selected_index.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.set_code_completion_selected_index.m_call = cast(type_of(CodeEdit_methods.set_code_completion_selected_index.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.confirm_code_completion.m_call = cast(type_of(CodeEdit_methods.confirm_code_completion.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.cancel_code_completion.m_call = cast(type_of(CodeEdit_methods.cancel_code_completion.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.set_code_completion_enabled.m_call = cast(type_of(CodeEdit_methods.set_code_completion_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.is_code_completion_enabled.m_call = cast(type_of(CodeEdit_methods.is_code_completion_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.set_code_completion_prefixes.m_call = cast(type_of(CodeEdit_methods.set_code_completion_prefixes.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.get_code_completion_prefixes.m_call = cast(type_of(CodeEdit_methods.get_code_completion_prefixes.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.set_line_length_guidelines.m_call = cast(type_of(CodeEdit_methods.set_line_length_guidelines.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.get_line_length_guidelines.m_call = cast(type_of(CodeEdit_methods.get_line_length_guidelines.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.set_symbol_lookup_on_click_enabled.m_call = cast(type_of(CodeEdit_methods.set_symbol_lookup_on_click_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.is_symbol_lookup_on_click_enabled.m_call = cast(type_of(CodeEdit_methods.is_symbol_lookup_on_click_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.get_text_for_symbol_lookup.m_call = cast(type_of(CodeEdit_methods.get_text_for_symbol_lookup.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.get_text_with_cursor_char.m_call = cast(type_of(CodeEdit_methods.get_text_with_cursor_char.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.set_symbol_lookup_word_as_valid.m_call = cast(type_of(CodeEdit_methods.set_symbol_lookup_word_as_valid.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.set_symbol_tooltip_on_hover_enabled.m_call = cast(type_of(CodeEdit_methods.set_symbol_tooltip_on_hover_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.is_symbol_tooltip_on_hover_enabled.m_call = cast(type_of(CodeEdit_methods.is_symbol_tooltip_on_hover_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.move_lines_up.m_call = cast(type_of(CodeEdit_methods.move_lines_up.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.move_lines_down.m_call = cast(type_of(CodeEdit_methods.move_lines_down.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.delete_lines.m_call = cast(type_of(CodeEdit_methods.delete_lines.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.duplicate_selection.m_call = cast(type_of(CodeEdit_methods.duplicate_selection.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeEdit_methods.duplicate_lines.m_call = cast(type_of(CodeEdit_methods.duplicate_lines.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
