...
ProjectSettings_Init_ :: proc (ProjectSettings_methods: ^ProjectSettings_MethodBind_List, loc := #caller_location) {
  ...
  ProjectSettings_methods.has_setting.m_call = cast(type_of(ProjectSettings_methods.has_setting.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ProjectSettings_methods.set_setting.m_call = cast(type_of(ProjectSettings_methods.set_setting.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ProjectSettings_methods.get_setting.m_call = cast(type_of(ProjectSettings_methods.get_setting.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ProjectSettings_methods.get_setting_with_override.m_call = cast(type_of(ProjectSettings_methods.get_setting_with_override.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ProjectSettings_methods.get_global_class_list.m_call = cast(type_of(ProjectSettings_methods.get_global_class_list.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ProjectSettings_methods.get_setting_with_override_and_custom_features.m_call = cast(type_of(ProjectSettings_methods.get_setting_with_override_and_custom_features.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ProjectSettings_methods.set_order.m_call = cast(type_of(ProjectSettings_methods.set_order.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ProjectSettings_methods.get_order.m_call = cast(type_of(ProjectSettings_methods.get_order.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ProjectSettings_methods.set_initial_value.m_call = cast(type_of(ProjectSettings_methods.set_initial_value.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ProjectSettings_methods.set_as_basic.m_call = cast(type_of(ProjectSettings_methods.set_as_basic.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ProjectSettings_methods.set_as_internal.m_call = cast(type_of(ProjectSettings_methods.set_as_internal.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ProjectSettings_methods.add_property_info.m_call = cast(type_of(ProjectSettings_methods.add_property_info.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ProjectSettings_methods.set_restart_if_changed.m_call = cast(type_of(ProjectSettings_methods.set_restart_if_changed.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ProjectSettings_methods.clear._clear = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.ProjectSettings, "clear", 83702148, loc))
  ProjectSettings_methods.clear.m_call = cast(type_of(ProjectSettings_methods.clear.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ProjectSettings_methods.localize_path.m_call = cast(type_of(ProjectSettings_methods.localize_path.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ProjectSettings_methods.globalize_path.m_call = cast(type_of(ProjectSettings_methods.globalize_path.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ProjectSettings_methods.save._save = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.ProjectSettings, "save", 166280745, loc))
  ProjectSettings_methods.save.m_call = cast(type_of(ProjectSettings_methods.save.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ProjectSettings_methods.load_resource_pack.m_call = cast(type_of(ProjectSettings_methods.load_resource_pack.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ProjectSettings_methods.save_custom.m_call = cast(type_of(ProjectSettings_methods.save_custom.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ProjectSettings_methods.get_changed_settings.m_call = cast(type_of(ProjectSettings_methods.get_changed_settings.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ProjectSettings_methods.check_changed_settings_in_group.m_call = cast(type_of(ProjectSettings_methods.check_changed_settings_in_group.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
