...
XRBodyModifier3D_Init_ :: proc (XRBodyModifier3D_methods: ^XRBodyModifier3D_MethodBind_List, loc := #caller_location) {
  ...
  XRBodyModifier3D_methods.set_body_tracker.m_call = cast(type_of(XRBodyModifier3D_methods.set_body_tracker.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  XRBodyModifier3D_methods.get_body_tracker.m_call = cast(type_of(XRBodyModifier3D_methods.get_body_tracker.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  XRBodyModifier3D_methods.set_body_update.m_call = cast(type_of(XRBodyModifier3D_methods.set_body_update.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  XRBodyModifier3D_methods.get_body_update.m_call = cast(type_of(XRBodyModifier3D_methods.get_body_update.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  XRBodyModifier3D_methods.set_bone_update.m_call = cast(type_of(XRBodyModifier3D_methods.set_bone_update.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  XRBodyModifier3D_methods.get_bone_update.m_call = cast(type_of(XRBodyModifier3D_methods.get_bone_update.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
