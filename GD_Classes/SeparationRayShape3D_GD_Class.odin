...
SeparationRayShape3D_Init_ :: proc (SeparationRayShape3D_methods: ^SeparationRayShape3D_MethodBind_List, loc := #caller_location) {
  SeparationRayShape3D_methods.set_length = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.SeparationRayShape3D, "set_length", 373806689, loc))
  SeparationRayShape3D_methods.get_length = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.SeparationRayShape3D, "get_length", 1740695150, loc))
  SeparationRayShape3D_methods.set_slide_on_slope = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.SeparationRayShape3D, "set_slide_on_slope", 2586408642, loc))
  SeparationRayShape3D_methods.get_slide_on_slope = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.SeparationRayShape3D, "get_slide_on_slope", 36873697, loc))
};
