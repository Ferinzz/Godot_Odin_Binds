...
GPUParticlesCollisionBox3D_MethodBind_List :: struct {
  set_size: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: GPUParticlesCollisionBox3D, #by_ptr args: i64 = 0, r_ret: ^GDW.Vector3)
  },
};
GPUParticlesCollisionBox3D_Init_ :: proc (GPUParticlesCollisionBox3D_methods: ^GPUParticlesCollisionBox3D_MethodBind_List, loc := #caller_location) {
  ...
  GPUParticlesCollisionBox3D_methods.set_size.m_call = cast(type_of(GPUParticlesCollisionBox3D_methods.set_size.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GPUParticlesCollisionBox3D_methods.get_size.m_call = cast(type_of(GPUParticlesCollisionBox3D_methods.get_size.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
