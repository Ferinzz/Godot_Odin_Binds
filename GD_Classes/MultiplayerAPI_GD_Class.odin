...
MultiplayerAPI_Init_ :: proc (MultiplayerAPI_methods: ^MultiplayerAPI_MethodBind_List, loc := #caller_location) {
  ...
  MultiplayerAPI_methods.has_multiplayer_peer.m_call = cast(type_of(MultiplayerAPI_methods.has_multiplayer_peer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MultiplayerAPI_methods.get_multiplayer_peer.m_call = cast(type_of(MultiplayerAPI_methods.get_multiplayer_peer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MultiplayerAPI_methods.set_multiplayer_peer.m_call = cast(type_of(MultiplayerAPI_methods.set_multiplayer_peer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MultiplayerAPI_methods.get_unique_id.m_call = cast(type_of(MultiplayerAPI_methods.get_unique_id.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MultiplayerAPI_methods.is_server.m_call = cast(type_of(MultiplayerAPI_methods.is_server.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MultiplayerAPI_methods.get_remote_sender_id.m_call = cast(type_of(MultiplayerAPI_methods.get_remote_sender_id.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  MultiplayerAPI_methods.poll._poll = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.MultiplayerAPI, "poll", 166280745, loc))
  MultiplayerAPI_methods.poll.m_call = cast(type_of(MultiplayerAPI_methods.poll.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  MultiplayerAPI_methods.rpc._rpc = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.MultiplayerAPI, "rpc", 2077486355, loc))
  MultiplayerAPI_methods.rpc.m_call = cast(type_of(MultiplayerAPI_methods.rpc.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MultiplayerAPI_methods.object_configuration_add.m_call = cast(type_of(MultiplayerAPI_methods.object_configuration_add.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MultiplayerAPI_methods.object_configuration_remove.m_call = cast(type_of(MultiplayerAPI_methods.object_configuration_remove.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MultiplayerAPI_methods.get_peers.m_call = cast(type_of(MultiplayerAPI_methods.get_peers.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MultiplayerAPI_methods.set_default_interface.m_call = cast(type_of(MultiplayerAPI_methods.set_default_interface.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MultiplayerAPI_methods.get_default_interface.m_call = cast(type_of(MultiplayerAPI_methods.get_default_interface.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MultiplayerAPI_methods.create_default_interface.m_call = cast(type_of(MultiplayerAPI_methods.create_default_interface.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
