...
UndoRedo_Init_ :: proc (UndoRedo_methods: ^UndoRedo_MethodBind_List, loc := #caller_location) {
  ...
  UndoRedo_methods.create_action.m_call = cast(type_of(UndoRedo_methods.create_action.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  UndoRedo_methods.commit_action.m_call = cast(type_of(UndoRedo_methods.commit_action.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  UndoRedo_methods.is_committing_action.m_call = cast(type_of(UndoRedo_methods.is_committing_action.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  UndoRedo_methods.add_do_method.m_call = cast(type_of(UndoRedo_methods.add_do_method.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  UndoRedo_methods.add_undo_method.m_call = cast(type_of(UndoRedo_methods.add_undo_method.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  UndoRedo_methods.add_do_property.m_call = cast(type_of(UndoRedo_methods.add_do_property.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  UndoRedo_methods.add_undo_property.m_call = cast(type_of(UndoRedo_methods.add_undo_property.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  UndoRedo_methods.add_do_reference.m_call = cast(type_of(UndoRedo_methods.add_do_reference.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  UndoRedo_methods.add_undo_reference.m_call = cast(type_of(UndoRedo_methods.add_undo_reference.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  UndoRedo_methods.start_force_keep_in_merge_ends.m_call = cast(type_of(UndoRedo_methods.start_force_keep_in_merge_ends.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  UndoRedo_methods.end_force_keep_in_merge_ends.m_call = cast(type_of(UndoRedo_methods.end_force_keep_in_merge_ends.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  UndoRedo_methods.get_history_count.m_call = cast(type_of(UndoRedo_methods.get_history_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  UndoRedo_methods.get_current_action.m_call = cast(type_of(UndoRedo_methods.get_current_action.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  UndoRedo_methods.get_action_name.m_call = cast(type_of(UndoRedo_methods.get_action_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  UndoRedo_methods.clear_history.m_call = cast(type_of(UndoRedo_methods.clear_history.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  UndoRedo_methods.get_current_action_name.m_call = cast(type_of(UndoRedo_methods.get_current_action_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  UndoRedo_methods.has_undo._has_undo = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.UndoRedo, "has_undo", 36873697, loc))
  UndoRedo_methods.has_undo.m_call = cast(type_of(UndoRedo_methods.has_undo.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  UndoRedo_methods.has_redo._has_redo = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.UndoRedo, "has_redo", 36873697, loc))
  UndoRedo_methods.has_redo.m_call = cast(type_of(UndoRedo_methods.has_redo.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  UndoRedo_methods.get_version.m_call = cast(type_of(UndoRedo_methods.get_version.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  UndoRedo_methods.set_max_steps.m_call = cast(type_of(UndoRedo_methods.set_max_steps.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  UndoRedo_methods.get_max_steps.m_call = cast(type_of(UndoRedo_methods.get_max_steps.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  UndoRedo_methods.redo._redo = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.UndoRedo, "redo", 2240911060, loc))
  UndoRedo_methods.redo.m_call = cast(type_of(UndoRedo_methods.redo.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  UndoRedo_methods.undo._undo = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.UndoRedo, "undo", 2240911060, loc))
  UndoRedo_methods.undo.m_call = cast(type_of(UndoRedo_methods.undo.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
