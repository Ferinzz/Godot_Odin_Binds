...
TubeTrailMesh_Init_ :: proc (TubeTrailMesh_methods: ^TubeTrailMesh_MethodBind_List, loc := #caller_location) {
  ...
  TubeTrailMesh_methods.set_radius.m_call = cast(type_of(TubeTrailMesh_methods.set_radius.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TubeTrailMesh_methods.get_radius.m_call = cast(type_of(TubeTrailMesh_methods.get_radius.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TubeTrailMesh_methods.set_radial_steps.m_call = cast(type_of(TubeTrailMesh_methods.set_radial_steps.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TubeTrailMesh_methods.get_radial_steps.m_call = cast(type_of(TubeTrailMesh_methods.get_radial_steps.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TubeTrailMesh_methods.set_sections.m_call = cast(type_of(TubeTrailMesh_methods.set_sections.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TubeTrailMesh_methods.get_sections.m_call = cast(type_of(TubeTrailMesh_methods.get_sections.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TubeTrailMesh_methods.set_section_length.m_call = cast(type_of(TubeTrailMesh_methods.set_section_length.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TubeTrailMesh_methods.get_section_length.m_call = cast(type_of(TubeTrailMesh_methods.get_section_length.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TubeTrailMesh_methods.set_section_rings.m_call = cast(type_of(TubeTrailMesh_methods.set_section_rings.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TubeTrailMesh_methods.get_section_rings.m_call = cast(type_of(TubeTrailMesh_methods.get_section_rings.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TubeTrailMesh_methods.set_cap_top.m_call = cast(type_of(TubeTrailMesh_methods.set_cap_top.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TubeTrailMesh_methods.is_cap_top.m_call = cast(type_of(TubeTrailMesh_methods.is_cap_top.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TubeTrailMesh_methods.set_cap_bottom.m_call = cast(type_of(TubeTrailMesh_methods.set_cap_bottom.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TubeTrailMesh_methods.is_cap_bottom.m_call = cast(type_of(TubeTrailMesh_methods.is_cap_bottom.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TubeTrailMesh_methods.set_curve.m_call = cast(type_of(TubeTrailMesh_methods.set_curve.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TubeTrailMesh_methods.get_curve.m_call = cast(type_of(TubeTrailMesh_methods.get_curve.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
