...
CharFXTransform_Init_ :: proc (CharFXTransform_methods: ^CharFXTransform_MethodBind_List, loc := #caller_location) {
  ...
  CharFXTransform_methods.get_transform.m_call = cast(type_of(CharFXTransform_methods.get_transform.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CharFXTransform_methods.set_transform.m_call = cast(type_of(CharFXTransform_methods.set_transform.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CharFXTransform_methods.get_range.m_call = cast(type_of(CharFXTransform_methods.get_range.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CharFXTransform_methods.set_range.m_call = cast(type_of(CharFXTransform_methods.set_range.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CharFXTransform_methods.get_elapsed_time.m_call = cast(type_of(CharFXTransform_methods.get_elapsed_time.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CharFXTransform_methods.set_elapsed_time.m_call = cast(type_of(CharFXTransform_methods.set_elapsed_time.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CharFXTransform_methods.is_visible.m_call = cast(type_of(CharFXTransform_methods.is_visible.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CharFXTransform_methods.set_visibility.m_call = cast(type_of(CharFXTransform_methods.set_visibility.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CharFXTransform_methods.is_outline.m_call = cast(type_of(CharFXTransform_methods.is_outline.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CharFXTransform_methods.set_outline.m_call = cast(type_of(CharFXTransform_methods.set_outline.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CharFXTransform_methods.get_offset.m_call = cast(type_of(CharFXTransform_methods.get_offset.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CharFXTransform_methods.set_offset.m_call = cast(type_of(CharFXTransform_methods.set_offset.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CharFXTransform_methods.get_color.m_call = cast(type_of(CharFXTransform_methods.get_color.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CharFXTransform_methods.set_color.m_call = cast(type_of(CharFXTransform_methods.set_color.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CharFXTransform_methods.get_environment.m_call = cast(type_of(CharFXTransform_methods.get_environment.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CharFXTransform_methods.set_environment.m_call = cast(type_of(CharFXTransform_methods.set_environment.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CharFXTransform_methods.get_glyph_index.m_call = cast(type_of(CharFXTransform_methods.get_glyph_index.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CharFXTransform_methods.set_glyph_index.m_call = cast(type_of(CharFXTransform_methods.set_glyph_index.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CharFXTransform_methods.get_relative_index.m_call = cast(type_of(CharFXTransform_methods.get_relative_index.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CharFXTransform_methods.set_relative_index.m_call = cast(type_of(CharFXTransform_methods.set_relative_index.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CharFXTransform_methods.get_glyph_count.m_call = cast(type_of(CharFXTransform_methods.get_glyph_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CharFXTransform_methods.set_glyph_count.m_call = cast(type_of(CharFXTransform_methods.set_glyph_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CharFXTransform_methods.get_glyph_flags.m_call = cast(type_of(CharFXTransform_methods.get_glyph_flags.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CharFXTransform_methods.set_glyph_flags.m_call = cast(type_of(CharFXTransform_methods.set_glyph_flags.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CharFXTransform_methods.get_font.m_call = cast(type_of(CharFXTransform_methods.get_font.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CharFXTransform_methods.set_font.m_call = cast(type_of(CharFXTransform_methods.set_font.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
