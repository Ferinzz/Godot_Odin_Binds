...
OpenXRInterface_Init_ :: proc (OpenXRInterface_methods: ^OpenXRInterface_MethodBind_List, loc := #caller_location) {
  ...
  OpenXRInterface_methods.get_session_state.m_call = cast(type_of(OpenXRInterface_methods.get_session_state.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRInterface_methods.get_display_refresh_rate.m_call = cast(type_of(OpenXRInterface_methods.get_display_refresh_rate.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRInterface_methods.set_display_refresh_rate.m_call = cast(type_of(OpenXRInterface_methods.set_display_refresh_rate.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRInterface_methods.get_render_target_size_multiplier.m_call = cast(type_of(OpenXRInterface_methods.get_render_target_size_multiplier.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRInterface_methods.set_render_target_size_multiplier.m_call = cast(type_of(OpenXRInterface_methods.set_render_target_size_multiplier.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRInterface_methods.is_foveation_supported.m_call = cast(type_of(OpenXRInterface_methods.is_foveation_supported.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRInterface_methods.get_foveation_level.m_call = cast(type_of(OpenXRInterface_methods.get_foveation_level.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRInterface_methods.set_foveation_level.m_call = cast(type_of(OpenXRInterface_methods.set_foveation_level.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRInterface_methods.get_foveation_dynamic.m_call = cast(type_of(OpenXRInterface_methods.get_foveation_dynamic.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRInterface_methods.set_foveation_dynamic.m_call = cast(type_of(OpenXRInterface_methods.set_foveation_dynamic.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRInterface_methods.is_action_set_active.m_call = cast(type_of(OpenXRInterface_methods.is_action_set_active.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRInterface_methods.set_action_set_active.m_call = cast(type_of(OpenXRInterface_methods.set_action_set_active.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRInterface_methods.get_action_sets.m_call = cast(type_of(OpenXRInterface_methods.get_action_sets.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRInterface_methods.get_available_display_refresh_rates.m_call = cast(type_of(OpenXRInterface_methods.get_available_display_refresh_rates.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRInterface_methods.set_motion_range.m_call = cast(type_of(OpenXRInterface_methods.set_motion_range.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRInterface_methods.get_motion_range.m_call = cast(type_of(OpenXRInterface_methods.get_motion_range.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRInterface_methods.get_hand_tracking_source.m_call = cast(type_of(OpenXRInterface_methods.get_hand_tracking_source.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRInterface_methods.get_hand_joint_flags.m_call = cast(type_of(OpenXRInterface_methods.get_hand_joint_flags.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRInterface_methods.get_hand_joint_rotation.m_call = cast(type_of(OpenXRInterface_methods.get_hand_joint_rotation.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRInterface_methods.get_hand_joint_position.m_call = cast(type_of(OpenXRInterface_methods.get_hand_joint_position.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRInterface_methods.get_hand_joint_radius.m_call = cast(type_of(OpenXRInterface_methods.get_hand_joint_radius.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRInterface_methods.get_hand_joint_linear_velocity.m_call = cast(type_of(OpenXRInterface_methods.get_hand_joint_linear_velocity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRInterface_methods.get_hand_joint_angular_velocity.m_call = cast(type_of(OpenXRInterface_methods.get_hand_joint_angular_velocity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRInterface_methods.is_hand_tracking_supported.m_call = cast(type_of(OpenXRInterface_methods.is_hand_tracking_supported.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRInterface_methods.is_hand_interaction_supported.m_call = cast(type_of(OpenXRInterface_methods.is_hand_interaction_supported.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRInterface_methods.is_eye_gaze_interaction_supported.m_call = cast(type_of(OpenXRInterface_methods.is_eye_gaze_interaction_supported.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRInterface_methods.get_vrs_min_radius.m_call = cast(type_of(OpenXRInterface_methods.get_vrs_min_radius.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRInterface_methods.set_vrs_min_radius.m_call = cast(type_of(OpenXRInterface_methods.set_vrs_min_radius.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRInterface_methods.get_vrs_strength.m_call = cast(type_of(OpenXRInterface_methods.get_vrs_strength.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRInterface_methods.set_vrs_strength.m_call = cast(type_of(OpenXRInterface_methods.set_vrs_strength.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRInterface_methods.set_cpu_level.m_call = cast(type_of(OpenXRInterface_methods.set_cpu_level.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRInterface_methods.set_gpu_level.m_call = cast(type_of(OpenXRInterface_methods.set_gpu_level.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
