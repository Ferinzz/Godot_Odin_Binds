...
TextureRect_Init_ :: proc (TextureRect_methods: ^TextureRect_MethodBind_List, loc := #caller_location) {
  ...
  TextureRect_methods.set_texture.m_call = cast(type_of(TextureRect_methods.set_texture.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextureRect_methods.get_texture.m_call = cast(type_of(TextureRect_methods.get_texture.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextureRect_methods.set_expand_mode.m_call = cast(type_of(TextureRect_methods.set_expand_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextureRect_methods.get_expand_mode.m_call = cast(type_of(TextureRect_methods.get_expand_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextureRect_methods.set_flip_h.m_call = cast(type_of(TextureRect_methods.set_flip_h.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextureRect_methods.is_flipped_h.m_call = cast(type_of(TextureRect_methods.is_flipped_h.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextureRect_methods.set_flip_v.m_call = cast(type_of(TextureRect_methods.set_flip_v.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextureRect_methods.is_flipped_v.m_call = cast(type_of(TextureRect_methods.is_flipped_v.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextureRect_methods.set_stretch_mode.m_call = cast(type_of(TextureRect_methods.set_stretch_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TextureRect_methods.get_stretch_mode.m_call = cast(type_of(TextureRect_methods.get_stretch_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
