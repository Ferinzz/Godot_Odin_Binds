...
BoneMap_Init_ :: proc (BoneMap_methods: ^BoneMap_MethodBind_List, loc := #caller_location) {
  ...
  BoneMap_methods.get_profile.m_call = cast(type_of(BoneMap_methods.get_profile.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BoneMap_methods.set_profile.m_call = cast(type_of(BoneMap_methods.set_profile.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BoneMap_methods.get_skeleton_bone_name.m_call = cast(type_of(BoneMap_methods.get_skeleton_bone_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BoneMap_methods.set_skeleton_bone_name.m_call = cast(type_of(BoneMap_methods.set_skeleton_bone_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BoneMap_methods.find_profile_bone_name.m_call = cast(type_of(BoneMap_methods.find_profile_bone_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
