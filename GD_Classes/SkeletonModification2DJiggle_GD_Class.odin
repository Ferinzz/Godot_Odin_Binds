...
SkeletonModification2DJiggle_Init_ :: proc (SkeletonModification2DJiggle_methods: ^SkeletonModification2DJiggle_MethodBind_List, loc := #caller_location) {
  ...
  SkeletonModification2DJiggle_methods.set_target_node.m_call = cast(type_of(SkeletonModification2DJiggle_methods.set_target_node.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DJiggle_methods.get_target_node.m_call = cast(type_of(SkeletonModification2DJiggle_methods.get_target_node.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DJiggle_methods.set_jiggle_data_chain_length.m_call = cast(type_of(SkeletonModification2DJiggle_methods.set_jiggle_data_chain_length.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DJiggle_methods.get_jiggle_data_chain_length.m_call = cast(type_of(SkeletonModification2DJiggle_methods.get_jiggle_data_chain_length.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DJiggle_methods.set_stiffness.m_call = cast(type_of(SkeletonModification2DJiggle_methods.set_stiffness.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DJiggle_methods.get_stiffness.m_call = cast(type_of(SkeletonModification2DJiggle_methods.get_stiffness.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DJiggle_methods.set_mass.m_call = cast(type_of(SkeletonModification2DJiggle_methods.set_mass.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DJiggle_methods.get_mass.m_call = cast(type_of(SkeletonModification2DJiggle_methods.get_mass.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DJiggle_methods.set_damping.m_call = cast(type_of(SkeletonModification2DJiggle_methods.set_damping.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DJiggle_methods.get_damping.m_call = cast(type_of(SkeletonModification2DJiggle_methods.get_damping.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DJiggle_methods.set_use_gravity.m_call = cast(type_of(SkeletonModification2DJiggle_methods.set_use_gravity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DJiggle_methods.get_use_gravity.m_call = cast(type_of(SkeletonModification2DJiggle_methods.get_use_gravity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DJiggle_methods.set_gravity.m_call = cast(type_of(SkeletonModification2DJiggle_methods.set_gravity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DJiggle_methods.get_gravity.m_call = cast(type_of(SkeletonModification2DJiggle_methods.get_gravity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DJiggle_methods.set_use_colliders.m_call = cast(type_of(SkeletonModification2DJiggle_methods.set_use_colliders.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DJiggle_methods.get_use_colliders.m_call = cast(type_of(SkeletonModification2DJiggle_methods.get_use_colliders.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DJiggle_methods.set_collision_mask.m_call = cast(type_of(SkeletonModification2DJiggle_methods.set_collision_mask.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DJiggle_methods.get_collision_mask.m_call = cast(type_of(SkeletonModification2DJiggle_methods.get_collision_mask.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DJiggle_methods.set_jiggle_joint_bone2d_node.m_call = cast(type_of(SkeletonModification2DJiggle_methods.set_jiggle_joint_bone2d_node.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DJiggle_methods.get_jiggle_joint_bone2d_node.m_call = cast(type_of(SkeletonModification2DJiggle_methods.get_jiggle_joint_bone2d_node.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DJiggle_methods.set_jiggle_joint_bone_index.m_call = cast(type_of(SkeletonModification2DJiggle_methods.set_jiggle_joint_bone_index.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DJiggle_methods.get_jiggle_joint_bone_index.m_call = cast(type_of(SkeletonModification2DJiggle_methods.get_jiggle_joint_bone_index.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DJiggle_methods.set_jiggle_joint_override.m_call = cast(type_of(SkeletonModification2DJiggle_methods.set_jiggle_joint_override.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DJiggle_methods.get_jiggle_joint_override.m_call = cast(type_of(SkeletonModification2DJiggle_methods.get_jiggle_joint_override.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DJiggle_methods.set_jiggle_joint_stiffness.m_call = cast(type_of(SkeletonModification2DJiggle_methods.set_jiggle_joint_stiffness.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DJiggle_methods.get_jiggle_joint_stiffness.m_call = cast(type_of(SkeletonModification2DJiggle_methods.get_jiggle_joint_stiffness.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DJiggle_methods.set_jiggle_joint_mass.m_call = cast(type_of(SkeletonModification2DJiggle_methods.set_jiggle_joint_mass.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DJiggle_methods.get_jiggle_joint_mass.m_call = cast(type_of(SkeletonModification2DJiggle_methods.get_jiggle_joint_mass.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DJiggle_methods.set_jiggle_joint_damping.m_call = cast(type_of(SkeletonModification2DJiggle_methods.set_jiggle_joint_damping.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DJiggle_methods.get_jiggle_joint_damping.m_call = cast(type_of(SkeletonModification2DJiggle_methods.get_jiggle_joint_damping.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DJiggle_methods.set_jiggle_joint_use_gravity.m_call = cast(type_of(SkeletonModification2DJiggle_methods.set_jiggle_joint_use_gravity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DJiggle_methods.get_jiggle_joint_use_gravity.m_call = cast(type_of(SkeletonModification2DJiggle_methods.get_jiggle_joint_use_gravity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DJiggle_methods.set_jiggle_joint_gravity.m_call = cast(type_of(SkeletonModification2DJiggle_methods.set_jiggle_joint_gravity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DJiggle_methods.get_jiggle_joint_gravity.m_call = cast(type_of(SkeletonModification2DJiggle_methods.get_jiggle_joint_gravity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
