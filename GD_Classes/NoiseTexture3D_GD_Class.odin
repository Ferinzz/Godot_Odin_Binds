...
NoiseTexture3D_Init_ :: proc (NoiseTexture3D_methods: ^NoiseTexture3D_MethodBind_List, loc := #caller_location) {
  NoiseTexture3D_methods.set_width = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.NoiseTexture3D, "set_width", 1286410249, loc))
  NoiseTexture3D_methods.set_height = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.NoiseTexture3D, "set_height", 1286410249, loc))
  NoiseTexture3D_methods.set_depth = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.NoiseTexture3D, "set_depth", 1286410249, loc))
  NoiseTexture3D_methods.set_noise = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.NoiseTexture3D, "set_noise", 4135492439, loc))
  NoiseTexture3D_methods.get_noise = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.NoiseTexture3D, "get_noise", 185851837, loc))
  NoiseTexture3D_methods.set_color_ramp = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.NoiseTexture3D, "set_color_ramp", 2756054477, loc))
  NoiseTexture3D_methods.get_color_ramp = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.NoiseTexture3D, "get_color_ramp", 132272999, loc))
  NoiseTexture3D_methods.set_seamless = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.NoiseTexture3D, "set_seamless", 2586408642, loc))
  NoiseTexture3D_methods.get_seamless = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.NoiseTexture3D, "get_seamless", 2240911060, loc))
  NoiseTexture3D_methods.set_invert = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.NoiseTexture3D, "set_invert", 2586408642, loc))
  NoiseTexture3D_methods.get_invert = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.NoiseTexture3D, "get_invert", 36873697, loc))
  NoiseTexture3D_methods.set_normalize = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.NoiseTexture3D, "set_normalize", 2586408642, loc))
  NoiseTexture3D_methods.is_normalized = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.NoiseTexture3D, "is_normalized", 36873697, loc))
  NoiseTexture3D_methods.set_seamless_blend_skirt = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.NoiseTexture3D, "set_seamless_blend_skirt", 373806689, loc))
  NoiseTexture3D_methods.get_seamless_blend_skirt = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.NoiseTexture3D, "get_seamless_blend_skirt", 191475506, loc))
};
