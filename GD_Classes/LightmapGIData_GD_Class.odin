...
ShadowmaskMode_LightmapGIData :: enum i64 {
  SHADOWMASK_MODE_NONE = 0,
  SHADOWMASK_MODE_REPLACE = 1,
  SHADOWMASK_MODE_OVERLAY = 2,
};
LightmapGIData_MethodBind_List :: struct {
  set_lightmap_textures: ^GDW.MethodBind,
  get_lightmap_textures: ^GDW.MethodBind,
  set_shadowmask_textures: ^GDW.MethodBind,
  get_shadowmask_textures: ^GDW.MethodBind,
  set_uses_spherical_harmonics: ^GDW.MethodBind,
  is_using_spherical_harmonics: ^GDW.MethodBind,
  add_user: ^GDW.MethodBind,
  get_user_count: ^GDW.MethodBind,
  get_user_path: ^GDW.MethodBind,
  clear_users: ^GDW.MethodBind,
  set_light_texture: ^GDW.MethodBind,
  get_light_texture: ^GDW.MethodBind,
};
LightmapGIData_Init_ :: proc (LightmapGIData_methods: ^LightmapGIData_MethodBind_List, loc := #caller_location) {
  LightmapGIData_methods.set_lightmap_textures = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.LightmapGIData, "set_lightmap_textures", 381264803, loc))
  LightmapGIData_methods.get_lightmap_textures = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.LightmapGIData, "get_lightmap_textures", 3995934104, loc))
  LightmapGIData_methods.set_shadowmask_textures = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.LightmapGIData, "set_shadowmask_textures", 381264803, loc))
  LightmapGIData_methods.get_shadowmask_textures = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.LightmapGIData, "get_shadowmask_textures", 3995934104, loc))
  LightmapGIData_methods.set_uses_spherical_harmonics = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.LightmapGIData, "set_uses_spherical_harmonics", 2586408642, loc))
  LightmapGIData_methods.is_using_spherical_harmonics = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.LightmapGIData, "is_using_spherical_harmonics", 36873697, loc))
  LightmapGIData_methods.add_user = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.LightmapGIData, "add_user", 4272570515, loc))
  LightmapGIData_methods.get_user_count = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.LightmapGIData, "get_user_count", 3905245786, loc))
  LightmapGIData_methods.get_user_path = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.LightmapGIData, "get_user_path", 408788394, loc))
  LightmapGIData_methods.clear_users = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.LightmapGIData, "clear_users", 3218959716, loc))
  LightmapGIData_methods.set_light_texture = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.LightmapGIData, "set_light_texture", 1278366092, loc))
  LightmapGIData_methods.get_light_texture = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.LightmapGIData, "get_light_texture", 3984243839, loc))
};
