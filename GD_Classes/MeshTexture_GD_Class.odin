...
MeshTexture_MethodBind_List :: struct {
  ...
  set_image_size: ^GDW.MethodBind,
  get_image_size: ^GDW.MethodBind,
  set_base_texture: ^GDW.MethodBind,
  get_base_texture: ^GDW.MethodBind,
};
MeshTexture_Init_ :: proc (MeshTexture_methods: ^MeshTexture_MethodBind_List, loc := #caller_location) {
  MeshTexture_methods.set_mesh = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.MeshTexture, "set_mesh", 194775623, loc))
  MeshTexture_methods.get_mesh = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.MeshTexture, "get_mesh", 1808005922, loc))
  MeshTexture_methods.set_image_size = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.MeshTexture, "set_image_size", 743155724, loc))
  MeshTexture_methods.get_image_size = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.MeshTexture, "get_image_size", 3341600327, loc))
  MeshTexture_methods.set_base_texture = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.MeshTexture, "set_base_texture", 4051416890, loc))
  MeshTexture_methods.get_base_texture = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.MeshTexture, "get_base_texture", 3635182373, loc))
};
