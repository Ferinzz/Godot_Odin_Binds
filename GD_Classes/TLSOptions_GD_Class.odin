...
TLSOptions_Init_ :: proc (TLSOptions_methods: ^TLSOptions_MethodBind_List, loc := #caller_location) {
  ...
  TLSOptions_methods.client.m_call = cast(type_of(TLSOptions_methods.client.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TLSOptions_methods.client_unsafe.m_call = cast(type_of(TLSOptions_methods.client_unsafe.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  TLSOptions_methods.server._server = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TLSOptions, "server", 36969539, loc))
  TLSOptions_methods.server.m_call = cast(type_of(TLSOptions_methods.server.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  TLSOptions_methods.is_server._is_server = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TLSOptions, "is_server", 36873697, loc))
  TLSOptions_methods.is_server.m_call = cast(type_of(TLSOptions_methods.is_server.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TLSOptions_methods.is_unsafe_client.m_call = cast(type_of(TLSOptions_methods.is_unsafe_client.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TLSOptions_methods.get_common_name_override.m_call = cast(type_of(TLSOptions_methods.get_common_name_override.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TLSOptions_methods.get_trusted_ca_chain.m_call = cast(type_of(TLSOptions_methods.get_trusted_ca_chain.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TLSOptions_methods.get_private_key.m_call = cast(type_of(TLSOptions_methods.get_private_key.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TLSOptions_methods.get_own_certificate.m_call = cast(type_of(TLSOptions_methods.get_own_certificate.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
