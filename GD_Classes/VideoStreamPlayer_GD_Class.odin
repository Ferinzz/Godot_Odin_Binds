...
VideoStreamPlayer_MethodBind_List :: struct {
  ...
  set_volume: ^GDW.MethodBind,
  get_volume: ^GDW.MethodBind,
  set_volume_db: ^GDW.MethodBind,
  get_volume_db: ^GDW.MethodBind,
  set_speed_scale: ^GDW.MethodBind,
  get_speed_scale: ^GDW.MethodBind,
  set_audio_track: ^GDW.MethodBind,
  get_audio_track: ^GDW.MethodBind,
  get_stream_name: ^GDW.MethodBind,
  get_stream_length: ^GDW.MethodBind,
  set_stream_position: ^GDW.MethodBind,
  get_stream_position: ^GDW.MethodBind,
  set_autoplay: ^GDW.MethodBind,
  has_autoplay: ^GDW.MethodBind,
  set_expand: ^GDW.MethodBind,
  has_expand: ^GDW.MethodBind,
  set_buffering_msec: ^GDW.MethodBind,
  get_buffering_msec: ^GDW.MethodBind,
  set_bus: ^GDW.MethodBind,
  get_bus: ^GDW.MethodBind,
  get_video_texture: ^GDW.MethodBind,
};
VideoStreamPlayer_Init_ :: proc (VideoStreamPlayer_methods: ^VideoStreamPlayer_MethodBind_List, loc := #caller_location) {
  VideoStreamPlayer_methods.set_stream = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.VideoStreamPlayer, "set_stream", 2317102564, loc))
  VideoStreamPlayer_methods.get_stream = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.VideoStreamPlayer, "get_stream", 438621487, loc))
  VideoStreamPlayer_methods.play = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.VideoStreamPlayer, "play", 3218959716, loc))
  VideoStreamPlayer_methods.stop = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.VideoStreamPlayer, "stop", 3218959716, loc))
  VideoStreamPlayer_methods.is_playing = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.VideoStreamPlayer, "is_playing", 36873697, loc))
  VideoStreamPlayer_methods.set_paused = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.VideoStreamPlayer, "set_paused", 2586408642, loc))
  VideoStreamPlayer_methods.is_paused = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.VideoStreamPlayer, "is_paused", 36873697, loc))
  VideoStreamPlayer_methods.set_loop = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.VideoStreamPlayer, "set_loop", 2586408642, loc))
  VideoStreamPlayer_methods.has_loop = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.VideoStreamPlayer, "has_loop", 36873697, loc))
  VideoStreamPlayer_methods.set_volume = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.VideoStreamPlayer, "set_volume", 373806689, loc))
  VideoStreamPlayer_methods.get_volume = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.VideoStreamPlayer, "get_volume", 1740695150, loc))
  VideoStreamPlayer_methods.set_volume_db = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.VideoStreamPlayer, "set_volume_db", 373806689, loc))
  VideoStreamPlayer_methods.get_volume_db = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.VideoStreamPlayer, "get_volume_db", 1740695150, loc))
  VideoStreamPlayer_methods.set_speed_scale = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.VideoStreamPlayer, "set_speed_scale", 373806689, loc))
  VideoStreamPlayer_methods.get_speed_scale = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.VideoStreamPlayer, "get_speed_scale", 1740695150, loc))
  VideoStreamPlayer_methods.set_audio_track = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.VideoStreamPlayer, "set_audio_track", 1286410249, loc))
  VideoStreamPlayer_methods.get_audio_track = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.VideoStreamPlayer, "get_audio_track", 3905245786, loc))
  VideoStreamPlayer_methods.get_stream_name = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.VideoStreamPlayer, "get_stream_name", 201670096, loc))
  VideoStreamPlayer_methods.get_stream_length = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.VideoStreamPlayer, "get_stream_length", 1740695150, loc))
  VideoStreamPlayer_methods.set_stream_position = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.VideoStreamPlayer, "set_stream_position", 373806689, loc))
  VideoStreamPlayer_methods.get_stream_position = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.VideoStreamPlayer, "get_stream_position", 1740695150, loc))
  VideoStreamPlayer_methods.set_autoplay = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.VideoStreamPlayer, "set_autoplay", 2586408642, loc))
  VideoStreamPlayer_methods.has_autoplay = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.VideoStreamPlayer, "has_autoplay", 36873697, loc))
  VideoStreamPlayer_methods.set_expand = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.VideoStreamPlayer, "set_expand", 2586408642, loc))
  VideoStreamPlayer_methods.has_expand = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.VideoStreamPlayer, "has_expand", 36873697, loc))
  VideoStreamPlayer_methods.set_buffering_msec = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.VideoStreamPlayer, "set_buffering_msec", 1286410249, loc))
  VideoStreamPlayer_methods.get_buffering_msec = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.VideoStreamPlayer, "get_buffering_msec", 3905245786, loc))
  VideoStreamPlayer_methods.set_bus = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.VideoStreamPlayer, "set_bus", 3304788590, loc))
  VideoStreamPlayer_methods.get_bus = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.VideoStreamPlayer, "get_bus", 2002593661, loc))
  VideoStreamPlayer_methods.get_video_texture = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.VideoStreamPlayer, "get_video_texture", 3635182373, loc))
};
