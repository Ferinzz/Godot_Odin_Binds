...
StreamPeer_Init_ :: proc (StreamPeer_methods: ^StreamPeer_MethodBind_List, loc := #caller_location) {
  ...
  StreamPeer_methods.put_data.m_call = cast(type_of(StreamPeer_methods.put_data.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  StreamPeer_methods.put_partial_data.m_call = cast(type_of(StreamPeer_methods.put_partial_data.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  StreamPeer_methods.get_data._get_data = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.StreamPeer, "get_data", 1171824711, loc))
  StreamPeer_methods.get_data.m_call = cast(type_of(StreamPeer_methods.get_data.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  StreamPeer_methods.get_partial_data.m_call = cast(type_of(StreamPeer_methods.get_partial_data.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  StreamPeer_methods.get_available_bytes.m_call = cast(type_of(StreamPeer_methods.get_available_bytes.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  StreamPeer_methods.set_big_endian.m_call = cast(type_of(StreamPeer_methods.set_big_endian.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  StreamPeer_methods.is_big_endian_enabled.m_call = cast(type_of(StreamPeer_methods.is_big_endian_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  StreamPeer_methods.put_8._put_8 = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.StreamPeer, "put_8", 1286410249, loc))
  StreamPeer_methods.put_8.m_call = cast(type_of(StreamPeer_methods.put_8.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  StreamPeer_methods.put_u8._put_u8 = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.StreamPeer, "put_u8", 1286410249, loc))
  StreamPeer_methods.put_u8.m_call = cast(type_of(StreamPeer_methods.put_u8.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  StreamPeer_methods.put_16._put_16 = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.StreamPeer, "put_16", 1286410249, loc))
  StreamPeer_methods.put_16.m_call = cast(type_of(StreamPeer_methods.put_16.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  StreamPeer_methods.put_u16._put_u16 = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.StreamPeer, "put_u16", 1286410249, loc))
  StreamPeer_methods.put_u16.m_call = cast(type_of(StreamPeer_methods.put_u16.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  StreamPeer_methods.put_32._put_32 = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.StreamPeer, "put_32", 1286410249, loc))
  StreamPeer_methods.put_32.m_call = cast(type_of(StreamPeer_methods.put_32.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  StreamPeer_methods.put_u32._put_u32 = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.StreamPeer, "put_u32", 1286410249, loc))
  StreamPeer_methods.put_u32.m_call = cast(type_of(StreamPeer_methods.put_u32.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  StreamPeer_methods.put_64._put_64 = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.StreamPeer, "put_64", 1286410249, loc))
  StreamPeer_methods.put_64.m_call = cast(type_of(StreamPeer_methods.put_64.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  StreamPeer_methods.put_u64._put_u64 = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.StreamPeer, "put_u64", 1286410249, loc))
  StreamPeer_methods.put_u64.m_call = cast(type_of(StreamPeer_methods.put_u64.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  StreamPeer_methods.put_half._put_half = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.StreamPeer, "put_half", 373806689, loc))
  StreamPeer_methods.put_half.m_call = cast(type_of(StreamPeer_methods.put_half.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  StreamPeer_methods.put_float._put_float = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.StreamPeer, "put_float", 373806689, loc))
  StreamPeer_methods.put_float.m_call = cast(type_of(StreamPeer_methods.put_float.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  StreamPeer_methods.put_double.m_call = cast(type_of(StreamPeer_methods.put_double.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  StreamPeer_methods.put_string.m_call = cast(type_of(StreamPeer_methods.put_string.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  StreamPeer_methods.put_utf8_string.m_call = cast(type_of(StreamPeer_methods.put_utf8_string.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  StreamPeer_methods.put_var._put_var = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.StreamPeer, "put_var", 738511890, loc))
  StreamPeer_methods.put_var.m_call = cast(type_of(StreamPeer_methods.put_var.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  StreamPeer_methods.get_8._get_8 = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.StreamPeer, "get_8", 2455072627, loc))
  StreamPeer_methods.get_8.m_call = cast(type_of(StreamPeer_methods.get_8.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  StreamPeer_methods.get_u8._get_u8 = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.StreamPeer, "get_u8", 2455072627, loc))
  StreamPeer_methods.get_u8.m_call = cast(type_of(StreamPeer_methods.get_u8.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  StreamPeer_methods.get_16._get_16 = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.StreamPeer, "get_16", 2455072627, loc))
  StreamPeer_methods.get_16.m_call = cast(type_of(StreamPeer_methods.get_16.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  StreamPeer_methods.get_u16._get_u16 = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.StreamPeer, "get_u16", 2455072627, loc))
  StreamPeer_methods.get_u16.m_call = cast(type_of(StreamPeer_methods.get_u16.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  StreamPeer_methods.get_32._get_32 = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.StreamPeer, "get_32", 2455072627, loc))
  StreamPeer_methods.get_32.m_call = cast(type_of(StreamPeer_methods.get_32.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  StreamPeer_methods.get_u32._get_u32 = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.StreamPeer, "get_u32", 2455072627, loc))
  StreamPeer_methods.get_u32.m_call = cast(type_of(StreamPeer_methods.get_u32.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  StreamPeer_methods.get_64._get_64 = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.StreamPeer, "get_64", 2455072627, loc))
  StreamPeer_methods.get_64.m_call = cast(type_of(StreamPeer_methods.get_64.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  StreamPeer_methods.get_u64._get_u64 = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.StreamPeer, "get_u64", 2455072627, loc))
  StreamPeer_methods.get_u64.m_call = cast(type_of(StreamPeer_methods.get_u64.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  StreamPeer_methods.get_half._get_half = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.StreamPeer, "get_half", 191475506, loc))
  StreamPeer_methods.get_half.m_call = cast(type_of(StreamPeer_methods.get_half.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  StreamPeer_methods.get_float._get_float = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.StreamPeer, "get_float", 191475506, loc))
  StreamPeer_methods.get_float.m_call = cast(type_of(StreamPeer_methods.get_float.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  StreamPeer_methods.get_double.m_call = cast(type_of(StreamPeer_methods.get_double.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  StreamPeer_methods.get_string.m_call = cast(type_of(StreamPeer_methods.get_string.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  StreamPeer_methods.get_utf8_string.m_call = cast(type_of(StreamPeer_methods.get_utf8_string.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  StreamPeer_methods.get_var._get_var = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.StreamPeer, "get_var", 3442865206, loc))
  StreamPeer_methods.get_var.m_call = cast(type_of(StreamPeer_methods.get_var.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
