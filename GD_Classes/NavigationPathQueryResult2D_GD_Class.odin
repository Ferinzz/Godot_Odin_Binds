...
NavigationPathQueryResult2D_MethodBind_List :: struct {
  set_path: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: NavigationPathQueryResult2D, #by_ptr args: i64 = 0, r_ret: ^GDW.PackedVector2Array)
  },
  set_path_types: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: NavigationPathQueryResult2D, #by_ptr args: i64 = 0, r_ret: ^GDW.PackedInt32Array)
  },
  set_path_rids: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: NavigationPathQueryResult2D, #by_ptr args: i64 = 0, r_ret: ^GDW.Array)
  },
  set_path_owner_ids: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: NavigationPathQueryResult2D, #by_ptr args: i64 = 0, r_ret: ^GDW.PackedInt64Array)
  },
  set_path_length: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: NavigationPathQueryResult2D, #by_ptr args: i64 = 0, r_ret: ^GDW.float)
  },
  reset: struct{
    using _reset: ^GDW.MethodBind,
    m_call: proc(_:^GDW.MethodBind, obj: NavigationPathQueryResult2D, #by_ptr args: i64 = 0, r_ret: rawptr = nil)
  },
  };
NavigationPathQueryResult2D_Init_ :: proc (NavigationPathQueryResult2D_methods: ^NavigationPathQueryResult2D_MethodBind_List, loc := #caller_location) {
  ...
  NavigationPathQueryResult2D_methods.set_path.m_call = cast(type_of(NavigationPathQueryResult2D_methods.set_path.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationPathQueryResult2D_methods.get_path.m_call = cast(type_of(NavigationPathQueryResult2D_methods.get_path.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationPathQueryResult2D_methods.set_path_types.m_call = cast(type_of(NavigationPathQueryResult2D_methods.set_path_types.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationPathQueryResult2D_methods.get_path_types.m_call = cast(type_of(NavigationPathQueryResult2D_methods.get_path_types.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationPathQueryResult2D_methods.set_path_rids.m_call = cast(type_of(NavigationPathQueryResult2D_methods.set_path_rids.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationPathQueryResult2D_methods.get_path_rids.m_call = cast(type_of(NavigationPathQueryResult2D_methods.get_path_rids.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationPathQueryResult2D_methods.set_path_owner_ids.m_call = cast(type_of(NavigationPathQueryResult2D_methods.set_path_owner_ids.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationPathQueryResult2D_methods.get_path_owner_ids.m_call = cast(type_of(NavigationPathQueryResult2D_methods.get_path_owner_ids.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationPathQueryResult2D_methods.set_path_length.m_call = cast(type_of(NavigationPathQueryResult2D_methods.set_path_length.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationPathQueryResult2D_methods.get_path_length.m_call = cast(type_of(NavigationPathQueryResult2D_methods.get_path_length.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationPathQueryResult2D_methods.reset.m_call = cast(type_of(NavigationPathQueryResult2D_methods.reset.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
