...
OpenXRCompositionLayerQuad_MethodBind_List :: struct {
  set_quad_size: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: OpenXRCompositionLayerQuad, #by_ptr args: struct{size: ^GDW.Vector2, }, r_ret: rawptr = nil)
  },
    get_quad_size: struct{
    using _get_quad_size: ^GDW.MethodBind,
    m_call: proc "c" (_:^GDW.MethodBind, obj: OpenXRCompositionLayerQuad, args: rawptr = nil, r_ret: ^GDW.Vector2)
  },
};
OpenXRCompositionLayerQuad_Init_ :: proc (OpenXRCompositionLayerQuad_methods: ^OpenXRCompositionLayerQuad_MethodBind_List, loc := #caller_location) {
  ...
  OpenXRCompositionLayerQuad_methods.set_quad_size._set_quad_size = (cast(^GDW.MethodBind)classDBGetMethodBind3(.OpenXRCompositionLayerQuad, "set_quad_size", 743155724, loc))
  ...
  OpenXRCompositionLayerQuad_methods.get_quad_size._get_quad_size = (cast(^GDW.MethodBind)classDBGetMethodBind3(.OpenXRCompositionLayerQuad, "get_quad_size", 3341600327, loc))
