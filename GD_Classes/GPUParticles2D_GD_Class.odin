...
DrawOrder_GPUParticles2D :: enum i64 {
  DRAW_ORDER_INDEX = 0,
  DRAW_ORDER_LIFETIME = 1,
  DRAW_ORDER_REVERSE_LIFETIME = 2,
};

EmitFlags_GPUParticles2D :: enum i64 {
...
GPUParticles2D_MethodBind_List :: struct {
  ...
  set_visibility_rect: ^GDW.MethodBind,
  ...
  get_visibility_rect: ^GDW.MethodBind,
  ...
  set_trail_sections: ^GDW.MethodBind,
  get_trail_sections: ^GDW.MethodBind,
  set_trail_section_subdivisions: ^GDW.MethodBind,
  get_trail_section_subdivisions: ^GDW.MethodBind,
...
GPUParticles2D_Init_ :: proc (GPUParticles2D_methods: ^GPUParticles2D_MethodBind_List, loc := #caller_location) {
  GPUParticles2D_methods.set_emitting = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "set_emitting", 2586408642, loc))
  GPUParticles2D_methods.set_amount = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "set_amount", 1286410249, loc))
  GPUParticles2D_methods.set_lifetime = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "set_lifetime", 373806689, loc))
  GPUParticles2D_methods.set_one_shot = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "set_one_shot", 2586408642, loc))
  GPUParticles2D_methods.set_pre_process_time = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "set_pre_process_time", 373806689, loc))
  GPUParticles2D_methods.set_explosiveness_ratio = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "set_explosiveness_ratio", 373806689, loc))
  GPUParticles2D_methods.set_randomness_ratio = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "set_randomness_ratio", 373806689, loc))
  GPUParticles2D_methods.set_visibility_rect = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "set_visibility_rect", 2046264180, loc))
  GPUParticles2D_methods.set_use_local_coordinates = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "set_use_local_coordinates", 2586408642, loc))
  GPUParticles2D_methods.set_fixed_fps = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "set_fixed_fps", 1286410249, loc))
  GPUParticles2D_methods.set_fractional_delta = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "set_fractional_delta", 2586408642, loc))
  GPUParticles2D_methods.set_interpolate = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "set_interpolate", 2586408642, loc))
  GPUParticles2D_methods.set_process_material = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "set_process_material", 2757459619, loc))
  GPUParticles2D_methods.set_speed_scale = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "set_speed_scale", 373806689, loc))
  GPUParticles2D_methods.set_collision_base_size = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "set_collision_base_size", 373806689, loc))
  GPUParticles2D_methods.set_interp_to_end = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "set_interp_to_end", 373806689, loc))
  GPUParticles2D_methods.request_particles_process = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "request_particles_process", 373806689, loc))
  GPUParticles2D_methods.is_emitting = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "is_emitting", 36873697, loc))
  GPUParticles2D_methods.get_amount = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "get_amount", 3905245786, loc))
  GPUParticles2D_methods.get_lifetime = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "get_lifetime", 1740695150, loc))
  GPUParticles2D_methods.get_one_shot = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "get_one_shot", 36873697, loc))
  GPUParticles2D_methods.get_pre_process_time = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "get_pre_process_time", 1740695150, loc))
  GPUParticles2D_methods.get_explosiveness_ratio = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "get_explosiveness_ratio", 1740695150, loc))
  GPUParticles2D_methods.get_randomness_ratio = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "get_randomness_ratio", 1740695150, loc))
  GPUParticles2D_methods.get_visibility_rect = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "get_visibility_rect", 1639390495, loc))
  GPUParticles2D_methods.get_use_local_coordinates = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "get_use_local_coordinates", 36873697, loc))
  GPUParticles2D_methods.get_fixed_fps = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "get_fixed_fps", 3905245786, loc))
  GPUParticles2D_methods.get_fractional_delta = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "get_fractional_delta", 36873697, loc))
  GPUParticles2D_methods.get_interpolate = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "get_interpolate", 36873697, loc))
  GPUParticles2D_methods.get_process_material = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "get_process_material", 5934680, loc))
  GPUParticles2D_methods.get_speed_scale = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "get_speed_scale", 1740695150, loc))
  GPUParticles2D_methods.get_collision_base_size = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "get_collision_base_size", 1740695150, loc))
  GPUParticles2D_methods.get_interp_to_end = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "get_interp_to_end", 1740695150, loc))
  GPUParticles2D_methods.set_draw_order = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "set_draw_order", 1939677959, loc))
  GPUParticles2D_methods.get_draw_order = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "get_draw_order", 941479095, loc))
  GPUParticles2D_methods.set_texture = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "set_texture", 4051416890, loc))
  GPUParticles2D_methods.get_texture = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "get_texture", 3635182373, loc))
  GPUParticles2D_methods.capture_rect = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "capture_rect", 1639390495, loc))
  GPUParticles2D_methods.restart = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "restart", 107499316, loc))
  GPUParticles2D_methods.set_sub_emitter = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "set_sub_emitter", 1348162250, loc))
  GPUParticles2D_methods.get_sub_emitter = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "get_sub_emitter", 4075236667, loc))
  GPUParticles2D_methods.emit_particle = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "emit_particle", 2179202058, loc))
  GPUParticles2D_methods.set_trail_enabled = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "set_trail_enabled", 2586408642, loc))
  GPUParticles2D_methods.set_trail_lifetime = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "set_trail_lifetime", 373806689, loc))
  GPUParticles2D_methods.is_trail_enabled = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "is_trail_enabled", 36873697, loc))
  GPUParticles2D_methods.get_trail_lifetime = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "get_trail_lifetime", 1740695150, loc))
  GPUParticles2D_methods.set_trail_sections = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "set_trail_sections", 1286410249, loc))
  GPUParticles2D_methods.get_trail_sections = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "get_trail_sections", 3905245786, loc))
  GPUParticles2D_methods.set_trail_section_subdivisions = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "set_trail_section_subdivisions", 1286410249, loc))
  GPUParticles2D_methods.get_trail_section_subdivisions = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "get_trail_section_subdivisions", 3905245786, loc))
  GPUParticles2D_methods.convert_from_particles = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "convert_from_particles", 1078189570, loc))
  GPUParticles2D_methods.set_amount_ratio = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "set_amount_ratio", 373806689, loc))
  GPUParticles2D_methods.get_amount_ratio = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "get_amount_ratio", 1740695150, loc))
  GPUParticles2D_methods.set_use_fixed_seed = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "set_use_fixed_seed", 2586408642, loc))
  GPUParticles2D_methods.get_use_fixed_seed = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "get_use_fixed_seed", 36873697, loc))
  GPUParticles2D_methods.set_seed = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "set_seed", 1286410249, loc))
  GPUParticles2D_methods.get_seed = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.GPUParticles2D, "get_seed", 3905245786, loc))
};
