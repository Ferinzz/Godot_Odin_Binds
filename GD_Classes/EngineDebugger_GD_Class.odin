...
EngineDebugger_Init_ :: proc (EngineDebugger_methods: ^EngineDebugger_MethodBind_List, loc := #caller_location) {
  ...
  EngineDebugger_methods.is_active.m_call = cast(type_of(EngineDebugger_methods.is_active.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EngineDebugger_methods.register_profiler.m_call = cast(type_of(EngineDebugger_methods.register_profiler.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EngineDebugger_methods.unregister_profiler.m_call = cast(type_of(EngineDebugger_methods.unregister_profiler.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EngineDebugger_methods.is_profiling.m_call = cast(type_of(EngineDebugger_methods.is_profiling.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EngineDebugger_methods.has_profiler.m_call = cast(type_of(EngineDebugger_methods.has_profiler.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EngineDebugger_methods.profiler_add_frame_data.m_call = cast(type_of(EngineDebugger_methods.profiler_add_frame_data.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EngineDebugger_methods.profiler_enable.m_call = cast(type_of(EngineDebugger_methods.profiler_enable.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EngineDebugger_methods.register_message_capture.m_call = cast(type_of(EngineDebugger_methods.register_message_capture.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EngineDebugger_methods.unregister_message_capture.m_call = cast(type_of(EngineDebugger_methods.unregister_message_capture.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EngineDebugger_methods.has_capture.m_call = cast(type_of(EngineDebugger_methods.has_capture.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EngineDebugger_methods.line_poll.m_call = cast(type_of(EngineDebugger_methods.line_poll.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EngineDebugger_methods.send_message.m_call = cast(type_of(EngineDebugger_methods.send_message.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  EngineDebugger_methods.debug._debug = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.EngineDebugger, "debug", 2751962654, loc))
  EngineDebugger_methods.debug.m_call = cast(type_of(EngineDebugger_methods.debug.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EngineDebugger_methods.script_debug.m_call = cast(type_of(EngineDebugger_methods.script_debug.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EngineDebugger_methods.set_lines_left.m_call = cast(type_of(EngineDebugger_methods.set_lines_left.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EngineDebugger_methods.get_lines_left.m_call = cast(type_of(EngineDebugger_methods.get_lines_left.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EngineDebugger_methods.set_depth.m_call = cast(type_of(EngineDebugger_methods.set_depth.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EngineDebugger_methods.get_depth.m_call = cast(type_of(EngineDebugger_methods.get_depth.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EngineDebugger_methods.is_breakpoint.m_call = cast(type_of(EngineDebugger_methods.is_breakpoint.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EngineDebugger_methods.is_skipping_breakpoints.m_call = cast(type_of(EngineDebugger_methods.is_skipping_breakpoints.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EngineDebugger_methods.insert_breakpoint.m_call = cast(type_of(EngineDebugger_methods.insert_breakpoint.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EngineDebugger_methods.remove_breakpoint.m_call = cast(type_of(EngineDebugger_methods.remove_breakpoint.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EngineDebugger_methods.clear_breakpoints.m_call = cast(type_of(EngineDebugger_methods.clear_breakpoints.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
