...
NavigationLink2D_Init_ :: proc (NavigationLink2D_methods: ^NavigationLink2D_MethodBind_List, loc := #caller_location) {
  ...
  NavigationLink2D_methods.get_rid.m_call = cast(type_of(NavigationLink2D_methods.get_rid.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationLink2D_methods.set_enabled.m_call = cast(type_of(NavigationLink2D_methods.set_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationLink2D_methods.is_enabled.m_call = cast(type_of(NavigationLink2D_methods.is_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationLink2D_methods.set_navigation_map.m_call = cast(type_of(NavigationLink2D_methods.set_navigation_map.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationLink2D_methods.get_navigation_map.m_call = cast(type_of(NavigationLink2D_methods.get_navigation_map.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationLink2D_methods.set_bidirectional.m_call = cast(type_of(NavigationLink2D_methods.set_bidirectional.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationLink2D_methods.is_bidirectional.m_call = cast(type_of(NavigationLink2D_methods.is_bidirectional.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationLink2D_methods.set_navigation_layers.m_call = cast(type_of(NavigationLink2D_methods.set_navigation_layers.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationLink2D_methods.get_navigation_layers.m_call = cast(type_of(NavigationLink2D_methods.get_navigation_layers.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationLink2D_methods.set_navigation_layer_value.m_call = cast(type_of(NavigationLink2D_methods.set_navigation_layer_value.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationLink2D_methods.get_navigation_layer_value.m_call = cast(type_of(NavigationLink2D_methods.get_navigation_layer_value.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationLink2D_methods.set_start_position.m_call = cast(type_of(NavigationLink2D_methods.set_start_position.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationLink2D_methods.get_start_position.m_call = cast(type_of(NavigationLink2D_methods.get_start_position.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationLink2D_methods.set_end_position.m_call = cast(type_of(NavigationLink2D_methods.set_end_position.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationLink2D_methods.get_end_position.m_call = cast(type_of(NavigationLink2D_methods.get_end_position.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationLink2D_methods.set_global_start_position.m_call = cast(type_of(NavigationLink2D_methods.set_global_start_position.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationLink2D_methods.get_global_start_position.m_call = cast(type_of(NavigationLink2D_methods.get_global_start_position.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationLink2D_methods.set_global_end_position.m_call = cast(type_of(NavigationLink2D_methods.set_global_end_position.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationLink2D_methods.get_global_end_position.m_call = cast(type_of(NavigationLink2D_methods.get_global_end_position.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationLink2D_methods.set_enter_cost.m_call = cast(type_of(NavigationLink2D_methods.set_enter_cost.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationLink2D_methods.get_enter_cost.m_call = cast(type_of(NavigationLink2D_methods.get_enter_cost.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationLink2D_methods.set_travel_cost.m_call = cast(type_of(NavigationLink2D_methods.set_travel_cost.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  NavigationLink2D_methods.get_travel_cost.m_call = cast(type_of(NavigationLink2D_methods.get_travel_cost.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
