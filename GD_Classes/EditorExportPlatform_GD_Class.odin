...
EditorExportPlatform_Init_ :: proc (EditorExportPlatform_methods: ^EditorExportPlatform_MethodBind_List, loc := #caller_location) {
  ...
  EditorExportPlatform_methods.get_os_name.m_call = cast(type_of(EditorExportPlatform_methods.get_os_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorExportPlatform_methods.create_preset.m_call = cast(type_of(EditorExportPlatform_methods.create_preset.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorExportPlatform_methods.find_export_template.m_call = cast(type_of(EditorExportPlatform_methods.find_export_template.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorExportPlatform_methods.get_current_presets.m_call = cast(type_of(EditorExportPlatform_methods.get_current_presets.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorExportPlatform_methods.save_pack.m_call = cast(type_of(EditorExportPlatform_methods.save_pack.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorExportPlatform_methods.save_zip.m_call = cast(type_of(EditorExportPlatform_methods.save_zip.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorExportPlatform_methods.save_pack_patch.m_call = cast(type_of(EditorExportPlatform_methods.save_pack_patch.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorExportPlatform_methods.save_zip_patch.m_call = cast(type_of(EditorExportPlatform_methods.save_zip_patch.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorExportPlatform_methods.gen_export_flags.m_call = cast(type_of(EditorExportPlatform_methods.gen_export_flags.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorExportPlatform_methods.export_project_files.m_call = cast(type_of(EditorExportPlatform_methods.export_project_files.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorExportPlatform_methods.export_project.m_call = cast(type_of(EditorExportPlatform_methods.export_project.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorExportPlatform_methods.export_pack.m_call = cast(type_of(EditorExportPlatform_methods.export_pack.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorExportPlatform_methods.export_zip.m_call = cast(type_of(EditorExportPlatform_methods.export_zip.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorExportPlatform_methods.export_pack_patch.m_call = cast(type_of(EditorExportPlatform_methods.export_pack_patch.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorExportPlatform_methods.export_zip_patch.m_call = cast(type_of(EditorExportPlatform_methods.export_zip_patch.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorExportPlatform_methods.clear_messages.m_call = cast(type_of(EditorExportPlatform_methods.clear_messages.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorExportPlatform_methods.add_message.m_call = cast(type_of(EditorExportPlatform_methods.add_message.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorExportPlatform_methods.get_message_count.m_call = cast(type_of(EditorExportPlatform_methods.get_message_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorExportPlatform_methods.get_message_type.m_call = cast(type_of(EditorExportPlatform_methods.get_message_type.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorExportPlatform_methods.get_message_category.m_call = cast(type_of(EditorExportPlatform_methods.get_message_category.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorExportPlatform_methods.get_message_text.m_call = cast(type_of(EditorExportPlatform_methods.get_message_text.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorExportPlatform_methods.get_worst_message_type.m_call = cast(type_of(EditorExportPlatform_methods.get_worst_message_type.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorExportPlatform_methods.ssh_run_on_remote.m_call = cast(type_of(EditorExportPlatform_methods.ssh_run_on_remote.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorExportPlatform_methods.ssh_run_on_remote_no_wait.m_call = cast(type_of(EditorExportPlatform_methods.ssh_run_on_remote_no_wait.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorExportPlatform_methods.ssh_push_to_remote.m_call = cast(type_of(EditorExportPlatform_methods.ssh_push_to_remote.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorExportPlatform_methods.get_internal_export_files.m_call = cast(type_of(EditorExportPlatform_methods.get_internal_export_files.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorExportPlatform_methods.get_forced_export_files.m_call = cast(type_of(EditorExportPlatform_methods.get_forced_export_files.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
