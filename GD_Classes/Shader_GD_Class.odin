...
Shader_Init_ :: proc (Shader_methods: ^Shader_MethodBind_List, loc := #caller_location) {
  ...
  Shader_methods.get_mode.m_call = cast(type_of(Shader_methods.get_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Shader_methods.set_code._set_code = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Shader, "set_code", 83702148, loc))
  Shader_methods.set_code.m_call = cast(type_of(Shader_methods.set_code.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Shader_methods.get_code._get_code = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Shader, "get_code", 201670096, loc))
  Shader_methods.get_code.m_call = cast(type_of(Shader_methods.get_code.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Shader_methods.set_default_texture_parameter.m_call = cast(type_of(Shader_methods.set_default_texture_parameter.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Shader_methods.get_default_texture_parameter.m_call = cast(type_of(Shader_methods.get_default_texture_parameter.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Shader_methods.get_shader_uniform_list.m_call = cast(type_of(Shader_methods.get_shader_uniform_list.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Shader_methods.inspect_native_shader_code.m_call = cast(type_of(Shader_methods.inspect_native_shader_code.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
