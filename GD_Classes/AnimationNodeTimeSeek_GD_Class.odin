...
AnimationNodeTimeSeek_MethodBind_List :: struct {
  set_explicit_elapse: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: AnimationNodeTimeSeek, #by_ptr args: struct{enable: ^GDW.Bool, }, r_ret: rawptr = nil)
  },
    is_explicit_elapse: struct{
    using _is_explicit_elapse: ^GDW.MethodBind,
    m_call: proc "c" (_:^GDW.MethodBind, obj: AnimationNodeTimeSeek, args: rawptr = nil, r_ret: ^GDW.Bool)
  },
};
AnimationNodeTimeSeek_Init_ :: proc (AnimationNodeTimeSeek_methods: ^AnimationNodeTimeSeek_MethodBind_List, loc := #caller_location) {
  ...
  AnimationNodeTimeSeek_methods.set_explicit_elapse._set_explicit_elapse = (cast(^GDW.MethodBind)classDBGetMethodBind3(.AnimationNodeTimeSeek, "set_explicit_elapse", 2586408642, loc))
  ...
  AnimationNodeTimeSeek_methods.is_explicit_elapse._is_explicit_elapse = (cast(^GDW.MethodBind)classDBGetMethodBind3(.AnimationNodeTimeSeek, "is_explicit_elapse", 36873697, loc))
