...
Path2D_Init_ :: proc (Path2D_methods: ^Path2D_MethodBind_List, loc := #caller_location) {
  Path2D_methods.set_curve = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Path2D, "set_curve", 659985499, loc))
  Path2D_methods.get_curve = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Path2D, "get_curve", 660369445, loc))
};
