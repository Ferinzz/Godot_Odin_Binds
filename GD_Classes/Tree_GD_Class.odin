...
Tree_Init_ :: proc (Tree_methods: ^Tree_MethodBind_List, loc := #caller_location) {
  ...
  Tree_methods.clear.m_call = cast(type_of(Tree_methods.clear.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Tree_methods.create_item._create_item = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Tree, "create_item", 528467046, loc))
  Tree_methods.create_item.m_call = cast(type_of(Tree_methods.create_item.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Tree_methods.get_root._get_root = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Tree, "get_root", 1514277247, loc))
  Tree_methods.get_root.m_call = cast(type_of(Tree_methods.get_root.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.set_column_custom_minimum_width.m_call = cast(type_of(Tree_methods.set_column_custom_minimum_width.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.set_column_expand.m_call = cast(type_of(Tree_methods.set_column_expand.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.set_column_expand_ratio.m_call = cast(type_of(Tree_methods.set_column_expand_ratio.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.set_column_clip_content.m_call = cast(type_of(Tree_methods.set_column_clip_content.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.is_column_expanding.m_call = cast(type_of(Tree_methods.is_column_expanding.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.is_column_clipping_content.m_call = cast(type_of(Tree_methods.is_column_clipping_content.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.get_column_expand_ratio.m_call = cast(type_of(Tree_methods.get_column_expand_ratio.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.get_column_width.m_call = cast(type_of(Tree_methods.get_column_width.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.set_hide_root.m_call = cast(type_of(Tree_methods.set_hide_root.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.is_root_hidden.m_call = cast(type_of(Tree_methods.is_root_hidden.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.get_next_selected.m_call = cast(type_of(Tree_methods.get_next_selected.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Tree_methods.get_selected._get_selected = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Tree, "get_selected", 1514277247, loc))
  Tree_methods.get_selected.m_call = cast(type_of(Tree_methods.get_selected.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Tree_methods.set_selected._set_selected = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Tree, "set_selected", 2662547442, loc))
  Tree_methods.set_selected.m_call = cast(type_of(Tree_methods.set_selected.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.get_selected_column.m_call = cast(type_of(Tree_methods.get_selected_column.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.get_pressed_button.m_call = cast(type_of(Tree_methods.get_pressed_button.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.set_select_mode.m_call = cast(type_of(Tree_methods.set_select_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.get_select_mode.m_call = cast(type_of(Tree_methods.get_select_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Tree_methods.deselect_all._deselect_all = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Tree, "deselect_all", 3218959716, loc))
  Tree_methods.deselect_all.m_call = cast(type_of(Tree_methods.deselect_all.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Tree_methods.set_columns._set_columns = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Tree, "set_columns", 1286410249, loc))
  Tree_methods.set_columns.m_call = cast(type_of(Tree_methods.set_columns.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Tree_methods.get_columns._get_columns = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Tree, "get_columns", 3905245786, loc))
  Tree_methods.get_columns.m_call = cast(type_of(Tree_methods.get_columns.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Tree_methods.get_edited._get_edited = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Tree, "get_edited", 1514277247, loc))
  Tree_methods.get_edited.m_call = cast(type_of(Tree_methods.get_edited.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.get_edited_column.m_call = cast(type_of(Tree_methods.get_edited_column.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.edit_selected.m_call = cast(type_of(Tree_methods.edit_selected.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.get_custom_popup_rect.m_call = cast(type_of(Tree_methods.get_custom_popup_rect.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.get_item_area_rect.m_call = cast(type_of(Tree_methods.get_item_area_rect.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.get_item_at_position.m_call = cast(type_of(Tree_methods.get_item_at_position.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.get_column_at_position.m_call = cast(type_of(Tree_methods.get_column_at_position.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.get_drop_section_at_position.m_call = cast(type_of(Tree_methods.get_drop_section_at_position.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.get_button_id_at_position.m_call = cast(type_of(Tree_methods.get_button_id_at_position.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.ensure_cursor_is_visible.m_call = cast(type_of(Tree_methods.ensure_cursor_is_visible.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.set_column_titles_visible.m_call = cast(type_of(Tree_methods.set_column_titles_visible.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.are_column_titles_visible.m_call = cast(type_of(Tree_methods.are_column_titles_visible.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.set_column_title.m_call = cast(type_of(Tree_methods.set_column_title.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.get_column_title.m_call = cast(type_of(Tree_methods.get_column_title.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.set_column_title_tooltip_text.m_call = cast(type_of(Tree_methods.set_column_title_tooltip_text.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.get_column_title_tooltip_text.m_call = cast(type_of(Tree_methods.get_column_title_tooltip_text.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.set_column_title_alignment.m_call = cast(type_of(Tree_methods.set_column_title_alignment.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.get_column_title_alignment.m_call = cast(type_of(Tree_methods.get_column_title_alignment.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.set_column_title_direction.m_call = cast(type_of(Tree_methods.set_column_title_direction.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.get_column_title_direction.m_call = cast(type_of(Tree_methods.get_column_title_direction.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.set_column_title_language.m_call = cast(type_of(Tree_methods.set_column_title_language.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.get_column_title_language.m_call = cast(type_of(Tree_methods.get_column_title_language.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  Tree_methods.get_scroll._get_scroll = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Tree, "get_scroll", 3341600327, loc))
  Tree_methods.get_scroll.m_call = cast(type_of(Tree_methods.get_scroll.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.scroll_to_item.m_call = cast(type_of(Tree_methods.scroll_to_item.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.set_h_scroll_enabled.m_call = cast(type_of(Tree_methods.set_h_scroll_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.is_h_scroll_enabled.m_call = cast(type_of(Tree_methods.is_h_scroll_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.set_v_scroll_enabled.m_call = cast(type_of(Tree_methods.set_v_scroll_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.is_v_scroll_enabled.m_call = cast(type_of(Tree_methods.is_v_scroll_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.set_scroll_hint_mode.m_call = cast(type_of(Tree_methods.set_scroll_hint_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.get_scroll_hint_mode.m_call = cast(type_of(Tree_methods.get_scroll_hint_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.set_tile_scroll_hint.m_call = cast(type_of(Tree_methods.set_tile_scroll_hint.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.is_scroll_hint_tiled.m_call = cast(type_of(Tree_methods.is_scroll_hint_tiled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.set_hide_folding.m_call = cast(type_of(Tree_methods.set_hide_folding.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.is_folding_hidden.m_call = cast(type_of(Tree_methods.is_folding_hidden.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.set_enable_recursive_folding.m_call = cast(type_of(Tree_methods.set_enable_recursive_folding.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.is_recursive_folding_enabled.m_call = cast(type_of(Tree_methods.is_recursive_folding_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.set_enable_drag_unfolding.m_call = cast(type_of(Tree_methods.set_enable_drag_unfolding.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.is_drag_unfolding_enabled.m_call = cast(type_of(Tree_methods.is_drag_unfolding_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.set_drop_mode_flags.m_call = cast(type_of(Tree_methods.set_drop_mode_flags.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.get_drop_mode_flags.m_call = cast(type_of(Tree_methods.get_drop_mode_flags.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.set_allow_rmb_select.m_call = cast(type_of(Tree_methods.set_allow_rmb_select.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.get_allow_rmb_select.m_call = cast(type_of(Tree_methods.get_allow_rmb_select.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.set_allow_reselect.m_call = cast(type_of(Tree_methods.set_allow_reselect.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.get_allow_reselect.m_call = cast(type_of(Tree_methods.get_allow_reselect.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.set_allow_search.m_call = cast(type_of(Tree_methods.set_allow_search.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.get_allow_search.m_call = cast(type_of(Tree_methods.get_allow_search.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.set_auto_tooltip.m_call = cast(type_of(Tree_methods.set_auto_tooltip.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Tree_methods.is_auto_tooltip_enabled.m_call = cast(type_of(Tree_methods.is_auto_tooltip_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
