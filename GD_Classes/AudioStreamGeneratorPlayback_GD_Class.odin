...
AudioStreamGeneratorPlayback_Init_ :: proc (AudioStreamGeneratorPlayback_methods: ^AudioStreamGeneratorPlayback_MethodBind_List, loc := #caller_location) {
  ...
  AudioStreamGeneratorPlayback_methods.push_frame.m_call = cast(type_of(AudioStreamGeneratorPlayback_methods.push_frame.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioStreamGeneratorPlayback_methods.can_push_buffer.m_call = cast(type_of(AudioStreamGeneratorPlayback_methods.can_push_buffer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioStreamGeneratorPlayback_methods.push_buffer.m_call = cast(type_of(AudioStreamGeneratorPlayback_methods.push_buffer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioStreamGeneratorPlayback_methods.get_frames_available.m_call = cast(type_of(AudioStreamGeneratorPlayback_methods.get_frames_available.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioStreamGeneratorPlayback_methods.get_skips.m_call = cast(type_of(AudioStreamGeneratorPlayback_methods.get_skips.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioStreamGeneratorPlayback_methods.clear_buffer.m_call = cast(type_of(AudioStreamGeneratorPlayback_methods.clear_buffer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
