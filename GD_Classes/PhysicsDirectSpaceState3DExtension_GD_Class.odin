...
PhysicsDirectSpaceState3DExtension_MethodBind_List :: struct {
  is_body_excluded_from_query: ^GDW.MethodBind,
};
PhysicsDirectSpaceState3DExtension_Init_ :: proc (PhysicsDirectSpaceState3DExtension_methods: ^PhysicsDirectSpaceState3DExtension_MethodBind_List, loc := #caller_location) {
  PhysicsDirectSpaceState3DExtension_methods.is_body_excluded_from_query = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.PhysicsDirectSpaceState3DExtension, "is_body_excluded_from_query", 4155700596, loc))
};
