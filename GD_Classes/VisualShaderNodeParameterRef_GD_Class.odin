...
VisualShaderNodeParameterRef_Init_ :: proc (VisualShaderNodeParameterRef_methods: ^VisualShaderNodeParameterRef_MethodBind_List, loc := #caller_location) {
  VisualShaderNodeParameterRef_methods.set_parameter_name = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.VisualShaderNodeParameterRef, "set_parameter_name", 83702148, loc))
  VisualShaderNodeParameterRef_methods.get_parameter_name = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.VisualShaderNodeParameterRef, "get_parameter_name", 201670096, loc))
};
