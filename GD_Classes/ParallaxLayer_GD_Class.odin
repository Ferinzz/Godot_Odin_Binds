...
ParallaxLayer_Init_ :: proc (ParallaxLayer_methods: ^ParallaxLayer_MethodBind_List, loc := #caller_location) {
  ...
  ParallaxLayer_methods.set_motion_scale.m_call = cast(type_of(ParallaxLayer_methods.set_motion_scale.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ParallaxLayer_methods.get_motion_scale.m_call = cast(type_of(ParallaxLayer_methods.get_motion_scale.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ParallaxLayer_methods.set_motion_offset.m_call = cast(type_of(ParallaxLayer_methods.set_motion_offset.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ParallaxLayer_methods.get_motion_offset.m_call = cast(type_of(ParallaxLayer_methods.get_motion_offset.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ParallaxLayer_methods.set_mirroring.m_call = cast(type_of(ParallaxLayer_methods.set_mirroring.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ParallaxLayer_methods.get_mirroring.m_call = cast(type_of(ParallaxLayer_methods.get_mirroring.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
