...
StatusIndicator_Init_ :: proc (StatusIndicator_methods: ^StatusIndicator_MethodBind_List, loc := #caller_location) {
  ...
  StatusIndicator_methods.set_tooltip.m_call = cast(type_of(StatusIndicator_methods.set_tooltip.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  StatusIndicator_methods.get_tooltip.m_call = cast(type_of(StatusIndicator_methods.get_tooltip.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  StatusIndicator_methods.set_icon.m_call = cast(type_of(StatusIndicator_methods.set_icon.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  StatusIndicator_methods.get_icon.m_call = cast(type_of(StatusIndicator_methods.get_icon.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  StatusIndicator_methods.set_visible.m_call = cast(type_of(StatusIndicator_methods.set_visible.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  StatusIndicator_methods.is_visible.m_call = cast(type_of(StatusIndicator_methods.is_visible.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  StatusIndicator_methods.set_menu.m_call = cast(type_of(StatusIndicator_methods.set_menu.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  StatusIndicator_methods.get_menu.m_call = cast(type_of(StatusIndicator_methods.get_menu.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  StatusIndicator_methods.get_rect.m_call = cast(type_of(StatusIndicator_methods.get_rect.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
