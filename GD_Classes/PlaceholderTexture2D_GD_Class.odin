...
PlaceholderTexture2D_MethodBind_List :: struct {
  set_size: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: PlaceholderTexture2D, #by_ptr args: struct{size: ^GDW.Vector2, }, r_ret: rawptr = nil)
  },
  };
PlaceholderTexture2D_Init_ :: proc (PlaceholderTexture2D_methods: ^PlaceholderTexture2D_MethodBind_List, loc := #caller_location) {
  ...
  PlaceholderTexture2D_methods.set_size._set_size = (cast(^GDW.MethodBind)classDBGetMethodBind3(.PlaceholderTexture2D, "set_size", 743155724, loc))
