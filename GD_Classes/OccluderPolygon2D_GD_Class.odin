...
OccluderPolygon2D_Init_ :: proc (OccluderPolygon2D_methods: ^OccluderPolygon2D_MethodBind_List, loc := #caller_location) {
  ...
  OccluderPolygon2D_methods.set_closed.m_call = cast(type_of(OccluderPolygon2D_methods.set_closed.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OccluderPolygon2D_methods.is_closed.m_call = cast(type_of(OccluderPolygon2D_methods.is_closed.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OccluderPolygon2D_methods.set_cull_mode.m_call = cast(type_of(OccluderPolygon2D_methods.set_cull_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OccluderPolygon2D_methods.get_cull_mode.m_call = cast(type_of(OccluderPolygon2D_methods.get_cull_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OccluderPolygon2D_methods.set_polygon.m_call = cast(type_of(OccluderPolygon2D_methods.set_polygon.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OccluderPolygon2D_methods.get_polygon.m_call = cast(type_of(OccluderPolygon2D_methods.get_polygon.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
