...
AcceptDialog_Init_ :: proc (AcceptDialog_methods: ^AcceptDialog_MethodBind_List, loc := #caller_location) {
  ...
  AcceptDialog_methods.get_ok_button.m_call = cast(type_of(AcceptDialog_methods.get_ok_button.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AcceptDialog_methods.get_label.m_call = cast(type_of(AcceptDialog_methods.get_label.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AcceptDialog_methods.set_hide_on_ok.m_call = cast(type_of(AcceptDialog_methods.set_hide_on_ok.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AcceptDialog_methods.get_hide_on_ok.m_call = cast(type_of(AcceptDialog_methods.get_hide_on_ok.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AcceptDialog_methods.set_close_on_escape.m_call = cast(type_of(AcceptDialog_methods.set_close_on_escape.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AcceptDialog_methods.get_close_on_escape.m_call = cast(type_of(AcceptDialog_methods.get_close_on_escape.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AcceptDialog_methods.add_button.m_call = cast(type_of(AcceptDialog_methods.add_button.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AcceptDialog_methods.add_cancel_button.m_call = cast(type_of(AcceptDialog_methods.add_cancel_button.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AcceptDialog_methods.remove_button.m_call = cast(type_of(AcceptDialog_methods.remove_button.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AcceptDialog_methods.register_text_enter.m_call = cast(type_of(AcceptDialog_methods.register_text_enter.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  AcceptDialog_methods.set_text._set_text = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.AcceptDialog, "set_text", 83702148, loc))
  AcceptDialog_methods.set_text.m_call = cast(type_of(AcceptDialog_methods.set_text.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AcceptDialog_methods.get_text.m_call = cast(type_of(AcceptDialog_methods.get_text.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AcceptDialog_methods.set_autowrap.m_call = cast(type_of(AcceptDialog_methods.set_autowrap.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AcceptDialog_methods.has_autowrap.m_call = cast(type_of(AcceptDialog_methods.has_autowrap.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AcceptDialog_methods.set_ok_button_text.m_call = cast(type_of(AcceptDialog_methods.set_ok_button_text.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AcceptDialog_methods.get_ok_button_text.m_call = cast(type_of(AcceptDialog_methods.get_ok_button_text.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
