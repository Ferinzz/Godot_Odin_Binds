...
VisualShaderNodeSample3D_MethodBind_List :: struct {
  set_source: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: VisualShaderNodeSample3D, #by_ptr args: i64 = 0, r_ret: ^VisualShaderNodeSample3D_Source)
  },
};
VisualShaderNodeSample3D_Init_ :: proc (VisualShaderNodeSample3D_methods: ^VisualShaderNodeSample3D_MethodBind_List, loc := #caller_location) {
  ...
  VisualShaderNodeSample3D_methods.set_source.m_call = cast(type_of(VisualShaderNodeSample3D_methods.set_source.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeSample3D_methods.get_source.m_call = cast(type_of(VisualShaderNodeSample3D_methods.get_source.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
