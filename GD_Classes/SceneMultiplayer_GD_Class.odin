...
SceneMultiplayer_Init_ :: proc (SceneMultiplayer_methods: ^SceneMultiplayer_MethodBind_List, loc := #caller_location) {
  ...
  SceneMultiplayer_methods.set_root_path.m_call = cast(type_of(SceneMultiplayer_methods.set_root_path.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SceneMultiplayer_methods.get_root_path.m_call = cast(type_of(SceneMultiplayer_methods.get_root_path.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SceneMultiplayer_methods.clear.m_call = cast(type_of(SceneMultiplayer_methods.clear.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SceneMultiplayer_methods.disconnect_peer.m_call = cast(type_of(SceneMultiplayer_methods.disconnect_peer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SceneMultiplayer_methods.get_authenticating_peers.m_call = cast(type_of(SceneMultiplayer_methods.get_authenticating_peers.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SceneMultiplayer_methods.send_auth.m_call = cast(type_of(SceneMultiplayer_methods.send_auth.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SceneMultiplayer_methods.complete_auth.m_call = cast(type_of(SceneMultiplayer_methods.complete_auth.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SceneMultiplayer_methods.set_auth_callback.m_call = cast(type_of(SceneMultiplayer_methods.set_auth_callback.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SceneMultiplayer_methods.get_auth_callback.m_call = cast(type_of(SceneMultiplayer_methods.get_auth_callback.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SceneMultiplayer_methods.set_auth_timeout.m_call = cast(type_of(SceneMultiplayer_methods.set_auth_timeout.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SceneMultiplayer_methods.get_auth_timeout.m_call = cast(type_of(SceneMultiplayer_methods.get_auth_timeout.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SceneMultiplayer_methods.set_refuse_new_connections.m_call = cast(type_of(SceneMultiplayer_methods.set_refuse_new_connections.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SceneMultiplayer_methods.is_refusing_new_connections.m_call = cast(type_of(SceneMultiplayer_methods.is_refusing_new_connections.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SceneMultiplayer_methods.set_allow_object_decoding.m_call = cast(type_of(SceneMultiplayer_methods.set_allow_object_decoding.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SceneMultiplayer_methods.is_object_decoding_allowed.m_call = cast(type_of(SceneMultiplayer_methods.is_object_decoding_allowed.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SceneMultiplayer_methods.set_server_relay_enabled.m_call = cast(type_of(SceneMultiplayer_methods.set_server_relay_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SceneMultiplayer_methods.is_server_relay_enabled.m_call = cast(type_of(SceneMultiplayer_methods.is_server_relay_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SceneMultiplayer_methods.send_bytes.m_call = cast(type_of(SceneMultiplayer_methods.send_bytes.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SceneMultiplayer_methods.get_max_sync_packet_size.m_call = cast(type_of(SceneMultiplayer_methods.get_max_sync_packet_size.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SceneMultiplayer_methods.set_max_sync_packet_size.m_call = cast(type_of(SceneMultiplayer_methods.set_max_sync_packet_size.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SceneMultiplayer_methods.get_max_delta_packet_size.m_call = cast(type_of(SceneMultiplayer_methods.get_max_delta_packet_size.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SceneMultiplayer_methods.set_max_delta_packet_size.m_call = cast(type_of(SceneMultiplayer_methods.set_max_delta_packet_size.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
