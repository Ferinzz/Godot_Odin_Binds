...
VisualShaderNodeIntConstant_MethodBind_List :: struct {
  set_constant: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: VisualShaderNodeIntConstant, #by_ptr args: struct{constant: ^GDW.Int, }, r_ret: rawptr = nil)
  },
    get_constant: struct{
    using _get_constant: ^GDW.MethodBind,
    m_call: proc "c" (_:^GDW.MethodBind, obj: VisualShaderNodeIntConstant, args: rawptr = nil, r_ret: ^GDW.Int)
  },
};
VisualShaderNodeIntConstant_Init_ :: proc (VisualShaderNodeIntConstant_methods: ^VisualShaderNodeIntConstant_MethodBind_List, loc := #caller_location) {
  ...
  VisualShaderNodeIntConstant_methods.set_constant._set_constant = (cast(^GDW.MethodBind)classDBGetMethodBind3(.VisualShaderNodeIntConstant, "set_constant", 1286410249, loc))
  ...
  VisualShaderNodeIntConstant_methods.get_constant._get_constant = (cast(^GDW.MethodBind)classDBGetMethodBind3(.VisualShaderNodeIntConstant, "get_constant", 3905245786, loc))
