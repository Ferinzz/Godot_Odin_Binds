...
VisualShaderNodeIntConstant_MethodBind_List :: struct {
  set_constant: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: VisualShaderNodeIntConstant, #by_ptr args: i64 = 0, r_ret: ^GDW.Int)
  },
};
VisualShaderNodeIntConstant_Init_ :: proc (VisualShaderNodeIntConstant_methods: ^VisualShaderNodeIntConstant_MethodBind_List, loc := #caller_location) {
  ...
  VisualShaderNodeIntConstant_methods.set_constant.m_call = cast(type_of(VisualShaderNodeIntConstant_methods.set_constant.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeIntConstant_methods.get_constant.m_call = cast(type_of(VisualShaderNodeIntConstant_methods.get_constant.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
