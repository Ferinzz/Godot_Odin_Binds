...
TextureParam_BaseMaterial3D :: enum i64 {
  TEXTURE_ALBEDO = 0,
  TEXTURE_METALLIC = 1,
  TEXTURE_ROUGHNESS = 2,
  TEXTURE_EMISSION = 3,
...
TextureFilter_BaseMaterial3D :: enum i64 {
...
DetailUV_BaseMaterial3D :: enum i64 {
  DETAIL_UV_1 = 0,
  DETAIL_UV_2 = 1,
};

Transparency_BaseMaterial3D :: enum i64 {
...
ShadingMode_BaseMaterial3D :: enum i64 {
...
Feature_BaseMaterial3D :: enum i64 {
  FEATURE_EMISSION = 0,
...
BlendMode_BaseMaterial3D :: enum i64 {
  BLEND_MODE_MIX = 0,
  BLEND_MODE_ADD = 1,
  BLEND_MODE_SUB = 2,
  BLEND_MODE_MUL = 3,
...
AlphaAntiAliasing_BaseMaterial3D :: enum i64 {
  ALPHA_ANTIALIASING_OFF = 0,
  ALPHA_ANTIALIASING_ALPHA_TO_COVERAGE = 1,
  ALPHA_ANTIALIASING_ALPHA_TO_COVERAGE_AND_TO_ONE = 2,
};

DepthDrawMode_BaseMaterial3D :: enum i64 {
  DEPTH_DRAW_OPAQUE_ONLY = 0,
  DEPTH_DRAW_ALWAYS = 1,
  DEPTH_DRAW_DISABLED = 2,
};

DepthTest_BaseMaterial3D :: enum i64 {
  DEPTH_TEST_DEFAULT = 0,
  DEPTH_TEST_INVERTED = 1,
};

CullMode_BaseMaterial3D :: enum i64 {
  CULL_BACK = 0,
  CULL_FRONT = 1,
  CULL_DISABLED = 2,
};

Flags_BaseMaterial3D :: enum i64 {
...
DiffuseMode_BaseMaterial3D :: enum i64 {
  DIFFUSE_BURLEY = 0,
  DIFFUSE_LAMBERT = 1,
...
SpecularMode_BaseMaterial3D :: enum i64 {
  SPECULAR_SCHLICK_GGX = 0,
  SPECULAR_TOON = 1,
  SPECULAR_DISABLED = 2,
};

BillboardMode_BaseMaterial3D :: enum i64 {
...
TextureChannel_BaseMaterial3D :: enum i64 {
...
EmissionOperator_BaseMaterial3D :: enum i64 {
  EMISSION_OP_ADD = 0,
  EMISSION_OP_MULTIPLY = 1,
};

DistanceFadeMode_BaseMaterial3D :: enum i64 {
...
StencilMode_BaseMaterial3D :: enum i64 {
...
StencilFlags_BaseMaterial3D :: enum i64 {
  STENCIL_FLAG_READ = 1,
  STENCIL_FLAG_WRITE = 2,
  STENCIL_FLAG_WRITE_DEPTH_FAIL = 4,
};

StencilCompare_BaseMaterial3D :: enum i64 {
...
BaseMaterial3D_MethodBind_List :: struct {
  ...
  set_shading_mode: ^GDW.MethodBind,
  get_shading_mode: ^GDW.MethodBind,
  set_specular: ^GDW.MethodBind,
  get_specular: ^GDW.MethodBind,
  set_metallic: ^GDW.MethodBind,
  get_metallic: ^GDW.MethodBind,
  set_roughness: ^GDW.MethodBind,
  get_roughness: ^GDW.MethodBind,
  set_emission: ^GDW.MethodBind,
  get_emission: ^GDW.MethodBind,
  set_emission_energy_multiplier: ^GDW.MethodBind,
  get_emission_energy_multiplier: ^GDW.MethodBind,
  set_emission_intensity: ^GDW.MethodBind,
  get_emission_intensity: ^GDW.MethodBind,
  set_normal_scale: ^GDW.MethodBind,
  get_normal_scale: ^GDW.MethodBind,
  set_rim: ^GDW.MethodBind,
  get_rim: ^GDW.MethodBind,
  set_rim_tint: ^GDW.MethodBind,
  get_rim_tint: ^GDW.MethodBind,
  set_clearcoat: ^GDW.MethodBind,
  get_clearcoat: ^GDW.MethodBind,
  set_clearcoat_roughness: ^GDW.MethodBind,
  get_clearcoat_roughness: ^GDW.MethodBind,
  set_anisotropy: ^GDW.MethodBind,
  get_anisotropy: ^GDW.MethodBind,
  set_heightmap_scale: ^GDW.MethodBind,
  get_heightmap_scale: ^GDW.MethodBind,
  set_subsurface_scattering_strength: ^GDW.MethodBind,
  get_subsurface_scattering_strength: ^GDW.MethodBind,
  set_transmittance_color: ^GDW.MethodBind,
  get_transmittance_color: ^GDW.MethodBind,
  set_transmittance_depth: ^GDW.MethodBind,
  get_transmittance_depth: ^GDW.MethodBind,
  set_transmittance_boost: ^GDW.MethodBind,
  get_transmittance_boost: ^GDW.MethodBind,
  set_backlight: ^GDW.MethodBind,
  get_backlight: ^GDW.MethodBind,
  set_refraction: ^GDW.MethodBind,
  get_refraction: ^GDW.MethodBind,
  set_point_size: ^GDW.MethodBind,
  get_point_size: ^GDW.MethodBind,
  set_detail_uv: ^GDW.MethodBind,
  get_detail_uv: ^GDW.MethodBind,
  set_blend_mode: ^GDW.MethodBind,
  get_blend_mode: ^GDW.MethodBind,
  set_depth_draw_mode: ^GDW.MethodBind,
  get_depth_draw_mode: ^GDW.MethodBind,
  set_depth_test: ^GDW.MethodBind,
  get_depth_test: ^GDW.MethodBind,
  set_cull_mode: ^GDW.MethodBind,
  get_cull_mode: ^GDW.MethodBind,
  set_diffuse_mode: ^GDW.MethodBind,
  get_diffuse_mode: ^GDW.MethodBind,
  set_specular_mode: ^GDW.MethodBind,
  get_specular_mode: ^GDW.MethodBind,
  set_flag: ^GDW.MethodBind,
  get_flag: ^GDW.MethodBind,
  set_texture_filter: ^GDW.MethodBind,
  get_texture_filter: ^GDW.MethodBind,
  set_feature: ^GDW.MethodBind,
  get_feature: ^GDW.MethodBind,
  set_texture: ^GDW.MethodBind,
  get_texture: ^GDW.MethodBind,
  set_detail_blend_mode: ^GDW.MethodBind,
  get_detail_blend_mode: ^GDW.MethodBind,
  set_uv1_scale: ^GDW.MethodBind,
  get_uv1_scale: ^GDW.MethodBind,
  set_uv1_offset: ^GDW.MethodBind,
  get_uv1_offset: ^GDW.MethodBind,
  set_uv1_triplanar_blend_sharpness: ^GDW.MethodBind,
  get_uv1_triplanar_blend_sharpness: ^GDW.MethodBind,
  set_uv2_scale: ^GDW.MethodBind,
  get_uv2_scale: ^GDW.MethodBind,
  set_uv2_offset: ^GDW.MethodBind,
  get_uv2_offset: ^GDW.MethodBind,
  set_uv2_triplanar_blend_sharpness: ^GDW.MethodBind,
  get_uv2_triplanar_blend_sharpness: ^GDW.MethodBind,
  ...
  set_heightmap_deep_parallax: ^GDW.MethodBind,
  is_heightmap_deep_parallax_enabled: ^GDW.MethodBind,
  set_heightmap_deep_parallax_min_layers: ^GDW.MethodBind,
  get_heightmap_deep_parallax_min_layers: ^GDW.MethodBind,
  set_heightmap_deep_parallax_max_layers: ^GDW.MethodBind,
  get_heightmap_deep_parallax_max_layers: ^GDW.MethodBind,
  set_heightmap_deep_parallax_flip_tangent: ^GDW.MethodBind,
  get_heightmap_deep_parallax_flip_tangent: ^GDW.MethodBind,
  set_heightmap_deep_parallax_flip_binormal: ^GDW.MethodBind,
  get_heightmap_deep_parallax_flip_binormal: ^GDW.MethodBind,
  set_grow: ^GDW.MethodBind,
  get_grow: ^GDW.MethodBind,
  set_emission_operator: ^GDW.MethodBind,
  get_emission_operator: ^GDW.MethodBind,
  set_ao_light_affect: ^GDW.MethodBind,
  get_ao_light_affect: ^GDW.MethodBind,
  ...
  set_grow_enabled: ^GDW.MethodBind,
  is_grow_enabled: ^GDW.MethodBind,
  set_metallic_texture_channel: ^GDW.MethodBind,
  get_metallic_texture_channel: ^GDW.MethodBind,
  set_roughness_texture_channel: ^GDW.MethodBind,
  get_roughness_texture_channel: ^GDW.MethodBind,
  set_ao_texture_channel: ^GDW.MethodBind,
  get_ao_texture_channel: ^GDW.MethodBind,
  set_refraction_texture_channel: ^GDW.MethodBind,
  get_refraction_texture_channel: ^GDW.MethodBind,
  set_proximity_fade_enabled: ^GDW.MethodBind,
  is_proximity_fade_enabled: ^GDW.MethodBind,
  set_proximity_fade_distance: ^GDW.MethodBind,
  get_proximity_fade_distance: ^GDW.MethodBind,
  set_msdf_pixel_range: ^GDW.MethodBind,
  get_msdf_pixel_range: ^GDW.MethodBind,
  set_msdf_outline_size: ^GDW.MethodBind,
  get_msdf_outline_size: ^GDW.MethodBind,
  set_distance_fade: ^GDW.MethodBind,
  get_distance_fade: ^GDW.MethodBind,
  set_distance_fade_max_distance: ^GDW.MethodBind,
  get_distance_fade_max_distance: ^GDW.MethodBind,
  set_distance_fade_min_distance: ^GDW.MethodBind,
  get_distance_fade_min_distance: ^GDW.MethodBind,
  set_z_clip_scale: ^GDW.MethodBind,
  get_z_clip_scale: ^GDW.MethodBind,
  set_fov_override: ^GDW.MethodBind,
  get_fov_override: ^GDW.MethodBind,
  set_stencil_mode: ^GDW.MethodBind,
  get_stencil_mode: ^GDW.MethodBind,
  set_stencil_flags: ^GDW.MethodBind,
  get_stencil_flags: ^GDW.MethodBind,
  set_stencil_compare: ^GDW.MethodBind,
  get_stencil_compare: ^GDW.MethodBind,
  set_stencil_reference: ^GDW.MethodBind,
  get_stencil_reference: ^GDW.MethodBind,
  set_stencil_effect_color: ^GDW.MethodBind,
  get_stencil_effect_color: ^GDW.MethodBind,
  set_stencil_effect_outline_thickness: ^GDW.MethodBind,
  get_stencil_effect_outline_thickness: ^GDW.MethodBind,
};
BaseMaterial3D_Init_ :: proc (BaseMaterial3D_methods: ^BaseMaterial3D_MethodBind_List, loc := #caller_location) {
  BaseMaterial3D_methods.set_albedo = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_albedo", 2920490490, loc))
  BaseMaterial3D_methods.get_albedo = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_albedo", 3444240500, loc))
  BaseMaterial3D_methods.set_transparency = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_transparency", 3435651667, loc))
  BaseMaterial3D_methods.get_transparency = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_transparency", 990903061, loc))
  BaseMaterial3D_methods.set_alpha_antialiasing = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_alpha_antialiasing", 3212649852, loc))
  BaseMaterial3D_methods.get_alpha_antialiasing = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_alpha_antialiasing", 2889939400, loc))
  BaseMaterial3D_methods.set_alpha_antialiasing_edge = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_alpha_antialiasing_edge", 373806689, loc))
  BaseMaterial3D_methods.get_alpha_antialiasing_edge = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_alpha_antialiasing_edge", 1740695150, loc))
  BaseMaterial3D_methods.set_shading_mode = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_shading_mode", 3368750322, loc))
  BaseMaterial3D_methods.get_shading_mode = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_shading_mode", 2132070559, loc))
  BaseMaterial3D_methods.set_specular = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_specular", 373806689, loc))
  BaseMaterial3D_methods.get_specular = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_specular", 1740695150, loc))
  BaseMaterial3D_methods.set_metallic = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_metallic", 373806689, loc))
  BaseMaterial3D_methods.get_metallic = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_metallic", 1740695150, loc))
  BaseMaterial3D_methods.set_roughness = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_roughness", 373806689, loc))
  BaseMaterial3D_methods.get_roughness = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_roughness", 1740695150, loc))
  BaseMaterial3D_methods.set_emission = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_emission", 2920490490, loc))
  BaseMaterial3D_methods.get_emission = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_emission", 3444240500, loc))
  BaseMaterial3D_methods.set_emission_energy_multiplier = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_emission_energy_multiplier", 373806689, loc))
  BaseMaterial3D_methods.get_emission_energy_multiplier = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_emission_energy_multiplier", 1740695150, loc))
  BaseMaterial3D_methods.set_emission_intensity = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_emission_intensity", 373806689, loc))
  BaseMaterial3D_methods.get_emission_intensity = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_emission_intensity", 1740695150, loc))
  BaseMaterial3D_methods.set_normal_scale = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_normal_scale", 373806689, loc))
  BaseMaterial3D_methods.get_normal_scale = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_normal_scale", 1740695150, loc))
  BaseMaterial3D_methods.set_rim = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_rim", 373806689, loc))
  BaseMaterial3D_methods.get_rim = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_rim", 1740695150, loc))
  BaseMaterial3D_methods.set_rim_tint = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_rim_tint", 373806689, loc))
  BaseMaterial3D_methods.get_rim_tint = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_rim_tint", 1740695150, loc))
  BaseMaterial3D_methods.set_clearcoat = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_clearcoat", 373806689, loc))
  BaseMaterial3D_methods.get_clearcoat = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_clearcoat", 1740695150, loc))
  BaseMaterial3D_methods.set_clearcoat_roughness = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_clearcoat_roughness", 373806689, loc))
  BaseMaterial3D_methods.get_clearcoat_roughness = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_clearcoat_roughness", 1740695150, loc))
  BaseMaterial3D_methods.set_anisotropy = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_anisotropy", 373806689, loc))
  BaseMaterial3D_methods.get_anisotropy = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_anisotropy", 1740695150, loc))
  BaseMaterial3D_methods.set_heightmap_scale = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_heightmap_scale", 373806689, loc))
  BaseMaterial3D_methods.get_heightmap_scale = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_heightmap_scale", 1740695150, loc))
  BaseMaterial3D_methods.set_subsurface_scattering_strength = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_subsurface_scattering_strength", 373806689, loc))
  BaseMaterial3D_methods.get_subsurface_scattering_strength = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_subsurface_scattering_strength", 1740695150, loc))
  BaseMaterial3D_methods.set_transmittance_color = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_transmittance_color", 2920490490, loc))
  BaseMaterial3D_methods.get_transmittance_color = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_transmittance_color", 3444240500, loc))
  BaseMaterial3D_methods.set_transmittance_depth = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_transmittance_depth", 373806689, loc))
  BaseMaterial3D_methods.get_transmittance_depth = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_transmittance_depth", 1740695150, loc))
  BaseMaterial3D_methods.set_transmittance_boost = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_transmittance_boost", 373806689, loc))
  BaseMaterial3D_methods.get_transmittance_boost = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_transmittance_boost", 1740695150, loc))
  BaseMaterial3D_methods.set_backlight = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_backlight", 2920490490, loc))
  BaseMaterial3D_methods.get_backlight = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_backlight", 3444240500, loc))
  BaseMaterial3D_methods.set_refraction = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_refraction", 373806689, loc))
  BaseMaterial3D_methods.get_refraction = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_refraction", 1740695150, loc))
  BaseMaterial3D_methods.set_point_size = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_point_size", 373806689, loc))
  BaseMaterial3D_methods.get_point_size = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_point_size", 1740695150, loc))
  BaseMaterial3D_methods.set_detail_uv = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_detail_uv", 456801921, loc))
  BaseMaterial3D_methods.get_detail_uv = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_detail_uv", 2306920512, loc))
  BaseMaterial3D_methods.set_blend_mode = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_blend_mode", 2830186259, loc))
  BaseMaterial3D_methods.get_blend_mode = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_blend_mode", 4022690962, loc))
  BaseMaterial3D_methods.set_depth_draw_mode = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_depth_draw_mode", 1456584748, loc))
  BaseMaterial3D_methods.get_depth_draw_mode = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_depth_draw_mode", 2578197639, loc))
  BaseMaterial3D_methods.set_depth_test = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_depth_test", 3918692338, loc))
  BaseMaterial3D_methods.get_depth_test = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_depth_test", 3434785811, loc))
  BaseMaterial3D_methods.set_cull_mode = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_cull_mode", 2338909218, loc))
  BaseMaterial3D_methods.get_cull_mode = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_cull_mode", 1941499586, loc))
  BaseMaterial3D_methods.set_diffuse_mode = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_diffuse_mode", 1045299638, loc))
  BaseMaterial3D_methods.get_diffuse_mode = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_diffuse_mode", 3973617136, loc))
  BaseMaterial3D_methods.set_specular_mode = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_specular_mode", 584737147, loc))
  BaseMaterial3D_methods.get_specular_mode = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_specular_mode", 2569953298, loc))
  BaseMaterial3D_methods.set_flag = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_flag", 3070159527, loc))
  BaseMaterial3D_methods.get_flag = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_flag", 1286410065, loc))
  BaseMaterial3D_methods.set_texture_filter = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_texture_filter", 22904437, loc))
  BaseMaterial3D_methods.get_texture_filter = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_texture_filter", 3289213076, loc))
  BaseMaterial3D_methods.set_feature = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_feature", 2819288693, loc))
  BaseMaterial3D_methods.get_feature = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_feature", 1965241794, loc))
  BaseMaterial3D_methods.set_texture = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_texture", 464208135, loc))
  BaseMaterial3D_methods.get_texture = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_texture", 329605813, loc))
  BaseMaterial3D_methods.set_detail_blend_mode = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_detail_blend_mode", 2830186259, loc))
  BaseMaterial3D_methods.get_detail_blend_mode = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_detail_blend_mode", 4022690962, loc))
  BaseMaterial3D_methods.set_uv1_scale = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_uv1_scale", 3460891852, loc))
  BaseMaterial3D_methods.get_uv1_scale = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_uv1_scale", 3360562783, loc))
  BaseMaterial3D_methods.set_uv1_offset = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_uv1_offset", 3460891852, loc))
  BaseMaterial3D_methods.get_uv1_offset = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_uv1_offset", 3360562783, loc))
  BaseMaterial3D_methods.set_uv1_triplanar_blend_sharpness = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_uv1_triplanar_blend_sharpness", 373806689, loc))
  BaseMaterial3D_methods.get_uv1_triplanar_blend_sharpness = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_uv1_triplanar_blend_sharpness", 1740695150, loc))
  BaseMaterial3D_methods.set_uv2_scale = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_uv2_scale", 3460891852, loc))
  BaseMaterial3D_methods.get_uv2_scale = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_uv2_scale", 3360562783, loc))
  BaseMaterial3D_methods.set_uv2_offset = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_uv2_offset", 3460891852, loc))
  BaseMaterial3D_methods.get_uv2_offset = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_uv2_offset", 3360562783, loc))
  BaseMaterial3D_methods.set_uv2_triplanar_blend_sharpness = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_uv2_triplanar_blend_sharpness", 373806689, loc))
  BaseMaterial3D_methods.get_uv2_triplanar_blend_sharpness = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_uv2_triplanar_blend_sharpness", 1740695150, loc))
  BaseMaterial3D_methods.set_billboard_mode = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_billboard_mode", 4202036497, loc))
  BaseMaterial3D_methods.get_billboard_mode = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_billboard_mode", 1283840139, loc))
  BaseMaterial3D_methods.set_particles_anim_h_frames = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_particles_anim_h_frames", 1286410249, loc))
  BaseMaterial3D_methods.get_particles_anim_h_frames = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_particles_anim_h_frames", 3905245786, loc))
  BaseMaterial3D_methods.set_particles_anim_v_frames = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_particles_anim_v_frames", 1286410249, loc))
  BaseMaterial3D_methods.get_particles_anim_v_frames = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_particles_anim_v_frames", 3905245786, loc))
  BaseMaterial3D_methods.set_particles_anim_loop = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_particles_anim_loop", 2586408642, loc))
  BaseMaterial3D_methods.get_particles_anim_loop = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_particles_anim_loop", 36873697, loc))
  BaseMaterial3D_methods.set_heightmap_deep_parallax = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_heightmap_deep_parallax", 2586408642, loc))
  BaseMaterial3D_methods.is_heightmap_deep_parallax_enabled = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "is_heightmap_deep_parallax_enabled", 36873697, loc))
  BaseMaterial3D_methods.set_heightmap_deep_parallax_min_layers = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_heightmap_deep_parallax_min_layers", 1286410249, loc))
  BaseMaterial3D_methods.get_heightmap_deep_parallax_min_layers = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_heightmap_deep_parallax_min_layers", 3905245786, loc))
  BaseMaterial3D_methods.set_heightmap_deep_parallax_max_layers = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_heightmap_deep_parallax_max_layers", 1286410249, loc))
  BaseMaterial3D_methods.get_heightmap_deep_parallax_max_layers = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_heightmap_deep_parallax_max_layers", 3905245786, loc))
  BaseMaterial3D_methods.set_heightmap_deep_parallax_flip_tangent = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_heightmap_deep_parallax_flip_tangent", 2586408642, loc))
  BaseMaterial3D_methods.get_heightmap_deep_parallax_flip_tangent = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_heightmap_deep_parallax_flip_tangent", 36873697, loc))
  BaseMaterial3D_methods.set_heightmap_deep_parallax_flip_binormal = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_heightmap_deep_parallax_flip_binormal", 2586408642, loc))
  BaseMaterial3D_methods.get_heightmap_deep_parallax_flip_binormal = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_heightmap_deep_parallax_flip_binormal", 36873697, loc))
  BaseMaterial3D_methods.set_grow = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_grow", 373806689, loc))
  BaseMaterial3D_methods.get_grow = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_grow", 1740695150, loc))
  BaseMaterial3D_methods.set_emission_operator = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_emission_operator", 3825128922, loc))
  BaseMaterial3D_methods.get_emission_operator = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_emission_operator", 974205018, loc))
  BaseMaterial3D_methods.set_ao_light_affect = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_ao_light_affect", 373806689, loc))
  BaseMaterial3D_methods.get_ao_light_affect = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_ao_light_affect", 1740695150, loc))
  BaseMaterial3D_methods.set_alpha_scissor_threshold = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_alpha_scissor_threshold", 373806689, loc))
  BaseMaterial3D_methods.get_alpha_scissor_threshold = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_alpha_scissor_threshold", 1740695150, loc))
  BaseMaterial3D_methods.set_alpha_hash_scale = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_alpha_hash_scale", 373806689, loc))
  BaseMaterial3D_methods.get_alpha_hash_scale = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_alpha_hash_scale", 1740695150, loc))
  BaseMaterial3D_methods.set_grow_enabled = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_grow_enabled", 2586408642, loc))
  BaseMaterial3D_methods.is_grow_enabled = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "is_grow_enabled", 36873697, loc))
  BaseMaterial3D_methods.set_metallic_texture_channel = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_metallic_texture_channel", 744167988, loc))
  BaseMaterial3D_methods.get_metallic_texture_channel = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_metallic_texture_channel", 568133867, loc))
  BaseMaterial3D_methods.set_roughness_texture_channel = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_roughness_texture_channel", 744167988, loc))
  BaseMaterial3D_methods.get_roughness_texture_channel = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_roughness_texture_channel", 568133867, loc))
  BaseMaterial3D_methods.set_ao_texture_channel = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_ao_texture_channel", 744167988, loc))
  BaseMaterial3D_methods.get_ao_texture_channel = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_ao_texture_channel", 568133867, loc))
  BaseMaterial3D_methods.set_refraction_texture_channel = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_refraction_texture_channel", 744167988, loc))
  BaseMaterial3D_methods.get_refraction_texture_channel = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_refraction_texture_channel", 568133867, loc))
  BaseMaterial3D_methods.set_proximity_fade_enabled = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_proximity_fade_enabled", 2586408642, loc))
  BaseMaterial3D_methods.is_proximity_fade_enabled = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "is_proximity_fade_enabled", 36873697, loc))
  BaseMaterial3D_methods.set_proximity_fade_distance = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_proximity_fade_distance", 373806689, loc))
  BaseMaterial3D_methods.get_proximity_fade_distance = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_proximity_fade_distance", 1740695150, loc))
  BaseMaterial3D_methods.set_msdf_pixel_range = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_msdf_pixel_range", 373806689, loc))
  BaseMaterial3D_methods.get_msdf_pixel_range = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_msdf_pixel_range", 1740695150, loc))
  BaseMaterial3D_methods.set_msdf_outline_size = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_msdf_outline_size", 373806689, loc))
  BaseMaterial3D_methods.get_msdf_outline_size = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_msdf_outline_size", 1740695150, loc))
  BaseMaterial3D_methods.set_distance_fade = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_distance_fade", 1379478617, loc))
  BaseMaterial3D_methods.get_distance_fade = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_distance_fade", 2694575734, loc))
  BaseMaterial3D_methods.set_distance_fade_max_distance = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_distance_fade_max_distance", 373806689, loc))
  BaseMaterial3D_methods.get_distance_fade_max_distance = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_distance_fade_max_distance", 1740695150, loc))
  BaseMaterial3D_methods.set_distance_fade_min_distance = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_distance_fade_min_distance", 373806689, loc))
  BaseMaterial3D_methods.get_distance_fade_min_distance = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_distance_fade_min_distance", 1740695150, loc))
  BaseMaterial3D_methods.set_z_clip_scale = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_z_clip_scale", 373806689, loc))
  BaseMaterial3D_methods.get_z_clip_scale = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_z_clip_scale", 1740695150, loc))
  BaseMaterial3D_methods.set_fov_override = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_fov_override", 373806689, loc))
  BaseMaterial3D_methods.get_fov_override = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_fov_override", 1740695150, loc))
  BaseMaterial3D_methods.set_stencil_mode = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_stencil_mode", 2272367200, loc))
  BaseMaterial3D_methods.get_stencil_mode = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_stencil_mode", 2908443456, loc))
  BaseMaterial3D_methods.set_stencil_flags = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_stencil_flags", 1286410249, loc))
  BaseMaterial3D_methods.get_stencil_flags = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_stencil_flags", 3905245786, loc))
  BaseMaterial3D_methods.set_stencil_compare = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_stencil_compare", 3741726481, loc))
  BaseMaterial3D_methods.get_stencil_compare = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_stencil_compare", 2824600492, loc))
  BaseMaterial3D_methods.set_stencil_reference = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_stencil_reference", 1286410249, loc))
  BaseMaterial3D_methods.get_stencil_reference = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_stencil_reference", 3905245786, loc))
  BaseMaterial3D_methods.set_stencil_effect_color = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_stencil_effect_color", 2920490490, loc))
  BaseMaterial3D_methods.get_stencil_effect_color = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_stencil_effect_color", 3444240500, loc))
  BaseMaterial3D_methods.set_stencil_effect_outline_thickness = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "set_stencil_effect_outline_thickness", 373806689, loc))
  BaseMaterial3D_methods.get_stencil_effect_outline_thickness = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BaseMaterial3D, "get_stencil_effect_outline_thickness", 1740695150, loc))
};
