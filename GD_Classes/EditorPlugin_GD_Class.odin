...
EditorPlugin_Init_ :: proc (EditorPlugin_methods: ^EditorPlugin_MethodBind_List, loc := #caller_location) {
  ...
  EditorPlugin_methods.add_dock.m_call = cast(type_of(EditorPlugin_methods.add_dock.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPlugin_methods.remove_dock.m_call = cast(type_of(EditorPlugin_methods.remove_dock.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPlugin_methods.add_control_to_container.m_call = cast(type_of(EditorPlugin_methods.add_control_to_container.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPlugin_methods.remove_control_from_container.m_call = cast(type_of(EditorPlugin_methods.remove_control_from_container.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPlugin_methods.add_tool_menu_item.m_call = cast(type_of(EditorPlugin_methods.add_tool_menu_item.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPlugin_methods.add_tool_submenu_item.m_call = cast(type_of(EditorPlugin_methods.add_tool_submenu_item.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPlugin_methods.remove_tool_menu_item.m_call = cast(type_of(EditorPlugin_methods.remove_tool_menu_item.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPlugin_methods.get_export_as_menu.m_call = cast(type_of(EditorPlugin_methods.get_export_as_menu.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPlugin_methods.add_custom_type.m_call = cast(type_of(EditorPlugin_methods.add_custom_type.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPlugin_methods.remove_custom_type.m_call = cast(type_of(EditorPlugin_methods.remove_custom_type.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPlugin_methods.add_control_to_dock.m_call = cast(type_of(EditorPlugin_methods.add_control_to_dock.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPlugin_methods.remove_control_from_docks.m_call = cast(type_of(EditorPlugin_methods.remove_control_from_docks.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPlugin_methods.set_dock_tab_icon.m_call = cast(type_of(EditorPlugin_methods.set_dock_tab_icon.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPlugin_methods.add_control_to_bottom_panel.m_call = cast(type_of(EditorPlugin_methods.add_control_to_bottom_panel.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPlugin_methods.remove_control_from_bottom_panel.m_call = cast(type_of(EditorPlugin_methods.remove_control_from_bottom_panel.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPlugin_methods.add_autoload_singleton.m_call = cast(type_of(EditorPlugin_methods.add_autoload_singleton.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPlugin_methods.remove_autoload_singleton.m_call = cast(type_of(EditorPlugin_methods.remove_autoload_singleton.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPlugin_methods.update_overlays.m_call = cast(type_of(EditorPlugin_methods.update_overlays.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPlugin_methods.make_bottom_panel_item_visible.m_call = cast(type_of(EditorPlugin_methods.make_bottom_panel_item_visible.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPlugin_methods.hide_bottom_panel.m_call = cast(type_of(EditorPlugin_methods.hide_bottom_panel.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPlugin_methods.get_undo_redo.m_call = cast(type_of(EditorPlugin_methods.get_undo_redo.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPlugin_methods.add_undo_redo_inspector_hook_callback.m_call = cast(type_of(EditorPlugin_methods.add_undo_redo_inspector_hook_callback.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPlugin_methods.remove_undo_redo_inspector_hook_callback.m_call = cast(type_of(EditorPlugin_methods.remove_undo_redo_inspector_hook_callback.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPlugin_methods.queue_save_layout.m_call = cast(type_of(EditorPlugin_methods.queue_save_layout.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPlugin_methods.add_translation_parser_plugin.m_call = cast(type_of(EditorPlugin_methods.add_translation_parser_plugin.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPlugin_methods.remove_translation_parser_plugin.m_call = cast(type_of(EditorPlugin_methods.remove_translation_parser_plugin.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPlugin_methods.add_import_plugin.m_call = cast(type_of(EditorPlugin_methods.add_import_plugin.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPlugin_methods.remove_import_plugin.m_call = cast(type_of(EditorPlugin_methods.remove_import_plugin.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPlugin_methods.add_scene_format_importer_plugin.m_call = cast(type_of(EditorPlugin_methods.add_scene_format_importer_plugin.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPlugin_methods.remove_scene_format_importer_plugin.m_call = cast(type_of(EditorPlugin_methods.remove_scene_format_importer_plugin.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPlugin_methods.add_scene_post_import_plugin.m_call = cast(type_of(EditorPlugin_methods.add_scene_post_import_plugin.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPlugin_methods.remove_scene_post_import_plugin.m_call = cast(type_of(EditorPlugin_methods.remove_scene_post_import_plugin.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPlugin_methods.add_export_plugin.m_call = cast(type_of(EditorPlugin_methods.add_export_plugin.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPlugin_methods.remove_export_plugin.m_call = cast(type_of(EditorPlugin_methods.remove_export_plugin.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPlugin_methods.add_export_platform.m_call = cast(type_of(EditorPlugin_methods.add_export_platform.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPlugin_methods.remove_export_platform.m_call = cast(type_of(EditorPlugin_methods.remove_export_platform.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPlugin_methods.add_node_3d_gizmo_plugin.m_call = cast(type_of(EditorPlugin_methods.add_node_3d_gizmo_plugin.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPlugin_methods.remove_node_3d_gizmo_plugin.m_call = cast(type_of(EditorPlugin_methods.remove_node_3d_gizmo_plugin.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPlugin_methods.add_inspector_plugin.m_call = cast(type_of(EditorPlugin_methods.add_inspector_plugin.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPlugin_methods.remove_inspector_plugin.m_call = cast(type_of(EditorPlugin_methods.remove_inspector_plugin.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPlugin_methods.add_resource_conversion_plugin.m_call = cast(type_of(EditorPlugin_methods.add_resource_conversion_plugin.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPlugin_methods.remove_resource_conversion_plugin.m_call = cast(type_of(EditorPlugin_methods.remove_resource_conversion_plugin.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPlugin_methods.set_input_event_forwarding_always_enabled.m_call = cast(type_of(EditorPlugin_methods.set_input_event_forwarding_always_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPlugin_methods.set_force_draw_over_forwarding_enabled.m_call = cast(type_of(EditorPlugin_methods.set_force_draw_over_forwarding_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPlugin_methods.add_context_menu_plugin.m_call = cast(type_of(EditorPlugin_methods.add_context_menu_plugin.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPlugin_methods.remove_context_menu_plugin.m_call = cast(type_of(EditorPlugin_methods.remove_context_menu_plugin.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPlugin_methods.get_editor_interface.m_call = cast(type_of(EditorPlugin_methods.get_editor_interface.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPlugin_methods.get_script_create_dialog.m_call = cast(type_of(EditorPlugin_methods.get_script_create_dialog.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPlugin_methods.add_debugger_plugin.m_call = cast(type_of(EditorPlugin_methods.add_debugger_plugin.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPlugin_methods.remove_debugger_plugin.m_call = cast(type_of(EditorPlugin_methods.remove_debugger_plugin.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorPlugin_methods.get_plugin_version.m_call = cast(type_of(EditorPlugin_methods.get_plugin_version.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
