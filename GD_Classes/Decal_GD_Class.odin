...
Decal_MethodBind_List :: struct {
  ...
  set_emission_energy: ^GDW.MethodBind,
  get_emission_energy: ^GDW.MethodBind,
  set_albedo_mix: ^GDW.MethodBind,
  get_albedo_mix: ^GDW.MethodBind,
  set_modulate: ^GDW.MethodBind,
  get_modulate: ^GDW.MethodBind,
  set_upper_fade: ^GDW.MethodBind,
  get_upper_fade: ^GDW.MethodBind,
  set_lower_fade: ^GDW.MethodBind,
  get_lower_fade: ^GDW.MethodBind,
  set_normal_fade: ^GDW.MethodBind,
  get_normal_fade: ^GDW.MethodBind,
...
Decal_Init_ :: proc (Decal_methods: ^Decal_MethodBind_List, loc := #caller_location) {
  Decal_methods.set_size = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Decal, "set_size", 3460891852, loc))
  Decal_methods.get_size = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Decal, "get_size", 3360562783, loc))
  Decal_methods.set_texture = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Decal, "set_texture", 2086764391, loc))
  Decal_methods.get_texture = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Decal, "get_texture", 3244119503, loc))
  Decal_methods.set_emission_energy = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Decal, "set_emission_energy", 373806689, loc))
  Decal_methods.get_emission_energy = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Decal, "get_emission_energy", 1740695150, loc))
  Decal_methods.set_albedo_mix = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Decal, "set_albedo_mix", 373806689, loc))
  Decal_methods.get_albedo_mix = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Decal, "get_albedo_mix", 1740695150, loc))
  Decal_methods.set_modulate = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Decal, "set_modulate", 2920490490, loc))
  Decal_methods.get_modulate = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Decal, "get_modulate", 3444240500, loc))
  Decal_methods.set_upper_fade = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Decal, "set_upper_fade", 373806689, loc))
  Decal_methods.get_upper_fade = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Decal, "get_upper_fade", 1740695150, loc))
  Decal_methods.set_lower_fade = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Decal, "set_lower_fade", 373806689, loc))
  Decal_methods.get_lower_fade = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Decal, "get_lower_fade", 1740695150, loc))
  Decal_methods.set_normal_fade = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Decal, "set_normal_fade", 373806689, loc))
  Decal_methods.get_normal_fade = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Decal, "get_normal_fade", 1740695150, loc))
  Decal_methods.set_enable_distance_fade = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Decal, "set_enable_distance_fade", 2586408642, loc))
  Decal_methods.is_distance_fade_enabled = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Decal, "is_distance_fade_enabled", 36873697, loc))
  Decal_methods.set_distance_fade_begin = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Decal, "set_distance_fade_begin", 373806689, loc))
  Decal_methods.get_distance_fade_begin = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Decal, "get_distance_fade_begin", 1740695150, loc))
  Decal_methods.set_distance_fade_length = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Decal, "set_distance_fade_length", 373806689, loc))
  Decal_methods.get_distance_fade_length = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Decal, "get_distance_fade_length", 1740695150, loc))
  Decal_methods.set_cull_mask = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Decal, "set_cull_mask", 1286410249, loc))
  Decal_methods.get_cull_mask = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.Decal, "get_cull_mask", 3905245786, loc))
};
