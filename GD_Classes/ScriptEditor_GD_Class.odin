...
ScriptEditor_Init_ :: proc (ScriptEditor_methods: ^ScriptEditor_MethodBind_List, loc := #caller_location) {
  ...
  ScriptEditor_methods.get_current_editor.m_call = cast(type_of(ScriptEditor_methods.get_current_editor.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ScriptEditor_methods.get_open_script_editors.m_call = cast(type_of(ScriptEditor_methods.get_open_script_editors.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ScriptEditor_methods.get_breakpoints.m_call = cast(type_of(ScriptEditor_methods.get_breakpoints.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ScriptEditor_methods.register_syntax_highlighter.m_call = cast(type_of(ScriptEditor_methods.register_syntax_highlighter.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ScriptEditor_methods.unregister_syntax_highlighter.m_call = cast(type_of(ScriptEditor_methods.unregister_syntax_highlighter.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ScriptEditor_methods.goto_line.m_call = cast(type_of(ScriptEditor_methods.goto_line.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ScriptEditor_methods.get_current_script.m_call = cast(type_of(ScriptEditor_methods.get_current_script.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ScriptEditor_methods.get_open_scripts.m_call = cast(type_of(ScriptEditor_methods.get_open_scripts.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ScriptEditor_methods.open_script_create_dialog.m_call = cast(type_of(ScriptEditor_methods.open_script_create_dialog.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ScriptEditor_methods.goto_help.m_call = cast(type_of(ScriptEditor_methods.goto_help.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ScriptEditor_methods.update_docs_from_script.m_call = cast(type_of(ScriptEditor_methods.update_docs_from_script.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ScriptEditor_methods.clear_docs_from_script.m_call = cast(type_of(ScriptEditor_methods.clear_docs_from_script.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
