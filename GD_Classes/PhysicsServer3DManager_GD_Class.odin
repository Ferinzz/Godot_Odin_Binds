...
PhysicsServer3DManager_Init_ :: proc (PhysicsServer3DManager_methods: ^PhysicsServer3DManager_MethodBind_List, loc := #caller_location) {
  ...
  PhysicsServer3DManager_methods.register_server.m_call = cast(type_of(PhysicsServer3DManager_methods.register_server.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicsServer3DManager_methods.set_default_server.m_call = cast(type_of(PhysicsServer3DManager_methods.set_default_server.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
