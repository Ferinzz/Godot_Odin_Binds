...
GLTFPhysicsShape_Init_ :: proc (GLTFPhysicsShape_methods: ^GLTFPhysicsShape_MethodBind_List, loc := #caller_location) {
  ...
  GLTFPhysicsShape_methods.from_node.m_call = cast(type_of(GLTFPhysicsShape_methods.from_node.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFPhysicsShape_methods.to_node.m_call = cast(type_of(GLTFPhysicsShape_methods.to_node.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFPhysicsShape_methods.from_resource.m_call = cast(type_of(GLTFPhysicsShape_methods.from_resource.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFPhysicsShape_methods.to_resource.m_call = cast(type_of(GLTFPhysicsShape_methods.to_resource.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFPhysicsShape_methods.from_dictionary.m_call = cast(type_of(GLTFPhysicsShape_methods.from_dictionary.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFPhysicsShape_methods.to_dictionary.m_call = cast(type_of(GLTFPhysicsShape_methods.to_dictionary.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFPhysicsShape_methods.get_shape_type.m_call = cast(type_of(GLTFPhysicsShape_methods.get_shape_type.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFPhysicsShape_methods.set_shape_type.m_call = cast(type_of(GLTFPhysicsShape_methods.set_shape_type.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFPhysicsShape_methods.get_size.m_call = cast(type_of(GLTFPhysicsShape_methods.get_size.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFPhysicsShape_methods.set_size.m_call = cast(type_of(GLTFPhysicsShape_methods.set_size.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFPhysicsShape_methods.get_radius.m_call = cast(type_of(GLTFPhysicsShape_methods.get_radius.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFPhysicsShape_methods.set_radius.m_call = cast(type_of(GLTFPhysicsShape_methods.set_radius.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFPhysicsShape_methods.get_height.m_call = cast(type_of(GLTFPhysicsShape_methods.get_height.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFPhysicsShape_methods.set_height.m_call = cast(type_of(GLTFPhysicsShape_methods.set_height.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFPhysicsShape_methods.get_is_trigger.m_call = cast(type_of(GLTFPhysicsShape_methods.get_is_trigger.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFPhysicsShape_methods.set_is_trigger.m_call = cast(type_of(GLTFPhysicsShape_methods.set_is_trigger.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFPhysicsShape_methods.get_mesh_index.m_call = cast(type_of(GLTFPhysicsShape_methods.get_mesh_index.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFPhysicsShape_methods.set_mesh_index.m_call = cast(type_of(GLTFPhysicsShape_methods.set_mesh_index.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFPhysicsShape_methods.get_importer_mesh.m_call = cast(type_of(GLTFPhysicsShape_methods.get_importer_mesh.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFPhysicsShape_methods.set_importer_mesh.m_call = cast(type_of(GLTFPhysicsShape_methods.set_importer_mesh.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
