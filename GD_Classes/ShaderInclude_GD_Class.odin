...
ShaderInclude_Init_ :: proc (ShaderInclude_methods: ^ShaderInclude_MethodBind_List, loc := #caller_location) {
  ShaderInclude_methods.set_code = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.ShaderInclude, "set_code", 83702148, loc))
  ShaderInclude_methods.get_code = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.ShaderInclude, "get_code", 201670096, loc))
};
