...
CameraFeed_Init_ :: proc (CameraFeed_methods: ^CameraFeed_MethodBind_List, loc := #caller_location) {
  ...
  CameraFeed_methods.get_id.m_call = cast(type_of(CameraFeed_methods.get_id.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  CameraFeed_methods.is_active._is_active = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.CameraFeed, "is_active", 36873697, loc))
  CameraFeed_methods.is_active.m_call = cast(type_of(CameraFeed_methods.is_active.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CameraFeed_methods.set_active.m_call = cast(type_of(CameraFeed_methods.set_active.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  CameraFeed_methods.get_name._get_name = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.CameraFeed, "get_name", 201670096, loc))
  CameraFeed_methods.get_name.m_call = cast(type_of(CameraFeed_methods.get_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  CameraFeed_methods.set_name._set_name = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.CameraFeed, "set_name", 83702148, loc))
  CameraFeed_methods.set_name.m_call = cast(type_of(CameraFeed_methods.set_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CameraFeed_methods.get_position.m_call = cast(type_of(CameraFeed_methods.get_position.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CameraFeed_methods.set_position.m_call = cast(type_of(CameraFeed_methods.set_position.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CameraFeed_methods.get_transform.m_call = cast(type_of(CameraFeed_methods.get_transform.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CameraFeed_methods.set_transform.m_call = cast(type_of(CameraFeed_methods.set_transform.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CameraFeed_methods.set_rgb_image.m_call = cast(type_of(CameraFeed_methods.set_rgb_image.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CameraFeed_methods.set_ycbcr_image.m_call = cast(type_of(CameraFeed_methods.set_ycbcr_image.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CameraFeed_methods.set_ycbcr_images.m_call = cast(type_of(CameraFeed_methods.set_ycbcr_images.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CameraFeed_methods.set_external.m_call = cast(type_of(CameraFeed_methods.set_external.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CameraFeed_methods.get_texture_tex_id.m_call = cast(type_of(CameraFeed_methods.get_texture_tex_id.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CameraFeed_methods.get_datatype.m_call = cast(type_of(CameraFeed_methods.get_datatype.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CameraFeed_methods.get_formats.m_call = cast(type_of(CameraFeed_methods.get_formats.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CameraFeed_methods.set_format.m_call = cast(type_of(CameraFeed_methods.set_format.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
