...
CanvasGroup_Init_ :: proc (CanvasGroup_methods: ^CanvasGroup_MethodBind_List, loc := #caller_location) {
  ...
  CanvasGroup_methods.set_fit_margin.m_call = cast(type_of(CanvasGroup_methods.set_fit_margin.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CanvasGroup_methods.get_fit_margin.m_call = cast(type_of(CanvasGroup_methods.get_fit_margin.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CanvasGroup_methods.set_clear_margin.m_call = cast(type_of(CanvasGroup_methods.set_clear_margin.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CanvasGroup_methods.get_clear_margin.m_call = cast(type_of(CanvasGroup_methods.get_clear_margin.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CanvasGroup_methods.set_use_mipmaps.m_call = cast(type_of(CanvasGroup_methods.set_use_mipmaps.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CanvasGroup_methods.is_using_mipmaps.m_call = cast(type_of(CanvasGroup_methods.is_using_mipmaps.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
