...
VisualShaderNodeParticleRandomness_MethodBind_List :: struct {
  set_op_type: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: VisualShaderNodeParticleRandomness, #by_ptr args: struct{type: ^VisualShaderNodeParticleRandomness_OpType, }, r_ret: rawptr = nil)
  },
    get_op_type: struct{
    using _get_op_type: ^GDW.MethodBind,
    m_call: proc "c" (_:^GDW.MethodBind, obj: VisualShaderNodeParticleRandomness, args: rawptr = nil, r_ret: ^VisualShaderNodeParticleRandomness_OpType)
  },
};
VisualShaderNodeParticleRandomness_Init_ :: proc (VisualShaderNodeParticleRandomness_methods: ^VisualShaderNodeParticleRandomness_MethodBind_List, loc := #caller_location) {
  ...
  VisualShaderNodeParticleRandomness_methods.set_op_type._set_op_type = (cast(^GDW.MethodBind)classDBGetMethodBind3(.VisualShaderNodeParticleRandomness, "set_op_type", 2060089061, loc))
  ...
  VisualShaderNodeParticleRandomness_methods.get_op_type._get_op_type = (cast(^GDW.MethodBind)classDBGetMethodBind3(.VisualShaderNodeParticleRandomness, "get_op_type", 3597061078, loc))
