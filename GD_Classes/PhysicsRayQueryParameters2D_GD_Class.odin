...
PhysicsRayQueryParameters2D_Init_ :: proc (PhysicsRayQueryParameters2D_methods: ^PhysicsRayQueryParameters2D_MethodBind_List, loc := #caller_location) {
  PhysicsRayQueryParameters2D_methods.create = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.PhysicsRayQueryParameters2D, "create", 3196569324, loc))
  PhysicsRayQueryParameters2D_methods.set_from = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.PhysicsRayQueryParameters2D, "set_from", 743155724, loc))
  PhysicsRayQueryParameters2D_methods.get_from = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.PhysicsRayQueryParameters2D, "get_from", 3341600327, loc))
  PhysicsRayQueryParameters2D_methods.set_to = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.PhysicsRayQueryParameters2D, "set_to", 743155724, loc))
  PhysicsRayQueryParameters2D_methods.get_to = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.PhysicsRayQueryParameters2D, "get_to", 3341600327, loc))
  PhysicsRayQueryParameters2D_methods.set_collision_mask = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.PhysicsRayQueryParameters2D, "set_collision_mask", 1286410249, loc))
  PhysicsRayQueryParameters2D_methods.get_collision_mask = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.PhysicsRayQueryParameters2D, "get_collision_mask", 3905245786, loc))
  PhysicsRayQueryParameters2D_methods.set_exclude = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.PhysicsRayQueryParameters2D, "set_exclude", 381264803, loc))
  PhysicsRayQueryParameters2D_methods.get_exclude = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.PhysicsRayQueryParameters2D, "get_exclude", 3995934104, loc))
  PhysicsRayQueryParameters2D_methods.set_collide_with_bodies = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.PhysicsRayQueryParameters2D, "set_collide_with_bodies", 2586408642, loc))
  PhysicsRayQueryParameters2D_methods.is_collide_with_bodies_enabled = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.PhysicsRayQueryParameters2D, "is_collide_with_bodies_enabled", 36873697, loc))
  PhysicsRayQueryParameters2D_methods.set_collide_with_areas = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.PhysicsRayQueryParameters2D, "set_collide_with_areas", 2586408642, loc))
  PhysicsRayQueryParameters2D_methods.is_collide_with_areas_enabled = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.PhysicsRayQueryParameters2D, "is_collide_with_areas_enabled", 36873697, loc))
  PhysicsRayQueryParameters2D_methods.set_hit_from_inside = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.PhysicsRayQueryParameters2D, "set_hit_from_inside", 2586408642, loc))
  PhysicsRayQueryParameters2D_methods.is_hit_from_inside_enabled = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.PhysicsRayQueryParameters2D, "is_hit_from_inside_enabled", 36873697, loc))
};
