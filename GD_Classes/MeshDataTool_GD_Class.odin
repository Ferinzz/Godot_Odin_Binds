...
MeshDataTool_Init_ :: proc (MeshDataTool_methods: ^MeshDataTool_MethodBind_List, loc := #caller_location) {
  ...
  MeshDataTool_methods.clear.m_call = cast(type_of(MeshDataTool_methods.clear.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshDataTool_methods.create_from_surface.m_call = cast(type_of(MeshDataTool_methods.create_from_surface.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshDataTool_methods.commit_to_surface.m_call = cast(type_of(MeshDataTool_methods.commit_to_surface.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshDataTool_methods.get_format.m_call = cast(type_of(MeshDataTool_methods.get_format.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshDataTool_methods.get_vertex_count.m_call = cast(type_of(MeshDataTool_methods.get_vertex_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshDataTool_methods.get_edge_count.m_call = cast(type_of(MeshDataTool_methods.get_edge_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshDataTool_methods.get_face_count.m_call = cast(type_of(MeshDataTool_methods.get_face_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshDataTool_methods.set_vertex.m_call = cast(type_of(MeshDataTool_methods.set_vertex.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshDataTool_methods.get_vertex.m_call = cast(type_of(MeshDataTool_methods.get_vertex.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshDataTool_methods.set_vertex_normal.m_call = cast(type_of(MeshDataTool_methods.set_vertex_normal.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshDataTool_methods.get_vertex_normal.m_call = cast(type_of(MeshDataTool_methods.get_vertex_normal.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshDataTool_methods.set_vertex_tangent.m_call = cast(type_of(MeshDataTool_methods.set_vertex_tangent.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshDataTool_methods.get_vertex_tangent.m_call = cast(type_of(MeshDataTool_methods.get_vertex_tangent.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshDataTool_methods.set_vertex_uv.m_call = cast(type_of(MeshDataTool_methods.set_vertex_uv.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshDataTool_methods.get_vertex_uv.m_call = cast(type_of(MeshDataTool_methods.get_vertex_uv.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshDataTool_methods.set_vertex_uv2.m_call = cast(type_of(MeshDataTool_methods.set_vertex_uv2.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshDataTool_methods.get_vertex_uv2.m_call = cast(type_of(MeshDataTool_methods.get_vertex_uv2.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshDataTool_methods.set_vertex_color.m_call = cast(type_of(MeshDataTool_methods.set_vertex_color.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshDataTool_methods.get_vertex_color.m_call = cast(type_of(MeshDataTool_methods.get_vertex_color.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshDataTool_methods.set_vertex_bones.m_call = cast(type_of(MeshDataTool_methods.set_vertex_bones.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshDataTool_methods.get_vertex_bones.m_call = cast(type_of(MeshDataTool_methods.get_vertex_bones.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshDataTool_methods.set_vertex_weights.m_call = cast(type_of(MeshDataTool_methods.set_vertex_weights.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshDataTool_methods.get_vertex_weights.m_call = cast(type_of(MeshDataTool_methods.get_vertex_weights.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshDataTool_methods.set_vertex_meta.m_call = cast(type_of(MeshDataTool_methods.set_vertex_meta.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshDataTool_methods.get_vertex_meta.m_call = cast(type_of(MeshDataTool_methods.get_vertex_meta.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshDataTool_methods.get_vertex_edges.m_call = cast(type_of(MeshDataTool_methods.get_vertex_edges.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshDataTool_methods.get_vertex_faces.m_call = cast(type_of(MeshDataTool_methods.get_vertex_faces.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshDataTool_methods.get_edge_vertex.m_call = cast(type_of(MeshDataTool_methods.get_edge_vertex.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshDataTool_methods.get_edge_faces.m_call = cast(type_of(MeshDataTool_methods.get_edge_faces.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshDataTool_methods.set_edge_meta.m_call = cast(type_of(MeshDataTool_methods.set_edge_meta.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshDataTool_methods.get_edge_meta.m_call = cast(type_of(MeshDataTool_methods.get_edge_meta.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshDataTool_methods.get_face_vertex.m_call = cast(type_of(MeshDataTool_methods.get_face_vertex.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshDataTool_methods.get_face_edge.m_call = cast(type_of(MeshDataTool_methods.get_face_edge.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshDataTool_methods.set_face_meta.m_call = cast(type_of(MeshDataTool_methods.set_face_meta.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshDataTool_methods.get_face_meta.m_call = cast(type_of(MeshDataTool_methods.get_face_meta.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshDataTool_methods.get_face_normal.m_call = cast(type_of(MeshDataTool_methods.get_face_normal.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshDataTool_methods.set_material.m_call = cast(type_of(MeshDataTool_methods.set_material.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  MeshDataTool_methods.get_material.m_call = cast(type_of(MeshDataTool_methods.get_material.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
