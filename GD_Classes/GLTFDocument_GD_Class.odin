...
GLTFDocument_Init_ :: proc (GLTFDocument_methods: ^GLTFDocument_MethodBind_List, loc := #caller_location) {
  ...
  GLTFDocument_methods.set_image_format.m_call = cast(type_of(GLTFDocument_methods.set_image_format.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFDocument_methods.get_image_format.m_call = cast(type_of(GLTFDocument_methods.get_image_format.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFDocument_methods.set_lossy_quality.m_call = cast(type_of(GLTFDocument_methods.set_lossy_quality.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFDocument_methods.get_lossy_quality.m_call = cast(type_of(GLTFDocument_methods.get_lossy_quality.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFDocument_methods.set_fallback_image_format.m_call = cast(type_of(GLTFDocument_methods.set_fallback_image_format.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFDocument_methods.get_fallback_image_format.m_call = cast(type_of(GLTFDocument_methods.get_fallback_image_format.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFDocument_methods.set_fallback_image_quality.m_call = cast(type_of(GLTFDocument_methods.set_fallback_image_quality.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFDocument_methods.get_fallback_image_quality.m_call = cast(type_of(GLTFDocument_methods.get_fallback_image_quality.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFDocument_methods.set_root_node_mode.m_call = cast(type_of(GLTFDocument_methods.set_root_node_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFDocument_methods.get_root_node_mode.m_call = cast(type_of(GLTFDocument_methods.get_root_node_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFDocument_methods.set_visibility_mode.m_call = cast(type_of(GLTFDocument_methods.set_visibility_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFDocument_methods.get_visibility_mode.m_call = cast(type_of(GLTFDocument_methods.get_visibility_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFDocument_methods.append_from_file.m_call = cast(type_of(GLTFDocument_methods.append_from_file.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFDocument_methods.append_from_buffer.m_call = cast(type_of(GLTFDocument_methods.append_from_buffer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFDocument_methods.append_from_scene.m_call = cast(type_of(GLTFDocument_methods.append_from_scene.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFDocument_methods.generate_scene.m_call = cast(type_of(GLTFDocument_methods.generate_scene.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFDocument_methods.generate_buffer.m_call = cast(type_of(GLTFDocument_methods.generate_buffer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFDocument_methods.write_to_filesystem.m_call = cast(type_of(GLTFDocument_methods.write_to_filesystem.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFDocument_methods.import_object_model_property.m_call = cast(type_of(GLTFDocument_methods.import_object_model_property.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFDocument_methods.export_object_model_property.m_call = cast(type_of(GLTFDocument_methods.export_object_model_property.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFDocument_methods.register_gltf_document_extension.m_call = cast(type_of(GLTFDocument_methods.register_gltf_document_extension.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFDocument_methods.unregister_gltf_document_extension.m_call = cast(type_of(GLTFDocument_methods.unregister_gltf_document_extension.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  GLTFDocument_methods.get_supported_gltf_extensions.m_call = cast(type_of(GLTFDocument_methods.get_supported_gltf_extensions.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
