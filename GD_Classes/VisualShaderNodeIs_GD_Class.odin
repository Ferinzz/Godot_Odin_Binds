...
VisualShaderNodeIs_Init_ :: proc (VisualShaderNodeIs_methods: ^VisualShaderNodeIs_MethodBind_List, loc := #caller_location) {
  ...
  VisualShaderNodeIs_methods.set_function.m_call = cast(type_of(VisualShaderNodeIs_methods.set_function.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeIs_methods.get_function.m_call = cast(type_of(VisualShaderNodeIs_methods.get_function.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
