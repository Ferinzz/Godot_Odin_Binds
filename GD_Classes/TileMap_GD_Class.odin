...
TileMap_MethodBind_List :: struct {
  ...
  force_update: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: TileMap, #by_ptr args: i64 = 0, r_ret: ^TileSet)
  },
  set_rendering_quadrant_size: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: TileMap, #by_ptr args: i64 = 0, r_ret: ^GDW.Int)
  },
  ...
  set_collision_animatable: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: TileMap, #by_ptr args: i64 = 0, r_ret: ^GDW.Bool)
  },
  set_collision_visibility_mode: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: TileMap, #by_ptr args: i64 = 0, r_ret: ^TileMap_VisibilityMode)
  },
  ...
  set_pattern: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: TileMap, #by_ptr args: i64 = 0, r_ret: rawptr = nil)
  },
    clear_layer: struct{
  ...
  get_used_rect: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: TileMap, #by_ptr args: i64 = 0, r_ret: ^GDW.Rect2i)
  },
  map_to_local: struct{
...
TileMap_Init_ :: proc (TileMap_methods: ^TileMap_MethodBind_List, loc := #caller_location) {
  ...
  TileMap_methods.set_navigation_map.m_call = cast(type_of(TileMap_methods.set_navigation_map.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.get_navigation_map.m_call = cast(type_of(TileMap_methods.get_navigation_map.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.force_update.m_call = cast(type_of(TileMap_methods.force_update.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  TileMap_methods.set_tileset._set_tileset = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TileMap, "set_tileset", 774531446, loc))
  TileMap_methods.set_tileset.m_call = cast(type_of(TileMap_methods.set_tileset.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.get_tileset.m_call = cast(type_of(TileMap_methods.get_tileset.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.set_rendering_quadrant_size.m_call = cast(type_of(TileMap_methods.set_rendering_quadrant_size.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.get_rendering_quadrant_size.m_call = cast(type_of(TileMap_methods.get_rendering_quadrant_size.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.get_layers_count.m_call = cast(type_of(TileMap_methods.get_layers_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  TileMap_methods.add_layer._add_layer = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TileMap, "add_layer", 1286410249, loc))
  TileMap_methods.add_layer.m_call = cast(type_of(TileMap_methods.add_layer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  TileMap_methods.move_layer._move_layer = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TileMap, "move_layer", 3937882851, loc))
  TileMap_methods.move_layer.m_call = cast(type_of(TileMap_methods.move_layer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.remove_layer.m_call = cast(type_of(TileMap_methods.remove_layer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.set_layer_name.m_call = cast(type_of(TileMap_methods.set_layer_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.get_layer_name.m_call = cast(type_of(TileMap_methods.get_layer_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.set_layer_enabled.m_call = cast(type_of(TileMap_methods.set_layer_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.is_layer_enabled.m_call = cast(type_of(TileMap_methods.is_layer_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.set_layer_modulate.m_call = cast(type_of(TileMap_methods.set_layer_modulate.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.get_layer_modulate.m_call = cast(type_of(TileMap_methods.get_layer_modulate.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.set_layer_y_sort_enabled.m_call = cast(type_of(TileMap_methods.set_layer_y_sort_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.is_layer_y_sort_enabled.m_call = cast(type_of(TileMap_methods.is_layer_y_sort_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.set_layer_y_sort_origin.m_call = cast(type_of(TileMap_methods.set_layer_y_sort_origin.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.get_layer_y_sort_origin.m_call = cast(type_of(TileMap_methods.get_layer_y_sort_origin.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.set_layer_z_index.m_call = cast(type_of(TileMap_methods.set_layer_z_index.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.get_layer_z_index.m_call = cast(type_of(TileMap_methods.get_layer_z_index.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.set_layer_navigation_enabled.m_call = cast(type_of(TileMap_methods.set_layer_navigation_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.is_layer_navigation_enabled.m_call = cast(type_of(TileMap_methods.is_layer_navigation_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.set_layer_navigation_map.m_call = cast(type_of(TileMap_methods.set_layer_navigation_map.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.get_layer_navigation_map.m_call = cast(type_of(TileMap_methods.get_layer_navigation_map.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.set_collision_animatable.m_call = cast(type_of(TileMap_methods.set_collision_animatable.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.is_collision_animatable.m_call = cast(type_of(TileMap_methods.is_collision_animatable.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.set_collision_visibility_mode.m_call = cast(type_of(TileMap_methods.set_collision_visibility_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.get_collision_visibility_mode.m_call = cast(type_of(TileMap_methods.get_collision_visibility_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.set_navigation_visibility_mode.m_call = cast(type_of(TileMap_methods.set_navigation_visibility_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.get_navigation_visibility_mode.m_call = cast(type_of(TileMap_methods.get_navigation_visibility_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  TileMap_methods.set_cell._set_cell = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TileMap, "set_cell", 966713560, loc))
  TileMap_methods.set_cell.m_call = cast(type_of(TileMap_methods.set_cell.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  TileMap_methods.erase_cell._erase_cell = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TileMap, "erase_cell", 2311374912, loc))
  TileMap_methods.erase_cell.m_call = cast(type_of(TileMap_methods.erase_cell.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.get_cell_source_id.m_call = cast(type_of(TileMap_methods.get_cell_source_id.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.get_cell_atlas_coords.m_call = cast(type_of(TileMap_methods.get_cell_atlas_coords.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.get_cell_alternative_tile.m_call = cast(type_of(TileMap_methods.get_cell_alternative_tile.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.get_cell_tile_data.m_call = cast(type_of(TileMap_methods.get_cell_tile_data.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.is_cell_flipped_h.m_call = cast(type_of(TileMap_methods.is_cell_flipped_h.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.is_cell_flipped_v.m_call = cast(type_of(TileMap_methods.is_cell_flipped_v.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.is_cell_transposed.m_call = cast(type_of(TileMap_methods.is_cell_transposed.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.get_coords_for_body_rid.m_call = cast(type_of(TileMap_methods.get_coords_for_body_rid.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.get_layer_for_body_rid.m_call = cast(type_of(TileMap_methods.get_layer_for_body_rid.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.get_pattern.m_call = cast(type_of(TileMap_methods.get_pattern.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.map_pattern.m_call = cast(type_of(TileMap_methods.map_pattern.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.set_pattern.m_call = cast(type_of(TileMap_methods.set_pattern.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.set_cells_terrain_connect.m_call = cast(type_of(TileMap_methods.set_cells_terrain_connect.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.set_cells_terrain_path.m_call = cast(type_of(TileMap_methods.set_cells_terrain_path.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.fix_invalid_tiles.m_call = cast(type_of(TileMap_methods.fix_invalid_tiles.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.clear_layer.m_call = cast(type_of(TileMap_methods.clear_layer.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  TileMap_methods.clear._clear = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TileMap, "clear", 3218959716, loc))
  TileMap_methods.clear.m_call = cast(type_of(TileMap_methods.clear.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.update_internals.m_call = cast(type_of(TileMap_methods.update_internals.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.notify_runtime_tile_data_update.m_call = cast(type_of(TileMap_methods.notify_runtime_tile_data_update.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.get_surrounding_cells.m_call = cast(type_of(TileMap_methods.get_surrounding_cells.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.get_used_cells.m_call = cast(type_of(TileMap_methods.get_used_cells.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.get_used_cells_by_id.m_call = cast(type_of(TileMap_methods.get_used_cells_by_id.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.get_used_rect.m_call = cast(type_of(TileMap_methods.get_used_rect.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.map_to_local.m_call = cast(type_of(TileMap_methods.map_to_local.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.local_to_map.m_call = cast(type_of(TileMap_methods.local_to_map.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileMap_methods.get_neighbor_cell.m_call = cast(type_of(TileMap_methods.get_neighbor_cell.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
