...
BitMap_Init_ :: proc (BitMap_methods: ^BitMap_MethodBind_List, loc := #caller_location) {
  ...
  BitMap_methods.create.m_call = cast(type_of(BitMap_methods.create.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BitMap_methods.create_from_image_alpha.m_call = cast(type_of(BitMap_methods.create_from_image_alpha.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  BitMap_methods.set_bitv._set_bitv = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BitMap, "set_bitv", 4153096796, loc))
  BitMap_methods.set_bitv.m_call = cast(type_of(BitMap_methods.set_bitv.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  BitMap_methods.set_bit._set_bit = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BitMap, "set_bit", 1383440665, loc))
  BitMap_methods.set_bit.m_call = cast(type_of(BitMap_methods.set_bit.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  BitMap_methods.get_bitv._get_bitv = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BitMap, "get_bitv", 3900751641, loc))
  BitMap_methods.get_bitv.m_call = cast(type_of(BitMap_methods.get_bitv.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  BitMap_methods.get_bit._get_bit = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BitMap, "get_bit", 2522259332, loc))
  BitMap_methods.get_bit.m_call = cast(type_of(BitMap_methods.get_bit.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BitMap_methods.set_bit_rect.m_call = cast(type_of(BitMap_methods.set_bit_rect.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BitMap_methods.get_true_bit_count.m_call = cast(type_of(BitMap_methods.get_true_bit_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  BitMap_methods.get_size._get_size = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BitMap, "get_size", 3690982128, loc))
  BitMap_methods.get_size.m_call = cast(type_of(BitMap_methods.get_size.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  BitMap_methods.resize._resize = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BitMap, "resize", 1130785943, loc))
  BitMap_methods.resize.m_call = cast(type_of(BitMap_methods.resize.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  BitMap_methods.grow_mask._grow_mask = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.BitMap, "grow_mask", 3317281434, loc))
  BitMap_methods.grow_mask.m_call = cast(type_of(BitMap_methods.grow_mask.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BitMap_methods.convert_to_image.m_call = cast(type_of(BitMap_methods.convert_to_image.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BitMap_methods.opaque_to_polygons.m_call = cast(type_of(BitMap_methods.opaque_to_polygons.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
