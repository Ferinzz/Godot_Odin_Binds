...
Geometry3D_Init_ :: proc (Geometry3D_methods: ^Geometry3D_MethodBind_List, loc := #caller_location) {
  ...
  Geometry3D_methods.compute_convex_mesh_points.m_call = cast(type_of(Geometry3D_methods.compute_convex_mesh_points.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Geometry3D_methods.build_box_planes.m_call = cast(type_of(Geometry3D_methods.build_box_planes.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Geometry3D_methods.build_cylinder_planes.m_call = cast(type_of(Geometry3D_methods.build_cylinder_planes.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Geometry3D_methods.build_capsule_planes.m_call = cast(type_of(Geometry3D_methods.build_capsule_planes.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Geometry3D_methods.get_closest_points_between_segments.m_call = cast(type_of(Geometry3D_methods.get_closest_points_between_segments.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Geometry3D_methods.get_closest_point_to_segment.m_call = cast(type_of(Geometry3D_methods.get_closest_point_to_segment.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Geometry3D_methods.get_closest_point_to_segment_uncapped.m_call = cast(type_of(Geometry3D_methods.get_closest_point_to_segment_uncapped.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Geometry3D_methods.get_triangle_barycentric_coords.m_call = cast(type_of(Geometry3D_methods.get_triangle_barycentric_coords.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Geometry3D_methods.ray_intersects_triangle.m_call = cast(type_of(Geometry3D_methods.ray_intersects_triangle.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Geometry3D_methods.segment_intersects_triangle.m_call = cast(type_of(Geometry3D_methods.segment_intersects_triangle.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Geometry3D_methods.segment_intersects_sphere.m_call = cast(type_of(Geometry3D_methods.segment_intersects_sphere.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Geometry3D_methods.segment_intersects_cylinder.m_call = cast(type_of(Geometry3D_methods.segment_intersects_cylinder.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Geometry3D_methods.segment_intersects_convex.m_call = cast(type_of(Geometry3D_methods.segment_intersects_convex.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Geometry3D_methods.clip_polygon.m_call = cast(type_of(Geometry3D_methods.clip_polygon.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  Geometry3D_methods.tetrahedralize_delaunay.m_call = cast(type_of(Geometry3D_methods.tetrahedralize_delaunay.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
