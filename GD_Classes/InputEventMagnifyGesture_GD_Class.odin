...
InputEventMagnifyGesture_Init_ :: proc (InputEventMagnifyGesture_methods: ^InputEventMagnifyGesture_MethodBind_List, loc := #caller_location) {
  ...
  InputEventMagnifyGesture_methods.set_factor.m_call = cast(type_of(InputEventMagnifyGesture_methods.set_factor.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  InputEventMagnifyGesture_methods.get_factor.m_call = cast(type_of(InputEventMagnifyGesture_methods.get_factor.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
