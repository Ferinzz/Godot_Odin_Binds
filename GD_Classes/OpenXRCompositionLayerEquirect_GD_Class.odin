...
OpenXRCompositionLayerEquirect_MethodBind_List :: struct {
  set_radius: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: OpenXRCompositionLayerEquirect, #by_ptr args: struct{radius: ^GDW.float, }, r_ret: rawptr = nil)
  },
    get_radius: struct{
    using _get_radius: ^GDW.MethodBind,
    m_call: proc "c" (_:^GDW.MethodBind, obj: OpenXRCompositionLayerEquirect, args: rawptr = nil, r_ret: ^GDW.float)
  },
  set_central_horizontal_angle: struct{
    using _set_central_horizontal_angle: ^GDW.MethodBind,
    m_call: proc "c" (_:^GDW.MethodBind, obj: OpenXRCompositionLayerEquirect, #by_ptr args: struct{angle: ^GDW.float, }, r_ret: rawptr = nil)
  },
  ...
  set_fallback_segments: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: OpenXRCompositionLayerEquirect, #by_ptr args: struct{segments: ^GDW.Int, }, r_ret: rawptr = nil)
  },
    get_fallback_segments: struct{
    using _get_fallback_segments: ^GDW.MethodBind,
    m_call: proc "c" (_:^GDW.MethodBind, obj: OpenXRCompositionLayerEquirect, args: rawptr = nil, r_ret: ^GDW.Int)
  },
};
OpenXRCompositionLayerEquirect_Init_ :: proc (OpenXRCompositionLayerEquirect_methods: ^OpenXRCompositionLayerEquirect_MethodBind_List, loc := #caller_location) {
  ...
  OpenXRCompositionLayerEquirect_methods.set_radius._set_radius = (cast(^GDW.MethodBind)classDBGetMethodBind3(.OpenXRCompositionLayerEquirect, "set_radius", 373806689, loc))
  ...
  OpenXRCompositionLayerEquirect_methods.get_radius._get_radius = (cast(^GDW.MethodBind)classDBGetMethodBind3(.OpenXRCompositionLayerEquirect, "get_radius", 1740695150, loc))
  ...
  OpenXRCompositionLayerEquirect_methods.set_central_horizontal_angle._set_central_horizontal_angle = (cast(^GDW.MethodBind)classDBGetMethodBind3(.OpenXRCompositionLayerEquirect, "set_central_horizontal_angle", 373806689, loc))
  ...
  OpenXRCompositionLayerEquirect_methods.get_central_horizontal_angle._get_central_horizontal_angle = (cast(^GDW.MethodBind)classDBGetMethodBind3(.OpenXRCompositionLayerEquirect, "get_central_horizontal_angle", 1740695150, loc))
  ...
  OpenXRCompositionLayerEquirect_methods.set_upper_vertical_angle._set_upper_vertical_angle = (cast(^GDW.MethodBind)classDBGetMethodBind3(.OpenXRCompositionLayerEquirect, "set_upper_vertical_angle", 373806689, loc))
  ...
  OpenXRCompositionLayerEquirect_methods.get_upper_vertical_angle._get_upper_vertical_angle = (cast(^GDW.MethodBind)classDBGetMethodBind3(.OpenXRCompositionLayerEquirect, "get_upper_vertical_angle", 1740695150, loc))
  ...
  OpenXRCompositionLayerEquirect_methods.set_lower_vertical_angle._set_lower_vertical_angle = (cast(^GDW.MethodBind)classDBGetMethodBind3(.OpenXRCompositionLayerEquirect, "set_lower_vertical_angle", 373806689, loc))
  ...
  OpenXRCompositionLayerEquirect_methods.get_lower_vertical_angle._get_lower_vertical_angle = (cast(^GDW.MethodBind)classDBGetMethodBind3(.OpenXRCompositionLayerEquirect, "get_lower_vertical_angle", 1740695150, loc))
  ...
  OpenXRCompositionLayerEquirect_methods.set_fallback_segments._set_fallback_segments = (cast(^GDW.MethodBind)classDBGetMethodBind3(.OpenXRCompositionLayerEquirect, "set_fallback_segments", 1286410249, loc))
  ...
  OpenXRCompositionLayerEquirect_methods.get_fallback_segments._get_fallback_segments = (cast(^GDW.MethodBind)classDBGetMethodBind3(.OpenXRCompositionLayerEquirect, "get_fallback_segments", 3905245786, loc))
