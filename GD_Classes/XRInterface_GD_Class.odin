...
XRInterface_Init_ :: proc (XRInterface_methods: ^XRInterface_MethodBind_List, loc := #caller_location) {
  ...
  XRInterface_methods.get_name.m_call = cast(type_of(XRInterface_methods.get_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  XRInterface_methods.get_capabilities.m_call = cast(type_of(XRInterface_methods.get_capabilities.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  XRInterface_methods.is_primary.m_call = cast(type_of(XRInterface_methods.is_primary.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  XRInterface_methods.set_primary.m_call = cast(type_of(XRInterface_methods.set_primary.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  XRInterface_methods.is_initialized.m_call = cast(type_of(XRInterface_methods.is_initialized.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  XRInterface_methods.initialize.m_call = cast(type_of(XRInterface_methods.initialize.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  XRInterface_methods.uninitialize.m_call = cast(type_of(XRInterface_methods.uninitialize.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  XRInterface_methods.get_system_info.m_call = cast(type_of(XRInterface_methods.get_system_info.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  XRInterface_methods.get_tracking_status.m_call = cast(type_of(XRInterface_methods.get_tracking_status.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  XRInterface_methods.get_render_target_size.m_call = cast(type_of(XRInterface_methods.get_render_target_size.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  XRInterface_methods.get_view_count.m_call = cast(type_of(XRInterface_methods.get_view_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  XRInterface_methods.trigger_haptic_pulse.m_call = cast(type_of(XRInterface_methods.trigger_haptic_pulse.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  XRInterface_methods.supports_play_area_mode.m_call = cast(type_of(XRInterface_methods.supports_play_area_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  XRInterface_methods.get_play_area_mode.m_call = cast(type_of(XRInterface_methods.get_play_area_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  XRInterface_methods.set_play_area_mode.m_call = cast(type_of(XRInterface_methods.set_play_area_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  XRInterface_methods.get_play_area.m_call = cast(type_of(XRInterface_methods.get_play_area.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  XRInterface_methods.get_anchor_detection_is_enabled.m_call = cast(type_of(XRInterface_methods.get_anchor_detection_is_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  XRInterface_methods.set_anchor_detection_is_enabled.m_call = cast(type_of(XRInterface_methods.set_anchor_detection_is_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  XRInterface_methods.get_camera_feed_id.m_call = cast(type_of(XRInterface_methods.get_camera_feed_id.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  XRInterface_methods.is_passthrough_supported.m_call = cast(type_of(XRInterface_methods.is_passthrough_supported.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  XRInterface_methods.is_passthrough_enabled.m_call = cast(type_of(XRInterface_methods.is_passthrough_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  XRInterface_methods.start_passthrough.m_call = cast(type_of(XRInterface_methods.start_passthrough.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  XRInterface_methods.stop_passthrough.m_call = cast(type_of(XRInterface_methods.stop_passthrough.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  XRInterface_methods.get_transform_for_view.m_call = cast(type_of(XRInterface_methods.get_transform_for_view.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  XRInterface_methods.get_projection_for_view.m_call = cast(type_of(XRInterface_methods.get_projection_for_view.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  XRInterface_methods.get_supported_environment_blend_modes.m_call = cast(type_of(XRInterface_methods.get_supported_environment_blend_modes.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  XRInterface_methods.set_environment_blend_mode.m_call = cast(type_of(XRInterface_methods.set_environment_blend_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  XRInterface_methods.get_environment_blend_mode.m_call = cast(type_of(XRInterface_methods.get_environment_blend_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
