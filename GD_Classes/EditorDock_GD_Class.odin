...
EditorDock_Init_ :: proc (EditorDock_methods: ^EditorDock_MethodBind_List, loc := #caller_location) {
  ...
  EditorDock_methods.open.m_call = cast(type_of(EditorDock_methods.open.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorDock_methods.make_visible.m_call = cast(type_of(EditorDock_methods.make_visible.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  EditorDock_methods.close._close = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.EditorDock, "close", 3218959716, loc))
  EditorDock_methods.close.m_call = cast(type_of(EditorDock_methods.close.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  EditorDock_methods.set_title._set_title = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.EditorDock, "set_title", 83702148, loc))
  EditorDock_methods.set_title.m_call = cast(type_of(EditorDock_methods.set_title.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  EditorDock_methods.get_title._get_title = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.EditorDock, "get_title", 201670096, loc))
  EditorDock_methods.get_title.m_call = cast(type_of(EditorDock_methods.get_title.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorDock_methods.set_layout_key.m_call = cast(type_of(EditorDock_methods.set_layout_key.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorDock_methods.get_layout_key.m_call = cast(type_of(EditorDock_methods.get_layout_key.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorDock_methods.set_global.m_call = cast(type_of(EditorDock_methods.set_global.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  EditorDock_methods.is_global._is_global = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.EditorDock, "is_global", 36873697, loc))
  EditorDock_methods.is_global.m_call = cast(type_of(EditorDock_methods.is_global.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorDock_methods.set_transient.m_call = cast(type_of(EditorDock_methods.set_transient.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorDock_methods.is_transient.m_call = cast(type_of(EditorDock_methods.is_transient.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorDock_methods.set_closable.m_call = cast(type_of(EditorDock_methods.set_closable.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorDock_methods.is_closable.m_call = cast(type_of(EditorDock_methods.is_closable.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorDock_methods.set_icon_name.m_call = cast(type_of(EditorDock_methods.set_icon_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorDock_methods.get_icon_name.m_call = cast(type_of(EditorDock_methods.get_icon_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorDock_methods.set_dock_icon.m_call = cast(type_of(EditorDock_methods.set_dock_icon.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorDock_methods.get_dock_icon.m_call = cast(type_of(EditorDock_methods.get_dock_icon.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorDock_methods.set_force_show_icon.m_call = cast(type_of(EditorDock_methods.set_force_show_icon.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorDock_methods.get_force_show_icon.m_call = cast(type_of(EditorDock_methods.get_force_show_icon.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorDock_methods.set_title_color.m_call = cast(type_of(EditorDock_methods.set_title_color.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorDock_methods.get_title_color.m_call = cast(type_of(EditorDock_methods.get_title_color.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorDock_methods.set_dock_shortcut.m_call = cast(type_of(EditorDock_methods.set_dock_shortcut.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorDock_methods.get_dock_shortcut.m_call = cast(type_of(EditorDock_methods.get_dock_shortcut.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorDock_methods.set_default_slot.m_call = cast(type_of(EditorDock_methods.set_default_slot.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorDock_methods.get_default_slot.m_call = cast(type_of(EditorDock_methods.get_default_slot.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorDock_methods.set_available_layouts.m_call = cast(type_of(EditorDock_methods.set_available_layouts.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  EditorDock_methods.get_available_layouts.m_call = cast(type_of(EditorDock_methods.get_available_layouts.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
