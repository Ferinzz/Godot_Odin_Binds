...
NavigationAgent3D_MethodBind_List :: struct {
  get_rid: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: NavigationAgent3D, args: rawptr = nil, r_ret: ^GDW.RID)
  },
  set_avoidance_enabled: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: NavigationAgent3D, args: rawptr = nil, r_ret: ^GDW.Bool)
  },
  set_path_desired_distance: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: NavigationAgent3D, args: rawptr = nil, r_ret: ^GDW.float)
  },
  ...
  set_max_neighbors: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: NavigationAgent3D, args: rawptr = nil, r_ret: ^GDW.Int)
  },
  ...
  set_pathfinding_algorithm: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: NavigationAgent3D, args: rawptr = nil, r_ret: ^NavigationPathQueryParameters3D_PathfindingAlgorithm)
  },
  set_path_postprocessing: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: NavigationAgent3D, args: rawptr = nil, r_ret: ^NavigationPathQueryParameters3D_PathPostProcessing)
  },
  set_path_metadata_flags: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: NavigationAgent3D, args: rawptr = nil, r_ret: ^NavigationPathQueryParameters3D_PathMetadataFlags)
  },
  ...
  set_target_position: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: NavigationAgent3D, args: rawptr = nil, r_ret: ^GDW.Vector3)
  },
  ...
  get_current_navigation_result: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: NavigationAgent3D, args: rawptr = nil, r_ret: ^NavigationPathQueryResult3D)
  },
  get_current_navigation_path: struct{
    using _get_current_navigation_path: ^GDW.MethodBind,
    m_call: proc(_:^GDW.MethodBind, obj: NavigationAgent3D, args: rawptr = nil, r_ret: ^GDW.PackedVector3Array)
  },
  ...
  set_debug_path_custom_color: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: NavigationAgent3D, args: rawptr = nil, r_ret: ^GDW.Color)
  },
