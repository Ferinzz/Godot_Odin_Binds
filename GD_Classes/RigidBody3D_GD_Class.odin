...
RigidBody3D_Init_ :: proc (RigidBody3D_methods: ^RigidBody3D_MethodBind_List, loc := #caller_location) {
  ...
  RigidBody3D_methods.set_mass.m_call = cast(type_of(RigidBody3D_methods.set_mass.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  RigidBody3D_methods.get_mass._get_mass = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.RigidBody3D, "get_mass", 1740695150, loc))
  RigidBody3D_methods.get_mass.m_call = cast(type_of(RigidBody3D_methods.get_mass.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.set_inertia.m_call = cast(type_of(RigidBody3D_methods.set_inertia.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.get_inertia.m_call = cast(type_of(RigidBody3D_methods.get_inertia.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.set_center_of_mass_mode.m_call = cast(type_of(RigidBody3D_methods.set_center_of_mass_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.get_center_of_mass_mode.m_call = cast(type_of(RigidBody3D_methods.get_center_of_mass_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.set_center_of_mass.m_call = cast(type_of(RigidBody3D_methods.set_center_of_mass.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.get_center_of_mass.m_call = cast(type_of(RigidBody3D_methods.get_center_of_mass.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.set_physics_material_override.m_call = cast(type_of(RigidBody3D_methods.set_physics_material_override.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.get_physics_material_override.m_call = cast(type_of(RigidBody3D_methods.get_physics_material_override.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.set_linear_velocity.m_call = cast(type_of(RigidBody3D_methods.set_linear_velocity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.get_linear_velocity.m_call = cast(type_of(RigidBody3D_methods.get_linear_velocity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.set_angular_velocity.m_call = cast(type_of(RigidBody3D_methods.set_angular_velocity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.get_angular_velocity.m_call = cast(type_of(RigidBody3D_methods.get_angular_velocity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.get_inverse_inertia_tensor.m_call = cast(type_of(RigidBody3D_methods.get_inverse_inertia_tensor.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.set_gravity_scale.m_call = cast(type_of(RigidBody3D_methods.set_gravity_scale.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.get_gravity_scale.m_call = cast(type_of(RigidBody3D_methods.get_gravity_scale.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.set_linear_damp_mode.m_call = cast(type_of(RigidBody3D_methods.set_linear_damp_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.get_linear_damp_mode.m_call = cast(type_of(RigidBody3D_methods.get_linear_damp_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.set_angular_damp_mode.m_call = cast(type_of(RigidBody3D_methods.set_angular_damp_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.get_angular_damp_mode.m_call = cast(type_of(RigidBody3D_methods.get_angular_damp_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.set_linear_damp.m_call = cast(type_of(RigidBody3D_methods.set_linear_damp.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.get_linear_damp.m_call = cast(type_of(RigidBody3D_methods.get_linear_damp.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.set_angular_damp.m_call = cast(type_of(RigidBody3D_methods.set_angular_damp.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.get_angular_damp.m_call = cast(type_of(RigidBody3D_methods.get_angular_damp.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.set_max_contacts_reported.m_call = cast(type_of(RigidBody3D_methods.set_max_contacts_reported.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.get_max_contacts_reported.m_call = cast(type_of(RigidBody3D_methods.get_max_contacts_reported.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.get_contact_count.m_call = cast(type_of(RigidBody3D_methods.get_contact_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.set_use_custom_integrator.m_call = cast(type_of(RigidBody3D_methods.set_use_custom_integrator.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.is_using_custom_integrator.m_call = cast(type_of(RigidBody3D_methods.is_using_custom_integrator.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.set_contact_monitor.m_call = cast(type_of(RigidBody3D_methods.set_contact_monitor.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.is_contact_monitor_enabled.m_call = cast(type_of(RigidBody3D_methods.is_contact_monitor_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.set_use_continuous_collision_detection.m_call = cast(type_of(RigidBody3D_methods.set_use_continuous_collision_detection.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.is_using_continuous_collision_detection.m_call = cast(type_of(RigidBody3D_methods.is_using_continuous_collision_detection.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.set_axis_velocity.m_call = cast(type_of(RigidBody3D_methods.set_axis_velocity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.apply_central_impulse.m_call = cast(type_of(RigidBody3D_methods.apply_central_impulse.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.apply_impulse.m_call = cast(type_of(RigidBody3D_methods.apply_impulse.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.apply_torque_impulse.m_call = cast(type_of(RigidBody3D_methods.apply_torque_impulse.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.apply_central_force.m_call = cast(type_of(RigidBody3D_methods.apply_central_force.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.apply_force.m_call = cast(type_of(RigidBody3D_methods.apply_force.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.apply_torque.m_call = cast(type_of(RigidBody3D_methods.apply_torque.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.add_constant_central_force.m_call = cast(type_of(RigidBody3D_methods.add_constant_central_force.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.add_constant_force.m_call = cast(type_of(RigidBody3D_methods.add_constant_force.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.add_constant_torque.m_call = cast(type_of(RigidBody3D_methods.add_constant_torque.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.set_constant_force.m_call = cast(type_of(RigidBody3D_methods.set_constant_force.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.get_constant_force.m_call = cast(type_of(RigidBody3D_methods.get_constant_force.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.set_constant_torque.m_call = cast(type_of(RigidBody3D_methods.set_constant_torque.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.get_constant_torque.m_call = cast(type_of(RigidBody3D_methods.get_constant_torque.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.set_sleeping.m_call = cast(type_of(RigidBody3D_methods.set_sleeping.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.is_sleeping.m_call = cast(type_of(RigidBody3D_methods.is_sleeping.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.set_can_sleep.m_call = cast(type_of(RigidBody3D_methods.set_can_sleep.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.is_able_to_sleep.m_call = cast(type_of(RigidBody3D_methods.is_able_to_sleep.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.set_lock_rotation_enabled.m_call = cast(type_of(RigidBody3D_methods.set_lock_rotation_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.is_lock_rotation_enabled.m_call = cast(type_of(RigidBody3D_methods.is_lock_rotation_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.set_freeze_enabled.m_call = cast(type_of(RigidBody3D_methods.set_freeze_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.is_freeze_enabled.m_call = cast(type_of(RigidBody3D_methods.is_freeze_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.set_freeze_mode.m_call = cast(type_of(RigidBody3D_methods.set_freeze_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.get_freeze_mode.m_call = cast(type_of(RigidBody3D_methods.get_freeze_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  RigidBody3D_methods.get_colliding_bodies.m_call = cast(type_of(RigidBody3D_methods.get_colliding_bodies.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
