...
CSGMesh3D_Init_ :: proc (CSGMesh3D_methods: ^CSGMesh3D_MethodBind_List, loc := #caller_location) {
  ...
  CSGMesh3D_methods.set_mesh.m_call = cast(type_of(CSGMesh3D_methods.set_mesh.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  CSGMesh3D_methods.get_mesh._get_mesh = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.CSGMesh3D, "get_mesh", 4081188045, loc))
  CSGMesh3D_methods.get_mesh.m_call = cast(type_of(CSGMesh3D_methods.get_mesh.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CSGMesh3D_methods.set_material.m_call = cast(type_of(CSGMesh3D_methods.set_material.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CSGMesh3D_methods.get_material.m_call = cast(type_of(CSGMesh3D_methods.get_material.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
