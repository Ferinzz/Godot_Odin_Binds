...
World3D_Init_ :: proc (World3D_methods: ^World3D_MethodBind_List, loc := #caller_location) {
  ...
  World3D_methods.get_space.m_call = cast(type_of(World3D_methods.get_space.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  World3D_methods.get_navigation_map.m_call = cast(type_of(World3D_methods.get_navigation_map.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  World3D_methods.get_scenario.m_call = cast(type_of(World3D_methods.get_scenario.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  World3D_methods.set_environment.m_call = cast(type_of(World3D_methods.set_environment.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  World3D_methods.get_environment.m_call = cast(type_of(World3D_methods.get_environment.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  World3D_methods.set_fallback_environment.m_call = cast(type_of(World3D_methods.set_fallback_environment.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  World3D_methods.get_fallback_environment.m_call = cast(type_of(World3D_methods.get_fallback_environment.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  World3D_methods.set_camera_attributes.m_call = cast(type_of(World3D_methods.set_camera_attributes.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  World3D_methods.get_camera_attributes.m_call = cast(type_of(World3D_methods.get_camera_attributes.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  World3D_methods.get_direct_space_state.m_call = cast(type_of(World3D_methods.get_direct_space_state.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
