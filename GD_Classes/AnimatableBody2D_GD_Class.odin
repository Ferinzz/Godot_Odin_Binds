...
AnimatableBody2D_Init_ :: proc (AnimatableBody2D_methods: ^AnimatableBody2D_MethodBind_List, loc := #caller_location) {
  ...
  AnimatableBody2D_methods.set_sync_to_physics.m_call = cast(type_of(AnimatableBody2D_methods.set_sync_to_physics.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AnimatableBody2D_methods.is_sync_to_physics_enabled.m_call = cast(type_of(AnimatableBody2D_methods.is_sync_to_physics_enabled.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
