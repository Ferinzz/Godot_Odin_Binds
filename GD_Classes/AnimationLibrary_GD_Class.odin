...
AnimationLibrary_Init_ :: proc (AnimationLibrary_methods: ^AnimationLibrary_MethodBind_List, loc := #caller_location) {
  ...
  AnimationLibrary_methods.add_animation.m_call = cast(type_of(AnimationLibrary_methods.add_animation.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AnimationLibrary_methods.remove_animation.m_call = cast(type_of(AnimationLibrary_methods.remove_animation.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AnimationLibrary_methods.rename_animation.m_call = cast(type_of(AnimationLibrary_methods.rename_animation.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AnimationLibrary_methods.has_animation.m_call = cast(type_of(AnimationLibrary_methods.has_animation.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AnimationLibrary_methods.get_animation.m_call = cast(type_of(AnimationLibrary_methods.get_animation.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AnimationLibrary_methods.get_animation_list.m_call = cast(type_of(AnimationLibrary_methods.get_animation_list.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AnimationLibrary_methods.get_animation_list_size.m_call = cast(type_of(AnimationLibrary_methods.get_animation_list_size.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
