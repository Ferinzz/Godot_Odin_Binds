...
VoxelGIData_Init_ :: proc (VoxelGIData_methods: ^VoxelGIData_MethodBind_List, loc := #caller_location) {
  ...
  VoxelGIData_methods.allocate.m_call = cast(type_of(VoxelGIData_methods.allocate.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VoxelGIData_methods.get_bounds.m_call = cast(type_of(VoxelGIData_methods.get_bounds.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VoxelGIData_methods.get_octree_size.m_call = cast(type_of(VoxelGIData_methods.get_octree_size.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VoxelGIData_methods.get_to_cell_xform.m_call = cast(type_of(VoxelGIData_methods.get_to_cell_xform.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VoxelGIData_methods.get_octree_cells.m_call = cast(type_of(VoxelGIData_methods.get_octree_cells.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VoxelGIData_methods.get_data_cells.m_call = cast(type_of(VoxelGIData_methods.get_data_cells.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VoxelGIData_methods.get_level_counts.m_call = cast(type_of(VoxelGIData_methods.get_level_counts.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VoxelGIData_methods.set_dynamic_range.m_call = cast(type_of(VoxelGIData_methods.set_dynamic_range.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VoxelGIData_methods.get_dynamic_range.m_call = cast(type_of(VoxelGIData_methods.get_dynamic_range.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VoxelGIData_methods.set_energy.m_call = cast(type_of(VoxelGIData_methods.set_energy.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VoxelGIData_methods.get_energy.m_call = cast(type_of(VoxelGIData_methods.get_energy.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  VoxelGIData_methods.set_bias._set_bias = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.VoxelGIData, "set_bias", 373806689, loc))
  VoxelGIData_methods.set_bias.m_call = cast(type_of(VoxelGIData_methods.set_bias.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  VoxelGIData_methods.get_bias._get_bias = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.VoxelGIData, "get_bias", 1740695150, loc))
  VoxelGIData_methods.get_bias.m_call = cast(type_of(VoxelGIData_methods.get_bias.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VoxelGIData_methods.set_normal_bias.m_call = cast(type_of(VoxelGIData_methods.set_normal_bias.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VoxelGIData_methods.get_normal_bias.m_call = cast(type_of(VoxelGIData_methods.get_normal_bias.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VoxelGIData_methods.set_propagation.m_call = cast(type_of(VoxelGIData_methods.set_propagation.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VoxelGIData_methods.get_propagation.m_call = cast(type_of(VoxelGIData_methods.get_propagation.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VoxelGIData_methods.set_interior.m_call = cast(type_of(VoxelGIData_methods.set_interior.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VoxelGIData_methods.is_interior.m_call = cast(type_of(VoxelGIData_methods.is_interior.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VoxelGIData_methods.set_use_two_bounces.m_call = cast(type_of(VoxelGIData_methods.set_use_two_bounces.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VoxelGIData_methods.is_using_two_bounces.m_call = cast(type_of(VoxelGIData_methods.is_using_two_bounces.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
