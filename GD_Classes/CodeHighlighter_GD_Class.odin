...
CodeHighlighter_Init_ :: proc (CodeHighlighter_methods: ^CodeHighlighter_MethodBind_List, loc := #caller_location) {
  ...
  CodeHighlighter_methods.add_keyword_color.m_call = cast(type_of(CodeHighlighter_methods.add_keyword_color.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeHighlighter_methods.remove_keyword_color.m_call = cast(type_of(CodeHighlighter_methods.remove_keyword_color.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeHighlighter_methods.has_keyword_color.m_call = cast(type_of(CodeHighlighter_methods.has_keyword_color.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeHighlighter_methods.get_keyword_color.m_call = cast(type_of(CodeHighlighter_methods.get_keyword_color.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeHighlighter_methods.set_keyword_colors.m_call = cast(type_of(CodeHighlighter_methods.set_keyword_colors.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeHighlighter_methods.clear_keyword_colors.m_call = cast(type_of(CodeHighlighter_methods.clear_keyword_colors.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeHighlighter_methods.get_keyword_colors.m_call = cast(type_of(CodeHighlighter_methods.get_keyword_colors.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeHighlighter_methods.add_member_keyword_color.m_call = cast(type_of(CodeHighlighter_methods.add_member_keyword_color.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeHighlighter_methods.remove_member_keyword_color.m_call = cast(type_of(CodeHighlighter_methods.remove_member_keyword_color.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeHighlighter_methods.has_member_keyword_color.m_call = cast(type_of(CodeHighlighter_methods.has_member_keyword_color.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeHighlighter_methods.get_member_keyword_color.m_call = cast(type_of(CodeHighlighter_methods.get_member_keyword_color.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeHighlighter_methods.set_member_keyword_colors.m_call = cast(type_of(CodeHighlighter_methods.set_member_keyword_colors.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeHighlighter_methods.clear_member_keyword_colors.m_call = cast(type_of(CodeHighlighter_methods.clear_member_keyword_colors.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeHighlighter_methods.get_member_keyword_colors.m_call = cast(type_of(CodeHighlighter_methods.get_member_keyword_colors.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeHighlighter_methods.add_color_region.m_call = cast(type_of(CodeHighlighter_methods.add_color_region.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeHighlighter_methods.remove_color_region.m_call = cast(type_of(CodeHighlighter_methods.remove_color_region.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeHighlighter_methods.has_color_region.m_call = cast(type_of(CodeHighlighter_methods.has_color_region.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeHighlighter_methods.set_color_regions.m_call = cast(type_of(CodeHighlighter_methods.set_color_regions.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeHighlighter_methods.clear_color_regions.m_call = cast(type_of(CodeHighlighter_methods.clear_color_regions.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeHighlighter_methods.get_color_regions.m_call = cast(type_of(CodeHighlighter_methods.get_color_regions.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeHighlighter_methods.set_function_color.m_call = cast(type_of(CodeHighlighter_methods.set_function_color.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeHighlighter_methods.get_function_color.m_call = cast(type_of(CodeHighlighter_methods.get_function_color.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeHighlighter_methods.set_number_color.m_call = cast(type_of(CodeHighlighter_methods.set_number_color.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeHighlighter_methods.get_number_color.m_call = cast(type_of(CodeHighlighter_methods.get_number_color.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeHighlighter_methods.set_symbol_color.m_call = cast(type_of(CodeHighlighter_methods.set_symbol_color.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeHighlighter_methods.get_symbol_color.m_call = cast(type_of(CodeHighlighter_methods.get_symbol_color.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeHighlighter_methods.set_member_variable_color.m_call = cast(type_of(CodeHighlighter_methods.set_member_variable_color.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  CodeHighlighter_methods.get_member_variable_color.m_call = cast(type_of(CodeHighlighter_methods.get_member_variable_color.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
