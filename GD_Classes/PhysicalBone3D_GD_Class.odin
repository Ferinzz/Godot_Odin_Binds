...
PhysicalBone3D_Init_ :: proc (PhysicalBone3D_methods: ^PhysicalBone3D_MethodBind_List, loc := #caller_location) {
  ...
  PhysicalBone3D_methods.apply_central_impulse.m_call = cast(type_of(PhysicalBone3D_methods.apply_central_impulse.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicalBone3D_methods.apply_impulse.m_call = cast(type_of(PhysicalBone3D_methods.apply_impulse.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicalBone3D_methods.set_joint_type.m_call = cast(type_of(PhysicalBone3D_methods.set_joint_type.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicalBone3D_methods.get_joint_type.m_call = cast(type_of(PhysicalBone3D_methods.get_joint_type.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicalBone3D_methods.set_joint_offset.m_call = cast(type_of(PhysicalBone3D_methods.set_joint_offset.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicalBone3D_methods.get_joint_offset.m_call = cast(type_of(PhysicalBone3D_methods.get_joint_offset.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicalBone3D_methods.set_joint_rotation.m_call = cast(type_of(PhysicalBone3D_methods.set_joint_rotation.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicalBone3D_methods.get_joint_rotation.m_call = cast(type_of(PhysicalBone3D_methods.get_joint_rotation.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicalBone3D_methods.set_body_offset.m_call = cast(type_of(PhysicalBone3D_methods.set_body_offset.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicalBone3D_methods.get_body_offset.m_call = cast(type_of(PhysicalBone3D_methods.get_body_offset.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicalBone3D_methods.get_simulate_physics.m_call = cast(type_of(PhysicalBone3D_methods.get_simulate_physics.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicalBone3D_methods.is_simulating_physics.m_call = cast(type_of(PhysicalBone3D_methods.is_simulating_physics.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicalBone3D_methods.get_bone_id.m_call = cast(type_of(PhysicalBone3D_methods.get_bone_id.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicalBone3D_methods.set_mass.m_call = cast(type_of(PhysicalBone3D_methods.set_mass.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicalBone3D_methods.get_mass.m_call = cast(type_of(PhysicalBone3D_methods.get_mass.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicalBone3D_methods.set_friction.m_call = cast(type_of(PhysicalBone3D_methods.set_friction.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicalBone3D_methods.get_friction.m_call = cast(type_of(PhysicalBone3D_methods.get_friction.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicalBone3D_methods.set_bounce.m_call = cast(type_of(PhysicalBone3D_methods.set_bounce.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicalBone3D_methods.get_bounce.m_call = cast(type_of(PhysicalBone3D_methods.get_bounce.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicalBone3D_methods.set_gravity_scale.m_call = cast(type_of(PhysicalBone3D_methods.set_gravity_scale.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicalBone3D_methods.get_gravity_scale.m_call = cast(type_of(PhysicalBone3D_methods.get_gravity_scale.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicalBone3D_methods.set_linear_damp_mode.m_call = cast(type_of(PhysicalBone3D_methods.set_linear_damp_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicalBone3D_methods.get_linear_damp_mode.m_call = cast(type_of(PhysicalBone3D_methods.get_linear_damp_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicalBone3D_methods.set_angular_damp_mode.m_call = cast(type_of(PhysicalBone3D_methods.set_angular_damp_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicalBone3D_methods.get_angular_damp_mode.m_call = cast(type_of(PhysicalBone3D_methods.get_angular_damp_mode.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicalBone3D_methods.set_linear_damp.m_call = cast(type_of(PhysicalBone3D_methods.set_linear_damp.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicalBone3D_methods.get_linear_damp.m_call = cast(type_of(PhysicalBone3D_methods.get_linear_damp.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicalBone3D_methods.set_angular_damp.m_call = cast(type_of(PhysicalBone3D_methods.set_angular_damp.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicalBone3D_methods.get_angular_damp.m_call = cast(type_of(PhysicalBone3D_methods.get_angular_damp.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicalBone3D_methods.set_linear_velocity.m_call = cast(type_of(PhysicalBone3D_methods.set_linear_velocity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicalBone3D_methods.get_linear_velocity.m_call = cast(type_of(PhysicalBone3D_methods.get_linear_velocity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicalBone3D_methods.set_angular_velocity.m_call = cast(type_of(PhysicalBone3D_methods.set_angular_velocity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicalBone3D_methods.get_angular_velocity.m_call = cast(type_of(PhysicalBone3D_methods.get_angular_velocity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicalBone3D_methods.set_use_custom_integrator.m_call = cast(type_of(PhysicalBone3D_methods.set_use_custom_integrator.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicalBone3D_methods.is_using_custom_integrator.m_call = cast(type_of(PhysicalBone3D_methods.is_using_custom_integrator.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicalBone3D_methods.set_can_sleep.m_call = cast(type_of(PhysicalBone3D_methods.set_can_sleep.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  PhysicalBone3D_methods.is_able_to_sleep.m_call = cast(type_of(PhysicalBone3D_methods.is_able_to_sleep.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
