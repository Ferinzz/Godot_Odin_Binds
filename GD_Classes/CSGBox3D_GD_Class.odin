...
CSGBox3D_Init_ :: proc (CSGBox3D_methods: ^CSGBox3D_MethodBind_List, loc := #caller_location) {
  CSGBox3D_methods.set_size = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.CSGBox3D, "set_size", 3460891852, loc))
  CSGBox3D_methods.get_size = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.CSGBox3D, "get_size", 3360562783, loc))
  CSGBox3D_methods.set_material = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.CSGBox3D, "set_material", 2757459619, loc))
  CSGBox3D_methods.get_material = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.CSGBox3D, "get_material", 5934680, loc))
};
