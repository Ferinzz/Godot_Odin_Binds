...
EditorResourcePicker_MethodBind_List :: struct {
  set_base_type: ^GDW.MethodBind,
  get_base_type: ^GDW.MethodBind,
  get_allowed_types: ^GDW.MethodBind,
  set_edited_resource: ^GDW.MethodBind,
  get_edited_resource: ^GDW.MethodBind,
  set_toggle_mode: ^GDW.MethodBind,
  is_toggle_mode: ^GDW.MethodBind,
  set_toggle_pressed: ^GDW.MethodBind,
...
EditorResourcePicker_Init_ :: proc (EditorResourcePicker_methods: ^EditorResourcePicker_MethodBind_List, loc := #caller_location) {
  EditorResourcePicker_methods.set_base_type = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.EditorResourcePicker, "set_base_type", 83702148, loc))
  EditorResourcePicker_methods.get_base_type = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.EditorResourcePicker, "get_base_type", 201670096, loc))
  EditorResourcePicker_methods.get_allowed_types = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.EditorResourcePicker, "get_allowed_types", 1139954409, loc))
  EditorResourcePicker_methods.set_edited_resource = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.EditorResourcePicker, "set_edited_resource", 968641751, loc))
  EditorResourcePicker_methods.get_edited_resource = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.EditorResourcePicker, "get_edited_resource", 2674603643, loc))
  EditorResourcePicker_methods.set_toggle_mode = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.EditorResourcePicker, "set_toggle_mode", 2586408642, loc))
  EditorResourcePicker_methods.is_toggle_mode = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.EditorResourcePicker, "is_toggle_mode", 36873697, loc))
  EditorResourcePicker_methods.set_toggle_pressed = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.EditorResourcePicker, "set_toggle_pressed", 2586408642, loc))
  EditorResourcePicker_methods.set_editable = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.EditorResourcePicker, "set_editable", 2586408642, loc))
  EditorResourcePicker_methods.is_editable = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.EditorResourcePicker, "is_editable", 36873697, loc))
};
