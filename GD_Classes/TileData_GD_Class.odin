...
TileData_Init_ :: proc (TileData_methods: ^TileData_MethodBind_List, loc := #caller_location) {
  ...
  TileData_methods.set_flip_h.m_call = cast(type_of(TileData_methods.set_flip_h.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  TileData_methods.get_flip_h._get_flip_h = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TileData, "get_flip_h", 36873697, loc))
  TileData_methods.get_flip_h.m_call = cast(type_of(TileData_methods.get_flip_h.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  TileData_methods.set_flip_v._set_flip_v = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TileData, "set_flip_v", 2586408642, loc))
  TileData_methods.set_flip_v.m_call = cast(type_of(TileData_methods.set_flip_v.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  TileData_methods.get_flip_v._get_flip_v = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.TileData, "get_flip_v", 36873697, loc))
  TileData_methods.get_flip_v.m_call = cast(type_of(TileData_methods.get_flip_v.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileData_methods.set_transpose.m_call = cast(type_of(TileData_methods.set_transpose.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileData_methods.get_transpose.m_call = cast(type_of(TileData_methods.get_transpose.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileData_methods.set_material.m_call = cast(type_of(TileData_methods.set_material.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileData_methods.get_material.m_call = cast(type_of(TileData_methods.get_material.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileData_methods.set_texture_origin.m_call = cast(type_of(TileData_methods.set_texture_origin.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileData_methods.get_texture_origin.m_call = cast(type_of(TileData_methods.get_texture_origin.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileData_methods.set_modulate.m_call = cast(type_of(TileData_methods.set_modulate.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileData_methods.get_modulate.m_call = cast(type_of(TileData_methods.get_modulate.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileData_methods.set_z_index.m_call = cast(type_of(TileData_methods.set_z_index.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileData_methods.get_z_index.m_call = cast(type_of(TileData_methods.get_z_index.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileData_methods.set_y_sort_origin.m_call = cast(type_of(TileData_methods.set_y_sort_origin.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileData_methods.get_y_sort_origin.m_call = cast(type_of(TileData_methods.get_y_sort_origin.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileData_methods.set_occluder_polygons_count.m_call = cast(type_of(TileData_methods.set_occluder_polygons_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileData_methods.get_occluder_polygons_count.m_call = cast(type_of(TileData_methods.get_occluder_polygons_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileData_methods.add_occluder_polygon.m_call = cast(type_of(TileData_methods.add_occluder_polygon.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileData_methods.remove_occluder_polygon.m_call = cast(type_of(TileData_methods.remove_occluder_polygon.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileData_methods.set_occluder_polygon.m_call = cast(type_of(TileData_methods.set_occluder_polygon.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileData_methods.get_occluder_polygon.m_call = cast(type_of(TileData_methods.get_occluder_polygon.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileData_methods.set_occluder.m_call = cast(type_of(TileData_methods.set_occluder.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileData_methods.get_occluder.m_call = cast(type_of(TileData_methods.get_occluder.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileData_methods.set_constant_linear_velocity.m_call = cast(type_of(TileData_methods.set_constant_linear_velocity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileData_methods.get_constant_linear_velocity.m_call = cast(type_of(TileData_methods.get_constant_linear_velocity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileData_methods.set_constant_angular_velocity.m_call = cast(type_of(TileData_methods.set_constant_angular_velocity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileData_methods.get_constant_angular_velocity.m_call = cast(type_of(TileData_methods.get_constant_angular_velocity.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileData_methods.set_collision_polygons_count.m_call = cast(type_of(TileData_methods.set_collision_polygons_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileData_methods.get_collision_polygons_count.m_call = cast(type_of(TileData_methods.get_collision_polygons_count.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileData_methods.add_collision_polygon.m_call = cast(type_of(TileData_methods.add_collision_polygon.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileData_methods.remove_collision_polygon.m_call = cast(type_of(TileData_methods.remove_collision_polygon.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileData_methods.set_collision_polygon_points.m_call = cast(type_of(TileData_methods.set_collision_polygon_points.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileData_methods.get_collision_polygon_points.m_call = cast(type_of(TileData_methods.get_collision_polygon_points.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileData_methods.set_collision_polygon_one_way.m_call = cast(type_of(TileData_methods.set_collision_polygon_one_way.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileData_methods.is_collision_polygon_one_way.m_call = cast(type_of(TileData_methods.is_collision_polygon_one_way.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileData_methods.set_collision_polygon_one_way_margin.m_call = cast(type_of(TileData_methods.set_collision_polygon_one_way_margin.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileData_methods.get_collision_polygon_one_way_margin.m_call = cast(type_of(TileData_methods.get_collision_polygon_one_way_margin.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileData_methods.set_terrain_set.m_call = cast(type_of(TileData_methods.set_terrain_set.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileData_methods.get_terrain_set.m_call = cast(type_of(TileData_methods.get_terrain_set.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileData_methods.set_terrain.m_call = cast(type_of(TileData_methods.set_terrain.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileData_methods.get_terrain.m_call = cast(type_of(TileData_methods.get_terrain.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileData_methods.set_terrain_peering_bit.m_call = cast(type_of(TileData_methods.set_terrain_peering_bit.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileData_methods.get_terrain_peering_bit.m_call = cast(type_of(TileData_methods.get_terrain_peering_bit.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileData_methods.is_valid_terrain_peering_bit.m_call = cast(type_of(TileData_methods.is_valid_terrain_peering_bit.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileData_methods.set_navigation_polygon.m_call = cast(type_of(TileData_methods.set_navigation_polygon.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileData_methods.get_navigation_polygon.m_call = cast(type_of(TileData_methods.get_navigation_polygon.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileData_methods.set_probability.m_call = cast(type_of(TileData_methods.set_probability.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileData_methods.get_probability.m_call = cast(type_of(TileData_methods.get_probability.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileData_methods.set_custom_data.m_call = cast(type_of(TileData_methods.set_custom_data.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileData_methods.get_custom_data.m_call = cast(type_of(TileData_methods.get_custom_data.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileData_methods.has_custom_data.m_call = cast(type_of(TileData_methods.has_custom_data.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileData_methods.set_custom_data_by_layer_id.m_call = cast(type_of(TileData_methods.set_custom_data_by_layer_id.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  TileData_methods.get_custom_data_by_layer_id.m_call = cast(type_of(TileData_methods.get_custom_data_by_layer_id.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
