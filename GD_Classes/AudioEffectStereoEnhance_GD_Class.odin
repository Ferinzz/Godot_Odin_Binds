...
AudioEffectStereoEnhance_MethodBind_List :: struct {
  set_pan_pullout: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: AudioEffectStereoEnhance, #by_ptr args: struct{amount: ^GDW.float, }, r_ret: rawptr = nil)
  },
    get_pan_pullout: struct{
    using _get_pan_pullout: ^GDW.MethodBind,
    m_call: proc "c" (_:^GDW.MethodBind, obj: AudioEffectStereoEnhance, args: rawptr = nil, r_ret: ^GDW.float)
  },
...
AudioEffectStereoEnhance_Init_ :: proc (AudioEffectStereoEnhance_methods: ^AudioEffectStereoEnhance_MethodBind_List, loc := #caller_location) {
  ...
  AudioEffectStereoEnhance_methods.set_pan_pullout._set_pan_pullout = (cast(^GDW.MethodBind)classDBGetMethodBind3(.AudioEffectStereoEnhance, "set_pan_pullout", 373806689, loc))
  ...
  AudioEffectStereoEnhance_methods.get_pan_pullout._get_pan_pullout = (cast(^GDW.MethodBind)classDBGetMethodBind3(.AudioEffectStereoEnhance, "get_pan_pullout", 1740695150, loc))
  ...
  AudioEffectStereoEnhance_methods.set_time_pullout._set_time_pullout = (cast(^GDW.MethodBind)classDBGetMethodBind3(.AudioEffectStereoEnhance, "set_time_pullout", 373806689, loc))
  ...
  AudioEffectStereoEnhance_methods.get_time_pullout._get_time_pullout = (cast(^GDW.MethodBind)classDBGetMethodBind3(.AudioEffectStereoEnhance, "get_time_pullout", 1740695150, loc))
  ...
  AudioEffectStereoEnhance_methods.set_surround._set_surround = (cast(^GDW.MethodBind)classDBGetMethodBind3(.AudioEffectStereoEnhance, "set_surround", 373806689, loc))
  ...
  AudioEffectStereoEnhance_methods.get_surround._get_surround = (cast(^GDW.MethodBind)classDBGetMethodBind3(.AudioEffectStereoEnhance, "get_surround", 1740695150, loc))
