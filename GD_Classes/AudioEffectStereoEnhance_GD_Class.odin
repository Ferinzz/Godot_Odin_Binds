...
AudioEffectStereoEnhance_Init_ :: proc (AudioEffectStereoEnhance_methods: ^AudioEffectStereoEnhance_MethodBind_List, loc := #caller_location) {
  ...
  AudioEffectStereoEnhance_methods.set_pan_pullout.m_call = cast(type_of(AudioEffectStereoEnhance_methods.set_pan_pullout.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioEffectStereoEnhance_methods.get_pan_pullout.m_call = cast(type_of(AudioEffectStereoEnhance_methods.get_pan_pullout.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioEffectStereoEnhance_methods.set_time_pullout.m_call = cast(type_of(AudioEffectStereoEnhance_methods.set_time_pullout.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioEffectStereoEnhance_methods.get_time_pullout.m_call = cast(type_of(AudioEffectStereoEnhance_methods.get_time_pullout.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioEffectStereoEnhance_methods.set_surround.m_call = cast(type_of(AudioEffectStereoEnhance_methods.set_surround.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioEffectStereoEnhance_methods.get_surround.m_call = cast(type_of(AudioEffectStereoEnhance_methods.get_surround.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
