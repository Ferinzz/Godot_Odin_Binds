...
SkeletonModification2DFABRIK_Init_ :: proc (SkeletonModification2DFABRIK_methods: ^SkeletonModification2DFABRIK_MethodBind_List, loc := #caller_location) {
  ...
  SkeletonModification2DFABRIK_methods.set_target_node.m_call = cast(type_of(SkeletonModification2DFABRIK_methods.set_target_node.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DFABRIK_methods.get_target_node.m_call = cast(type_of(SkeletonModification2DFABRIK_methods.get_target_node.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DFABRIK_methods.set_fabrik_data_chain_length.m_call = cast(type_of(SkeletonModification2DFABRIK_methods.set_fabrik_data_chain_length.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DFABRIK_methods.get_fabrik_data_chain_length.m_call = cast(type_of(SkeletonModification2DFABRIK_methods.get_fabrik_data_chain_length.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DFABRIK_methods.set_fabrik_joint_bone2d_node.m_call = cast(type_of(SkeletonModification2DFABRIK_methods.set_fabrik_joint_bone2d_node.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DFABRIK_methods.get_fabrik_joint_bone2d_node.m_call = cast(type_of(SkeletonModification2DFABRIK_methods.get_fabrik_joint_bone2d_node.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DFABRIK_methods.set_fabrik_joint_bone_index.m_call = cast(type_of(SkeletonModification2DFABRIK_methods.set_fabrik_joint_bone_index.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DFABRIK_methods.get_fabrik_joint_bone_index.m_call = cast(type_of(SkeletonModification2DFABRIK_methods.get_fabrik_joint_bone_index.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DFABRIK_methods.set_fabrik_joint_magnet_position.m_call = cast(type_of(SkeletonModification2DFABRIK_methods.set_fabrik_joint_magnet_position.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DFABRIK_methods.get_fabrik_joint_magnet_position.m_call = cast(type_of(SkeletonModification2DFABRIK_methods.get_fabrik_joint_magnet_position.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DFABRIK_methods.set_fabrik_joint_use_target_rotation.m_call = cast(type_of(SkeletonModification2DFABRIK_methods.set_fabrik_joint_use_target_rotation.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  SkeletonModification2DFABRIK_methods.get_fabrik_joint_use_target_rotation.m_call = cast(type_of(SkeletonModification2DFABRIK_methods.get_fabrik_joint_use_target_rotation.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
