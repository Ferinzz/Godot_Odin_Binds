...
ConcavePolygonShape2D_MethodBind_List :: struct {
  set_segments: ^GDW.MethodBind,
  get_segments: ^GDW.MethodBind,
};
ConcavePolygonShape2D_Init_ :: proc (ConcavePolygonShape2D_methods: ^ConcavePolygonShape2D_MethodBind_List, loc := #caller_location) {
  ConcavePolygonShape2D_methods.set_segments = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.ConcavePolygonShape2D, "set_segments", 1509147220, loc))
  ConcavePolygonShape2D_methods.get_segments = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.ConcavePolygonShape2D, "get_segments", 2961356807, loc))
};
