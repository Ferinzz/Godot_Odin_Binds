...
BoneAttachment3D_Init_ :: proc (BoneAttachment3D_methods: ^BoneAttachment3D_MethodBind_List, loc := #caller_location) {
  ...
  BoneAttachment3D_methods.get_skeleton.m_call = cast(type_of(BoneAttachment3D_methods.get_skeleton.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BoneAttachment3D_methods.set_bone_name.m_call = cast(type_of(BoneAttachment3D_methods.set_bone_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BoneAttachment3D_methods.get_bone_name.m_call = cast(type_of(BoneAttachment3D_methods.get_bone_name.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BoneAttachment3D_methods.set_bone_idx.m_call = cast(type_of(BoneAttachment3D_methods.set_bone_idx.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BoneAttachment3D_methods.get_bone_idx.m_call = cast(type_of(BoneAttachment3D_methods.get_bone_idx.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BoneAttachment3D_methods.on_skeleton_update.m_call = cast(type_of(BoneAttachment3D_methods.on_skeleton_update.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BoneAttachment3D_methods.set_override_pose.m_call = cast(type_of(BoneAttachment3D_methods.set_override_pose.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BoneAttachment3D_methods.get_override_pose.m_call = cast(type_of(BoneAttachment3D_methods.get_override_pose.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BoneAttachment3D_methods.set_use_external_skeleton.m_call = cast(type_of(BoneAttachment3D_methods.set_use_external_skeleton.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BoneAttachment3D_methods.get_use_external_skeleton.m_call = cast(type_of(BoneAttachment3D_methods.get_use_external_skeleton.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BoneAttachment3D_methods.set_external_skeleton.m_call = cast(type_of(BoneAttachment3D_methods.set_external_skeleton.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  BoneAttachment3D_methods.get_external_skeleton.m_call = cast(type_of(BoneAttachment3D_methods.get_external_skeleton.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
