...
ImageTexture_Init_ :: proc (ImageTexture_methods: ^ImageTexture_MethodBind_List, loc := #caller_location) {
  ...
  ImageTexture_methods.create_from_image.m_call = cast(type_of(ImageTexture_methods.create_from_image.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ImageTexture_methods.get_format.m_call = cast(type_of(ImageTexture_methods.get_format.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ImageTexture_methods.set_image.m_call = cast(type_of(ImageTexture_methods.set_image.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ImageTexture_methods.update._update = (cast(^GDW.MethodBind)GDW.classDBGetMethodBind3(.ImageTexture, "update", 532598488, loc))
  ImageTexture_methods.update.m_call = cast(type_of(ImageTexture_methods.update.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  ImageTexture_methods.set_size_override.m_call = cast(type_of(ImageTexture_methods.set_size_override.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
