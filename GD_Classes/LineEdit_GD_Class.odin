...
LineEdit_MethodBind_List :: struct {
  has_ime_text: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: LineEdit, args: rawptr = nil, r_ret: ^GDW.Bool)
  },
  cancel_ime: struct{
    using _cancel_ime: ^GDW.MethodBind,
    m_call: proc "c" (_:^GDW.MethodBind, obj: LineEdit, args: rawptr = nil, r_ret: rawptr = nil)
  },
    apply_ime: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: LineEdit, #by_ptr args: struct{alignment: ^GDW.HorizontalAlignment, }, r_ret: rawptr = nil)
  },
    get_horizontal_alignment: struct{
    using _get_horizontal_alignment: ^GDW.MethodBind,
    m_call: proc "c" (_:^GDW.MethodBind, obj: LineEdit, args: rawptr = nil, r_ret: ^GDW.HorizontalAlignment)
  },
  edit: struct{
    using _edit: ^GDW.MethodBind,
    m_call: proc "c" (_:^GDW.MethodBind, obj: LineEdit, #by_ptr args: struct{hide_focus: ^GDW.Bool, }, r_ret: rawptr = nil)
  },
    unedit: struct{
  ...
  set_keep_editing_on_text_submit: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: LineEdit, #by_ptr args: struct{enable: ^GDW.Bool, }, r_ret: rawptr = nil)
  },
  ...
  clear: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: LineEdit, #by_ptr args: struct{from: ^GDW.Int, to: ^GDW.Int, }, r_ret: rawptr = nil)
  },
    select_all: struct{
  ...
  get_selected_text: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: LineEdit, args: rawptr = nil, r_ret: ^GDW.gdstring)
  },
  get_selection_from_column: struct{
    using _get_selection_from_column: ^GDW.MethodBind,
    m_call: proc "c" (_:^GDW.MethodBind, obj: LineEdit, args: rawptr = nil, r_ret: ^GDW.Int)
  },
  ...
  set_text: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: LineEdit, #by_ptr args: struct{text: ^GDW.gdstring, }, r_ret: rawptr = nil)
  },
    get_text: struct{
  ...
  set_draw_control_chars: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: LineEdit, #by_ptr args: struct{direction: ^Control_TextDirection, }, r_ret: rawptr = nil)
  },
    get_text_direction: struct{
    using _get_text_direction: ^GDW.MethodBind,
    m_call: proc "c" (_:^GDW.MethodBind, obj: LineEdit, args: rawptr = nil, r_ret: ^Control_TextDirection)
  },
  set_language: struct{
    using _set_language: ^GDW.MethodBind,
    m_call: proc "c" (_:^GDW.MethodBind, obj: LineEdit, #by_ptr args: struct{language: ^GDW.gdstring, }, r_ret: rawptr = nil)
  },
    get_language: struct{
  ...
  set_structured_text_bidi_override: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: LineEdit, #by_ptr args: struct{parser: ^TextServer_StructuredTextParser, }, r_ret: rawptr = nil)
  },
    get_structured_text_bidi_override: struct{
    using _get_structured_text_bidi_override: ^GDW.MethodBind,
    m_call: proc "c" (_:^GDW.MethodBind, obj: LineEdit, args: rawptr = nil, r_ret: ^TextServer_StructuredTextParser)
  },
  set_structured_text_bidi_override_options: struct{
    using _set_structured_text_bidi_override_options: ^GDW.MethodBind,
    m_call: proc "c" (_:^GDW.MethodBind, obj: LineEdit, #by_ptr args: struct{args: ^GDW.Array, }, r_ret: rawptr = nil)
  },
    get_structured_text_bidi_override_options: struct{
    using _get_structured_text_bidi_override_options: ^GDW.MethodBind,
    m_call: proc "c" (_:^GDW.MethodBind, obj: LineEdit, args: rawptr = nil, r_ret: ^GDW.Array)
  },
  ...
  set_caret_column: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: LineEdit, #by_ptr args: struct{position: ^GDW.Int, }, r_ret: rawptr = nil)
  },
  ...
  get_next_composite_character_column: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: LineEdit, #by_ptr args: struct{column: ^GDW.Int, }, r_ret: ^GDW.Int)
  },
  ...
  get_scroll_offset: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: LineEdit, args: rawptr = nil, r_ret: ^GDW.float)
  },
  set_expand_to_text_length_enabled: struct{
    using _set_expand_to_text_length_enabled: ^GDW.MethodBind,
    m_call: proc "c" (_:^GDW.MethodBind, obj: LineEdit, #by_ptr args: struct{enabled: ^GDW.Bool, }, r_ret: rawptr = nil)
  },
  ...
  set_caret_blink_interval: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: LineEdit, #by_ptr args: struct{interval: ^GDW.float, }, r_ret: rawptr = nil)
  },
  ...
  set_max_length: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: LineEdit, #by_ptr args: struct{chars: ^GDW.Int, }, r_ret: rawptr = nil)
  },
  ...
  insert_text_at_caret: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: LineEdit, #by_ptr args: struct{from_column: ^GDW.Int, to_column: ^GDW.Int, }, r_ret: rawptr = nil)
  },
    set_editable: struct{
  ...
  set_secret_character: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: LineEdit, #by_ptr args: struct{character: ^GDW.gdstring, }, r_ret: rawptr = nil)
  },
  ...
  menu_option: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: LineEdit, #by_ptr args: struct{option: ^GDW.Int, }, r_ret: rawptr = nil)
  },
    get_menu: struct{
    using _get_menu: ^GDW.MethodBind,
    m_call: proc "c" (_:^GDW.MethodBind, obj: LineEdit, args: rawptr = nil, r_ret: ^PopupMenu)
  },
  ...
  set_virtual_keyboard_show_on_focus: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: LineEdit, #by_ptr args: struct{show_on_focus: ^GDW.Bool, }, r_ret: rawptr = nil)
  },
  ...
  set_virtual_keyboard_type: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: LineEdit, #by_ptr args: struct{type: ^LineEdit_VirtualKeyboardType, }, r_ret: rawptr = nil)
  },
    get_virtual_keyboard_type: struct{
    using _get_virtual_keyboard_type: ^GDW.MethodBind,
    m_call: proc "c" (_:^GDW.MethodBind, obj: LineEdit, args: rawptr = nil, r_ret: ^LineEdit_VirtualKeyboardType)
  },
  ...
  set_right_icon: struct{
    ...
    m_call: proc "c" (_:^GDW.MethodBind, obj: LineEdit, #by_ptr args: struct{icon: ^Texture2D, }, r_ret: rawptr = nil)
  },
    get_right_icon: struct{
    using _get_right_icon: ^GDW.MethodBind,
    m_call: proc "c" (_:^GDW.MethodBind, obj: LineEdit, args: rawptr = nil, r_ret: ^Texture2D)
  },
  set_icon_expand_mode: struct{
    using _set_icon_expand_mode: ^GDW.MethodBind,
    m_call: proc "c" (_:^GDW.MethodBind, obj: LineEdit, #by_ptr args: struct{mode: ^LineEdit_ExpandMode, }, r_ret: rawptr = nil)
  },
    get_icon_expand_mode: struct{
    using _get_icon_expand_mode: ^GDW.MethodBind,
    m_call: proc "c" (_:^GDW.MethodBind, obj: LineEdit, args: rawptr = nil, r_ret: ^LineEdit_ExpandMode)
  },
  set_right_icon_scale: struct{
    using _set_right_icon_scale: ^GDW.MethodBind,
    m_call: proc "c" (_:^GDW.MethodBind, obj: LineEdit, #by_ptr args: struct{scale: ^GDW.float, }, r_ret: rawptr = nil)
  },
...
LineEdit_Init_ :: proc (LineEdit_methods: ^LineEdit_MethodBind_List, loc := #caller_location) {
  ...
  LineEdit_methods.has_ime_text._has_ime_text = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "has_ime_text", 36873697, loc))
  LineEdit_methods.has_ime_text.m_call = cast(type_of(LineEdit_methods.has_ime_text.m_call))MB_ptr_call
  LineEdit_methods.cancel_ime._cancel_ime = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "cancel_ime", 3218959716, loc))
  LineEdit_methods.cancel_ime.m_call = cast(type_of(LineEdit_methods.cancel_ime.m_call))MB_ptr_call
  LineEdit_methods.apply_ime._apply_ime = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "apply_ime", 3218959716, loc))
  LineEdit_methods.apply_ime.m_call = cast(type_of(LineEdit_methods.apply_ime.m_call))MB_ptr_call
  LineEdit_methods.set_horizontal_alignment._set_horizontal_alignment = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "set_horizontal_alignment", 2312603777, loc))
  ...
  LineEdit_methods.get_horizontal_alignment._get_horizontal_alignment = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "get_horizontal_alignment", 341400642, loc))
  ...
  LineEdit_methods.edit._edit = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "edit", 107499316, loc))
  LineEdit_methods.edit.m_call = cast(type_of(LineEdit_methods.edit.m_call))MB_ptr_call
  LineEdit_methods.unedit._unedit = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "unedit", 3218959716, loc))
  LineEdit_methods.unedit.m_call = cast(type_of(LineEdit_methods.unedit.m_call))MB_ptr_call
  LineEdit_methods.is_editing._is_editing = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "is_editing", 36873697, loc))
  LineEdit_methods.is_editing.m_call = cast(type_of(LineEdit_methods.is_editing.m_call))MB_ptr_call
  LineEdit_methods.set_keep_editing_on_text_submit._set_keep_editing_on_text_submit = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "set_keep_editing_on_text_submit", 2586408642, loc))
  ...
  LineEdit_methods.is_editing_kept_on_text_submit._is_editing_kept_on_text_submit = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "is_editing_kept_on_text_submit", 36873697, loc))
  ...
  LineEdit_methods.clear._clear = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "clear", 3218959716, loc))
  LineEdit_methods.clear.m_call = cast(type_of(LineEdit_methods.clear.m_call))MB_ptr_call
  LineEdit_methods.select._select = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "select", 1328111411, loc))
  LineEdit_methods.select.m_call = cast(type_of(LineEdit_methods.select.m_call))MB_ptr_call
  LineEdit_methods.select_all._select_all = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "select_all", 3218959716, loc))
  LineEdit_methods.select_all.m_call = cast(type_of(LineEdit_methods.select_all.m_call))MB_ptr_call
  LineEdit_methods.deselect._deselect = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "deselect", 3218959716, loc))
  LineEdit_methods.deselect.m_call = cast(type_of(LineEdit_methods.deselect.m_call))MB_ptr_call
  LineEdit_methods.has_undo._has_undo = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "has_undo", 36873697, loc))
  LineEdit_methods.has_undo.m_call = cast(type_of(LineEdit_methods.has_undo.m_call))MB_ptr_call
  LineEdit_methods.has_redo._has_redo = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "has_redo", 36873697, loc))
  LineEdit_methods.has_redo.m_call = cast(type_of(LineEdit_methods.has_redo.m_call))MB_ptr_call
  LineEdit_methods.has_selection._has_selection = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "has_selection", 36873697, loc))
  LineEdit_methods.has_selection.m_call = cast(type_of(LineEdit_methods.has_selection.m_call))MB_ptr_call
  LineEdit_methods.get_selected_text._get_selected_text = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "get_selected_text", 2841200299, loc))
  LineEdit_methods.get_selected_text.m_call = cast(type_of(LineEdit_methods.get_selected_text.m_call))MB_ptr_call
  LineEdit_methods.get_selection_from_column._get_selection_from_column = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "get_selection_from_column", 3905245786, loc))
  ...
  LineEdit_methods.get_selection_to_column._get_selection_to_column = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "get_selection_to_column", 3905245786, loc))
  LineEdit_methods.get_selection_to_column.m_call = cast(type_of(LineEdit_methods.get_selection_to_column.m_call))MB_ptr_call
  LineEdit_methods.set_text._set_text = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "set_text", 83702148, loc))
  LineEdit_methods.set_text.m_call = cast(type_of(LineEdit_methods.set_text.m_call))MB_ptr_call
  LineEdit_methods.get_text._get_text = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "get_text", 201670096, loc))
  LineEdit_methods.get_text.m_call = cast(type_of(LineEdit_methods.get_text.m_call))MB_ptr_call
  LineEdit_methods.get_draw_control_chars._get_draw_control_chars = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "get_draw_control_chars", 36873697, loc))
  LineEdit_methods.get_draw_control_chars.m_call = cast(type_of(LineEdit_methods.get_draw_control_chars.m_call))MB_ptr_call
  LineEdit_methods.set_draw_control_chars._set_draw_control_chars = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "set_draw_control_chars", 2586408642, loc))
  LineEdit_methods.set_draw_control_chars.m_call = cast(type_of(LineEdit_methods.set_draw_control_chars.m_call))MB_ptr_call
  LineEdit_methods.set_text_direction._set_text_direction = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "set_text_direction", 119160795, loc))
  LineEdit_methods.set_text_direction.m_call = cast(type_of(LineEdit_methods.set_text_direction.m_call))MB_ptr_call
  LineEdit_methods.get_text_direction._get_text_direction = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "get_text_direction", 797257663, loc))
  LineEdit_methods.get_text_direction.m_call = cast(type_of(LineEdit_methods.get_text_direction.m_call))MB_ptr_call
  LineEdit_methods.set_language._set_language = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "set_language", 83702148, loc))
  LineEdit_methods.set_language.m_call = cast(type_of(LineEdit_methods.set_language.m_call))MB_ptr_call
  LineEdit_methods.get_language._get_language = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "get_language", 201670096, loc))
  LineEdit_methods.get_language.m_call = cast(type_of(LineEdit_methods.get_language.m_call))MB_ptr_call
  LineEdit_methods.set_structured_text_bidi_override._set_structured_text_bidi_override = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "set_structured_text_bidi_override", 55961453, loc))
  ...
  LineEdit_methods.get_structured_text_bidi_override._get_structured_text_bidi_override = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "get_structured_text_bidi_override", 3385126229, loc))
  ...
  LineEdit_methods.set_structured_text_bidi_override_options._set_structured_text_bidi_override_options = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "set_structured_text_bidi_override_options", 381264803, loc))
  ...
  LineEdit_methods.get_structured_text_bidi_override_options._get_structured_text_bidi_override_options = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "get_structured_text_bidi_override_options", 3995934104, loc))
  ...
  LineEdit_methods.set_placeholder._set_placeholder = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "set_placeholder", 83702148, loc))
  LineEdit_methods.set_placeholder.m_call = cast(type_of(LineEdit_methods.set_placeholder.m_call))MB_ptr_call
  LineEdit_methods.get_placeholder._get_placeholder = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "get_placeholder", 201670096, loc))
  LineEdit_methods.get_placeholder.m_call = cast(type_of(LineEdit_methods.get_placeholder.m_call))MB_ptr_call
  LineEdit_methods.set_caret_column._set_caret_column = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "set_caret_column", 1286410249, loc))
  LineEdit_methods.set_caret_column.m_call = cast(type_of(LineEdit_methods.set_caret_column.m_call))MB_ptr_call
  LineEdit_methods.get_caret_column._get_caret_column = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "get_caret_column", 3905245786, loc))
  LineEdit_methods.get_caret_column.m_call = cast(type_of(LineEdit_methods.get_caret_column.m_call))MB_ptr_call
  LineEdit_methods.get_next_composite_character_column._get_next_composite_character_column = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "get_next_composite_character_column", 923996154, loc))
  ...
  LineEdit_methods.get_previous_composite_character_column._get_previous_composite_character_column = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "get_previous_composite_character_column", 923996154, loc))
  ...
  LineEdit_methods.get_scroll_offset._get_scroll_offset = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "get_scroll_offset", 1740695150, loc))
  LineEdit_methods.get_scroll_offset.m_call = cast(type_of(LineEdit_methods.get_scroll_offset.m_call))MB_ptr_call
  LineEdit_methods.set_expand_to_text_length_enabled._set_expand_to_text_length_enabled = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "set_expand_to_text_length_enabled", 2586408642, loc))
  ...
  LineEdit_methods.is_expand_to_text_length_enabled._is_expand_to_text_length_enabled = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "is_expand_to_text_length_enabled", 36873697, loc))
  ...
  LineEdit_methods.set_caret_blink_enabled._set_caret_blink_enabled = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "set_caret_blink_enabled", 2586408642, loc))
  LineEdit_methods.set_caret_blink_enabled.m_call = cast(type_of(LineEdit_methods.set_caret_blink_enabled.m_call))MB_ptr_call
  LineEdit_methods.is_caret_blink_enabled._is_caret_blink_enabled = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "is_caret_blink_enabled", 36873697, loc))
  LineEdit_methods.is_caret_blink_enabled.m_call = cast(type_of(LineEdit_methods.is_caret_blink_enabled.m_call))MB_ptr_call
  LineEdit_methods.set_caret_mid_grapheme_enabled._set_caret_mid_grapheme_enabled = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "set_caret_mid_grapheme_enabled", 2586408642, loc))
  ...
  LineEdit_methods.is_caret_mid_grapheme_enabled._is_caret_mid_grapheme_enabled = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "is_caret_mid_grapheme_enabled", 36873697, loc))
  ...
  LineEdit_methods.set_caret_force_displayed._set_caret_force_displayed = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "set_caret_force_displayed", 2586408642, loc))
  ...
  LineEdit_methods.is_caret_force_displayed._is_caret_force_displayed = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "is_caret_force_displayed", 36873697, loc))
  ...
  LineEdit_methods.set_caret_blink_interval._set_caret_blink_interval = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "set_caret_blink_interval", 373806689, loc))
  ...
  LineEdit_methods.get_caret_blink_interval._get_caret_blink_interval = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "get_caret_blink_interval", 1740695150, loc))
  ...
  LineEdit_methods.set_max_length._set_max_length = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "set_max_length", 1286410249, loc))
  LineEdit_methods.set_max_length.m_call = cast(type_of(LineEdit_methods.set_max_length.m_call))MB_ptr_call
  LineEdit_methods.get_max_length._get_max_length = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "get_max_length", 3905245786, loc))
  LineEdit_methods.get_max_length.m_call = cast(type_of(LineEdit_methods.get_max_length.m_call))MB_ptr_call
  LineEdit_methods.insert_text_at_caret._insert_text_at_caret = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "insert_text_at_caret", 83702148, loc))
  LineEdit_methods.insert_text_at_caret.m_call = cast(type_of(LineEdit_methods.insert_text_at_caret.m_call))MB_ptr_call
  LineEdit_methods.delete_char_at_caret._delete_char_at_caret = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "delete_char_at_caret", 3218959716, loc))
  LineEdit_methods.delete_char_at_caret.m_call = cast(type_of(LineEdit_methods.delete_char_at_caret.m_call))MB_ptr_call
  LineEdit_methods.delete_text._delete_text = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "delete_text", 3937882851, loc))
  LineEdit_methods.delete_text.m_call = cast(type_of(LineEdit_methods.delete_text.m_call))MB_ptr_call
  LineEdit_methods.set_editable._set_editable = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "set_editable", 2586408642, loc))
  LineEdit_methods.set_editable.m_call = cast(type_of(LineEdit_methods.set_editable.m_call))MB_ptr_call
  LineEdit_methods.is_editable._is_editable = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "is_editable", 36873697, loc))
  LineEdit_methods.is_editable.m_call = cast(type_of(LineEdit_methods.is_editable.m_call))MB_ptr_call
  LineEdit_methods.set_secret._set_secret = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "set_secret", 2586408642, loc))
  LineEdit_methods.set_secret.m_call = cast(type_of(LineEdit_methods.set_secret.m_call))MB_ptr_call
  LineEdit_methods.is_secret._is_secret = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "is_secret", 36873697, loc))
  LineEdit_methods.is_secret.m_call = cast(type_of(LineEdit_methods.is_secret.m_call))MB_ptr_call
  LineEdit_methods.set_secret_character._set_secret_character = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "set_secret_character", 83702148, loc))
  LineEdit_methods.set_secret_character.m_call = cast(type_of(LineEdit_methods.set_secret_character.m_call))MB_ptr_call
  LineEdit_methods.get_secret_character._get_secret_character = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "get_secret_character", 201670096, loc))
  LineEdit_methods.get_secret_character.m_call = cast(type_of(LineEdit_methods.get_secret_character.m_call))MB_ptr_call
  LineEdit_methods.menu_option._menu_option = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "menu_option", 1286410249, loc))
  LineEdit_methods.menu_option.m_call = cast(type_of(LineEdit_methods.menu_option.m_call))MB_ptr_call
  LineEdit_methods.get_menu._get_menu = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "get_menu", 229722558, loc))
  LineEdit_methods.get_menu.m_call = cast(type_of(LineEdit_methods.get_menu.m_call))MB_ptr_call
  LineEdit_methods.is_menu_visible._is_menu_visible = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "is_menu_visible", 36873697, loc))
  LineEdit_methods.is_menu_visible.m_call = cast(type_of(LineEdit_methods.is_menu_visible.m_call))MB_ptr_call
  LineEdit_methods.set_context_menu_enabled._set_context_menu_enabled = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "set_context_menu_enabled", 2586408642, loc))
  ...
  LineEdit_methods.is_context_menu_enabled._is_context_menu_enabled = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "is_context_menu_enabled", 2240911060, loc))
  LineEdit_methods.is_context_menu_enabled.m_call = cast(type_of(LineEdit_methods.is_context_menu_enabled.m_call))MB_ptr_call
  LineEdit_methods.set_emoji_menu_enabled._set_emoji_menu_enabled = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "set_emoji_menu_enabled", 2586408642, loc))
  LineEdit_methods.set_emoji_menu_enabled.m_call = cast(type_of(LineEdit_methods.set_emoji_menu_enabled.m_call))MB_ptr_call
  LineEdit_methods.is_emoji_menu_enabled._is_emoji_menu_enabled = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "is_emoji_menu_enabled", 36873697, loc))
  LineEdit_methods.is_emoji_menu_enabled.m_call = cast(type_of(LineEdit_methods.is_emoji_menu_enabled.m_call))MB_ptr_call
  LineEdit_methods.set_backspace_deletes_composite_character_enabled._set_backspace_deletes_composite_character_enabled = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "set_backspace_deletes_composite_character_enabled", 2586408642, loc))
  ...
  LineEdit_methods.is_backspace_deletes_composite_character_enabled._is_backspace_deletes_composite_character_enabled = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "is_backspace_deletes_composite_character_enabled", 36873697, loc))
  ...
  LineEdit_methods.set_virtual_keyboard_enabled._set_virtual_keyboard_enabled = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "set_virtual_keyboard_enabled", 2586408642, loc))
  ...
  LineEdit_methods.is_virtual_keyboard_enabled._is_virtual_keyboard_enabled = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "is_virtual_keyboard_enabled", 36873697, loc))
  ...
  LineEdit_methods.set_virtual_keyboard_show_on_focus._set_virtual_keyboard_show_on_focus = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "set_virtual_keyboard_show_on_focus", 2586408642, loc))
  ...
  LineEdit_methods.get_virtual_keyboard_show_on_focus._get_virtual_keyboard_show_on_focus = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "get_virtual_keyboard_show_on_focus", 36873697, loc))
  ...
  LineEdit_methods.set_virtual_keyboard_type._set_virtual_keyboard_type = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "set_virtual_keyboard_type", 2696893573, loc))
  ...
  LineEdit_methods.get_virtual_keyboard_type._get_virtual_keyboard_type = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "get_virtual_keyboard_type", 1928699316, loc))
  ...
  LineEdit_methods.set_clear_button_enabled._set_clear_button_enabled = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "set_clear_button_enabled", 2586408642, loc))
  ...
  LineEdit_methods.is_clear_button_enabled._is_clear_button_enabled = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "is_clear_button_enabled", 36873697, loc))
  LineEdit_methods.is_clear_button_enabled.m_call = cast(type_of(LineEdit_methods.is_clear_button_enabled.m_call))MB_ptr_call
  LineEdit_methods.set_shortcut_keys_enabled._set_shortcut_keys_enabled = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "set_shortcut_keys_enabled", 2586408642, loc))
  ...
  LineEdit_methods.is_shortcut_keys_enabled._is_shortcut_keys_enabled = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "is_shortcut_keys_enabled", 36873697, loc))
  ...
  LineEdit_methods.set_middle_mouse_paste_enabled._set_middle_mouse_paste_enabled = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "set_middle_mouse_paste_enabled", 2586408642, loc))
  ...
  LineEdit_methods.is_middle_mouse_paste_enabled._is_middle_mouse_paste_enabled = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "is_middle_mouse_paste_enabled", 36873697, loc))
  ...
  LineEdit_methods.set_selecting_enabled._set_selecting_enabled = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "set_selecting_enabled", 2586408642, loc))
  LineEdit_methods.set_selecting_enabled.m_call = cast(type_of(LineEdit_methods.set_selecting_enabled.m_call))MB_ptr_call
  LineEdit_methods.is_selecting_enabled._is_selecting_enabled = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "is_selecting_enabled", 36873697, loc))
  LineEdit_methods.is_selecting_enabled.m_call = cast(type_of(LineEdit_methods.is_selecting_enabled.m_call))MB_ptr_call
  LineEdit_methods.set_deselect_on_focus_loss_enabled._set_deselect_on_focus_loss_enabled = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "set_deselect_on_focus_loss_enabled", 2586408642, loc))
  ...
  LineEdit_methods.is_deselect_on_focus_loss_enabled._is_deselect_on_focus_loss_enabled = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "is_deselect_on_focus_loss_enabled", 36873697, loc))
  ...
  LineEdit_methods.set_drag_and_drop_selection_enabled._set_drag_and_drop_selection_enabled = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "set_drag_and_drop_selection_enabled", 2586408642, loc))
  ...
  LineEdit_methods.is_drag_and_drop_selection_enabled._is_drag_and_drop_selection_enabled = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "is_drag_and_drop_selection_enabled", 36873697, loc))
  ...
  LineEdit_methods.set_right_icon._set_right_icon = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "set_right_icon", 4051416890, loc))
  LineEdit_methods.set_right_icon.m_call = cast(type_of(LineEdit_methods.set_right_icon.m_call))MB_ptr_call
  LineEdit_methods.get_right_icon._get_right_icon = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "get_right_icon", 255860311, loc))
  LineEdit_methods.get_right_icon.m_call = cast(type_of(LineEdit_methods.get_right_icon.m_call))MB_ptr_call
  LineEdit_methods.set_icon_expand_mode._set_icon_expand_mode = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "set_icon_expand_mode", 3019903192, loc))
  LineEdit_methods.set_icon_expand_mode.m_call = cast(type_of(LineEdit_methods.set_icon_expand_mode.m_call))MB_ptr_call
  LineEdit_methods.get_icon_expand_mode._get_icon_expand_mode = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "get_icon_expand_mode", 3273584435, loc))
  LineEdit_methods.get_icon_expand_mode.m_call = cast(type_of(LineEdit_methods.get_icon_expand_mode.m_call))MB_ptr_call
  LineEdit_methods.set_right_icon_scale._set_right_icon_scale = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "set_right_icon_scale", 373806689, loc))
  LineEdit_methods.set_right_icon_scale.m_call = cast(type_of(LineEdit_methods.set_right_icon_scale.m_call))MB_ptr_call
  LineEdit_methods.get_right_icon_scale._get_right_icon_scale = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "get_right_icon_scale", 1740695150, loc))
  LineEdit_methods.get_right_icon_scale.m_call = cast(type_of(LineEdit_methods.get_right_icon_scale.m_call))MB_ptr_call
  LineEdit_methods.set_flat._set_flat = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "set_flat", 2586408642, loc))
  LineEdit_methods.set_flat.m_call = cast(type_of(LineEdit_methods.set_flat.m_call))MB_ptr_call
  LineEdit_methods.is_flat._is_flat = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "is_flat", 36873697, loc))
  LineEdit_methods.is_flat.m_call = cast(type_of(LineEdit_methods.is_flat.m_call))MB_ptr_call
  LineEdit_methods.set_select_all_on_focus._set_select_all_on_focus = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "set_select_all_on_focus", 2586408642, loc))
  LineEdit_methods.set_select_all_on_focus.m_call = cast(type_of(LineEdit_methods.set_select_all_on_focus.m_call))MB_ptr_call
  LineEdit_methods.is_select_all_on_focus._is_select_all_on_focus = (cast(^GDW.MethodBind)classDBGetMethodBind3(.LineEdit, "is_select_all_on_focus", 36873697, loc))
