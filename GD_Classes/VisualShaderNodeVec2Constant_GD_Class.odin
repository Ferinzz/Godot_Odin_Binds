...
VisualShaderNodeVec2Constant_MethodBind_List :: struct {
  set_constant: struct{
    ...
    m_call: proc(_:^GDW.MethodBind, obj: VisualShaderNodeVec2Constant, #by_ptr args: i64 = 0, r_ret: ^GDW.Vector2)
  },
};
VisualShaderNodeVec2Constant_Init_ :: proc (VisualShaderNodeVec2Constant_methods: ^VisualShaderNodeVec2Constant_MethodBind_List, loc := #caller_location) {
  ...
  VisualShaderNodeVec2Constant_methods.set_constant.m_call = cast(type_of(VisualShaderNodeVec2Constant_methods.set_constant.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  VisualShaderNodeVec2Constant_methods.get_constant.m_call = cast(type_of(VisualShaderNodeVec2Constant_methods.get_constant.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
