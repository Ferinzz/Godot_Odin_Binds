...
AudioListener2D_Init_ :: proc (AudioListener2D_methods: ^AudioListener2D_MethodBind_List, loc := #caller_location) {
  ...
  AudioListener2D_methods.make_current.m_call = cast(type_of(AudioListener2D_methods.make_current.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioListener2D_methods.clear_current.m_call = cast(type_of(AudioListener2D_methods.clear_current.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  AudioListener2D_methods.is_current.m_call = cast(type_of(AudioListener2D_methods.is_current.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
