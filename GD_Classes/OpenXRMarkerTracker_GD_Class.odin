...
OpenXRMarkerTracker_Init_ :: proc (OpenXRMarkerTracker_methods: ^OpenXRMarkerTracker_MethodBind_List, loc := #caller_location) {
  ...
  OpenXRMarkerTracker_methods.set_bounds_size.m_call = cast(type_of(OpenXRMarkerTracker_methods.set_bounds_size.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRMarkerTracker_methods.get_bounds_size.m_call = cast(type_of(OpenXRMarkerTracker_methods.get_bounds_size.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRMarkerTracker_methods.set_marker_type.m_call = cast(type_of(OpenXRMarkerTracker_methods.set_marker_type.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRMarkerTracker_methods.get_marker_type.m_call = cast(type_of(OpenXRMarkerTracker_methods.get_marker_type.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRMarkerTracker_methods.set_marker_id.m_call = cast(type_of(OpenXRMarkerTracker_methods.set_marker_id.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRMarkerTracker_methods.get_marker_id.m_call = cast(type_of(OpenXRMarkerTracker_methods.get_marker_id.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRMarkerTracker_methods.set_marker_data.m_call = cast(type_of(OpenXRMarkerTracker_methods.set_marker_data.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
  ...
  OpenXRMarkerTracker_methods.get_marker_data.m_call = cast(type_of(OpenXRMarkerTracker_methods.get_marker_data.m_call))gdAPI.get_Interface_Address("object_method_bind_ptrcall")
};
